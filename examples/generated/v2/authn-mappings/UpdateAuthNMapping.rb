...
body = DatadogAPIClient::V2::AuthNMappingUpdateRequest.new({ data: DatadogAPIClient::V2::AuthNMappingUpdate.new({ id: "3653d3c6-0c75-11ea-ad28-fb5701eabc7d", type: DatadogAPIClient::V2::AuthNMappingsType::AUTHN_MAPPINGS }) }) # AuthNMappingUpdateRequest |
