...
body = DatadogAPIClient::V1::SyntheticsAPITest.new({
  config: DatadogAPIClient::V1::SyntheticsAPITestConfig.new({
    ...
    request: DatadogAPIClient::V1::SyntheticsTestRequest.new({
      ...
      headers: DatadogAPIClient::V1::SyntheticsTestHeaders.new({ unique: 'exampleeditanapitestreturnsokresponse' }),
  ...
  options: DatadogAPIClient::V1::SyntheticsTestOptions.new({
    ...
    monitor_priority: 5,
    _retry: DatadogAPIClient::V1::SyntheticsTestOptionsRetry.new({ count: 3, interval: 10 }),
    tick_every: 60
  }),
