...
body = DatadogAPIClient::V2::ElasticCloudIntegrationAccountRequest.new({
  data: DatadogAPIClient::V2::ElasticCloudIntegrationAccountCreateData.new({
    attributes: DatadogAPIClient::V2::ElasticCloudIntegrationAccountAttributes.new({
      interface: DatadogAPIClient::V2::ElasticCloudMonitoringInterface.new({
...
p api_instance.create_elastic_cloud_integration_account(ElasticCloudInterfaceId::ELASTIC_CLOUD, body)
