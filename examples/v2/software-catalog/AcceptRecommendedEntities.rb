...
DatadogAPIClient.configure do |config|
  config.unstable_operations["v2.accept_recommended_entities".to_sym] = true
end
api_instance = DatadogAPIClient::V2::SoftwareCatalogAPI.new

body = [
  DatadogAPIClient::V2::RecommendedEntityWithSchema.new({
    id: "123abc456def",
    schema: DatadogAPIClient::V2::EntityV3Service.new({
...
p api_instance.accept_recommended_entities(body)
