# Send running job event returns "Request accepted for processing" response
...
body = DatadogAPIClient::V2::CIAppCreatePipelineEventRequest.new({
  data: DatadogAPIClient::V2::CIAppCreatePipelineEventRequestData.new({
    attributes: DatadogAPIClient::V2::CIAppCreatePipelineEventRequestAttributes.new({
      resource: DatadogAPIClient::V2::CIAppPipelineEventInProgressJob.new({
        ...
        start: (Time.now + -120),
        status: DatadogAPIClient::V2::CIAppPipelineEventJobInProgressStatus::RUNNING,
