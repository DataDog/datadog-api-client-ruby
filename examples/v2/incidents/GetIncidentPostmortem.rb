...
DatadogAPIClient.configure do |config|
  config.unstable_operations["v2.get_incident_postmortem".to_sym] = true
end
...
p api_instance.get_incident_postmortem(POSTMORTEM_DATA_RELATIONSHIPS_INCIDENT_DATA_ID)
