...
DatadogAPIClient.configure do |config|
  config.unstable_operations["v2.update_incident_jira_template".to_sym] = true
end
...
p api_instance.update_incident_jira_template("9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d", body)
