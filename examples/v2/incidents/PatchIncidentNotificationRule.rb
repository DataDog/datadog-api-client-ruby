...
DatadogAPIClient.configure do |config|
  config.unstable_operations["v2.patch_incident_notification_rule".to_sym] = true
end
...
p api_instance.patch_incident_notification_rule("00000000-0000-0000-0000-000000000001", body)
