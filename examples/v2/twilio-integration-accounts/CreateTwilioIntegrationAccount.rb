...
body = DatadogAPIClient::V2::TwilioIntegrationAccountRequest.new({
  data: DatadogAPIClient::V2::TwilioIntegrationAccountCreateData.new({
    attributes: DatadogAPIClient::V2::TwilioIntegrationAccountAttributes.new({
...
p api_instance.create_twilio_integration_account(TwilioInterfaceType::TWILIO, body)
