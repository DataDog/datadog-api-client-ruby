...
DatadogAPIClient.configure do |config|
  config.unstable_operations["v2.create_aws_accountv2".to_sym] = true
end
api_instance = DatadogAPIClient::V2::AWSIntegrationAPI.new

body = DatadogAPIClient::V2::AWSAccountCreateRequest.new({
  data: DatadogAPIClient::V2::AWSAccountCreate.new({
    attributes: DatadogAPIClient::V2::AWSAccountCreateAttributes.new({
      account_tags: [],
...
p api_instance.create_aws_accountv2(body)
