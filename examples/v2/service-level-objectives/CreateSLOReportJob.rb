...
body = DatadogAPIClient::V2::SLOReportPostRequest.new({
  data: DatadogAPIClient::V2::SLOReportPostRequestData.new({
    attributes: DatadogAPIClient::V2::SloReportPostRequestAttributes.new({
      from_ts: 1690901870,
      to_ts: 1706803070,
