...
DatadogAPIClient.configure do |config|
  config.unstable_operations["v2.query_product_analytics_journey_scalar".to_sym] = true
end
api_instance = DatadogAPIClient::V2::ProductAnalyticsAPI.new

body = DatadogAPIClient::V2::ProductAnalyticsJourneyScalarRequest.new({
  data: DatadogAPIClient::V2::ProductAnalyticsJourneyScalarRequestData.new({
    attributes: DatadogAPIClient::V2::ProductAnalyticsJourneyScalarRequestAttributes.new({
      from: 1756425600000,
      query: DatadogAPIClient::V2::ProductAnalyticsJourneyScalarQuery.new({
        compute: DatadogAPIClient::V2::ProductAnalyticsJourneyScalarCompute.new({
          aggregation: "count",
...
p api_instance.query_product_analytics_journey_scalar(body)
