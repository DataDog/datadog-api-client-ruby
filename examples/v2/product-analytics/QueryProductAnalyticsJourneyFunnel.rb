...
DatadogAPIClient.configure do |config|
  config.unstable_operations["v2.query_product_analytics_journey_funnel".to_sym] = true
end
api_instance = DatadogAPIClient::V2::ProductAnalyticsAPI.new

body = DatadogAPIClient::V2::ProductAnalyticsJourneyFunnelRequest.new({
  data: DatadogAPIClient::V2::ProductAnalyticsJourneyFunnelRequestData.new({
    attributes: DatadogAPIClient::V2::ProductAnalyticsJourneyFunnelRequestAttributes.new({
      exclude_anonymous_traffic: false,
      from: 1756425600000,
      query: DatadogAPIClient::V2::ProductAnalyticsJourneyFunnelQuery.new({
        compute: DatadogAPIClient::V2::ProductAnalyticsJourneyFunnelCompute.new({}),
        group_by: [
    ...
    type: DatadogAPIClient::V2::ProductAnalyticsJourneyRequestType::JOURNEY_REQUEST,
  }),
})
p api_instance.query_product_analytics_journey_funnel(body)
