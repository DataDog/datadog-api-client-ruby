...
DatadogAPIClient.configure do |config|
  config.unstable_operations["v2.query_product_analytics_retention_timeseries".to_sym] = true
end
...
p api_instance.query_product_analytics_retention_timeseries(body)
