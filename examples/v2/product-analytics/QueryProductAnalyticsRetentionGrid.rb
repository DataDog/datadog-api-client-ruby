...
DatadogAPIClient.configure do |config|
  config.unstable_operations["v2.query_product_analytics_retention_grid".to_sym] = true
end
api_instance = DatadogAPIClient::V2::ProductAnalyticsAPI.new

body = DatadogAPIClient::V2::ProductAnalyticsRetentionGridRequest.new({
  data: DatadogAPIClient::V2::ProductAnalyticsRetentionGridRequestData.new({
    attributes: DatadogAPIClient::V2::ProductAnalyticsRetentionGridRequestAttributes.new({
      exclude_anonymous_traffic: false,
      from: 1756425600000,
      query: DatadogAPIClient::V2::ProductAnalyticsRetentionGridQuery.new({
    ...
    type: DatadogAPIClient::V2::ProductAnalyticsRetentionGridRequestType::RETENTION_GRID_REQUEST,
  }),
})
p api_instance.query_product_analytics_retention_grid(body)
