# Timeseries cross product query with product_analytics data source returns "OK" response
    ...
    attributes: DatadogAPIClient::V2::TimeseriesFormulaRequestAttributes.new({
      ...
      queries: [
        DatadogAPIClient::V2::EventsTimeseriesQuery.new({
          data_source: DatadogAPIClient::V2::EventsDataSource::PRODUCT_ANALYTICS,
          name: "a",
