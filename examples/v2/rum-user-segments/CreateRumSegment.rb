...
body = DatadogAPIClient::V2::RumSegmentCreateRequest.new({
  data: DatadogAPIClient::V2::RumSegmentCreateData.new({
    attributes: DatadogAPIClient::V2::RumSegmentCreateAttributes.new({
