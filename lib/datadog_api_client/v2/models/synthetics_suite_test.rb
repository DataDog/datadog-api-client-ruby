  ...
  class SyntheticsSuiteTest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SyntheticsSuiteTest` initialize method"
      end
      ...
      if attributes.key?(:'alerting_criticality')
        self.alerting_criticality = attributes[:'alerting_criticality']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          alerting_criticality == o.alerting_criticality &&
    ...
    # @!visibility private
    def hash
      [alerting_criticality, public_id, additional_properties].hash
    end
  end
end
