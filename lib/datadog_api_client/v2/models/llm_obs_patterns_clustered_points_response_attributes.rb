...
module DatadogAPIClient::V2
  ...
  class LLMObsPatternsClusteredPointsResponseAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsPatternsClusteredPointsResponseAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [next_page_token, points, topic_id, additional_properties].hash
    end
  end
end
