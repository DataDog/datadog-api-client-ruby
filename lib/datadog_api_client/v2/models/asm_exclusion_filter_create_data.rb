...
module DatadogAPIClient::V2
  ...
  class ASMExclusionFilterCreateData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ASMExclusionFilterCreateData` initialize method"
      end
