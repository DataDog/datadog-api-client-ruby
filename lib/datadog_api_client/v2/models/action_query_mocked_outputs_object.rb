  ...
  class ActionQueryMockedOutputsObject
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ActionQueryMockedOutputsObject` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [enabled, outputs, additional_properties].hash
    end
  end
end
