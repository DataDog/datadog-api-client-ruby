  ...
  class AWSAssumeRoleUpdate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AWSAssumeRoleUpdate` initialize method"
      end
    ...
    def valid?
      ...
      return false if !@account_id.nil? && @account_id !~ pattern
    ...
    # @!visibility private
    def hash
      [account_id, generate_new_external_id, role, type, additional_properties].hash
    end
  end
end
