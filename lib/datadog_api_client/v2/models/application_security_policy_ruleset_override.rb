...
module DatadogAPIClient::V2
  ...
  class ApplicationSecurityPolicyRulesetOverride
    ...
    def initialize(attributes = {})
      warn "[DEPRECATION] `ApplicationSecurityPolicyRulesetOverride` is deprecated."
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ApplicationSecurityPolicyRulesetOverride` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [blocking, enabled, id, additional_properties].hash
    end
  end
end
