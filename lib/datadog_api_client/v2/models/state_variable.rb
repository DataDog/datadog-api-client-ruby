  ...
  class StateVariable
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::StateVariable` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [id, name, properties, type, additional_properties].hash
    end
  end
end
