...
module DatadogAPIClient::V2
  ...
  class PipelineRenameFieldsProcessorField
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::PipelineRenameFieldsProcessorField` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [destination, include, preserve_source, source, additional_properties].hash
    end
  end
end
