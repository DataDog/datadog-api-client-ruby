  ...
  class IncidentImportRelationships
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentImportRelationships` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [commander_user, declared_by_user, additional_properties].hash
    end
  end
end
