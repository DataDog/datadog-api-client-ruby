  ...
  class ProductAnalyticsOccurrenceQuery
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ProductAnalyticsOccurrenceQuery` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [data_source, search, additional_properties].hash
    end
  end
end
