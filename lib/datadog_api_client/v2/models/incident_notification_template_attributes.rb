  ...
  class IncidentNotificationTemplateAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentNotificationTemplateAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [category, content, created, modified, name, subject, additional_properties].hash
    end
  end
end
