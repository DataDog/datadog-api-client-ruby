...
module DatadogAPIClient::V2
  ...
  class SyntheticsTestResultFileRef
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SyntheticsTestResultFileRef` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [bucket_key, encoding, name, size, type, additional_properties].hash
    end
  end
end
