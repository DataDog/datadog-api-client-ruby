  ...
  class SecurityMonitoringIntegrationConfigGoogleWorkspaceServiceAccount
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityMonitoringIntegrationConfigGoogleWorkspaceServiceAccount` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [client_email, private_key, project_id, type, additional_properties].hash
    end
  end
end
