...
module DatadogAPIClient::V2
  ...
  class LLMObsPatternsConfigsResponseAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsPatternsConfigsResponseAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [configs, additional_properties].hash
    end
  end
end
