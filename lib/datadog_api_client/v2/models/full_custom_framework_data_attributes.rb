  ...
  class FullCustomFrameworkDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::FullCustomFrameworkDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [created_at, created_by, description, handle, icon_url, id, modified_at, name, org_id, requirements, version, additional_properties].hash
    end
  end
end
