  ...
  class OktaAPITokenUpdate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::OktaAPITokenUpdate` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [api_token, domain, type, additional_properties].hash
    end
  end
end
