...
module DatadogAPIClient::V2
  ...
  class EventEmailAddressCreateAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::EventEmailAddressCreateAttributes` initialize method"
      end
    ...
    def valid?
      ...
      return false if !@notify_handles.nil? && @notify_handles.length > 10
    ...
    def notify_handles=(notify_handles)
      if !notify_handles.nil? && notify_handles.length > 10
    ...
    # @!visibility private
    def hash
      [alert_type, description, format, notify_handles, tags, additional_properties].hash
    end
  end
end
