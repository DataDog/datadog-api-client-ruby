...
module DatadogAPIClient::V2
  ...
  class FleetDeploymentV2DetailAgent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::FleetDeploymentV2DetailAgent` initialize method"
      end
      ...
      if attributes.key?(:'running_step')
        self.running_step = attributes[:'running_step']
      end
    ...
    # @!visibility private
    def hash
      [error, hostname, running_step, status, status_details, versions, additional_properties].hash
    end
  end
end
