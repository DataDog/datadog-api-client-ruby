...
module DatadogAPIClient::V2
  # 
  class JiraIssuesMetadataDataAttributesResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::JiraIssuesMetadataDataAttributesResponse` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [account_id, issue_type_id, project_id, additional_properties].hash
    end
  end
end
