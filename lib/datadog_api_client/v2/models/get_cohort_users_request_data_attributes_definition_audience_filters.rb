...
module DatadogAPIClient::V2
  # 
  class GetCohortUsersRequestDataAttributesDefinitionAudienceFilters
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::GetCohortUsersRequestDataAttributesDefinitionAudienceFilters` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [accounts, formula, segments, users, additional_properties].hash
    end
  end
end
