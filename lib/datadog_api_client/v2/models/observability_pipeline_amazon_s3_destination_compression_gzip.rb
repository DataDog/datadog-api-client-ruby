...
module DatadogAPIClient::V2
  # Gzip compression.
  class ObservabilityPipelineAmazonS3DestinationCompressionGzip
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineAmazonS3DestinationCompressionGzip` initialize method"
      end
