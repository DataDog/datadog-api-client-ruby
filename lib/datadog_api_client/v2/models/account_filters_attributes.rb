...
module DatadogAPIClient::V2
  ...
  class AccountFiltersAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AccountFiltersAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [account_filters, account_id, cloud, additional_properties].hash
    end
  end
end
