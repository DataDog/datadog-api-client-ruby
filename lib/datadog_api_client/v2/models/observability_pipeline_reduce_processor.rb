  ...
  class ObservabilityPipelineReduceProcessor
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineReduceProcessor` initialize method"
      end
    ...
    # @!visibility private
    def merge_strategies=(merge_strategies)
      if merge_strategies.nil?
        fail ArgumentError, 'invalid value for "merge_strategies", merge_strategies cannot be nil.'
      end
      @merge_strategies = merge_strategies
    end
    ...
    # @!visibility private
    def hash
      [enabled, group_by, id, include, inputs, merge_strategies, type, additional_properties].hash
    end
  end
end
