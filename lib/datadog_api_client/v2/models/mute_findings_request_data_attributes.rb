...
module DatadogAPIClient::V2
  ...
  class MuteFindingsRequestDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::MuteFindingsRequestDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [mute, additional_properties].hash
    end
  end
end
