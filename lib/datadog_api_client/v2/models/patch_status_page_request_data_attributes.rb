  ...
  class PatchStatusPageRequestDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::PatchStatusPageRequestDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [company_logo, domain_prefix, email_header_image, enabled, favicon, name, subscriptions_enabled, type, visualization_type, additional_properties].hash
    end
  end
end
