  ...
  class LLMObsAnnotationsDataAttributesResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsAnnotationsDataAttributesResponse` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [annotations, errors, additional_properties].hash
    end
  end
end
