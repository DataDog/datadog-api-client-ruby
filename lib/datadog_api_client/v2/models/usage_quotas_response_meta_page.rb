...
module DatadogAPIClient::V2
  ...
  class UsageQuotasResponseMetaPage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::UsageQuotasResponseMetaPage` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [next_cursor, additional_properties].hash
    end
  end
end
