...
module DatadogAPIClient::V2
  ...
  class CreateDegradationTemplateRequestDataAttributes
    ...
    def self.openapi_types
      {
        :'components_affected' => :'Array<CreateDegradationTemplateRequestDataAttributesComponentsAffectedItems>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CreateDegradationTemplateRequestDataAttributes` initialize method"
      end
