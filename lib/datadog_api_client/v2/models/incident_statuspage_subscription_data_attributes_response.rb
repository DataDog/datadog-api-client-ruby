...
module DatadogAPIClient::V2
  ...
  class IncidentStatuspageSubscriptionDataAttributesResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentStatuspageSubscriptionDataAttributesResponse` initialize method"
      end
    ...
    # @param confirmed [Object] Object to be assigned
    # @!visibility private
    def confirmed=(confirmed)
      if confirmed.nil?
        fail ArgumentError, 'invalid value for "confirmed", confirmed cannot be nil.'
      end
      @confirmed = confirmed
    end
    ...
    # @!visibility private
    def hash
      [confirmed, created_at, email, additional_properties].hash
    end
  end
end
