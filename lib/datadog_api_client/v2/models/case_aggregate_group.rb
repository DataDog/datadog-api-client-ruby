  ...
  class CaseAggregateGroup
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CaseAggregateGroup` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [group, value, additional_properties].hash
    end
  end
end
