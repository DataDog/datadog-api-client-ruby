  ...
  class ReportScheduleResponseAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ReportScheduleResponseAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [delivery_format, description, next_recurrence, recipients, resource_id, resource_type, rrule, status, tab_id, template_variables, timeframe, timezone, title, additional_properties].hash
    end
  end
end
