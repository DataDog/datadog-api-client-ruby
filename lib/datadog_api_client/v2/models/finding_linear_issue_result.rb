...
module DatadogAPIClient::V2
  ...
  class FindingLinearIssueResult
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::FindingLinearIssueResult` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [account_id, issue_id, issue_key, team_id, url, additional_properties].hash
    end
  end
end
