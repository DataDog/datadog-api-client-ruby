...
module DatadogAPIClient::V2
  ...
  class AggregatedLongTasksResponseAttributesCriteria
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AggregatedLongTasksResponseAttributesCriteria` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [max, metric, min, additional_properties].hash
    end
  end
end
