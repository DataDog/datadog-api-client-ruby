...
module DatadogAPIClient::V2
  ...
  class ASMExclusionListFilterData
    ...
    def self.openapi_types
      {
        :'attributes' => :'ASMExclusionFilterListAttributes',
        :'id' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ASMExclusionListFilterData` initialize method"
      end
