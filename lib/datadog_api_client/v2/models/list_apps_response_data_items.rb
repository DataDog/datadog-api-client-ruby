  ...
  class ListAppsResponseDataItems
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ListAppsResponseDataItems` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [attributes, id, meta, relationships, type].hash
    end
  end
end
