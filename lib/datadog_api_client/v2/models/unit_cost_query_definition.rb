...
module DatadogAPIClient::V2
  ...
  class UnitCostQueryDefinition
    ...
    def self.openapi_types
      {
        :'formulas' => :'Array<Hash<String, Object>>',
        :'queries' => :'Array<Hash<String, Object>>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::UnitCostQueryDefinition` initialize method"
      end
