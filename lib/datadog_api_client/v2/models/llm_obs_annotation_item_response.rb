...
module DatadogAPIClient::V2
  ...
  class LLMObsAnnotationItemResponse
    ...
    def self.openapi_types
      {
        ...
        :'label_values' => :'Array<LLMObsAnnotationLabelValueResponse>',
        :'modified_at' => :'Time',
        :'modified_by' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsAnnotationItemResponse` initialize method"
      end
