...
module DatadogAPIClient::V2
  ...
  class ElasticCloudIntegrationAccountAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ElasticCloudIntegrationAccountAttributes` initialize method"
      end
    ...
    # @param interface [Object] Object to be assigned
    # @!visibility private
    def interface=(interface)
      if interface.nil?
        fail ArgumentError, 'invalid value for "interface", interface cannot be nil.'
      end
      @interface = interface
    end
    ...
    # @!visibility private
    def hash
      [interface, name, permissions, additional_properties].hash
    end
  end
end
