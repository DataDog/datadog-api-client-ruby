  ...
  class CommitmentsListResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CommitmentsListResponse` initialize method"
      end
    ...
    # @param commitments [Object] Object to be assigned
    # @!visibility private
    def commitments=(commitments)
      if commitments.nil?
        fail ArgumentError, 'invalid value for "commitments", commitments cannot be nil.'
      end
      @commitments = commitments
    end
    ...
    # @!visibility private
    def hash
      [commitments, meta, additional_properties].hash
    end
  end
end
