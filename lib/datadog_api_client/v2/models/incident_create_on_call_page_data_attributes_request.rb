  ...
  class IncidentCreateOnCallPageDataAttributesRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentCreateOnCallPageDataAttributesRequest` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [description, role, services, tags, target, title, additional_properties].hash
    end
  end
end
