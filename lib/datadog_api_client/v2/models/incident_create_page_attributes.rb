...
module DatadogAPIClient::V2
  ...
  class IncidentCreatePageAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentCreatePageAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [description, services, tags, target, title, additional_properties].hash
    end
  end
end
