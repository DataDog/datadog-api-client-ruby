...
module DatadogAPIClient::V2
  ...
  class ElasticCloudMonitoringAccountAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ElasticCloudMonitoringAccountAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [authentication, dataflows, name, permissions, settings, additional_properties].hash
    end
  end
end
