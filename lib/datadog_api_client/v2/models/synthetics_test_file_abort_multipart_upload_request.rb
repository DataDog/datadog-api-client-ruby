  ...
  class SyntheticsTestFileAbortMultipartUploadRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SyntheticsTestFileAbortMultipartUploadRequest` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [key, upload_id, additional_properties].hash
    end
  end
end
