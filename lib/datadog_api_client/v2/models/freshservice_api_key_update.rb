  ...
  class FreshserviceAPIKeyUpdate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::FreshserviceAPIKeyUpdate` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [api_key, domain, type, additional_properties].hash
    end
  end
end
