...
module DatadogAPIClient::V2
  ...
  class CreateDeploymentGateParamsDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CreateDeploymentGateParamsDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [dry_run, env, identifier, service, additional_properties].hash
    end
  end
end
