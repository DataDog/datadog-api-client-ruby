  ...
  class ChatMessage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ChatMessage` initialize method"
      end
    ...
    # @param chat_id [Object] Object to be assigned
    # @!visibility private
    def chat_id=(chat_id)
      if chat_id.nil?
        fail ArgumentError, 'invalid value for "chat_id", chat_id cannot be nil.'
      end
      @chat_id = chat_id
    end
    ...
    # @!visibility private
    def hash
      [chat_id, content, id, role, user_uuid, additional_properties].hash
    end
  end
end
