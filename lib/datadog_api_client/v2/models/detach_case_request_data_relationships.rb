...
module DatadogAPIClient::V2
  # Relationships detaching findings from their case.
  class DetachCaseRequestDataRelationships
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DetachCaseRequestDataRelationships` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [findings, additional_properties].hash
    end
  end
end
