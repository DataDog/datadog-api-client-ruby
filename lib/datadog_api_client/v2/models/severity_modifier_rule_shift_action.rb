...
module DatadogAPIClient::V2
  ...
  class SeverityModifierRuleShiftAction
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SeverityModifierRuleShiftAction` initialize method"
      end
      ...
      if attributes.key?(:'severity_delta')
        self.severity_delta = attributes[:'severity_delta']
      end
    ...
    def valid?
      ...
      return false if @severity_delta.nil?
    ...
    # Custom attribute writer method with validation
    # @param severity_delta [Object] Object to be assigned
    # @!visibility private
    def severity_delta=(severity_delta)
      if severity_delta.nil?
        fail ArgumentError, 'invalid value for "severity_delta", severity_delta cannot be nil.'
      end
      @severity_delta = severity_delta
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          severity_delta == o.severity_delta &&
          type == o.type &&
    ...
    # @!visibility private
    def hash
      [description, severity_delta, type, additional_properties].hash
    end
  end
end
