...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [domain, integration_type, name, secrets, settings, additional_properties].hash
    end
  end
end
