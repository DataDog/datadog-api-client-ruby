...
module DatadogAPIClient::V2
  ...
  class ResourceFilterAttributes
    ...
    def self.openapi_types
      {
        :'cloud_provider' => :'Hash<String, Hash<String, Array<String>>>',
        :'uuid' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ResourceFilterAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [cloud_provider, uuid, additional_properties].hash
    end
  end
end
