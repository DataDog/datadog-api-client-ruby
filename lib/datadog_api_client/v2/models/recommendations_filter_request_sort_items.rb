  ...
  class RecommendationsFilterRequestSortItems
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RecommendationsFilterRequestSortItems` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [expression, order, additional_properties].hash
    end
  end
end
