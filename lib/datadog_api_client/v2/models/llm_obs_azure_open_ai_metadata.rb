...
module DatadogAPIClient::V2
  ...
  class LLMObsAzureOpenAIMetadata
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsAzureOpenAIMetadata` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [deployment_id, model_version, resource_name, additional_properties].hash
    end
  end
end
