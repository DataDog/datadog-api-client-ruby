  ...
  class BudgetWithEntriesData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::BudgetWithEntriesData` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [created_at, created_by, end_month, entries, id, metrics_query, name, org_id, start_month, tags, total_amount, updated_at, updated_by, additional_properties].hash
    end
  end
end
