  ...
  class CommitmentsScalarColumn
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CommitmentsScalarColumn` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [meta, name, type, values, additional_properties].hash
    end
  end
end
