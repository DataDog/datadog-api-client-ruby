...
module DatadogAPIClient::V2
  ...
  class ApplicationSecurityExclusionFilterAttributes
    ...
    def self.openapi_types
      {
        ...
        :'on_match' => :'ApplicationSecurityExclusionFilterOnMatch',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ApplicationSecurityExclusionFilterAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [description, enabled, event_query, ip_list, on_match, parameters, path_glob, rules_target, scope, additional_properties].hash
    end
  end
end
