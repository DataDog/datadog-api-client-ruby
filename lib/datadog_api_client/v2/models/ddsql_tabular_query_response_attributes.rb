  ...
  class DdsqlTabularQueryResponseAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DdsqlTabularQueryResponseAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [columns, query_id, state, warnings, additional_properties].hash
    end
  end
end
