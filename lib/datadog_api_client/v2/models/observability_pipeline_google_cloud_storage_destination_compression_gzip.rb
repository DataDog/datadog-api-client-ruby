...
module DatadogAPIClient::V2
  # Gzip compression.
  class ObservabilityPipelineGoogleCloudStorageDestinationCompressionGzip
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineGoogleCloudStorageDestinationCompressionGzip` initialize method"
      end
    ...
    def level=(level)
      ...
      if level > 9
        fail ArgumentError, 'invalid value for "level", must be smaller than or equal to 9.'
      end
      if level < 1
