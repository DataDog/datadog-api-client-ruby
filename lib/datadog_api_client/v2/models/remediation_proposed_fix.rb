  ...
  class RemediationProposedFix
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RemediationProposedFix` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [description, reversible, risk, title, additional_properties].hash
    end
  end
end
