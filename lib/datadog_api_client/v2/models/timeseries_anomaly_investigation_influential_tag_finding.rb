...
module DatadogAPIClient::V2
  ...
  class TimeseriesAnomalyInvestigationInfluentialTagFinding
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::TimeseriesAnomalyInvestigationInfluentialTagFinding` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param headline [Object] Object to be assigned
    # @!visibility private
    def headline=(headline)
      if headline.nil?
        fail ArgumentError, 'invalid value for "headline", headline cannot be nil.'
      end
      @headline = headline
    end
    ...
    # @!visibility private
    def hash
      [description, headline, tag, type, additional_properties].hash
    end
  end
end
