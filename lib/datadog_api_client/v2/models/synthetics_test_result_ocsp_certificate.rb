...
module DatadogAPIClient::V2
  ...
  class SyntheticsTestResultOCSPCertificate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SyntheticsTestResultOCSPCertificate` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [revocation_reason, revocation_time, serial_number, additional_properties].hash
    end
  end
end
