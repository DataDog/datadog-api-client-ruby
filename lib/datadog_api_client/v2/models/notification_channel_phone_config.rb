...
module DatadogAPIClient::V2
  ...
  class NotificationChannelPhoneConfig
    ...
    # Formatted number is the formatted international version of Number (e.g. +33 7 1 23 45 67).
    attr_reader :formatted_number

    # Number is the E-164 formatted phone number (e.g. +3371234567)
    attr_reader :number

    # Region is the ISO 3166-1 alpha-2 two-letter country code.
    attr_reader :region
    ...
    # Verified indicates whether this phone has been verified by the user in Datadog On-Call
