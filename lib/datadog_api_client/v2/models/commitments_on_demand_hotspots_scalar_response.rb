  ...
  class CommitmentsOnDemandHotspotsScalarResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CommitmentsOnDemandHotspotsScalarResponse` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [columns, meta, total, additional_properties].hash
    end
  end
end
