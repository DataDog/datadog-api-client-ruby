...
module DatadogAPIClient::V2
  ...
  class LLMObsOpenAIMetadata
    ...
    attr_accessor :reasoning_summary
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsOpenAIMetadata` initialize method"
      end
      ...
      if attributes.key?(:'reasoning_summary')
        self.reasoning_summary = attributes[:'reasoning_summary']
      end
    end
    ...
    # @!visibility private
    def hash
      [reasoning_effort, reasoning_summary, additional_properties].hash
    end
  end
end
