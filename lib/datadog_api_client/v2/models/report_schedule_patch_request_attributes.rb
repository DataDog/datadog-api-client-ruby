...
module DatadogAPIClient::V2
  ...
  class ReportSchedulePatchRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ReportSchedulePatchRequestAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [delivery_format, description, recipients, rrule, tab_id, template_variables, timeframe, timezone, title, additional_properties].hash
    end
  end
end
