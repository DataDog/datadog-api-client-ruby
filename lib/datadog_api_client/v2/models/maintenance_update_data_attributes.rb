...
module DatadogAPIClient::V2
  ...
  class MaintenanceUpdateDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::MaintenanceUpdateDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [components_affected, created_at, description, manual_transition, modified_at, started_at, status, additional_properties].hash
    end
  end
end
