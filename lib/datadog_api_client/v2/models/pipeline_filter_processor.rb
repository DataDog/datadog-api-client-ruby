  ...
  class PipelineFilterProcessor
    ...
    def self.openapi_types
      {
        ...
        :'include' => :'String',
        :'inputs' => :'Array<String>',
        :'type' => :'PipelineFilterProcessorType'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::PipelineFilterProcessor` initialize method"
      end
