  ...
  class JiraIssueTemplateUpdateRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::JiraIssueTemplateUpdateRequestAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [fields, name, additional_properties].hash
    end
  end
end
