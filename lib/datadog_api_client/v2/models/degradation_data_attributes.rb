  ...
  class DegradationDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DegradationDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [components_affected, created_at, description, modified_at, status, title, updates, additional_properties].hash
    end
  end
end
