...
module DatadogAPIClient::V2
  ...
  class LLMObsExperimentationSortField
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsExperimentationSortField` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [direction, field, additional_properties].hash
    end
  end
end
