  ...
  class AnalysisFix
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AnalysisFix` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param edits [Object] Object to be assigned
    # @!visibility private
    def edits=(edits)
      if edits.nil?
        fail ArgumentError, 'invalid value for "edits", edits cannot be nil.'
      end
      @edits = edits
    end
    ...
    # @!visibility private
    def hash
      [description, edits, additional_properties].hash
    end
  end
end
