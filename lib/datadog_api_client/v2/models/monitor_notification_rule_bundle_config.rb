  ...
  class MonitorNotificationRuleBundleConfig
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::MonitorNotificationRuleBundleConfig` initialize method"
      end
    ...
    def valid?
      ...
      return false if @duration > 2147483647
      true
    end
