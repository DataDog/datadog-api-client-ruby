  ...
  class EntityV3APISpec
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::EntityV3APISpec` initialize method"
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          implemented_by == o.implemented_by &&
    ...
    # @!visibility private
    def hash
      [implemented_by, interface, lifecycle, tier, type].hash
    end
  end
end
