...
module DatadogAPIClient::V2
  ...
  class MaintenanceTemplateDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::MaintenanceTemplateDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [completed_description, component_ids, created_at, in_progress_description, maintenance_title, modified_at, name, scheduled_description, additional_properties].hash
    end
  end
end
