...
module DatadogAPIClient::V2
  # 
  class SankeyRequestDataAttributesSearchOccurrences
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SankeyRequestDataAttributesSearchOccurrences` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [meta, operator, value, additional_properties].hash
    end
  end
end
