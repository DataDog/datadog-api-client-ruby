  ...
  class UpdateAppResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::UpdateAppResponse` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [data, included, meta, relationship, additional_properties].hash
    end
  end
end
