...
module DatadogAPIClient::V2
  ...
  class CreatePageRequestDataAttributes
    ...
    # The level of urgency for the alert. Possible value `low` or `high`.
    attr_reader :urgency
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CreatePageRequestDataAttributes` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param urgency [Object] Object to be assigned
    # @!visibility private
    def urgency=(urgency)
      if urgency.nil?
        fail ArgumentError, 'invalid value for "urgency", urgency cannot be nil.'
      end
      @urgency = urgency
    end
    ...
    # @!visibility private
    def hash
      [description, tags, target, title, urgency, additional_properties].hash
    end
  end
end
