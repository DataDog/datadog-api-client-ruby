...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringIntegrationConfigCreateData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityMonitoringIntegrationConfigCreateData` initialize method"
      end
