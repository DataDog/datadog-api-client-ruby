...
module DatadogAPIClient::V2
  ...
  class RecommendedEntityWithSchema
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RecommendedEntityWithSchema` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [id, schema, additional_properties].hash
    end
  end
end
