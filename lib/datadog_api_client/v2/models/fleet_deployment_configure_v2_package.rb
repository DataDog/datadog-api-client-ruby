...
module DatadogAPIClient::V2
  ...
  class FleetDeploymentConfigureV2Package
    ...
    attr_accessor :apm_instrumentation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::FleetDeploymentConfigureV2Package` initialize method"
      end
      ...
      if attributes.key?(:'apm_instrumentation')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          apm_instrumentation == o.apm_instrumentation &&
          name == o.name &&
          version == o.version &&
    ...
    # @!visibility private
    def hash
      [apm_instrumentation, name, version, additional_properties].hash
    end
  end
end
