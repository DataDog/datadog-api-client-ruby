  ...
  class EscalationPolicyCreateRequestDataAttributesStepsItems
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::EscalationPolicyCreateRequestDataAttributesStepsItems` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [assignment, escalate_after_seconds, targets, additional_properties].hash
    end
  end
end
