  ...
  class ActionInbox
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ActionInbox` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [reason_description, additional_properties].hash
    end
  end
end
