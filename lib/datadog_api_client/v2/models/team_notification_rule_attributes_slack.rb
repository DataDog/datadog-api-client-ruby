  ...
  class TeamNotificationRuleAttributesSlack
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::TeamNotificationRuleAttributesSlack` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [channel, workspace, additional_properties].hash
    end
  end
end
