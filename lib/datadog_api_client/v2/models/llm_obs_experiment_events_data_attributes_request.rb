  ...
  class LLMObsExperimentEventsDataAttributesRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsExperimentEventsDataAttributesRequest` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [metrics, spans, additional_properties].hash
    end
  end
end
