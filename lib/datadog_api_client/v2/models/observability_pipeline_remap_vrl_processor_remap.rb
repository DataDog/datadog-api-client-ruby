...
module DatadogAPIClient::V2
  ...
  class ObservabilityPipelineRemapVrlProcessorRemap
    include BaseGenericModel

    # Whether to drop events that cause errors during transformation.
    attr_accessor :drop_on_error
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineRemapVrlProcessorRemap` initialize method"
      end
    ...
    def valid?
      ...
      return false if @source.to_s.length > 3000
      true
    end
    ...
    def source=(source)
      ...
      if source.to_s.length > 3000
        fail ArgumentError, 'invalid value for "source", the character length must be smaller than or equal to 3000.'
      end
      @source = source
    end
