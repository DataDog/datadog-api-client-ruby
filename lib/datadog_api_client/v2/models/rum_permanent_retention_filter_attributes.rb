...
module DatadogAPIClient::V2
  ...
  class RumPermanentRetentionFilterAttributes
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'editability')
        self.editability = attributes[:'editability']
      end
    ...
    # @!visibility private
    def hash
      [cross_product_sampling, description, editability, name, additional_properties].hash
    end
  end
end
