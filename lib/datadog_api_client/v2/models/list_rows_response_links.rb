  ...
  class ListRowsResponseLinks
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ListRowsResponseLinks` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [first, _next, _self, additional_properties].hash
    end
  end
end
