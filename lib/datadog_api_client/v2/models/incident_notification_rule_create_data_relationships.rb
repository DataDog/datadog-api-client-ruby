  ...
  class IncidentNotificationRuleCreateDataRelationships
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentNotificationRuleCreateDataRelationships` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [incident_type, notification_template, additional_properties].hash
    end
  end
end
