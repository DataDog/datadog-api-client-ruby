...
module DatadogAPIClient::V2
  ...
  class ASMExclusionFilterListAttributes
    ...
    def self.openapi_types
      {
        ...
        :'path_glob' => :'String',
        :'rules_target' => :'Array<ASMExclusionFilterListRulesTarget>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ASMExclusionFilterListAttributes` initialize method"
      end
