  ...
  class ItemApiPayloadMeta
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ItemApiPayloadMeta` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [page, schema, additional_properties].hash
    end
  end
end
