...
module DatadogAPIClient::V2
  ...
  class ApplicationSecurityExclusionFilterListAttributes
    ...
    def self.openapi_types
      {
        ...
        :'metadata' => :'ApplicationSecurityExclusionFilterMetadata',
        :'parameters' => :'Array<String>',
        :'path_glob' => :'String',
        :'rules_target' => :'Array<ApplicationSecurityExclusionFilterListRulesTarget>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ApplicationSecurityExclusionFilterListAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [description, enabled, ip_list, metadata, parameters, path_glob, rules_target, scope].hash
    end
  end
end
