  ...
  class SyntheticsDowntimeTimeSlotResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SyntheticsDowntimeTimeSlotResponse` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [duration, id, name, recurrence, start, timezone, additional_properties].hash
    end
  end
end
