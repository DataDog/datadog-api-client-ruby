...
module DatadogAPIClient::V2
  ...
  class IncidentRuleExecutionStateDataResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentRuleExecutionStateDataResponse` initialize method"
      end
