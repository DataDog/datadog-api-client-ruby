...
module DatadogAPIClient::V2
  ...
  class ObservabilityPipelineAmazonSecurityLakeDestination
    ...
    def valid?
      ...
      return false if @bucket.to_s.length > 63
      return false if @bucket.to_s.length < 3
    ...
    def bucket=(bucket)
      ...
      if bucket.to_s.length > 63
        fail ArgumentError, 'invalid value for "bucket", the character length must be smaller than or equal to 63.'
      end
      if bucket.to_s.length < 3
        fail ArgumentError, 'invalid value for "bucket", the character length must be great than or equal to 3.'
      end
      @bucket = bucket
    end
