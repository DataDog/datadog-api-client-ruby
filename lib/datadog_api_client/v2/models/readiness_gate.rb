...
module DatadogAPIClient::V2
  ...
  class ReadinessGate
    ...
    # @param threshold_type [Object] Object to be assigned
    # @!visibility private
    def threshold_type=(threshold_type)
      if threshold_type.nil?
        fail ArgumentError, 'invalid value for "threshold_type", threshold_type cannot be nil.'
      end
    ...
    # @!visibility private
    def hash
      [threshold_type, additional_properties].hash
    end
  end
end
