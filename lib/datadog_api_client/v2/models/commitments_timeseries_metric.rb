...
module DatadogAPIClient::V2
  ...
  class CommitmentsTimeseriesMetric
    ...
    def self.openapi_types
      {
        :'series' => :'Hash<String, Array<Float>>',
        :'times' => :'Array<Integer>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CommitmentsTimeseriesMetric` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [series, times, unit, additional_properties].hash
    end
  end
end
