...
module DatadogAPIClient::V2
  ...
  class ASMExclusionFilterAttributes
    ...
    def self.openapi_types
      {
        ...
        :'path_glob' => :'String',
        :'rules_target' => :'Array<ASMExclusionFilterRulesTarget>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ASMExclusionFilterAttributes` initialize method"
      end
