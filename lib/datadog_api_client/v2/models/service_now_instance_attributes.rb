  ...
  class ServiceNowInstanceAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ServiceNowInstanceAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [instance_name, additional_properties].hash
    end
  end
end
