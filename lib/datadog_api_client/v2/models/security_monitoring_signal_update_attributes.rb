...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringSignalUpdateAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityMonitoringSignalUpdateAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [archive_comment, archive_reason, assignee, state, version, additional_properties].hash
    end
  end
end
