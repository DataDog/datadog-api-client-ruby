...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringIntegrationConfigSentinelOneSecrets
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityMonitoringIntegrationConfigSentinelOneSecrets` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [api_token, additional_properties].hash
    end
  end
end
