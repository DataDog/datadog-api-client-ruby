  ...
  class DatabricksDataObservabilityJobsMonitoringIntegrationDataflowSettingsResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DatabricksDataObservabilityJobsMonitoringIntegrationDataflowSettingsResponse` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [dd_api_key_id, djm_global_init_script_enabled, script_gpum_enabled, script_logs_enabled, serverless_jobs_enabled, additional_properties].hash
    end
  end
end
