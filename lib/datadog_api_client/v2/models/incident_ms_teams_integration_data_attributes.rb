...
module DatadogAPIClient::V2
  ...
  class IncidentMSTeamsIntegrationDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentMSTeamsIntegrationDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [created, integration_type, modified, status, teams, additional_properties].hash
    end
  end
end
