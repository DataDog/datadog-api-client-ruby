...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringRuleResponse
    ...
    # @!visibility private
    def type=(type)
      validator = DatadogAPIClient::V2::EnumAttributeValidator.new('SecurityMonitoringRuleTypeRead', ['log_detection', 'infrastructure_configuration', 'workload_security', 'cloud_configuration'])
