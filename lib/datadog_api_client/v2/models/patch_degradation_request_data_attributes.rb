...
module DatadogAPIClient::V2
  ...
  class PatchDegradationRequestDataAttributes
    ...
    def self.openapi_types
      {
        :'components_affected' => :'Array<PatchDegradationRequestDataAttributesComponentsAffectedItems>',
        :'description' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::PatchDegradationRequestDataAttributes` initialize method"
      end
