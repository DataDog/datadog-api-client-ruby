  ...
  class AWSCcmConfigValidationRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AWSCcmConfigValidationRequestAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [account_id, bucket_name, bucket_region, report_name, report_prefix, additional_properties].hash
    end
  end
end
