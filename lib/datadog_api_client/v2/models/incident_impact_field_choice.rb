  ...
  class IncidentImpactFieldChoice
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentImpactFieldChoice` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [description, display_name, value, additional_properties].hash
    end
  end
end
