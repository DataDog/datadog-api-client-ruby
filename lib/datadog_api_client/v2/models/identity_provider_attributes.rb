  ...
  class IdentityProviderAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IdentityProviderAttributes` initialize method"
      end
    ...
    # @param authentication_method [Object] Object to be assigned
    # @!visibility private
    def authentication_method=(authentication_method)
      if authentication_method.nil?
        fail ArgumentError, 'invalid value for "authentication_method", authentication_method cannot be nil.'
      end
      @authentication_method = authentication_method
    end
    ...
    # @!visibility private
    def hash
      [authentication_method, enabled, additional_properties].hash
    end
  end
end
