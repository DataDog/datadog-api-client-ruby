...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringSignalInvestigationFeedbackSection
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityMonitoringSignalInvestigationFeedbackSection` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [id, metrics, title, additional_properties].hash
    end
  end
end
