...
module DatadogAPIClient::V2
  ...
  class PipelineRenameFieldsProcessor
    ...
    def self.openapi_types
      {
        :'fields' => :'Array<PipelineRenameFieldsProcessorField>',
        :'id' => :'String',
        :'include' => :'String',
        :'inputs' => :'Array<String>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::PipelineRenameFieldsProcessor` initialize method"
      end
