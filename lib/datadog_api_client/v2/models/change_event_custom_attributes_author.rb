...
module DatadogAPIClient::V2
  ...
  class ChangeEventCustomAttributesAuthor
    ...
    def valid?
      ...
      return false if @name.to_s.length > 128.0
    ...
    def name=(name)
      ...
      if name.to_s.length > 128.0
        fail ArgumentError, 'invalid value for "name", the character length must be smaller than or equal to 128.0.'
      end
      @name = name
    end
