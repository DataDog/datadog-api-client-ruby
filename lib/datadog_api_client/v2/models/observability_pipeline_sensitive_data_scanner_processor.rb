  ...
  class ObservabilityPipelineSensitiveDataScannerProcessor
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineSensitiveDataScannerProcessor` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [id, include, inputs, rules, type, additional_properties].hash
    end
  end
end
