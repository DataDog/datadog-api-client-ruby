...
module DatadogAPIClient::V2
  ...
  class IncidentResponderRelationships
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentResponderRelationships` initialize method"
      end
      ...
      if attributes.key?(:'role_assignments')
        self.role_assignments = attributes[:'role_assignments']
      end
    ...
    # @!visibility private
    def hash
      [created_by, last_modified_by, role_assignments, user, additional_properties].hash
    end
  end
end
