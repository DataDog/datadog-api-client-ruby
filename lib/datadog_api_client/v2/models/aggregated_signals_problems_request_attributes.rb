  ...
  class AggregatedSignalsProblemsRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AggregatedSignalsProblemsRequestAttributes` initialize method"
      end
      ...
      if attributes.key?(:'detection_types')
        if (value = attributes[:'detection_types']).is_a?(Array)
          self.detection_types = value
        end
      end
    ...
    def valid?
      ...
      return false if @sample_size > 50
    ...
    def sample_size=(sample_size)
      ...
      if sample_size > 50
        fail ArgumentError, 'invalid value for "sample_size", must be smaller than or equal to 50.'
      end
      if sample_size < 1
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          criteria == o.criteria &&
          detection_types == o.detection_types &&
          filter == o.filter &&
          from == o.from &&
    ...
    # @!visibility private
    def hash
      [application_id, criteria, detection_types, filter, from, sample_size, to, view_name, additional_properties].hash
    end
  end
end
