  ...
  class ProductAnalyticsCalendarInterval
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ProductAnalyticsCalendarInterval` initialize method"
      end
    ...
    # @param quantity [Object] Object to be assigned
    # @!visibility private
    ...
    # @!visibility private
    def hash
      [alignment, quantity, timezone, type, additional_properties].hash
    end
  end
end
