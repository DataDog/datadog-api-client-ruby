...
module DatadogAPIClient::V2
  ...
  class PrintReportResponseAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::PrintReportResponseAttributes` initialize method"
      end
    ...
    # @param download_url [Object] Object to be assigned
    # @!visibility private
    def download_url=(download_url)
      if download_url.nil?
        fail ArgumentError, 'invalid value for "download_url", download_url cannot be nil.'
      end
      @download_url = download_url
    end
    ...
    # @!visibility private
    def hash
      [download_url, from_ts, resource_id, resource_type, template_variables, timeframe, timezone, to_ts, additional_properties].hash
    end
  end
end
