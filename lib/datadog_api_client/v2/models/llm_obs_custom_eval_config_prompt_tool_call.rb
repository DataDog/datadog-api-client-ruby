  ...
  class LLMObsCustomEvalConfigPromptToolCall
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsCustomEvalConfigPromptToolCall` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [arguments, id, name, type, additional_properties].hash
    end
  end
end
