...
module DatadogAPIClient::V2
  ...
  class OrgAuthorizedClientRelationshipOAuth2ClientData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::OrgAuthorizedClientRelationshipOAuth2ClientData` initialize method"
      end
