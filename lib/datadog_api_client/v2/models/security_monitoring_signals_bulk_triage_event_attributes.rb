  ...
  class SecurityMonitoringSignalsBulkTriageEventAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityMonitoringSignalsBulkTriageEventAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [archive_comment, archive_comment_timestamp, archive_comment_user, archive_reason, assignee, id, incident_ids, state, state_update_timestamp, state_update_user, additional_properties].hash
    end
  end
end
