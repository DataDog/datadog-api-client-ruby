...
module DatadogAPIClient::V2
  ...
  class CreateBackfilledMaintenanceRequestDataAttributesUpdatesItems
    ...
    def self.openapi_types
      {
        :'components_affected' => :'Array<CreateBackfilledMaintenanceRequestDataAttributesUpdatesItemsComponentsAffectedItems>',
        :'description' => :'String',
        :'started_at' => :'Time',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CreateBackfilledMaintenanceRequestDataAttributesUpdatesItems` initialize method"
      end
