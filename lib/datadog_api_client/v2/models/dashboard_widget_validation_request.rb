...
module DatadogAPIClient::V2
  ...
  class DashboardWidgetValidationRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DashboardWidgetValidationRequest` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [layout_type, reflow_type, widgets, additional_properties].hash
    end
  end
end
