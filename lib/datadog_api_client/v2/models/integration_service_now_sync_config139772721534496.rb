  ...
  class IntegrationServiceNowSyncConfig139772721534496
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IntegrationServiceNowSyncConfig139772721534496` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [comments, priority, status, additional_properties].hash
    end
  end
end
