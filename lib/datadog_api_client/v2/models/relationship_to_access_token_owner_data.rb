...
module DatadogAPIClient::V2
  ...
  class RelationshipToAccessTokenOwnerData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RelationshipToAccessTokenOwnerData` initialize method"
      end
