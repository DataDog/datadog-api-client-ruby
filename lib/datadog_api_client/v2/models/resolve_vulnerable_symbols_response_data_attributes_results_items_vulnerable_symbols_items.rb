...
module DatadogAPIClient::V2
  ...
  class ResolveVulnerableSymbolsResponseDataAttributesResultsItemsVulnerableSymbolsItems
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ResolveVulnerableSymbolsResponseDataAttributesResultsItemsVulnerableSymbolsItems` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [advisory_id, symbols, additional_properties].hash
    end
  end
end
