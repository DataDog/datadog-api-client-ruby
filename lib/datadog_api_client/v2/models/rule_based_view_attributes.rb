  ...
  class RuleBasedViewAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RuleBasedViewAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [count, rules, additional_properties].hash
    end
  end
end
