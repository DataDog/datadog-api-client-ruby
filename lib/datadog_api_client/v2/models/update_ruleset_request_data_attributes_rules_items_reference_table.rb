  ...
  class UpdateRulesetRequestDataAttributesRulesItemsReferenceTable
    ...
    def self.openapi_types
      {
        ...
        :'field_pairs' => :'Array<UpdateRulesetRequestDataAttributesRulesItemsReferenceTableFieldPairsItems>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::UpdateRulesetRequestDataAttributesRulesItemsReferenceTable` initialize method"
      end
