  ...
  class LLMObsExperimentationSearchDataAttributesRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsExperimentationSearchDataAttributesRequest` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [content_preview, filter, include, page, additional_properties].hash
    end
  end
end
