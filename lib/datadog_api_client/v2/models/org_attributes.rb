  ...
  class OrgAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::OrgAttributes` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param sharing [Object] Object to be assigned
    # @!visibility private
    def sharing=(sharing)
      if sharing.nil?
        fail ArgumentError, 'invalid value for "sharing", sharing cannot be nil.'
      end
      @sharing = sharing
    end
    ...
    # @!visibility private
    def hash
      [created_at, description, disabled, modified_at, name, public_id, sharing, url, additional_properties].hash
    end
  end
end
