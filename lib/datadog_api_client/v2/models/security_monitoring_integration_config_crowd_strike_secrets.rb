...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringIntegrationConfigCrowdStrikeSecrets
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityMonitoringIntegrationConfigCrowdStrikeSecrets` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [client_id, client_secret, additional_properties].hash
    end
  end
end
