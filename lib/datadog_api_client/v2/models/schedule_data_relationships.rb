  ...
  class ScheduleDataRelationships
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ScheduleDataRelationships` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [layers, teams, additional_properties].hash
    end
  end
end
