  ...
  class ApplicationSecurityWafCustomRuleConditionOptions
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ApplicationSecurityWafCustomRuleConditionOptions` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [case_sensitive, min_length, additional_properties].hash
    end
  end
end
