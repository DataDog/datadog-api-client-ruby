...
module DatadogAPIClient::V2
  ...
  class LogsArchiveIntegrationS3AccessKey
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LogsArchiveIntegrationS3AccessKey` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [access_key_id, additional_properties].hash
    end
  end
end
