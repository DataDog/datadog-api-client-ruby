...
module DatadogAPIClient::V2
  ...
  class CommitmentsUtilizationScalarProductBreakdownEntry
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CommitmentsUtilizationScalarProductBreakdownEntry` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param utilization [Object] Object to be assigned
    # @!visibility private
    def utilization=(utilization)
      if utilization.nil?
        fail ArgumentError, 'invalid value for "utilization", utilization cannot be nil.'
      end
      @utilization = utilization
    end
    ...
    # @!visibility private
    def hash
      [product, utilization, additional_properties].hash
    end
  end
end
