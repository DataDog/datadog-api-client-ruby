...
module DatadogAPIClient::V2
  ...
  class FullPersonalAccessTokenAttributes
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'public_portion')
        self.public_portion = attributes[:'public_portion']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          key == o.key &&
          name == o.name &&
          public_portion == o.public_portion &&
          scopes == o.scopes &&
    ...
    # @!visibility private
    def hash
      [_alias, created_at, expires_at, key, name, public_portion, scopes, additional_properties].hash
    end
  end
end
