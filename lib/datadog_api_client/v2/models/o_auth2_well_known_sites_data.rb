...
module DatadogAPIClient::V2
  ...
  class OAuth2WellKnownSitesData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::OAuth2WellKnownSitesData` initialize method"
      end
