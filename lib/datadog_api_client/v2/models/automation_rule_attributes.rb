...
module DatadogAPIClient::V2
  ...
  class AutomationRuleAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AutomationRuleAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [action, created_at, modified_at, name, state, trigger, additional_properties].hash
    end
  end
end
