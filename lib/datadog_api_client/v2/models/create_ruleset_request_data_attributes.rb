  ...
  class CreateRulesetRequestDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CreateRulesetRequestDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [enabled, rules, additional_properties].hash
    end
  end
end
