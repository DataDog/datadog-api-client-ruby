...
module DatadogAPIClient::V2
  # Zstd compression.
  class ObservabilityPipelineGoogleCloudStorageDestinationCompressionZstd
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineGoogleCloudStorageDestinationCompressionZstd` initialize method"
      end
    ...
    def level=(level)
      ...
      if level > 21
        fail ArgumentError, 'invalid value for "level", must be smaller than or equal to 21.'
      end
      if level < 1
