...
module DatadogAPIClient::V2
  ...
  class RemediationGuardrailDecision
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RemediationGuardrailDecision` initialize method"
      end
      ...
      if attributes.key?(:'guardrail_id')
        self.guardrail_id = attributes[:'guardrail_id']
      end
    end
    ...
    # @!visibility private
    def hash
      [decision, guardrail_id, additional_properties].hash
    end
  end
end
