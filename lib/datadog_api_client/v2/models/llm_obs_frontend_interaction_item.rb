...
module DatadogAPIClient::V2
  ...
  # content.
  class LLMObsFrontendInteractionItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsFrontendInteractionItem` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [frontend, type, additional_properties].hash
    end
  end
end
