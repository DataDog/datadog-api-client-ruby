...
module DatadogAPIClient::V2
  ...
  class OnCallEventEmailAddressCreateAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::OnCallEventEmailAddressCreateAttributes` initialize method"
      end
    ...
    def valid?
      ...
      return false if @team_handle.to_s.length > 195
      true
    end
    ...
    def team_handle=(team_handle)
      ...
      if team_handle.to_s.length > 195
        fail ArgumentError, 'invalid value for "team_handle", the character length must be smaller than or equal to 195.'
      end
      @team_handle = team_handle
    end
