  ...
  class ObservabilityPipelineEnrichmentTableFile
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineEnrichmentTableFile` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [encoding, key, path, schema, additional_properties].hash
    end
  end
end
