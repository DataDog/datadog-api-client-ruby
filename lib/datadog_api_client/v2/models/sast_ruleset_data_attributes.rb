...
module DatadogAPIClient::V2
  ...
  class SastRulesetDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SastRulesetDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [description, name, rules, short_description, additional_properties].hash
    end
  end
end
