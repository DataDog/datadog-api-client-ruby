  ...
  class SyntheticsNetworkTestConfig
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SyntheticsNetworkTestConfig` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [assertions, request, additional_properties].hash
    end
  end
end
