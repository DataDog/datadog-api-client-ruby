  ...
  class CycloneDXAssetComponent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CycloneDXAssetComponent` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [bom_ref, name, type, additional_properties].hash
    end
  end
end
