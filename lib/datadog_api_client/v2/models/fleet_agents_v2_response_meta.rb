...
module DatadogAPIClient::V2
  ...
  class FleetAgentsV2ResponseMeta
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::FleetAgentsV2ResponseMeta` initialize method"
      end
