  ...
  class AWSAssumeRole
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AWSAssumeRole` initialize method"
      end
    ...
    def valid?
      ...
      return false if @account_id !~ pattern
