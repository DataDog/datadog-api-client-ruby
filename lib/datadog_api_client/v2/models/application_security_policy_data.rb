...
module DatadogAPIClient::V2
  ...
  class ApplicationSecurityPolicyData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ApplicationSecurityPolicyData` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [attributes, id, metadata, type, additional_properties].hash
    end
  end
end
