...
module DatadogAPIClient::V2
  ...
  class PipelineAddFieldsProcessor
    ...
    def self.openapi_types
      {
        ...
        :'include' => :'String',
        :'inputs' => :'Array<String>',
        :'type' => :'PipelineAddFieldsProcessorType'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::PipelineAddFieldsProcessor` initialize method"
      end
