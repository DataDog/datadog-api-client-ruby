...
module DatadogAPIClient::V2
  ...
  class ProductAnalyticsRetentionGridRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ProductAnalyticsRetentionGridRequestAttributes` initialize method"
      end
