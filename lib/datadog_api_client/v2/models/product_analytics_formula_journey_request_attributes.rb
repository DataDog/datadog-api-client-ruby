...
module DatadogAPIClient::V2
  ...
  class ProductAnalyticsFormulaJourneyRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ProductAnalyticsFormulaJourneyRequestAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [from, interval, query, to, additional_properties].hash
    end
  end
end
