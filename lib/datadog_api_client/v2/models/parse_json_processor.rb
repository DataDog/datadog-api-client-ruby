  ...
  class ParseJSONProcessor
    ...
    def self.openapi_types
      {
        ...
        :'include' => :'String',
        :'inputs' => :'Array<String>',
        :'type' => :'PipelineParseJSONProcessorType'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ParseJSONProcessor` initialize method"
      end
