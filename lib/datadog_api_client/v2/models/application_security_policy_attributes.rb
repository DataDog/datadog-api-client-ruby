...
module DatadogAPIClient::V2
  # A WAF policy.
  class ApplicationSecurityPolicyAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ApplicationSecurityPolicyAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [description, is_default, name, protection_presets, rules, rulesets, scope, version, additional_properties].hash
    end
  end
end
