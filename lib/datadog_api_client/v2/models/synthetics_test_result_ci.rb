  ...
  class SyntheticsTestResultCI
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SyntheticsTestResultCI` initialize method"
      end
      ...
      if attributes.key?(:'workspace_path')
        self.workspace_path = attributes[:'workspace_path']
      end
    end
    ...
    # @!visibility private
    def hash
      [pipeline, provider, stage, workspace_path, additional_properties].hash
    end
  end
end
