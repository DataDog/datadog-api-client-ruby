...
module DatadogAPIClient::V2
  ...
  class SecureEmbedCreateResponseAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecureEmbedCreateResponseAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [created_at, credential, dashboard_id, global_time, global_time_selectable, id, selectable_template_vars, share_type, status, title, token, url, viewing_preferences, additional_properties].hash
    end
  end
end
