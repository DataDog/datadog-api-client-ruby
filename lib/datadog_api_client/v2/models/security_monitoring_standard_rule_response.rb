...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringStandardRuleResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'finding_type')
        self.finding_type = attributes[:'finding_type']
      end
    ...
    # @!visibility private
    def hash
      [blocking, calculated_fields, cases, compliance_signal_options, created_at, creation_author_id, creator, custom_message, custom_name, default_rule_id, default_tags, dependencies, deprecation_date, filters, finding_type, group_signals_by, has_extended_title, id, is_beta, is_default, is_deleted, is_deprecated, is_enabled, is_partner, message, metadata, name, options, queries, reference_tables, scheduling_options, tags, third_party_cases, type, update_author_id, updated_at, updater, version, additional_properties].hash
    end
  end
end
