...
module DatadogAPIClient::V2
  ...
  class CostTagDescriptionUpsertRequestDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CostTagDescriptionUpsertRequestDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [cloud, description, additional_properties].hash
    end
  end
end
