...
module DatadogAPIClient::V2
  ...
  class RumRetentionQuotaCustomConfig
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RumRetentionQuotaCustomConfig` initialize method"
      end
    ...
    def valid?
      ...
      return false if @session_limit < 1000
    ...
    def session_limit=(session_limit)
      ...
      if session_limit < 1000
        fail ArgumentError, 'invalid value for "session_limit", must be greater than or equal to 1000.'
      end
      @session_limit = session_limit
    end
