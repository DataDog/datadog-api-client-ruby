  ...
  class CreateComponentRequestDataAttributesComponentsItems
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CreateComponentRequestDataAttributesComponentsItems` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [name, position, type, additional_properties].hash
    end
  end
end
