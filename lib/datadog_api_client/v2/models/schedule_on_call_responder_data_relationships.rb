  ...
  class ScheduleOnCallResponderDataRelationships
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ScheduleOnCallResponderDataRelationships` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [shifts, additional_properties].hash
    end
  end
end
