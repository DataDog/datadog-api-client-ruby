  ...
  class LLMObsDataDeletionRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsDataDeletionRequestAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [delay, from, query, to, additional_properties].hash
    end
  end
end
