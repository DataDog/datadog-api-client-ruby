...
module DatadogAPIClient::V2
  ...
  class LLMObsExperimentSpanDataResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsExperimentSpanDataResponse` initialize method"
      end
