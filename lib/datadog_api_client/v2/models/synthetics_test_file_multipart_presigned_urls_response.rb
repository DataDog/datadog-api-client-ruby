...
module DatadogAPIClient::V2
  ...
  class SyntheticsTestFileMultipartPresignedUrlsResponse
    ...
    attr_accessor :multipart_presigned_urls_params
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SyntheticsTestFileMultipartPresignedUrlsResponse` initialize method"
      end
      ...
      if attributes.key?(:'multipart_presigned_urls_params')
        self.multipart_presigned_urls_params = attributes[:'multipart_presigned_urls_params']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          multipart_presigned_urls_params == o.multipart_presigned_urls_params &&
    ...
    # @!visibility private
    def hash
      [bucket_key, multipart_presigned_urls_params, additional_properties].hash
    end
  end
end
