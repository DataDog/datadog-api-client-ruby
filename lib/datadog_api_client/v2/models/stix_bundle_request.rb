...
module DatadogAPIClient::V2
  ...
  class STIXBundleRequest
    ...
    def self.openapi_types
      {
        :'id' => :'String',
        :'objects' => :'Array<STIXIndicatorObject>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::STIXBundleRequest` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param objects [Object] Object to be assigned
    # @!visibility private
    def objects=(objects)
      if objects.nil?
        fail ArgumentError, 'invalid value for "objects", objects cannot be nil.'
      end
      @objects = objects
    end
    ...
    # @!visibility private
    def hash
      [id, objects, spec_version, type, additional_properties].hash
    end
  end
end
