...
module DatadogAPIClient::V2
  ...
  class FlutterSourcemapAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::FlutterSourcemapAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [arch, created_at, mapkind, service, size, variant, version, additional_properties].hash
    end
  end
end
