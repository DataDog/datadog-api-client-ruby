  ...
  class AggregatedLongTasksRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AggregatedLongTasksRequestAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [application_id, criteria, filter, from, sample_size, to, view_name, additional_properties].hash
    end
  end
end
