...
module DatadogAPIClient::V2
  ...
  class CostSettingDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CostSettingDataAttributes` initialize method"
      end
      ...
      if attributes.key?(:'setting_name')
        self.setting_name = attributes[:'setting_name']
      end
    ...
    def valid?
      ...
      return false if @setting_name.nil?
    ...
    # Custom attribute writer method with validation
    # @param last_modified_by [Object] Object to be assigned
    # @!visibility private
    def last_modified_by=(last_modified_by)
      if last_modified_by.nil?
        fail ArgumentError, 'invalid value for "last_modified_by", last_modified_by cannot be nil.'
      end
      @last_modified_by = last_modified_by
    end

    # Custom attribute writer method with validation
    # @param setting_name [Object] Object to be assigned
    # @!visibility private
    def setting_name=(setting_name)
      if setting_name.nil?
        fail ArgumentError, 'invalid value for "setting_name", setting_name cannot be nil.'
      end
      @setting_name = setting_name
    end
    ...
    # @!visibility private
    def hash
      [created_at, created_by, data, description, last_modified_by, setting_name, updated_at, version, additional_properties].hash
    end
  end
end
