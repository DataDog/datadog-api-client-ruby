  ...
  class UpdateDeploymentRuleParamsDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::UpdateDeploymentRuleParamsDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [dry_run, name, options, additional_properties].hash
    end
  end
end
