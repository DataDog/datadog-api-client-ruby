  ...
  class CreateAppRequestDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CreateAppRequestDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [components, description, embedded_queries, input_schema, name, root_instance_name, scripts, tags].hash
    end
  end
end
