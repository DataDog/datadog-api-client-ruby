  ...
  class DORAIncidentObjectAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DORAIncidentObjectAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [custom_tags, env, finished_at, git, name, services, severity, started_at, team, version, additional_properties].hash
    end
  end
end
