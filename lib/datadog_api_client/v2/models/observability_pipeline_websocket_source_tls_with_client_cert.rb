  ...
  class ObservabilityPipelineWebsocketSourceTlsWithClientCert
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineWebsocketSourceTlsWithClientCert` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [ca_file, crt_file, key_file, key_pass_key, mode, additional_properties].hash
    end
  end
end
