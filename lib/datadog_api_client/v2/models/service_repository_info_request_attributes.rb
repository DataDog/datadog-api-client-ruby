...
module DatadogAPIClient::V2
  ...
  class ServiceRepositoryInfoRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ServiceRepositoryInfoRequestAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [service, version, additional_properties].hash
    end
  end
end
