...
module DatadogAPIClient::V2
  ...
  class RumSegmentCreateAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RumSegmentCreateAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [data_query, description, name, tags, additional_properties].hash
    end
  end
end
