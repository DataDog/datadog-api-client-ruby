...
module DatadogAPIClient::V2
  ...
  class DashboardSearchAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DashboardSearchAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [tags, title, additional_properties].hash
    end
  end
end
