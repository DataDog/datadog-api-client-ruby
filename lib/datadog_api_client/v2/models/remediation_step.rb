  ...
  class RemediationStep
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RemediationStep` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [action_fqn, approval_state, description, reversible, risk, step_id, additional_properties].hash
    end
  end
end
