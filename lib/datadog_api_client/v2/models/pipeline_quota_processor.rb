  ...
  class PipelineQuotaProcessor
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'String',
        :'overrides' => :'Array<PipelineQuotaProcessorOverride>',
        :'partition_fields' => :'Array<String>',
        :'type' => :'PipelineQuotaProcessorType'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::PipelineQuotaProcessor` initialize method"
      end
