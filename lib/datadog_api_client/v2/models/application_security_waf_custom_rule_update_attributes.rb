  ...
  class ApplicationSecurityWafCustomRuleUpdateAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ApplicationSecurityWafCustomRuleUpdateAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [action, blocking, conditions, enabled, name, path_glob, scope, tags, additional_properties].hash
    end
  end
end
