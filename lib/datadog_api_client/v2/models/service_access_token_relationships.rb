...
module DatadogAPIClient::V2
  ...
  class ServiceAccessTokenRelationships
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ServiceAccessTokenRelationships` initialize method"
      end
