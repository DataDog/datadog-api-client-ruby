  ...
  class DdsqlTabularQueryFetchRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DdsqlTabularQueryFetchRequestAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [query_id, additional_properties].hash
    end
  end
end
