...
module DatadogAPIClient::V2
  ...
  class LLMObsExperimentEventsV2DataResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsExperimentEventsV2DataResponse` initialize method"
      end
