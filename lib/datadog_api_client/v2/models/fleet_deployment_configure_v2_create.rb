...
module DatadogAPIClient::V2
  ...
  class FleetDeploymentConfigureV2Create
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::FleetDeploymentConfigureV2Create` initialize method"
      end
