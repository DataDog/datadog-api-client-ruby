...
module DatadogAPIClient::V2
  ...
  class ObservabilityPipelineDiskBufferOptions
    ...
    # @!visibility private
    def valid?
      return false if !@max_size.nil? && @max_size > 536870912000
      return false if !@max_size.nil? && @max_size < 268435488
      true
    end
    ...
    def max_size=(max_size)
      if !max_size.nil? && max_size > 536870912000
        fail ArgumentError, 'invalid value for "max_size", must be smaller than or equal to 536870912000.'
      end
      if !max_size.nil? && max_size < 268435488
        fail ArgumentError, 'invalid value for "max_size", must be greater than or equal to 268435488.'
      end
      @max_size = max_size
    end
