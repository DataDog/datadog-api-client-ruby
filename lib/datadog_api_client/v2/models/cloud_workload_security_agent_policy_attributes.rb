...
module DatadogAPIClient::V2
  ...
  class CloudWorkloadSecurityAgentPolicyAttributes
    ...
    # @!visibility private
    def hash
      [blocking_rules_count, datadog_managed, description, disabled_rules_count, enabled, host_tags, monitoring_rules_count, name, policy_version, priority, rule_count, update_date, updated_at, updater, additional_properties].hash
    end
  end
end
