...
module DatadogAPIClient::V2
  ...
  class ConfluencePostmortemSettings
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ConfluencePostmortemSettings` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param space_id [Object] Object to be assigned
    # @!visibility private
    def space_id=(space_id)
      if space_id.nil?
        fail ArgumentError, 'invalid value for "space_id", space_id cannot be nil.'
      end
      @space_id = space_id
    end
    ...
    # @!visibility private
    def hash
      [account_id, parent_id, space_id, additional_properties].hash
    end
  end
end
