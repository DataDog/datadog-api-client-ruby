  ...
  class TimeseriesAnomalyInvestigationFormulaLimit
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::TimeseriesAnomalyInvestigationFormulaLimit` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [count, order, additional_properties].hash
    end
  end
end
