...
module DatadogAPIClient::V2
  # A component affected by a backfilled maintenance update.
  class CreateBackfilledMaintenanceRequestDataAttributesUpdatesItemsComponentsAffectedItems
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CreateBackfilledMaintenanceRequestDataAttributesUpdatesItemsComponentsAffectedItems` initialize method"
      end
