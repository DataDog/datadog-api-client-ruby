  ...
  class AutomationRuleTriggerData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AutomationRuleTriggerData` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [approval_type, change_type, field, from_status_name, to_status_name, additional_properties].hash
    end
  end
end
