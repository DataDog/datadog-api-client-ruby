...
module DatadogAPIClient::V2
  ...
  class AWSCcmConfigValidationIssue
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AWSCcmConfigValidationIssue` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [code, description, additional_properties].hash
    end
  end
end
