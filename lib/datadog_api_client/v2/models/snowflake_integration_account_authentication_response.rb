...
module DatadogAPIClient::V2
  ...
  class SnowflakeIntegrationAccountAuthenticationResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SnowflakeIntegrationAccountAuthenticationResponse` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [auth_type, private_key_name, additional_properties].hash
    end
  end
end
