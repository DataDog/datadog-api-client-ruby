...
module DatadogAPIClient::V2
  ...
  class CostTagPipelineActiveKeyAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CostTagPipelineActiveKeyAttributes` initialize method"
      end
    ...
    def rule_count=(rule_count)
      if rule_count.nil?
        fail ArgumentError, 'invalid value for "rule_count", rule_count cannot be nil.'
      end
      @rule_count = rule_count
    end
    ...
    # @!visibility private
    def hash
      [rule_count, additional_properties].hash
    end
  end
end
