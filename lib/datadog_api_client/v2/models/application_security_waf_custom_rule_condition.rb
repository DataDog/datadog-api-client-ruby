  ...
  class ApplicationSecurityWafCustomRuleCondition
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ApplicationSecurityWafCustomRuleCondition` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [operator, parameters, additional_properties].hash
    end
  end
end
