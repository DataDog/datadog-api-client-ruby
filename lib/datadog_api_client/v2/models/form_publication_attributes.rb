...
module DatadogAPIClient::V2
  ...
  class FormPublicationAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::FormPublicationAttributes` initialize method"
      end
    ...
    def valid?
      ...
      return false if @form_version.nil?
      return false if @modified_at.nil?
      return false if @org_id.nil?
      return false if @publish_seq.nil?
    ...
    # Custom attribute writer method with validation
    # @param form_version [Object] Object to be assigned
    # @!visibility private
    def form_version=(form_version)
      if form_version.nil?
        fail ArgumentError, 'invalid value for "form_version", form_version cannot be nil.'
      end
      @form_version = form_version
    end
    ...
    # Custom attribute writer method with validation
    # @param publish_seq [Object] Object to be assigned
    # @!visibility private
    def publish_seq=(publish_seq)
      if publish_seq.nil?
        fail ArgumentError, 'invalid value for "publish_seq", publish_seq cannot be nil.'
      end
      @publish_seq = publish_seq
    end
