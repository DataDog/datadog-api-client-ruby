...
module DatadogAPIClient::V2
  ...
  class AmsIntegrationAccountSchemaResponseSecretsObject
    ...
    def self.openapi_types
      {
        ...
        :'properties' => :'Hash<String, AmsIntegrationAccountSchemaResponseSettingsField>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AmsIntegrationAccountSchemaResponseSecretsObject` initialize method"
      end
