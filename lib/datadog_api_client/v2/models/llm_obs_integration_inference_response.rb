  ...
  class LLMObsIntegrationInferenceResponse
    ...
    def self.openapi_types
      {
        ...
        :'error_response' => :'LLMObsInferenceErrorResponse',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsIntegrationInferenceResponse` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param response [Object] Object to be assigned
    # @!visibility private
    def response=(response)
      if response.nil?
        fail ArgumentError, 'invalid value for "response", response cannot be nil.'
      end
      @response = response
    end
    ...
    # @!visibility private
    def hash
      [anthropic_metadata, azure_openai_metadata, bedrock_metadata, error_response, frequency_penalty, json_schema, max_completion_tokens, max_tokens, messages, model_id, openai_metadata, presence_penalty, response, temperature, tools, top_k, top_p, vertex_ai_metadata, additional_properties].hash
    end
  end
end
