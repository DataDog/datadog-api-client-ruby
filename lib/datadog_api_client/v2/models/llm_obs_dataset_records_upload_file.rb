...
module DatadogAPIClient::V2
  ...
  class LLMObsDatasetRecordsUploadFile
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsDatasetRecordsUploadFile` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [file, additional_properties].hash
    end
  end
end
