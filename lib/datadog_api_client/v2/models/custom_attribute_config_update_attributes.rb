  ...
  class CustomAttributeConfigUpdateAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CustomAttributeConfigUpdateAttributes` initialize method"
      end
      ...
      if attributes.key?(:'map_from')
        self.map_from = attributes[:'map_from']
      end
      ...
      if attributes.key?(:'type_data')
        self.type_data = attributes[:'type_data']
      end
    end
    ...
    # @!visibility private
    def hash
      [description, display_name, map_from, type, type_data, additional_properties].hash
    end
  end
end
