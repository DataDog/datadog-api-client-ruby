  ...
  class LLMObsExperimentationNumberPage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsExperimentationNumberPage` initialize method"
      end
    ...
    def valid?
      ...
      return false if !@number.nil? && @number > 2147483647
    ...
    # @!visibility private
    def number=(number)
      if !number.nil? && number > 2147483647
    ...
    # @!visibility private
    def hash
      [limit, number, additional_properties].hash
    end
  end
end
