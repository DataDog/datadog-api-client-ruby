...
module DatadogAPIClient::V2
  ...
  class McpCrossAppAccessIssuerUrlUpdateAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::McpCrossAppAccessIssuerUrlUpdateAttributes` initialize method"
      end
    ...
    # @param issuer_url [Object] Object to be assigned
    # @!visibility private
    def issuer_url=(issuer_url)
      if issuer_url.nil?
        fail ArgumentError, 'invalid value for "issuer_url", issuer_url cannot be nil.'
      end
      @issuer_url = issuer_url
    end
    ...
    # @!visibility private
    def hash
      [issuer_url, additional_properties].hash
    end
  end
end
