  ...
  class AIGuardMessage
    ...
    def self.openapi_types
      {
        ...
        :'tool_call_id' => :'String',
        :'tool_calls' => :'Array<AIGuardToolCall>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AIGuardMessage` initialize method"
      end
      ...
      if attributes.key?(:'tool_call_id')
        self.tool_call_id = attributes[:'tool_call_id']
      end
    ...
    # @!visibility private
    def hash
      [content, role, tool_call_id, tool_calls, additional_properties].hash
    end
  end
end
