...
module DatadogAPIClient::V2
  # The definition of `ObservabilityPipelineSensitiveDataScannerProcessorScopeInclude` object.
  class ObservabilityPipelineSensitiveDataScannerProcessorScopeInclude
    ...
    # The definition of `ObservabilityPipelineSensitiveDataScannerProcessorScopeIncludeTarget` object.
    attr_reader :target
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineSensitiveDataScannerProcessorScopeInclude` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [options, target, additional_properties].hash
    end
  end
end
