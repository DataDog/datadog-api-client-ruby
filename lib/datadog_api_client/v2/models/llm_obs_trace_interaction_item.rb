...
module DatadogAPIClient::V2
  ...
  class LLMObsTraceInteractionItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsTraceInteractionItem` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [content_id, type, additional_properties].hash
    end
  end
end
