...
module DatadogAPIClient::V2
  ...
  class IncidentZoomIntegrationDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentZoomIntegrationDataAttributes` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param meetings [Object] Object to be assigned
    # @!visibility private
    def meetings=(meetings)
      if meetings.nil?
        fail ArgumentError, 'invalid value for "meetings", meetings cannot be nil.'
      end
      @meetings = meetings
    end
    ...
    # @!visibility private
    def hash
      [created, integration_type, meetings, modified, status, additional_properties].hash
    end
  end
end
