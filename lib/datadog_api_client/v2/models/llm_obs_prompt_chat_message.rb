  ...
  class LLMObsPromptChatMessage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsPromptChatMessage` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [content, role, additional_properties].hash
    end
  end
end
