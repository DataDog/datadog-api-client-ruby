...
module DatadogAPIClient::V2
  ...
  class ScheduleOnCallRespondersDataRelationships
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ScheduleOnCallRespondersDataRelationships` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [responders, schedule, additional_properties].hash
    end
  end
end
