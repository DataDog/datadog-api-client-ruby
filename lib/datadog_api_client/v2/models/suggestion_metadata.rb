  ...
  class SuggestionMetadata
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SuggestionMetadata` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [variant_id, additional_properties].hash
    end
  end
end
