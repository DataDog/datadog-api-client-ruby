...
module DatadogAPIClient::V2
  ...
  class IoCExplorerListResponseAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IoCExplorerListResponseAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [data, metadata, paging, additional_properties].hash
    end
  end
end
