...
module DatadogAPIClient::V2
  ...
  class AiMemoryViolationResultResponseAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AiMemoryViolationResultResponseAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [created_at, created_by, line, message, name, repository_id, rule, sha, type, additional_properties].hash
    end
  end
end
