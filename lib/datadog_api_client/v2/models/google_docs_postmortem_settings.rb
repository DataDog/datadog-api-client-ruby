...
module DatadogAPIClient::V2
  ...
  class GoogleDocsPostmortemSettings
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::GoogleDocsPostmortemSettings` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param parent_folder_id [Object] Object to be assigned
    # @!visibility private
    def parent_folder_id=(parent_folder_id)
      if parent_folder_id.nil?
        fail ArgumentError, 'invalid value for "parent_folder_id", parent_folder_id cannot be nil.'
      end
      @parent_folder_id = parent_folder_id
    end
    ...
    # @!visibility private
    def hash
      [account_id, parent_folder_id, additional_properties].hash
    end
  end
end
