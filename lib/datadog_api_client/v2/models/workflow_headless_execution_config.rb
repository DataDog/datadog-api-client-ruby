...
module DatadogAPIClient::V2
  # 
  class WorkflowHeadlessExecutionConfig
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::WorkflowHeadlessExecutionConfig` initialize method"
      end
    ...
    # @param connections [Object] Object to be assigned
    # @!visibility private
    def connections=(connections)
      if connections.nil?
        fail ArgumentError, 'invalid value for "connections", connections cannot be nil.'
      end
      @connections = connections
    end
    ...
    # @!visibility private
    def hash
      [connections, inputs, additional_properties].hash
    end
  end
end
