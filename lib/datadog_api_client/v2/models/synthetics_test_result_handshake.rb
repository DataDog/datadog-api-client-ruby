...
module DatadogAPIClient::V2
  ...
  class SyntheticsTestResultHandshake
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SyntheticsTestResultHandshake` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [request, response, additional_properties].hash
    end
  end
end
