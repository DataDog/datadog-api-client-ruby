  ...
  class LLMObsDisplayBlockInteractionResponseItem
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsDisplayBlockInteractionResponseItem` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [already_existed, content_id, display_block, id, type, additional_properties].hash
    end
  end
end
