...
module DatadogAPIClient::V2
  ...
  class UserOverrideIdentityProviderData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::UserOverrideIdentityProviderData` initialize method"
      end
