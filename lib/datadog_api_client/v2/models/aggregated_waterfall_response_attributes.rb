...
module DatadogAPIClient::V2
  ...
  class AggregatedWaterfallResponseAttributes
    ...
    attr_reader :total_cache_hit_rate_pct
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AggregatedWaterfallResponseAttributes` initialize method"
      end
      ...
      if attributes.key?(:'total_cache_hit_rate_pct')
        self.total_cache_hit_rate_pct = attributes[:'total_cache_hit_rate_pct']
      end
    ...
    def valid?
      ...
      return false if @total_cache_hit_rate_pct.nil?
    ...
    # Custom attribute writer method with validation
    # @param resources [Object] Object to be assigned
    # @!visibility private
    def resources=(resources)
      if resources.nil?
        fail ArgumentError, 'invalid value for "resources", resources cannot be nil.'
      end
      @resources = resources
    end
    ...
    # Custom attribute writer method with validation
    # @param total_cache_hit_rate_pct [Object] Object to be assigned
    # @!visibility private
    def total_cache_hit_rate_pct=(total_cache_hit_rate_pct)
      if total_cache_hit_rate_pct.nil?
        fail ArgumentError, 'invalid value for "total_cache_hit_rate_pct", total_cache_hit_rate_pct cannot be nil.'
      end
      @total_cache_hit_rate_pct = total_cache_hit_rate_pct
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          to == o.to &&
          total_cache_hit_rate_pct == o.total_cache_hit_rate_pct &&
    ...
    # @!visibility private
    def hash
      [application_id, criteria, from, resources, sampled_view_ids, to, total_cache_hit_rate_pct, view_count, view_name, additional_properties].hash
    end
  end
end
