...
module DatadogAPIClient::V2
  ...
  class SecurityFindingsSearchRequestPage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityFindingsSearchRequestPage` initialize method"
      end
    ...
    # @!visibility private
    def valid?
      return false if !@limit.nil? && @limit > 150
    ...
    def limit=(limit)
      if !limit.nil? && limit > 150
        fail ArgumentError, 'invalid value for "limit", must be smaller than or equal to 150.'
      end
