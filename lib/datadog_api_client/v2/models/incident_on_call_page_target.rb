...
module DatadogAPIClient::V2
  ...
  class IncidentOnCallPageTarget
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentOnCallPageTarget` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [identifier, type, additional_properties].hash
    end
  end
end
