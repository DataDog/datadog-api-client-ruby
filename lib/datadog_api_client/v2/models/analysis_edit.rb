  ...
  class AnalysisEdit
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AnalysisEdit` initialize method"
      end
      ...
      if attributes.key?(:'edit_type')
        self.edit_type = attributes[:'edit_type']
      end
    ...
    # @param edit_type [Object] Object to be assigned
    # @!visibility private
    def edit_type=(edit_type)
      if edit_type.nil?
        fail ArgumentError, 'invalid value for "edit_type", edit_type cannot be nil.'
      end
      @edit_type = edit_type
    end
    ...
    # @!visibility private
    def hash
      [content, edit_type, _end, start, additional_properties].hash
    end
  end
end
