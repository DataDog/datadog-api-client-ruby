  ...
  class SyntheticsTestResultBrowserError
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SyntheticsTestResultBrowserError` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [description, method, name, status, type, url, additional_properties].hash
    end
  end
end
