  ...
  class SyntheticsTestResultOCSPResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SyntheticsTestResultOCSPResponse` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [certificate, status, updates, additional_properties].hash
    end
  end
end
