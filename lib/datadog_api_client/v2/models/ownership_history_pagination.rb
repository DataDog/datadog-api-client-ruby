...
module DatadogAPIClient::V2
  ...
  class OwnershipHistoryPagination
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::OwnershipHistoryPagination` initialize method"
      end
    ...
    # @param has_more [Object] Object to be assigned
    # @!visibility private
    def has_more=(has_more)
      if has_more.nil?
        fail ArgumentError, 'invalid value for "has_more", has_more cannot be nil.'
      end
      @has_more = has_more
    end
    ...
    # @!visibility private
    def hash
      [has_more, next_cursor, additional_properties].hash
    end
  end
end
