  ...
  class EntityOwnerDestination
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::EntityOwnerDestination` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [slack, team_id, additional_properties].hash
    end
  end
end
