  ...
  class ObservabilityPipelineAddEnvVarsProcessor
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineAddEnvVarsProcessor` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param variables [Object] Object to be assigned
    # @!visibility private
    def variables=(variables)
      if variables.nil?
        fail ArgumentError, 'invalid value for "variables", variables cannot be nil.'
      end
      @variables = variables
    end
