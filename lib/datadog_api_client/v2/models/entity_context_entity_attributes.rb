...
module DatadogAPIClient::V2
  ...
  class EntityContextEntityAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::EntityContextEntityAttributes` initialize method"
      end
    ...
    # @param revisions [Object] Object to be assigned
    # @!visibility private
    def revisions=(revisions)
      if revisions.nil?
        fail ArgumentError, 'invalid value for "revisions", revisions cannot be nil.'
      end
      @revisions = revisions
    end
    ...
    # @!visibility private
    def hash
      [revisions, additional_properties].hash
    end
  end
end
