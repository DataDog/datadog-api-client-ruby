  ...
  class LLMObsDatasetBatchUpdateInsertRecord
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsDatasetBatchUpdateInsertRecord` initialize method"
      end
      ...
      if attributes.key?(:'tag_operations')
        self.tag_operations = attributes[:'tag_operations']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          input == o.input &&
          metadata == o.metadata &&
          tag_operations == o.tag_operations &&
          tags == o.tags &&
    ...
    # @!visibility private
    def hash
      [expected_output, id, input, metadata, tag_operations, tags, additional_properties].hash
    end
  end
end
