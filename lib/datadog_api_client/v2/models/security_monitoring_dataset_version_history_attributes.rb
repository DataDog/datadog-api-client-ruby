...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringDatasetVersionHistoryAttributes
    ...
    def self.openapi_types
      {
        :'count' => :'Integer',
        :'data' => :'Hash<String, SecurityMonitoringDatasetVersionEntry>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityMonitoringDatasetVersionHistoryAttributes` initialize method"
      end
