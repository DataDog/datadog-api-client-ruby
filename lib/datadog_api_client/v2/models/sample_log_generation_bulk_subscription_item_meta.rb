  ...
  class SampleLogGenerationBulkSubscriptionItemMeta
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SampleLogGenerationBulkSubscriptionItemMeta` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [error, status, additional_properties].hash
    end
  end
end
