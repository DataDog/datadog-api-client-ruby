...
module DatadogAPIClient::V2
  ...
  class LLMObsFrontendContentBlock
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsFrontendContentBlock` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [code, type, additional_properties].hash
    end
  end
end
