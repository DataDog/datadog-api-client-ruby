...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringDatasetDependencyAttributesResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityMonitoringDatasetDependencyAttributesResponse` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [count, ids, resource_type, additional_properties].hash
    end
  end
end
