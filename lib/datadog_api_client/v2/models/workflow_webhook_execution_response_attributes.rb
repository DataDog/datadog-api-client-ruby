...
module DatadogAPIClient::V2
  # 
  class WorkflowWebhookExecutionResponseAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::WorkflowWebhookExecutionResponseAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [instance_id, workflow_id, additional_properties].hash
    end
  end
end
