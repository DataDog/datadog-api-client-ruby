  ...
  class EntityRelationships
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::EntityRelationships` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [incidents, oncall, raw_schema, related_entities, schema, additional_properties].hash
    end
  end
end
