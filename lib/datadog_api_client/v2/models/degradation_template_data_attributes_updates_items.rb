...
module DatadogAPIClient::V2
  ...
  class DegradationTemplateDataAttributesUpdatesItems
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DegradationTemplateDataAttributesUpdatesItems` initialize method"
      end
