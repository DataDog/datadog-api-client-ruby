...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringDatasetVersionEntry
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityMonitoringDatasetVersionEntry` initialize method"
      end
    ...
    # @param changes [Object] Object to be assigned
    # @!visibility private
    def changes=(changes)
      if changes.nil?
        fail ArgumentError, 'invalid value for "changes", changes cannot be nil.'
      end
      @changes = changes
    end
    ...
    # @!visibility private
    def hash
      [changes, dataset, additional_properties].hash
    end
  end
end
