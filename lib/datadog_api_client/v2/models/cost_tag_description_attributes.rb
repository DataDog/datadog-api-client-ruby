...
module DatadogAPIClient::V2
  ...
  class CostTagDescriptionAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CostTagDescriptionAttributes` initialize method"
      end
    ...
    # @param cloud [Object] Object to be assigned
    # @!visibility private
    def cloud=(cloud)
      if cloud.nil?
        fail ArgumentError, 'invalid value for "cloud", cloud cannot be nil.'
      end
      @cloud = cloud
    end
    ...
    # @!visibility private
    def hash
      [cloud, created_at, description, source, tag_key, updated_at, additional_properties].hash
    end
  end
end
