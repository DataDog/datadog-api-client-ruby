  ...
  class CostTagAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CostTagAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [sources, value, additional_properties].hash
    end
  end
end
