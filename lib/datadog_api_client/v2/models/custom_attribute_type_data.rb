  ...
  class CustomAttributeTypeData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CustomAttributeTypeData` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [options, additional_properties].hash
    end
  end
end
