  ...
  class ItemApiPayloadMetaPage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ItemApiPayloadMetaPage` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [has_more, total_count, total_filtered_count, additional_properties].hash
    end
  end
end
