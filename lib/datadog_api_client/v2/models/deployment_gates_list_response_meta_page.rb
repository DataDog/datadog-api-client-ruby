  ...
  class DeploymentGatesListResponseMetaPage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DeploymentGatesListResponseMetaPage` initialize method"
      end
    ...
    # @!visibility private
    def valid?
      return false if !@size.nil? && @size > 1000
    ...
    # @!visibility private
    def size=(size)
      if !size.nil? && size > 1000
        fail ArgumentError, 'invalid value for "size", must be smaller than or equal to 1000.'
      end
      if !size.nil? && size < 1
    ...
    # @!visibility private
    def hash
      [cursor, next_cursor, size, additional_properties].hash
    end
  end
end
