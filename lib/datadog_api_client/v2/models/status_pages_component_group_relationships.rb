  ...
  class StatusPagesComponentGroupRelationships
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::StatusPagesComponentGroupRelationships` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [created_by_user, group, last_modified_by_user, status_page, additional_properties].hash
    end
  end
end
