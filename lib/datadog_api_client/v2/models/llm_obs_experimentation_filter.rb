...
module DatadogAPIClient::V2
  ...
  class LLMObsExperimentationFilter
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsExperimentationFilter` initialize method"
      end
      ...
      if attributes.key?(:'include_deleted')
        self.include_deleted = attributes[:'include_deleted']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          include_deleted == o.include_deleted &&
    ...
    # @!visibility private
    def hash
      [include_deleted, is_deleted, query, scope, version, additional_properties].hash
    end
  end
end
