  ...
  class UpdateRulesetRequestDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::UpdateRulesetRequestDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [enabled, last_version, rules, additional_properties].hash
    end
  end
end
