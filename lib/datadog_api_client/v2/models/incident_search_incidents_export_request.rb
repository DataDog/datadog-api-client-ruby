...
module DatadogAPIClient::V2
  ...
  class IncidentSearchIncidentsExportRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentSearchIncidentsExportRequest` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [fields, query, additional_properties].hash
    end
  end
end
