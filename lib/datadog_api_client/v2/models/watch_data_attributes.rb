  ...
  class WatchDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::WatchDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [application_id, data_source, event_id, timestamp, additional_properties].hash
    end
  end
end
