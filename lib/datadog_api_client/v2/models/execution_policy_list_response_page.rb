...
module DatadogAPIClient::V2
  # Pagination details.
  class ExecutionPolicyListResponsePage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ExecutionPolicyListResponsePage` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [total, additional_properties].hash
    end
  end
end
