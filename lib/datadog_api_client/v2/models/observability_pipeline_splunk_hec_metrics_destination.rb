  ...
  class ObservabilityPipelineSplunkHecMetricsDestination
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineSplunkHecMetricsDestination` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [buffer, compression, default_namespace, endpoint_url_key, id, index, inputs, source, sourcetype, tls, token_key, type, additional_properties].hash
    end
  end
end
