...
module DatadogAPIClient::V2
  ...
  class IncidentCreateAttributes
    ...
    attr_accessor :initial_timeline_cells
    ...
    def self.attribute_map
      {
        ...
        :'fields' => :'fields',
        :'initial_timeline_cells' => :'initial_timeline_cells',
    ...
    def self.openapi_types
      {
        ...
        :'initial_timeline_cells' => :'Array<IncidentTimelineCellCreateAttributes>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'initial_timeline_cells')
        if (value = attributes[:'initial_timeline_cells']).is_a?(Array)
          self.initial_timeline_cells = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fields == o.fields &&
          initial_timeline_cells == o.initial_timeline_cells &&
    ...
    def hash
      [customer_impacted, fields, initial_timeline_cells, notification_handles, title].hash
    end
