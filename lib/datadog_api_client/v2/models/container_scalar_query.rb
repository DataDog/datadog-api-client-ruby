  ...
  class ContainerScalarQuery
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ContainerScalarQuery` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [aggregator, data_source, is_normalized_cpu, limit, metric, name, sort, tag_filters, text_filter, additional_properties].hash
    end
  end
end
