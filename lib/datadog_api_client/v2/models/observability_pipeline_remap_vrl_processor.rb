...
module DatadogAPIClient::V2
  ...
  class ObservabilityPipelineRemapVrlProcessor
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineRemapVrlProcessor` initialize method"
      end
    ...
    def valid?
      ...
      return false if @remaps.length > 15
    ...
    def remaps=(remaps)
      if remaps.nil?
        fail ArgumentError, 'invalid value for "remaps", remaps cannot be nil.'
      end
      if remaps.length > 15
        fail ArgumentError, 'invalid value for "remaps", number of items must be less than or equal to 15.'
      end
      if remaps.length < 1
        fail ArgumentError, 'invalid value for "remaps", number of items must be greater than or equal to 1.'
      end
      @remaps = remaps
    end
