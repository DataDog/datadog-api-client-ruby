  ...
  class ObservabilityPipelineAmazonS3GenericCompressionZstd
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineAmazonS3GenericCompressionZstd` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [level, type, additional_properties].hash
    end
  end
end
