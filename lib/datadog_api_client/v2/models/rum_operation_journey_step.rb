  ...
  class RUMOperationJourneyStep
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RUMOperationJourneyStep` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [composite, nodes, type, additional_properties].hash
    end
  end
end
