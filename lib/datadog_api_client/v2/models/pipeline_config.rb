...
module DatadogAPIClient::V2
  ...
  class PipelineConfig
    ...
    def self.openapi_types
      {
        :'destinations' => :'Array<PipelineConfigDestination>',
        :'processors' => :'Array<PipelineConfigProcessor>',
        :'sources' => :'Array<PipelineConfigSource>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::PipelineConfig` initialize method"
      end
