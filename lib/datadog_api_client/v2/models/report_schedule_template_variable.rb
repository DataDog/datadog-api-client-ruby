...
module DatadogAPIClient::V2
  ...
  class ReportScheduleTemplateVariable
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ReportScheduleTemplateVariable` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [name, values, additional_properties].hash
    end
  end
end
