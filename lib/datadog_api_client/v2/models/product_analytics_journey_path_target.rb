  ...
  class ProductAnalyticsJourneyPathTarget
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ProductAnalyticsJourneyPathTarget` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [_end, start, type, additional_properties].hash
    end
  end
end
