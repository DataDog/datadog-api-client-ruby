...
module DatadogAPIClient::V2
  ...
  class ScorecardScoreRelationships
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ScorecardScoreRelationships` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [entity, rule, scorecard, service, team, additional_properties].hash
    end
  end
end
