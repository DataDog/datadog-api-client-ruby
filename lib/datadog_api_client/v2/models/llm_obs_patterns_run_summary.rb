  ...
  class LLMObsPatternsRunSummary
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsPatternsRunSummary` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [completed_at, config_snapshot, created_at, id, status, additional_properties].hash
    end
  end
end
