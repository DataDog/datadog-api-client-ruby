...
module DatadogAPIClient::V2
  ...
  class LLMObsExperimentEventsV2Response
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsExperimentEventsV2Response` initialize method"
      end
