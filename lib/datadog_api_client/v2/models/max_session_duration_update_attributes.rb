...
module DatadogAPIClient::V2
  ...
  class MaxSessionDurationUpdateAttributes
    ...
    def valid?
      ...
      return false if @max_session_duration > 2592000
    ...
    def max_session_duration=(max_session_duration)
      ...
      if max_session_duration > 2592000
        fail ArgumentError, 'invalid value for "max_session_duration", must be smaller than or equal to 2592000.'
      end
