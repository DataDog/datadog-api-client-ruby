...
module DatadogAPIClient::V2
  ...
  class RemediationListInvestigationsResponse
    include BaseGenericModel

    # The matching investigations.
    attr_accessor :investigations
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RemediationListInvestigationsResponse` initialize method"
      end
      ...
      if attributes.key?(:'investigations')
        if (value = attributes[:'investigations']).is_a?(Array)
    ...
    # @!visibility private
    def hash
      [investigations, next_page_token, additional_properties].hash
    end
  end
end
