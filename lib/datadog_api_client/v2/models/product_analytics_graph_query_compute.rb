...
module DatadogAPIClient::V2
  ...
  class ProductAnalyticsGraphQueryCompute
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ProductAnalyticsGraphQueryCompute` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [aggregation, interval, metric, target, additional_properties].hash
    end
  end
end
