  ...
  class ExecutionStep
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ExecutionStep` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [completed_at, error, id, name, started_at, status, additional_properties].hash
    end
  end
end
