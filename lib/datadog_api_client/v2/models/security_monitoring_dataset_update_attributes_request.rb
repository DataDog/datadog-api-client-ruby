...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringDatasetUpdateAttributesRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityMonitoringDatasetUpdateAttributesRequest` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [definition, description, version, additional_properties].hash
    end
  end
end
