  ...
  class ObservabilityPipelineSocketDestination
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineSocketDestination` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [encoding, framing, id, inputs, mode, tls, type, additional_properties].hash
    end
  end
end
