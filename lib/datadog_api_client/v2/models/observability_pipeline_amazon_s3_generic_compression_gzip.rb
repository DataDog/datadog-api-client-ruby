  ...
  class ObservabilityPipelineAmazonS3GenericCompressionGzip
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineAmazonS3GenericCompressionGzip` initialize method"
      end
