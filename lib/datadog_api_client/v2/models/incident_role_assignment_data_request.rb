...
module DatadogAPIClient::V2
  ...
  class IncidentRoleAssignmentDataRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentRoleAssignmentDataRequest` initialize method"
      end
