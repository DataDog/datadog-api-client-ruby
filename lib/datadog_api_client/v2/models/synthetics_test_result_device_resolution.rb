  ...
  class SyntheticsTestResultDeviceResolution
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SyntheticsTestResultDeviceResolution` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [height, pixel_ratio, width, additional_properties].hash
    end
  end
end
