...
module DatadogAPIClient::V2
  ...
  class LLMObsExperimentationAnalyticsValue
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsExperimentationAnalyticsValue` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [by, metrics, additional_properties].hash
    end
  end
end
