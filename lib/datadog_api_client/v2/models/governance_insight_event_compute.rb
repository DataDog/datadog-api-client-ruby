...
module DatadogAPIClient::V2
  ...
  class GovernanceInsightEventCompute
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::GovernanceInsightEventCompute` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [aggregation, interval, additional_properties].hash
    end
  end
end
