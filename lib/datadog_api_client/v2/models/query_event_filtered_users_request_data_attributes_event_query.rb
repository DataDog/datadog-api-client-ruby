  ...
  class QueryEventFilteredUsersRequestDataAttributesEventQuery
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::QueryEventFilteredUsersRequestDataAttributesEventQuery` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [query, time_frame, additional_properties].hash
    end
  end
end
