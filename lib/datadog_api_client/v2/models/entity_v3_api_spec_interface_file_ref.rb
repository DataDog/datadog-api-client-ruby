  ...
  class EntityV3APISpecInterfaceFileRef
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::EntityV3APISpecInterfaceFileRef` initialize method"
      end
      ...
      if attributes.key?(:'file_ref')
        self.file_ref = attributes[:'file_ref']
      end
    end
