  ...
  class FleetDeploymentConfigureAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::FleetDeploymentConfigureAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [config_operations, filter_query, additional_properties].hash
    end
  end
end
