...
module DatadogAPIClient::V2
  ...
  class LLMObsAnnotationsDataAttributesRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsAnnotationsDataAttributesRequest` initialize method"
      end
    ...
    def valid?
      ...
      return false if @annotations.length < 1
      true
    end
    ...
    # @!visibility private
    def hash
      [annotations, additional_properties].hash
    end
  end
end
