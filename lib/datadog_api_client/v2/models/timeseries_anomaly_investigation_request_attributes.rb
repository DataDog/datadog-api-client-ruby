...
module DatadogAPIClient::V2
  ...
  class TimeseriesAnomalyInvestigationRequestAttributes
    ...
    def self.openapi_types
      {
        :'requests' => :'Array<TimeseriesAnomalyInvestigationTimeseriesRequest>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::TimeseriesAnomalyInvestigationRequestAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [requests, additional_properties].hash
    end
  end
end
