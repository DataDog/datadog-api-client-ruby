...
module DatadogAPIClient::V2
  ...
  class IncidentTimelineEntryDataAttributesRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentTimelineEntryDataAttributesRequest` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [cell_type, content, display_time, important, additional_properties].hash
    end
  end
end
