...
module DatadogAPIClient::V2
  ...
  class PipelineRemoveFieldsProcessor
    ...
    def self.openapi_types
      {
        ...
        :'include' => :'String',
        :'inputs' => :'Array<String>',
        :'type' => :'PipelineRemoveFieldsProcessorType'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::PipelineRemoveFieldsProcessor` initialize method"
      end
