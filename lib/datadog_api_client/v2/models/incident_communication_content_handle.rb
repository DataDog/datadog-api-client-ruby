...
module DatadogAPIClient::V2
  ...
  class IncidentCommunicationContentHandle
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentCommunicationContentHandle` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [created_at, display_name, handle, additional_properties].hash
    end
  end
end
