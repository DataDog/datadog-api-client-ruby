...
module DatadogAPIClient::V2
  # Zstd compression.
  class ObservabilityPipelineAzureStorageDestinationCompressionZstd
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineAzureStorageDestinationCompressionZstd` initialize method"
      end
