...
module DatadogAPIClient::V2
  ...
  class IncidentGoogleMeetIntegrationDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentGoogleMeetIntegrationDataAttributes` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param spaces [Object] Object to be assigned
    # @!visibility private
    def spaces=(spaces)
      if spaces.nil?
        fail ArgumentError, 'invalid value for "spaces", spaces cannot be nil.'
      end
      @spaces = spaces
    end
    ...
    # @!visibility private
    def hash
      [created, integration_type, modified, spaces, status, additional_properties].hash
    end
  end
end
