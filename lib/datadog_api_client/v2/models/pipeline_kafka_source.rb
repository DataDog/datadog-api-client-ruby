  ...
  class PipelineKafkaSource
    ...
    def self.openapi_types
      {
        :'group_id' => :'String',
        :'id' => :'String',
        :'librdkafka_options' => :'Array<PipelineKafkaSourceLibrdkafkaOption>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::PipelineKafkaSource` initialize method"
      end
