...
module DatadogAPIClient::V2
  ...
  class AiCustomRulesetRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AiCustomRulesetRequestAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [description, name, short_description, additional_properties].hash
    end
  end
end
