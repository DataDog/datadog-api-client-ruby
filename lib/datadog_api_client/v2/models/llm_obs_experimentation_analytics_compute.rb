...
module DatadogAPIClient::V2
  ...
  class LLMObsExperimentationAnalyticsCompute
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsExperimentationAnalyticsCompute` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [metric, name, additional_properties].hash
    end
  end
end
