  ...
  class ProductAnalyticsJourneyFunnelQuery
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ProductAnalyticsJourneyFunnelQuery` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [compute, group_by, search, additional_properties].hash
    end
  end
end
