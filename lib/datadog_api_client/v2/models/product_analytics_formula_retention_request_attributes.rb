...
module DatadogAPIClient::V2
  ...
  class ProductAnalyticsFormulaRetentionRequestAttributes
    include BaseGenericModel

    # Whether to exclude sessions that are not tied to an identified user.
    attr_accessor :exclude_anonymous_traffic
    ...
    def self.openapi_types
      {
        :'exclude_anonymous_traffic' => :'Boolean',
        :'from' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ProductAnalyticsFormulaRetentionRequestAttributes` initialize method"
      end
      ...
      if attributes.key?(:'exclude_anonymous_traffic')
        self.exclude_anonymous_traffic = attributes[:'exclude_anonymous_traffic']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          exclude_anonymous_traffic == o.exclude_anonymous_traffic &&
          from == o.from &&
          query == o.query &&
          to == o.to &&
    ...
    # @!visibility private
    def hash
      [exclude_anonymous_traffic, from, query, to, additional_properties].hash
    end
  end
end
