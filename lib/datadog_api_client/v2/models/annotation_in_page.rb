  ...
  class AnnotationInPage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AnnotationInPage` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [author_id, color, created_at, description, end_time, id, modified_at, page_id, start_time, type, widget_ids, additional_properties].hash
    end
  end
end
