  ...
  class AgenticEvent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AgenticEvent` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [message, payload, type, additional_properties].hash
    end
  end
end
