  ...
  class CreateServiceNowTicketRequestDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CreateServiceNowTicketRequestDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [assignee_id, description, priority, title, additional_properties].hash
    end
  end
end
