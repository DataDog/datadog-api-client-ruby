...
module DatadogAPIClient::V2
  ...
  class RumPermanentRetentionFilterMeta
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RumPermanentRetentionFilterMeta` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [source, updated_at, updated_by_handle, additional_properties].hash
    end
  end
end
