  ...
  class Variant
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::Variant` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [created_at, id, key, name, updated_at, value, additional_properties].hash
    end
  end
end
