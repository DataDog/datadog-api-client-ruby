...
module DatadogAPIClient::V2
  ...
  class DatabricksDataObservabilityQualityMonitoringIntegrationDataflowResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DatabricksDataObservabilityQualityMonitoringIntegrationDataflowResponse` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [enabled, settings, additional_properties].hash
    end
  end
end
