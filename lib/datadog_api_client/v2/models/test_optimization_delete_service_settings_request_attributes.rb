...
module DatadogAPIClient::V2
  ...
  class TestOptimizationDeleteServiceSettingsRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::TestOptimizationDeleteServiceSettingsRequestAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [env, repository_id, service_name, additional_properties].hash
    end
  end
end
