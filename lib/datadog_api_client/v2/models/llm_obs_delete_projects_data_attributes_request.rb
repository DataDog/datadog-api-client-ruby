  ...
  class LLMObsDeleteProjectsDataAttributesRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsDeleteProjectsDataAttributesRequest` initialize method"
      end
    ...
    # @param project_ids [Object] Object to be assigned
    # @!visibility private
    def project_ids=(project_ids)
      if project_ids.nil?
        fail ArgumentError, 'invalid value for "project_ids", project_ids cannot be nil.'
      end
      @project_ids = project_ids
    end
    ...
    # @!visibility private
    def hash
      [project_ids, additional_properties].hash
    end
  end
end
