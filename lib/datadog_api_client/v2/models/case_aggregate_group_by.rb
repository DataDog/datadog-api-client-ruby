  ...
  class CaseAggregateGroupBy
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CaseAggregateGroupBy` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [groups, limit, additional_properties].hash
    end
  end
end
