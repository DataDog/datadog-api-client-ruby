...
module DatadogAPIClient::V2
  ...
  class CreateDegradationRequestDataAttributesUpdatesItems
    ...
    def self.openapi_types
      {
        :'components_affected' => :'Array<CreateDegradationRequestDataAttributesUpdatesItemsComponentsAffectedItems>',
        :'description' => :'String',
        :'started_at' => :'Time',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CreateDegradationRequestDataAttributesUpdatesItems` initialize method"
      end
