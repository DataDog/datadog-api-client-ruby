  ...
  class ItemApiPayloadMetaSchema
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ItemApiPayloadMetaSchema` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [fields, primary_key, additional_properties].hash
    end
  end
end
