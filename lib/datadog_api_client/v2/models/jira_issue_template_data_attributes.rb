  ...
  class JiraIssueTemplateDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::JiraIssueTemplateDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [fields, issue_type_id, name, project_id, additional_properties].hash
    end
  end
end
