  ...
  class IoCTriageEvent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IoCTriageEvent` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [triage_state, triaged_at, triaged_by, additional_properties].hash
    end
  end
end
