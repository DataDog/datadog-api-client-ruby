...
module DatadogAPIClient::V2
  ...
  class FleetClustersResponseDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::FleetClustersResponseDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [clusters, additional_properties].hash
    end
  end
end
