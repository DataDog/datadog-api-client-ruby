  ...
  class LLMObsPatternsTriggerResponseAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsPatternsTriggerResponseAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [config_id, run_id, status, additional_properties].hash
    end
  end
end
