...
module DatadogAPIClient::V2
  ...
  class DashboardSearchResponseMeta
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DashboardSearchResponseMeta` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [aggregations, total, additional_properties].hash
    end
  end
end
