  ...
  class CreateDataDeletionRequestBodyAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CreateDataDeletionRequestBodyAttributes` initialize method"
      end
    ...
    def valid?
      ...
      return false if @displayed_total < 1
    ...
    def displayed_total=(displayed_total)
      ...
      if displayed_total < 1
        fail ArgumentError, 'invalid value for "displayed_total", must be greater than or equal to 1.'
      end
      @displayed_total = displayed_total
    end
