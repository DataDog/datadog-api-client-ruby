...
module DatadogAPIClient::V2
  ...
  class DegradationTemplateDataAttributes
    ...
    def self.openapi_types
      {
        :'components_affected' => :'Array<DegradationTemplateDataAttributesComponentsAffectedItems>',
        :'created_at' => :'Time',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DegradationTemplateDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [components_affected, created_at, degradation_title, modified_at, name, updates, additional_properties].hash
    end
  end
end
