  ...
  class LLMObsPatternsRunStatusResponseAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsPatternsRunStatusResponseAttributes` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param progress [Object] Object to be assigned
    # @!visibility private
    def progress=(progress)
      if progress.nil?
        fail ArgumentError, 'invalid value for "progress", progress cannot be nil.'
      end
      @progress = progress
    end
    ...
    # Custom attribute writer method with validation
    # @param step [Object] Object to be assigned
    # @!visibility private
    def step=(step)
      if step.nil?
        fail ArgumentError, 'invalid value for "step", step cannot be nil.'
      end
      @step = step
    end
    ...
    # @!visibility private
    def hash
      [created_at, progress, status, step, additional_properties].hash
    end
  end
end
