...
module DatadogAPIClient::V2
  # Relationships of the case to attach findings to.
  class AttachCaseRequestDataRelationships
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AttachCaseRequestDataRelationships` initialize method"
      end
