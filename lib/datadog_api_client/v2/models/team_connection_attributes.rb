  ...
  class TeamConnectionAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::TeamConnectionAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [managed_by, source, additional_properties].hash
    end
  end
end
