...
module DatadogAPIClient::V2
  ...
  class DashboardSearchAggregationBucketMultiKey
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DashboardSearchAggregationBucketMultiKey` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [count, value, additional_properties].hash
    end
  end
end
