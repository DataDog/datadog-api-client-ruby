...
module DatadogAPIClient::V2
  ...
  class EntityContextResponseMeta
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::EntityContextResponseMeta` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [page, total_count, additional_properties].hash
    end
  end
end
