  ...
  class LongTaskMetricStats
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LongTaskMetricStats` initialize method"
      end
    ...
    # @param average [Object] Object to be assigned
    # @!visibility private
    def average=(average)
      if average.nil?
        fail ArgumentError, 'invalid value for "average", average cannot be nil.'
      end
      @average = average
    end
    ...
    # @!visibility private
    def hash
      [average, max, min, additional_properties].hash
    end
  end
end
