...
module DatadogAPIClient::V2
  ...
  class WebhooksOAuth2ClientCredentialsUpdateData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::WebhooksOAuth2ClientCredentialsUpdateData` initialize method"
      end
