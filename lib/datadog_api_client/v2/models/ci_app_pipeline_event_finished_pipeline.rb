  ...
  class CIAppPipelineEventFinishedPipeline
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CIAppPipelineEventFinishedPipeline` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [_end, error, git, is_manual, is_resumed, level, metrics, name, node, parameters, parent_pipeline, partial_retry, pipeline_id, previous_attempt, queue_time, start, status, tags, unique_id, url, additional_properties].hash
    end
  end
end
