  ...
  class EntityIntegrationConfigAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::EntityIntegrationConfigAttributes` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param integration_id [Object] Object to be assigned
    # @!visibility private
    def integration_id=(integration_id)
      if integration_id.nil?
        fail ArgumentError, 'invalid value for "integration_id", integration_id cannot be nil.'
      end
      @integration_id = integration_id
    end
    ...
    # @!visibility private
    def hash
      [config, integration_id, org_id, additional_properties].hash
    end
  end
end
