...
module DatadogAPIClient::V2
  ...
  class IssueAttributes
    ...
    # @!visibility private
    def hash
      [error_message, error_type, file_path, first_seen, first_seen_version, function_name, impacted_sessions, impacted_users, is_crash, languages, last_seen, last_seen_version, platform, service, state, total_count, additional_properties].hash
    end
  end
end
