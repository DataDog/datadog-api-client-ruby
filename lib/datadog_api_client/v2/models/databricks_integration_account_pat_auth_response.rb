...
module DatadogAPIClient::V2
  ...
  class DatabricksIntegrationAccountPatAuthResponse
    ...
    def initialize(attributes = {})
      warn "[DEPRECATION] `DatabricksIntegrationAccountPatAuthResponse` is deprecated."
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DatabricksIntegrationAccountPatAuthResponse` initialize method"
      end
