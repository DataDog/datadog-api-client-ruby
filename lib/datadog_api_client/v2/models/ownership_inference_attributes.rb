...
module DatadogAPIClient::V2
  ...
  class OwnershipInferenceAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::OwnershipInferenceAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [checksum, confidence, created_at, evidence_versions, explanation, owner_type, primary_contact_ref, sources, status, updated_at, additional_properties].hash
    end
  end
end
