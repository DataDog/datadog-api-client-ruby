  ...
  class RUMProductAnalyticsRetentionScale
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RUMProductAnalyticsRetentionScale` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [last_modified_at, state, additional_properties].hash
    end
  end
end
