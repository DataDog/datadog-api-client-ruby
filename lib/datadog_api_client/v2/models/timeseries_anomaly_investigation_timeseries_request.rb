  ...
  class TimeseriesAnomalyInvestigationTimeseriesRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::TimeseriesAnomalyInvestigationTimeseriesRequest` initialize method"
      end
    ...
    def from=(from)
      ...
      if from < 1
        fail ArgumentError, 'invalid value for "from", must be greater than or equal to 1.'
      end
      @from = from
    end
    ...
    def to=(to)
      ...
      if to < 1
        fail ArgumentError, 'invalid value for "to", must be greater than or equal to 1.'
      end
      @to = to
    end
    ...
    # @!visibility private
    def hash
      [formulas, from, interval, queries, to, additional_properties].hash
    end
  end
end
