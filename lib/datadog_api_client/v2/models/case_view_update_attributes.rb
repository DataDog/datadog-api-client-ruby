  ...
  class CaseViewUpdateAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CaseViewUpdateAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [name, np_rule_id, query, additional_properties].hash
    end
  end
end
