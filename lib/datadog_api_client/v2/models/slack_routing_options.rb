  ...
  class SlackRoutingOptions
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SlackRoutingOptions` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [channel_id, channel_name, workspace_id, workspace_name, additional_properties].hash
    end
  end
end
