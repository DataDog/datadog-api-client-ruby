...
module DatadogAPIClient::V2
  ...
  class CreateBackfilledMaintenanceRequestDataAttributes
    ...
    def self.openapi_types
      {
        :'title' => :'String',
        :'updates' => :'Array<CreateBackfilledMaintenanceRequestDataAttributesUpdatesItems>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CreateBackfilledMaintenanceRequestDataAttributes` initialize method"
      end
    ...
    def valid?
      ...
      return false if @updates.length > 2
      return false if @updates.length < 2
      true
    end
    ...
    def updates=(updates)
      ...
      if updates.length > 2
        fail ArgumentError, 'invalid value for "updates", number of items must be less than or equal to 2.'
      end
      if updates.length < 2
        fail ArgumentError, 'invalid value for "updates", number of items must be greater than or equal to 2.'
      end
      @updates = updates
    end
