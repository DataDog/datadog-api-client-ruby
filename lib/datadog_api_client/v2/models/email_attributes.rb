  ...
  class EmailAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::EmailAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [active, address, _alias, formats, additional_properties].hash
    end
  end
end
