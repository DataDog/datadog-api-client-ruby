...
module DatadogAPIClient::V2
  ...
  class RUMOperationResponseData
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RUMOperationResponseData` initialize method"
      end
