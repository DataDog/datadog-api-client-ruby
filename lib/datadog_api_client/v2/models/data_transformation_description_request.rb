...
module DatadogAPIClient::V2
  # 
  class DataTransformationDescriptionRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DataTransformationDescriptionRequest` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param script [Object] Object to be assigned
    # @!visibility private
    def script=(script)
      if script.nil?
        fail ArgumentError, 'invalid value for "script", script cannot be nil.'
      end
      @script = script
    end
    ...
    # @!visibility private
    def hash
      [action_id, script, additional_properties].hash
    end
  end
end
