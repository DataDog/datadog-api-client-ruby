  ...
  class ListAppsResponseDataItemsAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ListAppsResponseDataItemsAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [description, favorite, name, self_service, tags, additional_properties].hash
    end
  end
end
