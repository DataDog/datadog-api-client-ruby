  ...
  class TimeseriesAnomalyInvestigationFormula
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::TimeseriesAnomalyInvestigationFormula` initialize method"
      end
    ...
    def valid?
      ...
      return false if @formula.to_s.length < 1
      true
    end
    ...
    def formula=(formula)
      ...
      if formula.to_s.length < 1
        fail ArgumentError, 'invalid value for "formula", the character length must be great than or equal to 1.'
      end
      @formula = formula
    end
