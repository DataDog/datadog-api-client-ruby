...
module DatadogAPIClient::V2
  ...
  class PipelineQuotaProcessorLimit
    ...
    def self.openapi_types
      {
        :'enforce' => :'PipelineQuotaProcessorLimitEnforceType',
        :'limit' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::PipelineQuotaProcessorLimit` initialize method"
      end
