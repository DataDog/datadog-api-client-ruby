  ...
  class UpdateFlakyTestsRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::UpdateFlakyTestsRequestAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [tests, additional_properties].hash
    end
  end
end
