  ...
  class LLMObsDatasetBatchUpdateUpdateRecord
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsDatasetBatchUpdateUpdateRecord` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [expected_output, id, input, metadata, tag_operations, additional_properties].hash
    end
  end
end
