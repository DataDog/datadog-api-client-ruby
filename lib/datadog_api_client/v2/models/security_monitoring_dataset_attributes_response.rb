...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringDatasetAttributesResponse
    ...
    # Custom attribute writer method with validation
    # @param is_deprecated [Object] Object to be assigned
    # @!visibility private
    def is_deprecated=(is_deprecated)
      if is_deprecated.nil?
        fail ArgumentError, 'invalid value for "is_deprecated", is_deprecated cannot be nil.'
      end
    ...
    # @!visibility private
    def hash
      [created_at, created_by_handle, created_by_name, definition, description, id, is_default, is_deprecated, modified_at, name, updated_by_handle, updated_by_name, version, additional_properties].hash
    end
  end
end
