  ...
  class TeamRoutingRulesDataRelationshipsRulesDataItems
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::TeamRoutingRulesDataRelationshipsRulesDataItems` initialize method"
      end
