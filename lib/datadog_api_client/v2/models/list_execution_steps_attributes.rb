...
module DatadogAPIClient::V2
  ...
  class ListExecutionStepsAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ListExecutionStepsAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [steps, additional_properties].hash
    end
  end
end
