  ...
  class SyntheticsTestResultCdnCacheStatus
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SyntheticsTestResultCdnCacheStatus` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [cached, status, additional_properties].hash
    end
  end
end
