  ...
  class ProductAnalyticsRetentionGroupBy
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ProductAnalyticsRetentionGroupBy` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [facet, limit, should_exclude_missing, sort, source, target, additional_properties].hash
    end
  end
end
