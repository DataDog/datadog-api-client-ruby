  ...
  class AWSSecretManager
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AWSSecretManager` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [connection_id, region, additional_properties].hash
    end
  end
end
