...
module DatadogAPIClient::V2
  ...
  class DefaultRulesetsPerLanguageDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::DefaultRulesetsPerLanguageDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [rulesets, additional_properties].hash
    end
  end
end
