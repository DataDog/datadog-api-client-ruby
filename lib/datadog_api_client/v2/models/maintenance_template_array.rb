...
module DatadogAPIClient::V2
  ...
  class MaintenanceTemplateArray
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::MaintenanceTemplateArray` initialize method"
      end
