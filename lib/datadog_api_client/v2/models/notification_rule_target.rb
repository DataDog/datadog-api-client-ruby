  ...
  class NotificationRuleTarget
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::NotificationRuleTarget` initialize method"
      end
    ...
    # @param configuration [Object] Object to be assigned
    # @!visibility private
    def configuration=(configuration)
      if configuration.nil?
        fail ArgumentError, 'invalid value for "configuration", configuration cannot be nil.'
      end
      @configuration = configuration
    end
    ...
    # @!visibility private
    def hash
      [configuration, type, version, additional_properties].hash
    end
  end
end
