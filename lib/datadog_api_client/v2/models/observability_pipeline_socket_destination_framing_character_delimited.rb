  ...
  class ObservabilityPipelineSocketDestinationFramingCharacterDelimited
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineSocketDestinationFramingCharacterDelimited` initialize method"
      end
    ...
    def valid?
      ...
      return false if @delimiter.to_s.length > 1
      return false if @delimiter.to_s.length < 1
    ...
    # @!visibility private
    def hash
      [delimiter, method, additional_properties].hash
    end
  end
end
