...
module DatadogAPIClient::V2
  ...
  class SyntheticsTestResultStepElementUpdates
    ...
    attr_accessor :target_outer_html
    ...
    def self.openapi_types
      {
        :'multi_locator' => :'Hash<String, String>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SyntheticsTestResultStepElementUpdates` initialize method"
      end
      ...
      if attributes.key?(:'target_outer_html')
        self.target_outer_html = attributes[:'target_outer_html']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          target_outer_html == o.target_outer_html &&
          version == o.version &&
    ...
    # @!visibility private
    def hash
      [multi_locator, target_outer_html, version, additional_properties].hash
    end
  end
end
