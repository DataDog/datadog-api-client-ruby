...
module DatadogAPIClient::V2
  ...
  class NotebookSearchAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::NotebookSearchAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [meta, name, tags, additional_properties].hash
    end
  end
end
