...
module DatadogAPIClient::V2
  ...
  class LLMObsDatasetRecordTagOperations
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsDatasetRecordTagOperations` initialize method"
      end
      ...
      if attributes.key?(:'set')
        if (value = attributes[:'set']).is_a?(Array)
          self.set = value
        end
      end
    end
    ...
    # @!visibility private
    def hash
      [add, remove, set, additional_properties].hash
    end
  end
end
