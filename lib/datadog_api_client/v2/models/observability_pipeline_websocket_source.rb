  ...
  class ObservabilityPipelineWebsocketSource
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineWebsocketSource` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [auth_strategy, custom_key, decoding, id, password_key, tls, token_key, type, uri_key, username_key, additional_properties].hash
    end
  end
end
