...
module DatadogAPIClient::V2
  ...
  class ApplicationSecurityExclusionFilterMetadata
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ApplicationSecurityExclusionFilterMetadata` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [added_at, added_by, modified_at, modified_by, additional_properties].hash
    end
  end
end
