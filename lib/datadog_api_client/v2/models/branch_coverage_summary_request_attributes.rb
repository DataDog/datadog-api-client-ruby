  ...
  class BranchCoverageSummaryRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::BranchCoverageSummaryRequestAttributes` initialize method"
      end
    ...
    # @param branch [Object] Object to be assigned
    # @!visibility private
    def branch=(branch)
      if branch.nil?
        fail ArgumentError, 'invalid value for "branch", branch cannot be nil.'
      end
      if branch.to_s.length < 1
        fail ArgumentError, 'invalid value for "branch", the character length must be great than or equal to 1.'
      end
      @branch = branch
    end
