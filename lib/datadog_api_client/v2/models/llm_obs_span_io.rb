  ...
  class LLMObsSpanIO
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsSpanIO` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [messages, value, additional_properties].hash
    end
  end
end
