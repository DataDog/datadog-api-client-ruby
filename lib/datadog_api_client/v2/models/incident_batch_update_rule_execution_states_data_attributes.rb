...
module DatadogAPIClient::V2
  ...
  class IncidentBatchUpdateRuleExecutionStatesDataAttributes
    ...
    def self.openapi_types
      {
        :'rules' => :'Array<IncidentRuleExecutionStateRule>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentBatchUpdateRuleExecutionStatesDataAttributes` initialize method"
      end
