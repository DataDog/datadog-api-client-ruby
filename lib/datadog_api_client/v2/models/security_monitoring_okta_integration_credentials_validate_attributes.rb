...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringOktaIntegrationCredentialsValidateAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityMonitoringOktaIntegrationCredentialsValidateAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [domain, integration_type, secrets, additional_properties].hash
    end
  end
end
