...
module DatadogAPIClient::V2
  ...
  class TimeseriesAnomalyInvestigationAnomalyFinding
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::TimeseriesAnomalyInvestigationAnomalyFinding` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [description, headline, type, additional_properties].hash
    end
  end
end
