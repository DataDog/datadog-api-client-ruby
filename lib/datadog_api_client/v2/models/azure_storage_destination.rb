  ...
  class AzureStorageDestination
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AzureStorageDestination` initialize method"
      end
    ...
    # @param container_name [Object] Object to be assigned
    # @!visibility private
    def container_name=(container_name)
      if container_name.nil?
        fail ArgumentError, 'invalid value for "container_name", container_name cannot be nil.'
      end
      @container_name = container_name
    end
