  ...
  class AIGuardToolCallFunction
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AIGuardToolCallFunction` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [arguments, name, additional_properties].hash
    end
  end
end
