...
module DatadogAPIClient::V2
  ...
  class ProductAnalyticsRetentionListRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ProductAnalyticsRetentionListRequestAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [from, query, to, additional_properties].hash
    end
  end
end
