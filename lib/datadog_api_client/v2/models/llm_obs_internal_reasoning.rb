  ...
  class LLMObsInternalReasoning
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsInternalReasoning` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [reasoning_tokens, text, additional_properties].hash
    end
  end
end
