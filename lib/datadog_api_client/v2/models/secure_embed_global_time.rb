  ...
  class SecureEmbedGlobalTime
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecureEmbedGlobalTime` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [live_span, additional_properties].hash
    end
  end
end
