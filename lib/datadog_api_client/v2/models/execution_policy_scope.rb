...
module DatadogAPIClient::V2
  ...
  class ExecutionPolicyScope
    ...
    attr_accessor :remote_action_rshell
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ExecutionPolicyScope` initialize method"
      end
      ...
      if attributes.key?(:'kubernetes')
        self.kubernetes = attributes[:'kubernetes']
      end

      if attributes.key?(:'remote_action_rshell')
        self.remote_action_rshell = attributes[:'remote_action_rshell']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          remote_action_rshell == o.remote_action_rshell &&
          scripts == o.scripts &&
    ...
    # @!visibility private
    def hash
      [kubernetes, remote_action_rshell, scripts, additional_properties].hash
    end
  end
end
