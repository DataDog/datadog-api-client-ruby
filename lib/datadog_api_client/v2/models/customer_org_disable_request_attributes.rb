...
module DatadogAPIClient::V2
  ...
  class CustomerOrgDisableRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CustomerOrgDisableRequestAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [org_uuid, additional_properties].hash
    end
  end
end
