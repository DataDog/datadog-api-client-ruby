  ...
  class ComponentGrid
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ComponentGrid` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [events, id, name, properties, type].hash
    end
  end
end
