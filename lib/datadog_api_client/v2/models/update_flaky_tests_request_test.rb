  ...
  class UpdateFlakyTestsRequestTest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::UpdateFlakyTestsRequestTest` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param new_state [Object] Object to be assigned
    # @!visibility private
    def new_state=(new_state)
      if new_state.nil?
        fail ArgumentError, 'invalid value for "new_state", new_state cannot be nil.'
      end
      @new_state = new_state
    end
    ...
    # @!visibility private
    def hash
      [id, new_state, additional_properties].hash
    end
  end
end
