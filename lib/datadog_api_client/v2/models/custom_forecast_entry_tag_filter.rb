...
module DatadogAPIClient::V2
  ...
  class CustomForecastEntryTagFilter
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CustomForecastEntryTagFilter` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param tag_value [Object] Object to be assigned
    # @!visibility private
    def tag_value=(tag_value)
      if tag_value.nil?
        fail ArgumentError, 'invalid value for "tag_value", tag_value cannot be nil.'
      end
      @tag_value = tag_value
    end
