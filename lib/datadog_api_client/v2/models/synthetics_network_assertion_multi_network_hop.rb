  ...
  class SyntheticsNetworkAssertionMultiNetworkHop
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SyntheticsNetworkAssertionMultiNetworkHop` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [operator, property, target, type, additional_properties].hash
    end
  end
end
