  ...
  class SnowflakeIntegrationAccountResponseAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SnowflakeIntegrationAccountResponseAttributes` initialize method"
      end
    ...
    # Custom attribute writer method with validation
    # @param dataflows [Object] Object to be assigned
    # @!visibility private
    def dataflows=(dataflows)
      if dataflows.nil?
        fail ArgumentError, 'invalid value for "dataflows", dataflows cannot be nil.'
      end
      @dataflows = dataflows
    end
