  ...
  class CostRecommendationDataAttributesPotentialDailySavings
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CostRecommendationDataAttributesPotentialDailySavings` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [amount, currency, additional_properties].hash
    end
  end
end
