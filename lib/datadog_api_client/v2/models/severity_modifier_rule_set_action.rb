...
module DatadogAPIClient::V2
  ...
  class SeverityModifierRuleSetAction
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SeverityModifierRuleSetAction` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [description, severity, type, additional_properties].hash
    end
  end
end
