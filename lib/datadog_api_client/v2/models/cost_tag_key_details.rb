  ...
  class CostTagKeyDetails
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CostTagKeyDetails` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [description, tag_values, additional_properties].hash
    end
  end
end
