...
module DatadogAPIClient::V2
  # 
  class EventEmailAddressResponseDataRelationships
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::EventEmailAddressResponseDataRelationships` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [created_by, revoked_by, additional_properties].hash
    end
  end
end
