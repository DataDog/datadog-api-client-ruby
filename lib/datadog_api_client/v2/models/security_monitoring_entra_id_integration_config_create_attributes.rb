...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringEntraIdIntegrationConfigCreateAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityMonitoringEntraIdIntegrationConfigCreateAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [domain, integration_type, name, settings, additional_properties].hash
    end
  end
end
