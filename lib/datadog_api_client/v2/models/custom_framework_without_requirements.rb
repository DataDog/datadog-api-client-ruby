  ...
  class CustomFrameworkWithoutRequirements
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CustomFrameworkWithoutRequirements` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [description, handle, icon_url, name, version, additional_properties].hash
    end
  end
end
