  ...
  class ObservabilityPipelineHttpClientSource
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineHttpClientSource` initialize method"
      end
      ...
      if attributes.key?(:'scrape_interval_secs')
        self.scrape_interval_secs = attributes[:'scrape_interval_secs']
      end

      if attributes.key?(:'scrape_timeout_secs')
        self.scrape_timeout_secs = attributes[:'scrape_timeout_secs']
      end
