...
module DatadogAPIClient::V2
  ...
  class RumHardcodedRetentionFilterAttributes
    ...
    attr_accessor :cross_product_sampling_editability
    ...
    def self.openapi_types
      {
        :'cross_product_sampling' => :'RumHardcodedCrossProductSampling',
        :'cross_product_sampling_editability' => :'RumHardcodedCrossProductSamplingEditability',
        :'enabled' => :'Boolean',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RumHardcodedRetentionFilterAttributes` initialize method"
      end
      ...
      if attributes.key?(:'cross_product_sampling_editability')
        self.cross_product_sampling_editability = attributes[:'cross_product_sampling_editability']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cross_product_sampling_editability == o.cross_product_sampling_editability &&
          enabled == o.enabled &&
    ...
    # @!visibility private
    def hash
      [cross_product_sampling, cross_product_sampling_editability, enabled, event_type, name, query, sample_rate, additional_properties].hash
    end
  end
end
