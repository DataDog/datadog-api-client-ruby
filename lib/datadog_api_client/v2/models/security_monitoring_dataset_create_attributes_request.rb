...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringDatasetCreateAttributesRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityMonitoringDatasetCreateAttributesRequest` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [definition, description, additional_properties].hash
    end
  end
end
