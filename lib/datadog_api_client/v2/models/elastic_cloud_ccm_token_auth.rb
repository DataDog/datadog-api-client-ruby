...
module DatadogAPIClient::V2
  ...
  class ElasticCloudCcmTokenAuth
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ElasticCloudCcmTokenAuth` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [api_key, type, additional_properties].hash
    end
  end
end
