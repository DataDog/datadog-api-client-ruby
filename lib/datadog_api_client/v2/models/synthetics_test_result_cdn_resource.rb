  ...
  class SyntheticsTestResultCdnResource
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SyntheticsTestResultCdnResource` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [cdn, resolved_ip, timestamp, timings, additional_properties].hash
    end
  end
end
