...
module DatadogAPIClient::V2
  ...
  class FleetDeploymentPackageUpgradeV2Attributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::FleetDeploymentPackageUpgradeV2Attributes` initialize method"
      end
