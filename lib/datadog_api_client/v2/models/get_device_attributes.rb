...
module DatadogAPIClient::V2
  ...
  class GetDeviceAttributes
    ...
    # @!visibility private
    def hash
      [description, device_type, integration, ip_address, location, model, name, os_hostname, os_name, os_version, ping_status, product_name, serial_number, status, subnet, sys_object_id, tags, vendor, version, additional_properties].hash
    end
  end
end
