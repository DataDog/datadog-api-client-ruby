  ...
  class AWSLogsConfig
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AWSLogsConfig` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [lambda_forwarder, additional_properties].hash
    end
  end
end
