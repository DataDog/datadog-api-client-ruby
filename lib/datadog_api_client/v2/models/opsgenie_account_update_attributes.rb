...
module DatadogAPIClient::V2
  ...
  class OpsgenieAccountUpdateAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::OpsgenieAccountUpdateAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [api_key, region, additional_properties].hash
    end
  end
end
