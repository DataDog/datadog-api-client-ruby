  ...
  class AutomationRuleCreateAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::AutomationRuleCreateAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [action, name, state, trigger, additional_properties].hash
    end
  end
end
