  ...
  class LLMObsSpanSearchOptions
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsSpanSearchOptions` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [include_attachments, time_offset, additional_properties].hash
    end
  end
end
