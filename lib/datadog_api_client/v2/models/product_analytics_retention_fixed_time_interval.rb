  ...
  class ProductAnalyticsRetentionFixedTimeInterval
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ProductAnalyticsRetentionFixedTimeInterval` initialize method"
      end
    ...
    def value=(value)
      ...
      if value <= 0
        fail ArgumentError, 'invalid value for "value", must be greater than 0.'
      end
      @value = value
    end
