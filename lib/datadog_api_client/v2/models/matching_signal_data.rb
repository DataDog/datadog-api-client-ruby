...
module DatadogAPIClient::V2
  ...
  class MatchingSignalData
    include BaseGenericModel

    # Attributes of a matching security signal.
    attr_reader :attributes

    # The ID of the matching signal.
    attr_reader :id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::MatchingSignalData` initialize method"
      end
