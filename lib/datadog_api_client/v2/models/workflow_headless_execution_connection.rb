...
module DatadogAPIClient::V2
  # 
  class WorkflowHeadlessExecutionConnection
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::WorkflowHeadlessExecutionConnection` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [connection_id, label, additional_properties].hash
    end
  end
end
