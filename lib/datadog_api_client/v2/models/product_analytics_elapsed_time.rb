...
module DatadogAPIClient::V2
  ...
  class ProductAnalyticsElapsedTime
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ProductAnalyticsElapsedTime` initialize method"
      end
    ...
    # @param avg [Object] Object to be assigned
    # @!visibility private
    def avg=(avg)
      if avg.nil?
        fail ArgumentError, 'invalid value for "avg", avg cannot be nil.'
      end
      @avg = avg
    end
    ...
    # @!visibility private
    def hash
      [avg, max, min, additional_properties].hash
    end
  end
end
