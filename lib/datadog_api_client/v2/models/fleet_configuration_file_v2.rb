  ...
  class FleetConfigurationFileV2
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::FleetConfigurationFileV2` initialize method"
      end
      ...
      if attributes.key?(:'agent_hash')
        self.agent_hash = attributes[:'agent_hash']
      end
