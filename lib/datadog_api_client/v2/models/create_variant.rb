  ...
  class CreateVariant
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CreateVariant` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [key, name, value, additional_properties].hash
    end
  end
end
