  ...
  class IntegrationAccountDataflowStatus
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IntegrationAccountDataflowStatus` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [health, message, updated_at, additional_properties].hash
    end
  end
end
