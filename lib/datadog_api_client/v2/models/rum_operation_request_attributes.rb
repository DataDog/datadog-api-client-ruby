...
module DatadogAPIClient::V2
  ...
  class RUMOperationRequestAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RUMOperationRequestAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [application_id, category, description, display_name, feature_ids, journey_rum, name, tags, additional_properties].hash
    end
  end
end
