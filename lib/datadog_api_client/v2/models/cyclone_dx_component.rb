  ...
  class CycloneDXComponent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CycloneDXComponent` initialize method"
      end
    ...
    # @param bom_ref [Object] Object to be assigned
    # @!visibility private
    def bom_ref=(bom_ref)
      if bom_ref.nil?
        fail ArgumentError, 'invalid value for "bom_ref", bom_ref cannot be nil.'
      end
      @bom_ref = bom_ref
    end
