  ...
  class PersonalAccessTokenCreateAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::PersonalAccessTokenCreateAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [expires_at, name, scopes, additional_properties].hash
    end
  end
end
