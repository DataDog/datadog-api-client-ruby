  ...
  class ProductAnalyticsAnalyticsListResponseAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ProductAnalyticsAnalyticsListResponseAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [records, total_count, additional_properties].hash
    end
  end
end
