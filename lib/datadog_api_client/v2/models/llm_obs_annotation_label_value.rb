...
module DatadogAPIClient::V2
  ...
  class LLMObsAnnotationLabelValue
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsAnnotationLabelValue` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [assessment, label_schema_id, reasoning, value, additional_properties].hash
    end
  end
end
