...
module DatadogAPIClient::V2
  ...
  class SecurityMonitoringSignalsBulkTriageEvent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SecurityMonitoringSignalsBulkTriageEvent` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [event, id, additional_properties].hash
    end
  end
end
