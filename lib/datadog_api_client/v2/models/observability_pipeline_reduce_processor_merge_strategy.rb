  ...
  class ObservabilityPipelineReduceProcessorMergeStrategy
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineReduceProcessorMergeStrategy` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [path, strategy, additional_properties].hash
    end
  end
end
