...
module DatadogAPIClient::V2
  ...
  class CreateSnapshotTemplateVariable
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CreateSnapshotTemplateVariable` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [name, prefix, values, additional_properties].hash
    end
  end
end
