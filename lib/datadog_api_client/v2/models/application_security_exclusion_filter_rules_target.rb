...
module DatadogAPIClient::V2
  ...
  class ApplicationSecurityExclusionFilterRulesTarget
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ApplicationSecurityExclusionFilterRulesTarget` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [rule_id, tags, additional_properties].hash
    end
  end
end
