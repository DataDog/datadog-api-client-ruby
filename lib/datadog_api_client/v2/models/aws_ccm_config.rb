...
module DatadogAPIClient::V2
  ...
  class AWSCcmConfig
    ...
    attr_reader :data_export_configs
    ...
    # @!visibility private
    def valid?
      return false if @data_export_configs.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param data_export_configs [Object] Object to be assigned
    # @!visibility private
    def data_export_configs=(data_export_configs)
      if data_export_configs.nil?
        fail ArgumentError, 'invalid value for "data_export_configs", data_export_configs cannot be nil.'
      end
      @data_export_configs = data_export_configs
    end
