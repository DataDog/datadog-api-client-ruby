  ...
  class PersonalAccessTokenAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::PersonalAccessTokenAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [created_at, expires_at, modified_at, name, scopes, additional_properties].hash
    end
  end
end
