  ...
  class VariantWeightRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::VariantWeightRequest` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [value, variant_id, variant_key, additional_properties].hash
    end
  end
end
