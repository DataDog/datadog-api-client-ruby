  ...
  class ChangeEvent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ChangeEvent` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [aggregation_key, attributes, category, message, tags, timestamp, title].hash
    end
  end
end
