...
module DatadogAPIClient::V2
  ...
  class CreateMaintenanceRequestDataAttributesUpdatesItems
    ...
    def self.openapi_types
      {
        :'components_affected' => :'Array<CreateMaintenanceRequestDataAttributesUpdatesItemsComponentsAffectedItems>',
        :'description' => :'String',
        :'started_at' => :'Time',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CreateMaintenanceRequestDataAttributesUpdatesItems` initialize method"
      end
