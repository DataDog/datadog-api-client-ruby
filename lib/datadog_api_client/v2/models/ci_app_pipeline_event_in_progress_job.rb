  ...
  class CIAppPipelineEventInProgressJob
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::CIAppPipelineEventInProgressJob` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [dependencies, error, git, id, level, metrics, name, node, parameters, pipeline_name, pipeline_unique_id, queue_time, stage_id, stage_name, start, status, tags, url, additional_properties].hash
    end
  end
end
