...
module DatadogAPIClient::V2
  ...
  class RumSegmentResponseAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RumSegmentResponseAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [created_at, created_by, data_query, description, modified_at, modified_by, name, org_id, row_count, source, tags, type, uuid, version, additional_properties].hash
    end
  end
end
