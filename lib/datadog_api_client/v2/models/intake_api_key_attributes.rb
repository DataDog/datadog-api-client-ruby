  ...
  class IntakeAPIKeyAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IntakeAPIKeyAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [api_key, org_id, additional_properties].hash
    end
  end
end
