  ...
  class IncidentImportResponseRelationships
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentImportResponseRelationships` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [attachments, commander_user, created_by_user, declared_by_user, impacts, incident_type, integrations, last_modified_by_user, responders, user_defined_fields, additional_properties].hash
    end
  end
end
