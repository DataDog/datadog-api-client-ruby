...
module DatadogAPIClient::V2
  ...
  class ObservabilityPipelineTagCardinalityLimitProcessorTrackingMode
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineTagCardinalityLimitProcessorTrackingMode` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [mode, additional_properties].hash
    end
  end
end
