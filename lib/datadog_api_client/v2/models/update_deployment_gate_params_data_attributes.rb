  ...
  class UpdateDeploymentGateParamsDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::UpdateDeploymentGateParamsDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [dry_run, additional_properties].hash
    end
  end
end
