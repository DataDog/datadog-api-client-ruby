  ...
  class ObservabilityPipelineAmazonS3DestinationCompressionZstd
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::ObservabilityPipelineAmazonS3DestinationCompressionZstd` initialize method"
      end
