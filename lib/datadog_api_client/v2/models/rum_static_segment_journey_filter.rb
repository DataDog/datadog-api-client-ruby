...
module DatadogAPIClient::V2
  ...
  class RumStaticSegmentJourneyFilter
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::RumStaticSegmentJourneyFilter` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [attribute, value, additional_properties].hash
    end
  end
end
