  ...
  class SalesforceIncidentsTemplateCreateAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::SalesforceIncidentsTemplateCreateAttributes` initialize method"
      end
    ...
    def valid?
      ...
      return false if @description.to_s.length > 2048
      return false if @description.to_s.length < 1
      return false if @name.nil?
      return false if @name.to_s.length > 100
      return false if @name.to_s.length < 1
      return false if @owner_id.nil?
      return false if @owner_id.to_s.length > 255
      return false if @owner_id.to_s.length < 1
      return false if @priority.nil?
      return false if @salesforce_org_id.nil?
    ...
    # Custom attribute writer method with validation
    # @param salesforce_org_id [Object] Object to be assigned
    # @!visibility private
    def salesforce_org_id=(salesforce_org_id)
      if salesforce_org_id.nil?
        fail ArgumentError, 'invalid value for "salesforce_org_id", salesforce_org_id cannot be nil.'
      end
      @salesforce_org_id = salesforce_org_id
    end
