...
module DatadogAPIClient::V2
  ...
  class FleetDeploymentsV2Response
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::FleetDeploymentsV2Response` initialize method"
      end
