...
module DatadogAPIClient::V2
  ...
  class IncidentStatusPageNoticeIntegrationDataAttributes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::IncidentStatusPageNoticeIntegrationDataAttributes` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [created, integration_type, modified, status, additional_properties].hash
    end
  end
end
