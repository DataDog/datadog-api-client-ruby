  ...
  class MaintenanceUpdateDataRelationships
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::MaintenanceUpdateDataRelationships` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [created_by_user, last_modified_by_user, maintenance, additional_properties].hash
    end
  end
end
