  ...
  class LLMObsDatasetUpdateDataAttributesRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::LLMObsDatasetUpdateDataAttributesRequest` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [description, metadata, name, additional_properties].hash
    end
  end
end
