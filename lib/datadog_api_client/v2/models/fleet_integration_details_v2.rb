...
module DatadogAPIClient::V2
  ...
  class FleetIntegrationDetailsV2
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::FleetIntegrationDetailsV2` initialize method"
      end
      ...
      if attributes.key?(:'is_init')
        self.is_init = attributes[:'is_init']
      end
    ...
    # @!visibility private
    def hash
      [data_type, error_messages, init_config, instance_config, is_custom_check, is_default, is_init, log_config, name, pod_count, source_index, source_path, type, additional_properties].hash
    end
  end
end
