  ...
  class JiraIssueDataMeta
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V2::JiraIssueDataMeta` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [findings, vulnerabilities, additional_properties].hash
    end
  end
end
