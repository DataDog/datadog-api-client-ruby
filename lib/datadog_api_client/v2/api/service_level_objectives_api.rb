...
module DatadogAPIClient::V2
  class ServiceLevelObjectivesAPI
    ...
    # Create a new SLO report.
    #
    # Create a job to generate an SLO report. The report job is processed asynchronously and will eventually result in a CSV report being available for download.
    #
    # Check the status of the job and download the CSV report using the returned `report_id`.
    #
    # @param body [SLOReportPostRequest] Create SLO report job request body.
    ...
    #
    # Reports are not guaranteed to exist indefinitely. It is recommended to download the report as soon as it is available.
    #
