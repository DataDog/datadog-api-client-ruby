  ...
  class IntegrationAccountsAPI
    ...
    def create_web_integration_account_with_http_info(integration_name, body, opts = {})
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IntegrationAccountsAPI.create_web_integration_account ...'
      end
      # verify the required parameter 'integration_name' is set
      if @api_client.config.client_side_validation && integration_name.nil?
        fail ArgumentError, "Missing the required parameter 'integration_name' when calling IntegrationAccountsAPI.create_web_integration_account"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling IntegrationAccountsAPI.create_web_integration_account"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IntegrationAccountsAPI#create_web_integration_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_web_integration_account_with_http_info(integration_name, account_id, opts = {})
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IntegrationAccountsAPI.delete_web_integration_account ...'
      end
      # verify the required parameter 'integration_name' is set
      if @api_client.config.client_side_validation && integration_name.nil?
        fail ArgumentError, "Missing the required parameter 'integration_name' when calling IntegrationAccountsAPI.delete_web_integration_account"
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling IntegrationAccountsAPI.delete_web_integration_account"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IntegrationAccountsAPI#delete_web_integration_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_web_integration_account_with_http_info(integration_name, account_id, opts = {})
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IntegrationAccountsAPI.get_web_integration_account ...'
      end
      # verify the required parameter 'integration_name' is set
      if @api_client.config.client_side_validation && integration_name.nil?
        fail ArgumentError, "Missing the required parameter 'integration_name' when calling IntegrationAccountsAPI.get_web_integration_account"
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling IntegrationAccountsAPI.get_web_integration_account"
      end
      # resource path
      local_var_path = '/api/v2/web-integrations/{integration_name}/accounts/{account_id}'.sub('{integration_name}', CGI.escape(integration_name.to_s).gsub('%2F', '/')).sub('{account_id}', CGI.escape(account_id.to_s).gsub('%2F', '/'))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IntegrationAccountsAPI#get_web_integration_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_web_integration_account_schema_with_http_info(integration_name, opts = {})
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IntegrationAccountsAPI.get_web_integration_account_schema ...'
      end
      # verify the required parameter 'integration_name' is set
      if @api_client.config.client_side_validation && integration_name.nil?
        fail ArgumentError, "Missing the required parameter 'integration_name' when calling IntegrationAccountsAPI.get_web_integration_account_schema"
      end
      # resource path
      ...
      data, status_code, headers = @api_client.call_api(Net::HTTP::Get, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IntegrationAccountsAPI#get_web_integration_account_schema\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_web_integration_accounts_with_http_info(integration_name, opts = {})
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IntegrationAccountsAPI.list_web_integration_accounts ...'
      end
      # verify the required parameter 'integration_name' is set
      if @api_client.config.client_side_validation && integration_name.nil?
        fail ArgumentError, "Missing the required parameter 'integration_name' when calling IntegrationAccountsAPI.list_web_integration_accounts"
      end
      # resource path
      local_var_path = '/api/v2/web-integrations/{integration_name}/accounts'.sub('{integration_name}', CGI.escape(integration_name.to_s).gsub('%2F', '/'))
      ...
      data, status_code, headers = @api_client.call_api(Net::HTTP::Get, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IntegrationAccountsAPI#list_web_integration_accounts\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_web_integration_account_with_http_info(integration_name, account_id, body, opts = {})
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IntegrationAccountsAPI.update_web_integration_account ...'
      end
      # verify the required parameter 'integration_name' is set
      if @api_client.config.client_side_validation && integration_name.nil?
        fail ArgumentError, "Missing the required parameter 'integration_name' when calling IntegrationAccountsAPI.update_web_integration_account"
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling IntegrationAccountsAPI.update_web_integration_account"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling IntegrationAccountsAPI.update_web_integration_account"
      end
      # resource path
      local_var_path = '/api/v2/web-integrations/{integration_name}/accounts/{account_id}'.sub('{integration_name}', CGI.escape(integration_name.to_s).gsub('%2F', '/')).sub('{account_id}', CGI.escape(account_id.to_s).gsub('%2F', '/'))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IntegrationAccountsAPI#update_web_integration_account\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
