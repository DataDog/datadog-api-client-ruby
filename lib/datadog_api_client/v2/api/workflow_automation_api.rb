...
module DatadogAPIClient::V2
  class WorkflowAutomationAPI
    ...
    # Execute a workflow.
    #
    # Execute the given workflow. This API requires a [registered application key](https://docs.datadoghq.com/api/latest/action-connection/#register-a-new-app-key). Alternatively, you can also configure these permissions [in our UI](https://docs.datadoghq.com/account_management/api-app-keys/#actions-api-access).
    #
    # @param workflow_id [String] The ID of the workflow.
    ...
    # Delete an existing Workflow.
    #
    # Delete a workflow by ID. This API requires a [registered application key](https://docs.datadoghq.com/api/latest/action-connection/#register-a-new-app-key). Alternatively, you can also configure these permissions [in our UI](https://docs.datadoghq.com/account_management/api-app-keys/#actions-api-access).
    #
    # @param workflow_id [String] The ID of the workflow.
    # @param opts [Hash] the optional parameters
    ...
    # Get an existing Workflow.
    #
    # Get a workflow by ID. This API requires a [registered application key](https://docs.datadoghq.com/api/latest/action-connection/#register-a-new-app-key). Alternatively, you can also configure these permissions [in our UI](https://docs.datadoghq.com/account_management/api-app-keys/#actions-api-access).
    #
    # @param workflow_id [String] The ID of the workflow.
    # @param opts [Hash] the optional parameters
    ...
    # Update an existing Workflow.
    #
    # Update a workflow by ID. This API requires a [registered application key](https://docs.datadoghq.com/api/latest/action-connection/#register-a-new-app-key). Alternatively, you can also configure these permissions [in our UI](https://docs.datadoghq.com/account_management/api-app-keys/#actions-api-access).
    #
    # @param workflow_id [String] The ID of the workflow.
