...
module DatadogAPIClient::V2
  class ErrorTrackingAPI
    ...
    # Get the details of an error tracking issue.
    #
    # Get the details of an error tracking issue by `issue_id`.
    #
    # @param issue_id [String] The identifier of the issue
    # @param opts [Hash] the optional parameters
    # @option opts [Array<IssueIncludeQueryParameterItem>] :include Comma-separated list of relationship objects that should be included in the response.
    ...
    # Search error tracking issues.
    #
    # Search issues endpoint allows you to programmatically search for issues within your organization. This endpoint returns a list of issues that match a given search query, following the event search syntax. The search results are limited to a maximum of 100 issues.
    #
    # @param body [IssuesSearchRequest] Search issues request payload
    # @param opts [Hash] the optional parameters
    # @option opts [Array<IssueIncludeQueryParameterItem>] :include Comma-separated list of relationship objects that should be included in the response.
    # @return [Array<(IssuesResponse, Integer, Hash)>] IssuesResponse data, response status code and response headers
