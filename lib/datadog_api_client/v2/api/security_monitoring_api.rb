...
module DatadogAPIClient::V2
  class SecurityMonitoringAPI
    ...
    # @option opts [Severity] :filter_cvss_base_severity Filter by vulnerability base severity.
    ...
    # @option opts [Severity] :filter_cvss_datadog_severity Filter by vulnerability Datadog severity.
    # @option opts [String] :filter_cvss_datadog_vector Filter by vulnerability Datadog CVSS vector.
    # @option opts [Status] :filter_status Filter by the status of the vulnerability.
    # @option opts [Tool] :filter_tool Filter by the tool of the vulnerability.
    ...
    # @option opts [Severity] :filter_risks_epss_severity Filter by vulnerability [EPSS](https://www.first.org/epss/) severity.
    # @option opts [String] :filter_language Filter by language.
    # @option opts [Ecosystem] :filter_ecosystem Filter by ecosystem.
