...
module DatadogAPIClient::V2
  class SecurityMonitoringAPI
    ...
    #
    # @param body [ReorderInboxRulesParameters] The list of rules to reorder. The order of the rules in the list becomes the new order in the pipeline. 
    # @param opts [Hash] the optional parameters
    # @return [Array<(Object, Integer, Hash)>] Object data, response status code and response headers
    ...
    # To reorder fields, you must provide the full list of pipeline rules in the new order.
    #
    # @param body [ReorderMuteRulesParameters] The list of rules to reorder. The order of the rules in the list becomes the new order in the pipeline. 
    # @param opts [Hash] the optional parameters
    # @return [Array<(Object, Integer, Hash)>] Object data, response status code and response headers
