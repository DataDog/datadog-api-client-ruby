...
module DatadogAPIClient::V2
  class SecurityMonitoringAPI
    ...
    def create_custom_framework_with_http_info(body, opts = {})
      unstable_enabled = @api_client.config.unstable_operations["v2.create_custom_framework".to_sym]
      if unstable_enabled
        @api_client.config.logger.warn format("Using unstable operation '%s'", "v2.create_custom_framework")
      else
        raise DatadogAPIClient::APIError.new(message: format("Unstable operation '%s' is disabled", "v2.create_custom_framework"))
      end
    ...
    def delete_custom_framework(handle, version, opts = {})
      delete_custom_framework_with_http_info(handle, version, opts)
      nil
    end
    ...
    def delete_custom_framework_with_http_info(handle, version, opts = {})
      unstable_enabled = @api_client.config.unstable_operations["v2.delete_custom_framework".to_sym]
      if unstable_enabled
        @api_client.config.logger.warn format("Using unstable operation '%s'", "v2.delete_custom_framework")
      else
        raise DatadogAPIClient::APIError.new(message: format("Unstable operation '%s' is disabled", "v2.delete_custom_framework"))
      end
    ...
    #
    # @see #retrieve_custom_framework_with_http_info
    def retrieve_custom_framework(handle, version, opts = {})
      data, _status_code, _headers = retrieve_custom_framework_with_http_info(handle, version, opts)
      data
    end
    ...
    # @param version [String] The framework version
    # @param opts [Hash] the optional parameters
    # @return [Array<(RetrieveCustomFrameworkResponse, Integer, Hash)>] RetrieveCustomFrameworkResponse data, response status code and response headers
    def retrieve_custom_framework_with_http_info(handle, version, opts = {})

      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SecurityMonitoringAPI.retrieve_custom_framework ...'
      end
      # verify the required parameter 'handle' is set
      if @api_client.config.client_side_validation && handle.nil?
        fail ArgumentError, "Missing the required parameter 'handle' when calling SecurityMonitoringAPI.retrieve_custom_framework"
      end
      # verify the required parameter 'version' is set
      if @api_client.config.client_side_validation && version.nil?
        fail ArgumentError, "Missing the required parameter 'version' when calling SecurityMonitoringAPI.retrieve_custom_framework"
      end
      # resource path
      local_var_path = '/api/v2/cloud_security_management/custom_frameworks/{handle}/{version}'.sub('{handle}', CGI.escape(handle.to_s).gsub('%2F', '/')).sub('{version}', CGI.escape(version.to_s).gsub('%2F', '/'))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'RetrieveCustomFrameworkResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || [:apiKeyAuth, :appKeyAuth, :AuthZ]

      new_options = opts.merge(
        :operation => :retrieve_custom_framework,
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(Net::HTTP::Get, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SecurityMonitoringAPI#retrieve_custom_framework\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_custom_framework_with_http_info(handle, version, body, opts = {})
      unstable_enabled = @api_client.config.unstable_operations["v2.update_custom_framework".to_sym]
      if unstable_enabled
        @api_client.config.logger.warn format("Using unstable operation '%s'", "v2.update_custom_framework")
      else
        raise DatadogAPIClient::APIError.new(message: format("Unstable operation '%s' is disabled", "v2.update_custom_framework"))
      end
