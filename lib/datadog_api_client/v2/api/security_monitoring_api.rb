...
module DatadogAPIClient::V2
  class SecurityMonitoringAPI
    ...
    # Attach findings to a Case.
    #
    # Attach findings to a case. You can attach up to 50 findings per case. If a finding is already attached to another case, it will be detached and attached to the specified case.
    #
    # @param case_id [String] The unique identifier of the case to attach findings to
    ...
    # Attach findings to a Jira issue.
    #
    # Attach findings to a Jira issue by providing the Jira issue URL. You can attach up to 50 findings per Jira issue. If the Jira issue is not linked to any case, this operation will create a case for the findings and link the Jira issue to the created case. If a finding is already attached to another Jira issue, it will be detached and attached to the specified Jira issue.
    #
    ...
    # Create cases for findings.
    #
    # Create cases for findings. You can create up to 50 cases per request and associate up to 50 findings per case. If a finding is already attached to another case, it will be detached and attached to the newly created case.
    #
    ...
    # Create Jira issues for findings.
    #
    # Create Jira issues for findings. This operation creates a case in Datadog and creates a Jira issue linked to that case for bidirectional sync between Datadog and Jira. You can create up to 50 Jira issues per request and associate up to 50 findings per Jira issue. If a finding is already attached to another Jira issue, it will be detached and attached to the newly created Jira issue.
    #
