...
module DatadogAPIClient::V2
  class SecurityMonitoringAPI
    ...
    # @param opts [Hash] the optional parameters
    # @return [Array<(SeverityModifierRuleReorderRequest, Integer, Hash)>] SeverityModifierRuleReorderRequest data, response status code and response headers
    def reorder_security_findings_automation_severity_modifier_rules_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'SeverityModifierRuleReorderRequest'
