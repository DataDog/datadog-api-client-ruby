...
module DatadogAPIClient::V2
  class SecurityMonitoringAPI
    ...
    #
    # @param body [AttachServiceNowTicketRequest] 
    # @param opts [Hash] the optional parameters
    # @return [Array<(FindingCaseResponse, Integer, Hash)>] FindingCaseResponse data, response status code and response headers
    ...
    # The maximum number of signals that can be updated in a single request is 199.
    #
    # @param body [SecurityMonitoringSignalsBulkAssigneeUpdateRequest] Attributes describing the signal assignee updates.
    # @param opts [Hash] the optional parameters
    # @return [Array<(SecurityMonitoringSignalsBulkTriageUpdateResponse, Integer, Hash)>] SecurityMonitoringSignalsBulkTriageUpdateResponse data, response status code and response headers
    ...
    #
    # @see #bulk_edit_security_monitoring_signals_state_with_http_info
    ...
    # The maximum number of signals that can be updated in a single request is 199.
    #
    # @param body [SecurityMonitoringSignalsBulkStateUpdateRequest] Attributes describing the signal state updates.
    # @param opts [Hash] the optional parameters
    # @return [Array<(SecurityMonitoringSignalsBulkTriageUpdateResponse, Integer, Hash)>] SecurityMonitoringSignalsBulkTriageUpdateResponse data, response status code and response headers
    ...
    #
    # @param body [SecurityMonitoringRuleBulkExportPayload] 
    # @param opts [Hash] the optional parameters
    # @return [Array<(File, Integer, Hash)>] File data, response status code and response headers
    ...
    #
    # @see #create_service_now_tickets_with_http_info
    ...
    #
    # @param body [CreateServiceNowTicketRequestArray] 
    # @param opts [Hash] the optional parameters
    # @return [Array<(FindingCaseResponseArray, Integer, Hash)>] FindingCaseResponseArray data, response status code and response headers
    ...
    #
    # @see #get_matching_signals_with_http_info
    def get_matching_signals(event_id, track, opts = {})
      data, _status_code, _headers = get_matching_signals_with_http_info(event_id, track, opts)
      data
    end
    ...
    #
    # @param event_id [String] The ID of the event to find matching signals for.
    # @param track [String] The product track that the event belongs to.
    # @param opts [Hash] the optional parameters
    # @return [Array<(MatchingSignalsResponse, Integer, Hash)>] MatchingSignalsResponse data, response status code and response headers
    def get_matching_signals_with_http_info(event_id, track, opts = {})
      unstable_enabled = @api_client.config.unstable_operations["v2.get_matching_signals".to_sym]
      if unstable_enabled
        @api_client.config.logger.warn format("Using unstable operation '%s'", "v2.get_matching_signals")
      else
        raise DatadogAPIClient::APIError.new(message: format("Unstable operation '%s' is disabled", "v2.get_matching_signals"))
      end

      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SecurityMonitoringAPI.get_matching_signals ...'
      end
      # verify the required parameter 'event_id' is set
      if @api_client.config.client_side_validation && event_id.nil?
        fail ArgumentError, "Missing the required parameter 'event_id' when calling SecurityMonitoringAPI.get_matching_signals"
      end
      # verify the required parameter 'track' is set
      if @api_client.config.client_side_validation && track.nil?
        fail ArgumentError, "Missing the required parameter 'track' when calling SecurityMonitoringAPI.get_matching_signals"
      end
      # resource path
      local_var_path = '/api/v2/security_monitoring/events/{event_id}/matching_signals'.sub('{event_id}', CGI.escape(event_id.to_s).gsub('%2F', '/'))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'MatchingSignalsResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || [:apiKeyAuth, :appKeyAuth, :AuthZ]

      new_options = opts.merge(
        :operation => :get_matching_signals,
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(Net::HTTP::Get, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SecurityMonitoringAPI#get_matching_signals\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    #
    # @param dataset_id [String] The UUID of the dataset.
    # @param version [Integer] The version number of the dataset to retrieve.
    # @param opts [Hash] the optional parameters
    # @return [Array<(SecurityMonitoringDatasetResponse, Integer, Hash)>] SecurityMonitoringDatasetResponse data, response status code and response headers
    ...
    # @option opts [Integer] :page_number Specific page number to return.
    # @return [Array<(SecurityMonitoringDatasetVersionHistoryResponse, Integer, Hash)>] SecurityMonitoringDatasetVersionHistoryResponse data, response status code and response headers
    ...
    # @option opts [Integer] :page_size Size for a given page. The maximum allowed value is 100.
    # @option opts [Integer] :page_number Specific page number to return.
    # @option opts [String] :sort Attribute used to sort datasets. Prefix with `-` to sort in descending order.
    # @option opts [String] :filter_query A search query to filter datasets by name or description.
    ...
    #
    # @see #update_findings_assignee_with_http_info
    ...
    #
    # @param body [AssigneeRequest] 
    # @param opts [Hash] the optional parameters
    # @return [Array<(AssigneeResponse, Integer, Hash)>] AssigneeResponse data, response status code and response headers
