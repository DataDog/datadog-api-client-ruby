...
module DatadogAPIClient::V2
  class SecurityMonitoringAPI
    ...
    def delete_custom_framework(org_id, handle, version, opts = {})
      data, _status_code, _headers = delete_custom_framework_with_http_info(org_id, handle, version, opts)
      data
    end
    ...
    def delete_custom_framework_with_http_info(org_id, handle, version, opts = {})
      ...
      if @api_client.config.client_side_validation && org_id.nil?
        fail ArgumentError, "Missing the required parameter 'org_id' when calling SecurityMonitoringAPI.delete_custom_framework"
      end
      ...
      # resource path
      local_var_path = '/api/v2/orgs/{org_id}/cloud_security_management/custom_frameworks/{handle}/{version}'.sub('{org_id}', CGI.escape(org_id.to_s).gsub('%2F', '/')).sub('{handle}', CGI.escape(handle.to_s).gsub('%2F', '/')).sub('{version}', CGI.escape(version.to_s).gsub('%2F', '/'))
