...
module DatadogAPIClient::V2
  class ObservabilityPipelinesAPI
    ...
    # @param body [ObservabilityPipelineCreateRequest] 
    # @param opts [Hash] the optional parameters
    # @return [Array<(ValidationErrorResponse, Integer, Hash)>] ValidationErrorResponse data, response status code and response headers
    def validate_pipeline_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ValidationErrorResponse'
