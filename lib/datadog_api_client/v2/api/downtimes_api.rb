...
module DatadogAPIClient::V2
  class DowntimesAPI
    ...
    # @param opts [Hash] the optional parameters
    # @return [Array<(Array<MonitorDowntimeMatchResponse>, Integer, Hash)>] Array<MonitorDowntimeMatchResponse> data, response status code and response headers
    def list_monitor_downtimes_with_http_info(monitor_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<MonitorDowntimeMatchResponse>'
    ...
    # @param body [DowntimeEditRequest] Update a downtime request body.
    # @param opts [Hash] the optional parameters
    # @return [Array<(DowntimeResponse, Integer, Hash)>] DowntimeResponse data, response status code and response headers
