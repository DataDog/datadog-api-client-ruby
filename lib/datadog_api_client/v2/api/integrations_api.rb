...
module DatadogAPIClient::V2
  class IntegrationsAPI
    ...
    # List Integrations.
    #
    # @see #list_integrations_with_http_info
    ...
    # @return [Array<(ListIntegrationsResponse, Integer, Hash)>] ListIntegrationsResponse data, response status code and response headers
    def list_integrations_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = '/api/v2/integrations'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ListIntegrationsResponse'
