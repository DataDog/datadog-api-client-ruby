...
module DatadogAPIClient::V2
  class OnCallAPI
    ...
    def delete_on_call_schedule(schedule_uuid, opts = {})
      delete_on_call_schedule_with_http_info(schedule_uuid, opts)
      nil
    end
    ...
    def delete_on_call_schedule_with_http_info(schedule_uuid, opts = {})
      ...
      if @api_client.config.client_side_validation && schedule_uuid.nil?
        fail ArgumentError, "Missing the required parameter 'schedule_uuid' when calling OnCallAPI.delete_on_call_schedule"
      end
      # resource path
      local_var_path = '/api/v2/on-call/schedules/{schedule_uuid}'.sub('{schedule_uuid}', CGI.escape(schedule_uuid.to_s).gsub('%2F', '/'))
    ...
    def get_on_call_schedule(schedule_uuid, opts = {})
      data, _status_code, _headers = get_on_call_schedule_with_http_info(schedule_uuid, opts)
      data
    end
    ...
    # @option opts [String] :include Comma-separated list of included relationships to be returned. Allowed values: `teams`, `layers`, `layers.members`, `layers.members.user`.
    # @return [Array<(Schedule, Integer, Hash)>] Schedule data, response status code and response headers
    def get_on_call_schedule_with_http_info(schedule_uuid, opts = {})
      ...
      # verify the required parameter 'schedule_uuid' is set
      if @api_client.config.client_side_validation && schedule_uuid.nil?
        fail ArgumentError, "Missing the required parameter 'schedule_uuid' when calling OnCallAPI.get_on_call_schedule"
      end
      # resource path
      local_var_path = '/api/v2/on-call/schedules/{schedule_uuid}'.sub('{schedule_uuid}', CGI.escape(schedule_uuid.to_s).gsub('%2F', '/'))
    ...
    def update_on_call_schedule(schedule_uuid, body, opts = {})
      data, _status_code, _headers = update_on_call_schedule_with_http_info(schedule_uuid, body, opts)
      data
    end
    ...
    def update_on_call_schedule_with_http_info(schedule_uuid, body, opts = {})
      ...
      # verify the required parameter 'schedule_uuid' is set
      if @api_client.config.client_side_validation && schedule_uuid.nil?
        fail ArgumentError, "Missing the required parameter 'schedule_uuid' when calling OnCallAPI.update_on_call_schedule"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
