...
module DatadogAPIClient::V2
  class TeamsAPI
    ...
    # Create team notification rule.
    # @param team_id [String] None
    # @param body [TeamNotificationRule] 
    # @param opts [Hash] the optional parameters
    # @return [Array<(TeamNotificationRule, Integer, Hash)>] TeamNotificationRule data, response status code and response headers
    def create_team_notification_rule_with_http_info(team_id, body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'TeamNotificationRule'
    ...
    def delete_team_notification_rule(rule_id, team_id, opts = {})
      delete_team_notification_rule_with_http_info(rule_id, team_id, opts)
      nil
    end
    ...
    # @param opts [Hash] the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_team_notification_rule_with_http_info(rule_id, team_id, opts = {})
      ...
      # resource path
      local_var_path = '/api/v2/team/{team_id}/notification-rules/{rule_id}'.sub('{rule_id}', CGI.escape(rule_id.to_s).gsub('%2F', '/')).sub('{team_id}', CGI.escape(team_id.to_s).gsub('%2F', '/'))
    ...
    def get_team_notification_rule(rule_id, team_id, opts = {})
      data, _status_code, _headers = get_team_notification_rule_with_http_info(rule_id, team_id, opts)
      data
    end
    ...
    # @param opts [Hash] the optional parameters
    # @return [Array<(TeamNotificationRule, Integer, Hash)>] TeamNotificationRule data, response status code and response headers
    def get_team_notification_rule_with_http_info(rule_id, team_id, opts = {})
    ...
    def update_team_notification_rule(rule_id, team_id, body, opts = {})
      data, _status_code, _headers = update_team_notification_rule_with_http_info(rule_id, team_id, body, opts)
      data
    end
    ...
    # @param opts [Hash] the optional parameters
    # @return [Array<(TeamNotificationRule, Integer, Hash)>] TeamNotificationRule data, response status code and response headers
    def update_team_notification_rule_with_http_info(rule_id, team_id, body, opts = {})
