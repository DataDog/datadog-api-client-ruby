...
module DatadogAPIClient::V2
  class EventsAPI
    ...
    #
    # @param body [ChangeEventCreateRequestPayload] Event request object
    # @param opts [Hash] the optional parameters
    # @return [Array<(ChangeEventCreateResponsePayload, Integer, Hash)>] ChangeEventCreateResponsePayload data, response status code and response headers
    def create_event_with_http_info(body, opts = {})
      unstable_enabled = @api_client.config.unstable_operations["v2.create_event".to_sym]
      if unstable_enabled
        @api_client.config.logger.warn format("Using unstable operation '%s'", "v2.create_event")
      else
        raise DatadogAPIClient::APIError.new(message: format("Unstable operation '%s' is disabled", "v2.create_event"))
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ChangeEventCreateResponsePayload'
