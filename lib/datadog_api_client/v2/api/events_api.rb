...
module DatadogAPIClient::V2
  class EventsAPI
    ...
    #
    # @param body [ChangeEventCreateRequest] Event request object
    # @param opts [Hash] the optional parameters
    # @return [Array<(ChangeEventCreateResponse, Integer, Hash)>] ChangeEventCreateResponse data, response status code and response headers
    def create_event_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ChangeEventCreateResponse'
