  ...
  class DataAccessControlsAPI
    ...
    def create_dataset_with_http_info(body, opts = {})
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DataAccessControlsAPI.create_dataset ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling DataAccessControlsAPI.create_dataset"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DataAccessControlsAPI#create_dataset\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def delete_dataset_with_http_info(dataset_id, opts = {})
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DataAccessControlsAPI.delete_dataset ...'
      end
      # verify the required parameter 'dataset_id' is set
      if @api_client.config.client_side_validation && dataset_id.nil?
        fail ArgumentError, "Missing the required parameter 'dataset_id' when calling DataAccessControlsAPI.delete_dataset"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DataAccessControlsAPI#delete_dataset\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_all_datasets_with_http_info(opts = {})
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DataAccessControlsAPI.get_all_datasets ...'
      end
      # resource path
      local_var_path = '/api/v2/datasets'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DataAccessControlsAPI#get_all_datasets\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_dataset_with_http_info(dataset_id, opts = {})
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DataAccessControlsAPI.get_dataset ...'
      end
      # verify the required parameter 'dataset_id' is set
      if @api_client.config.client_side_validation && dataset_id.nil?
        fail ArgumentError, "Missing the required parameter 'dataset_id' when calling DataAccessControlsAPI.get_dataset"
      end
      # resource path
      local_var_path = '/api/v2/datasets/{dataset_id}'.sub('{dataset_id}', CGI.escape(dataset_id.to_s).gsub('%2F', '/'))
      ...
      data, status_code, headers = @api_client.call_api(Net::HTTP::Get, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DataAccessControlsAPI#get_dataset\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_dataset_with_http_info(dataset_id, body, opts = {})
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DataAccessControlsAPI.update_dataset ...'
      end
      # verify the required parameter 'dataset_id' is set
      if @api_client.config.client_side_validation && dataset_id.nil?
        fail ArgumentError, "Missing the required parameter 'dataset_id' when calling DataAccessControlsAPI.update_dataset"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling DataAccessControlsAPI.update_dataset"
      end
      # resource path
      local_var_path = '/api/v2/datasets/{dataset_id}'.sub('{dataset_id}', CGI.escape(dataset_id.to_s).gsub('%2F', '/'))
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DataAccessControlsAPI#update_dataset\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
