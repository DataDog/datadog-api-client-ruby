...
module DatadogAPIClient::V2
  class ReferenceTablesAPI
    ...
    def get_rows_by_id(row_id, id, opts = {})
      data, _status_code, _headers = get_rows_by_id_with_http_info(row_id, id, opts)
      data
    end
    ...
    def get_rows_by_id_with_http_info(row_id, id, opts = {})
