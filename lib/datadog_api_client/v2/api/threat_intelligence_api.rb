...
module DatadogAPIClient::V2
  class ThreatIntelligenceAPI
    ...
    #
    # @see #add_stix_threat_intel_with_http_info
    ...
    # @param body [STIXBundleRequest] A STIX 2.1 bundle containing indicator objects. The request body must not exceed 50 MB as received or 100 MB after decompression.
