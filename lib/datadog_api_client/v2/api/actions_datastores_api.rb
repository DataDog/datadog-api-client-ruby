...
module DatadogAPIClient::V2
  class ActionsDatastoresAPI
    ...
    # Write datastore item.
    #
    # @see #write_datastore_item_with_http_info
    def write_datastore_item(datastore_id, body, opts = {})
      data, _status_code, _headers = write_datastore_item_with_http_info(datastore_id, body, opts)
      data
    end
    ...
    def write_datastore_item_with_http_info(datastore_id, body, opts = {})

      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ActionsDatastoresAPI.write_datastore_item ...'
      end
      # verify the required parameter 'datastore_id' is set
      if @api_client.config.client_side_validation && datastore_id.nil?
        fail ArgumentError, "Missing the required parameter 'datastore_id' when calling ActionsDatastoresAPI.write_datastore_item"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling ActionsDatastoresAPI.write_datastore_item"
      end
      # resource path
      local_var_path = '/api/v2/actions-datastores/{datastore_id}/items'.sub('{datastore_id}', CGI.escape(datastore_id.to_s).gsub('%2F', '/'))
      ...
      new_options = opts.merge(
        :operation => :write_datastore_item,
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(Net::HTTP::Post, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ActionsDatastoresAPI#write_datastore_item\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
