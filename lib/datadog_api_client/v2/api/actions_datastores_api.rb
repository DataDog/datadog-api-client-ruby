...
module DatadogAPIClient::V2
  class ActionsDatastoresAPI
    ...
    def delete_datastore(datastore_id, opts = {})
      data, _status_code, _headers = delete_datastore_with_http_info(datastore_id, opts)
      data
    end
    ...
    # @param datastore_id [String] The ID of the datastore.
    # @param opts [Hash] the optional parameters
    # @return [Array<(DeleteAppsDatastoreResponse, Integer, Hash)>] DeleteAppsDatastoreResponse data, response status code and response headers
    def delete_datastore_with_http_info(datastore_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'DeleteAppsDatastoreResponse'
    ...
    def delete_datastore_item(datastore_id, body, opts = {})
      delete_datastore_item_with_http_info(datastore_id, body, opts)
      nil
    end
    ...
    def list_datastore_items_with_http_info(datastore_id, opts = {})
      ...
      query_params[:'itemKey'] = opts[:'item_key'] if !opts[:'item_key'].nil?
