...
module DatadogAPIClient::V2
  class AgentlessScanningAPI
    ...
    # Create azure scan options.
    #
    # Activate Agentless scan options for an Azure account.
    #
    ...
    # Delete azure scan options.
    #
    # Delete Agentless scan options for an Azure account.
    #
    ...
    def update_azure_scan_options(subscription_id, body, opts = {})
      update_azure_scan_options_with_http_info(subscription_id, body, opts)
      nil
    end
