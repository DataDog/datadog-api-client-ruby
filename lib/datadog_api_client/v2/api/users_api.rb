...
module DatadogAPIClient::V2
  class UsersAPI
    ...
    # Anonymize users.
    #
    # @see #anonymize_users_with_http_info
    ...
    #
    # @param body [AnonymizeUsersRequest] 
    # @param opts [Hash] the optional parameters
    # @return [Array<(AnonymizeUsersResponse, Integer, Hash)>] AnonymizeUsersResponse data, response status code and response headers
