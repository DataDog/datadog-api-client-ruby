...
module DatadogAPIClient::V2
  class CloudCostManagementAPI
    ...
    def delete_budget(budget_id, opts = {})
      data, _status_code, _headers = delete_budget_with_http_info(budget_id, opts)
      data
    end
    ...
    # @param opts [Hash] the optional parameters
    # @return [Array<(NotFoundResponse, Integer, Hash)>] NotFoundResponse data, response status code and response headers
    def delete_budget_with_http_info(budget_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'NotFoundResponse'
    ...
    # Update if exists, or create a new budget.
    #
