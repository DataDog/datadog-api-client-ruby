...
module DatadogAPIClient::V2
  class CloudCostManagementAPI
    ...
    def list_cost_oci_configs_with_http_info(opts = {})
      unstable_enabled = @api_client.config.unstable_operations["v2.list_cost_oci_configs".to_sym]
      if unstable_enabled
        @api_client.config.logger.warn format("Using unstable operation '%s'", "v2.list_cost_oci_configs")
      else
        raise DatadogAPIClient::APIError.new(message: format("Unstable operation '%s' is disabled", "v2.list_cost_oci_configs"))
      end
