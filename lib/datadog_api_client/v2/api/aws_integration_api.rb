...
module DatadogAPIClient::V2
  class AWSIntegrationAPI
    ...
    # AWS Integration - Generate new external ID.
    #
    # @see #generate_new_external_id_with_http_info
    def generate_new_external_id(opts = {})
      data, _status_code, _headers = generate_new_external_id_with_http_info(opts)
      data
    end
    ...
    def generate_new_external_id_with_http_info(opts = {})
      unstable_enabled = @api_client.config.unstable_operations["v2.generate_new_external_id".to_sym]
      if unstable_enabled
        @api_client.config.logger.warn format("Using unstable operation '%s'", "v2.generate_new_external_id")
      else
        raise DatadogAPIClient::APIError.new(message: format("Unstable operation '%s' is disabled", "v2.generate_new_external_id"))
      end

      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AWSIntegrationAPI.generate_new_external_id ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :generate_new_external_id,
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(Net::HTTP::Post, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AWSIntegrationAPI#generate_new_external_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    #
    # @param opts [Hash] the optional parameters
    # @option opts [String] :aws_account_id 
    ...
    # AWS Integration - List log services.
    #
    # @see #list_aws_log_services_with_http_info
    def list_aws_log_services(opts = {})
      data, _status_code, _headers = list_aws_log_services_with_http_info(opts)
      data
    end
    ...
    def list_aws_log_services_with_http_info(opts = {})
      unstable_enabled = @api_client.config.unstable_operations["v2.list_aws_log_services".to_sym]
      if unstable_enabled
        @api_client.config.logger.warn format("Using unstable operation '%s'", "v2.list_aws_log_services")
      else
        raise DatadogAPIClient::APIError.new(message: format("Unstable operation '%s' is disabled", "v2.list_aws_log_services"))
      end

      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AWSIntegrationAPI.list_aws_log_services ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :list_aws_log_services,
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(Net::HTTP::Get, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AWSIntegrationAPI#list_aws_log_services\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end

    # AWS Integration - List namespaces.
    #
    ...
    # AWS Integration - List namespaces.
    #
    # Get a list of AWS CloudWatch namespaces that can send metrics to Datadog.
    #
    # @param opts [Hash] the optional parameters
    ...
    def list_aws_namespaces_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = '/api/v2/integration/aws/namespaces'
