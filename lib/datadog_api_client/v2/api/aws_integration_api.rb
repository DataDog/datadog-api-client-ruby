...
module DatadogAPIClient::V2
  class AWSIntegrationAPI
    ...
    def delete_aws_account(aws_account_id, opts = {})
      delete_aws_account_with_http_info(aws_account_id, opts)
      nil
    end
    ...
    #
    # @param aws_account_id [String] The ID of the AWS Account Integration Config
    # @param opts [Hash] the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_aws_account_with_http_info(aws_account_id, opts = {})
      ...
      # verify the required parameter 'aws_account_id' is set
      if @api_client.config.client_side_validation && aws_account_id.nil?
        fail ArgumentError, "Missing the required parameter 'aws_account_id' when calling AWSIntegrationAPI.delete_aws_account"
      end
      # resource path
      local_var_path = '/api/v2/integration/aws/accounts/{aws_account_id}'.sub('{aws_account_id}', CGI.escape(aws_account_id.to_s).gsub('%2F', '/'))
    ...
    def get_aws_account(aws_account_id, opts = {})
      data, _status_code, _headers = get_aws_account_with_http_info(aws_account_id, opts)
      data
    end
    ...
    # @param opts [Hash] the optional parameters
    # @return [Array<(AWSAccountResponse, Integer, Hash)>] AWSAccountResponse data, response status code and response headers
    def get_aws_account_with_http_info(aws_account_id, opts = {})
      ...
      # verify the required parameter 'aws_account_id' is set
      if @api_client.config.client_side_validation && aws_account_id.nil?
        fail ArgumentError, "Missing the required parameter 'aws_account_id' when calling AWSIntegrationAPI.get_aws_account"
      end
      # resource path
      local_var_path = '/api/v2/integration/aws/accounts/{aws_account_id}'.sub('{aws_account_id}', CGI.escape(aws_account_id.to_s).gsub('%2F', '/'))
    ...
    def update_aws_account(aws_account_id, body, opts = {})
      data, _status_code, _headers = update_aws_account_with_http_info(aws_account_id, body, opts)
      data
    end
    ...
    # @param opts [Hash] the optional parameters
    # @return [Array<(AWSAccountResponse, Integer, Hash)>] AWSAccountResponse data, response status code and response headers
    def update_aws_account_with_http_info(aws_account_id, body, opts = {})
      ...
      # verify the required parameter 'aws_account_id' is set
      if @api_client.config.client_side_validation && aws_account_id.nil?
        fail ArgumentError, "Missing the required parameter 'aws_account_id' when calling AWSIntegrationAPI.update_aws_account"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
