  ...
  class IncidentTeamsAPI
    ...
    def list_incident_teams_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 9223372036854775807
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling IncidentTeamsAPI.list_incident_teams, must be smaller than or equal to 9223372036854775807.'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 1
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling IncidentTeamsAPI.list_incident_teams, must be greater than or equal to 1.'
      end
      # resource path
      local_var_path = '/api/v2/teams'
