...
module DatadogAPIClient::V2
  class IncidentsAPI
    ...
    # Delete incident notification template.
    #
    ...
    # @param opts [Hash] the optional parameters
    # @option opts [String] :include Comma-separated list of resources to include. Supported values: `created_by_user`, `last_modified_by_user`, `incident_type` 
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    ...
    # List incident notification templates.
    #
    # Lists all notification templates for the organization. Optionally filter by incident type.
    #
    # @param opts [Hash] the optional parameters
