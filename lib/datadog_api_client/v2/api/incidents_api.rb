...
module DatadogAPIClient::V2
  class IncidentsAPI
    ...
    #
    # @see #create_incident_postmortem_with_http_info
    def create_incident_postmortem(incident_id, body, opts = {})
      data, _status_code, _headers = create_incident_postmortem_with_http_info(incident_id, body, opts)
      data
    end
    ...
    #
    # @param incident_id [String] The UUID of the incident.
    # @param body [IncidentPostmortemCreateRequest] Postmortem creation payload.
    # @param opts [Hash] the optional parameters
    # @option opts [String] :include Resources to include in the response. Supported values: `last_modified_by_user`, `postmortem_owner_user`, `postmortem_owner_responder`, `incident`.
    # @return [Array<(IncidentPostmortemResponse, Integer, Hash)>] IncidentPostmortemResponse data, response status code and response headers
    def create_incident_postmortem_with_http_info(incident_id, body, opts = {})
      unstable_enabled = @api_client.config.unstable_operations["v2.create_incident_postmortem".to_sym]
      if unstable_enabled
        @api_client.config.logger.warn format("Using unstable operation '%s'", "v2.create_incident_postmortem")
      else
        raise DatadogAPIClient::APIError.new(message: format("Unstable operation '%s' is disabled", "v2.create_incident_postmortem"))
      end

      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentsAPI.create_incident_postmortem ...'
      end
      # verify the required parameter 'incident_id' is set
      if @api_client.config.client_side_validation && incident_id.nil?
        fail ArgumentError, "Missing the required parameter 'incident_id' when calling IncidentsAPI.create_incident_postmortem"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling IncidentsAPI.create_incident_postmortem"
      end
      # resource path
      local_var_path = '/api/v2/incidents/{incident_id}/postmortem'.sub('{incident_id}', CGI.escape(incident_id.to_s).gsub('%2F', '/'))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'IncidentPostmortemResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || [:apiKeyAuth, :appKeyAuth, :AuthZ]

      new_options = opts.merge(
        :operation => :create_incident_postmortem,
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(Net::HTTP::Post, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentsAPI#create_incident_postmortem\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    #
    # @see #delete_incident_postmortem_with_http_info
    def delete_incident_postmortem(incident_id, opts = {})
      delete_incident_postmortem_with_http_info(incident_id, opts)
      nil
    end
    ...
    # @param opts [Hash] the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def delete_incident_postmortem_with_http_info(incident_id, opts = {})
      unstable_enabled = @api_client.config.unstable_operations["v2.delete_incident_postmortem".to_sym]
      if unstable_enabled
        @api_client.config.logger.warn format("Using unstable operation '%s'", "v2.delete_incident_postmortem")
      else
        raise DatadogAPIClient::APIError.new(message: format("Unstable operation '%s' is disabled", "v2.delete_incident_postmortem"))
      end

      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentsAPI.delete_incident_postmortem ...'
      end
      # verify the required parameter 'incident_id' is set
      if @api_client.config.client_side_validation && incident_id.nil?
        fail ArgumentError, "Missing the required parameter 'incident_id' when calling IncidentsAPI.delete_incident_postmortem"
      end
      # resource path
      local_var_path = '/api/v2/incidents/{incident_id}/postmortem'.sub('{incident_id}', CGI.escape(incident_id.to_s).gsub('%2F', '/'))
      ...
      new_options = opts.merge(
        :operation => :delete_incident_postmortem,
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(Net::HTTP::Delete, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentsAPI#delete_incident_postmortem\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    #
    # @see #get_incident_postmortem_with_http_info
    def get_incident_postmortem(incident_id, opts = {})
      data, _status_code, _headers = get_incident_postmortem_with_http_info(incident_id, opts)
      data
    end
    ...
    # @option opts [String] :include Resources to include in the response. Supported values: `last_modified_by_user`, `postmortem_owner_user`, `postmortem_owner_responder`, `incident`.
    # @return [Array<(IncidentPostmortemResponse, Integer, Hash)>] IncidentPostmortemResponse data, response status code and response headers
    def get_incident_postmortem_with_http_info(incident_id, opts = {})
      unstable_enabled = @api_client.config.unstable_operations["v2.get_incident_postmortem".to_sym]
      if unstable_enabled
        @api_client.config.logger.warn format("Using unstable operation '%s'", "v2.get_incident_postmortem")
      else
        raise DatadogAPIClient::APIError.new(message: format("Unstable operation '%s' is disabled", "v2.get_incident_postmortem"))
      end

      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentsAPI.get_incident_postmortem ...'
      end
      # verify the required parameter 'incident_id' is set
      if @api_client.config.client_side_validation && incident_id.nil?
        fail ArgumentError, "Missing the required parameter 'incident_id' when calling IncidentsAPI.get_incident_postmortem"
      end
      # resource path
      local_var_path = '/api/v2/incidents/{incident_id}/postmortem'.sub('{incident_id}', CGI.escape(incident_id.to_s).gsub('%2F', '/'))
      ...
      data, status_code, headers = @api_client.call_api(Net::HTTP::Get, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentsAPI#get_incident_postmortem\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    #
    # @see #update_incident_postmortem_with_http_info
    def update_incident_postmortem(incident_id, body, opts = {})
      data, _status_code, _headers = update_incident_postmortem_with_http_info(incident_id, body, opts)
      data
    end
    ...
    #
    # @param incident_id [String] The UUID of the incident.
    # @param body [IncidentPostmortemUpdateRequest] Postmortem update payload.
    # @param opts [Hash] the optional parameters
    # @option opts [String] :include Resources to include in the response. Supported values: `last_modified_by_user`, `postmortem_owner_user`, `postmortem_owner_responder`, `incident`.
    # @return [Array<(IncidentPostmortemResponse, Integer, Hash)>] IncidentPostmortemResponse data, response status code and response headers
    def update_incident_postmortem_with_http_info(incident_id, body, opts = {})
      unstable_enabled = @api_client.config.unstable_operations["v2.update_incident_postmortem".to_sym]
      if unstable_enabled
        @api_client.config.logger.warn format("Using unstable operation '%s'", "v2.update_incident_postmortem")
      else
        raise DatadogAPIClient::APIError.new(message: format("Unstable operation '%s' is disabled", "v2.update_incident_postmortem"))
      end

      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: IncidentsAPI.update_incident_postmortem ...'
      end
      # verify the required parameter 'incident_id' is set
      if @api_client.config.client_side_validation && incident_id.nil?
        fail ArgumentError, "Missing the required parameter 'incident_id' when calling IncidentsAPI.update_incident_postmortem"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling IncidentsAPI.update_incident_postmortem"
      end
      # resource path
      local_var_path = '/api/v2/incidents/{incident_id}/postmortem'.sub('{incident_id}', CGI.escape(incident_id.to_s).gsub('%2F', '/'))
      ...
      data, status_code, headers = @api_client.call_api(Net::HTTP::Patch, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: IncidentsAPI#update_incident_postmortem\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
