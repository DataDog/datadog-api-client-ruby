  ...
  class LogsMetricsApi
    ...
    def create_logs_metric_with_http_info(body, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"LogsMetricsApi.create_logs_metric",
    ...
    def delete_logs_metric_with_http_info(metric_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"LogsMetricsApi.delete_logs_metric",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def get_logs_metric_with_http_info(metric_id, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"LogsMetricsApi.get_logs_metric",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_logs_metrics_with_http_info(opts = {})
      ...
      new_options = opts.merge(
        :operation => :"LogsMetricsApi.list_logs_metrics",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def update_logs_metric_with_http_info(metric_id, body, opts = {})
      ...
      new_options = opts.merge(
        :operation => :"LogsMetricsApi.update_logs_metric",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
