...
module DatadogAPIClient::V2
  class StaticAnalysisAPI
    ...
    # Show Custom Rule.
    #
    # @see #show_custom_rule_with_http_info
    def show_custom_rule(ruleset_name, rule_name, opts = {})
      data, _status_code, _headers = show_custom_rule_with_http_info(ruleset_name, rule_name, opts)
      data
    end
    ...
    # @param opts [Hash] the optional parameters
    # @return [Array<(CustomRuleResponse, Integer, Hash)>] CustomRuleResponse data, response status code and response headers
    def show_custom_rule_with_http_info(ruleset_name, rule_name, opts = {})
      unstable_enabled = @api_client.config.unstable_operations["v2.show_custom_rule".to_sym]
      if unstable_enabled
        @api_client.config.logger.warn format("Using unstable operation '%s'", "v2.show_custom_rule")
      else
        raise DatadogAPIClient::APIError.new(message: format("Unstable operation '%s' is disabled", "v2.show_custom_rule"))
      end

      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StaticAnalysisAPI.show_custom_rule ...'
      end
      # verify the required parameter 'ruleset_name' is set
      if @api_client.config.client_side_validation && ruleset_name.nil?
        fail ArgumentError, "Missing the required parameter 'ruleset_name' when calling StaticAnalysisAPI.show_custom_rule"
      end
      # verify the required parameter 'rule_name' is set
      if @api_client.config.client_side_validation && rule_name.nil?
        fail ArgumentError, "Missing the required parameter 'rule_name' when calling StaticAnalysisAPI.show_custom_rule"
      end
      # resource path
      local_var_path = '/api/v2/static-analysis/custom/rulesets/{ruleset_name}/rules/{rule_name}'.sub('{ruleset_name}', CGI.escape(ruleset_name.to_s).gsub('%2F', '/')).sub('{rule_name}', CGI.escape(rule_name.to_s).gsub('%2F', '/'))
      ...
      data, status_code, headers = @api_client.call_api(Net::HTTP::Get, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StaticAnalysisAPI#show_custom_rule\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    #
    # @see #show_custom_rule_revision_with_http_info
    def show_custom_rule_revision(ruleset_name, rule_name, id, opts = {})
      data, _status_code, _headers = show_custom_rule_revision_with_http_info(ruleset_name, rule_name, id, opts)
      data
    end
    ...
    def show_custom_rule_revision_with_http_info(ruleset_name, rule_name, id, opts = {})
      unstable_enabled = @api_client.config.unstable_operations["v2.show_custom_rule_revision".to_sym]
      if unstable_enabled
        @api_client.config.logger.warn format("Using unstable operation '%s'", "v2.show_custom_rule_revision")
      else
        raise DatadogAPIClient::APIError.new(message: format("Unstable operation '%s' is disabled", "v2.show_custom_rule_revision"))
      end

      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StaticAnalysisAPI.show_custom_rule_revision ...'
      end
      # verify the required parameter 'ruleset_name' is set
      if @api_client.config.client_side_validation && ruleset_name.nil?
        fail ArgumentError, "Missing the required parameter 'ruleset_name' when calling StaticAnalysisAPI.show_custom_rule_revision"
      end
      # verify the required parameter 'rule_name' is set
      if @api_client.config.client_side_validation && rule_name.nil?
        fail ArgumentError, "Missing the required parameter 'rule_name' when calling StaticAnalysisAPI.show_custom_rule_revision"
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling StaticAnalysisAPI.show_custom_rule_revision"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :show_custom_rule_revision,
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(Net::HTTP::Get, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StaticAnalysisAPI#show_custom_rule_revision\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # Show Custom Ruleset.
    #
    # @see #show_custom_ruleset_with_http_info
    def show_custom_ruleset(ruleset_name, opts = {})
      data, _status_code, _headers = show_custom_ruleset_with_http_info(ruleset_name, opts)
      data
    end
    ...
    def show_custom_ruleset_with_http_info(ruleset_name, opts = {})
      unstable_enabled = @api_client.config.unstable_operations["v2.show_custom_ruleset".to_sym]
      if unstable_enabled
        @api_client.config.logger.warn format("Using unstable operation '%s'", "v2.show_custom_ruleset")
      else
        raise DatadogAPIClient::APIError.new(message: format("Unstable operation '%s' is disabled", "v2.show_custom_ruleset"))
      end

      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StaticAnalysisAPI.show_custom_ruleset ...'
      end
      # verify the required parameter 'ruleset_name' is set
      if @api_client.config.client_side_validation && ruleset_name.nil?
        fail ArgumentError, "Missing the required parameter 'ruleset_name' when calling StaticAnalysisAPI.show_custom_ruleset"
      end
      # resource path
      local_var_path = '/api/v2/static-analysis/custom/rulesets/{ruleset_name}'.sub('{ruleset_name}', CGI.escape(ruleset_name.to_s).gsub('%2F', '/'))
      ...
      data, status_code, headers = @api_client.call_api(Net::HTTP::Get, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StaticAnalysisAPI#show_custom_ruleset\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_custom_ruleset(ruleset_name, body, opts = {})
      update_custom_ruleset_with_http_info(ruleset_name, body, opts)
      nil
    end
