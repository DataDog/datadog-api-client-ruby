...
module DatadogAPIClient::V1_20270101
  ...
  class DashboardSummaryDefinition
    ...
    def self.openapi_types
      {
        :'author' => :'DatadogAPIClient::V1::Creator',
        :'created' => :'Time',
        :'icon' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1_20270101::DashboardSummaryDefinition` initialize method"
      end
      ...
      if attributes.key?(:'last_view_date')
        self.last_view_date = attributes[:'last_view_date']
      end
    ...
    # @!visibility private
    def hash
      [author, created, icon, id, integration_id, is_favorite, is_read_only, is_shared, last_view_date, modified, popularity, tags, title, type, url, additional_properties].hash
    end
  end
end
