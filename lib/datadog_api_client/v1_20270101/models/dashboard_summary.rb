  ...
  class DashboardSummary
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1_20270101::DashboardSummary` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [dashboards, total, additional_properties].hash
    end
  end
end
