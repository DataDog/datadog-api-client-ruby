  ...
  module BaseGenericModel
      ...
      self.class.openapi_types.each_pair do |key, type|
        if attributes.key?(self.class.attribute_map[key]) && attributes[self.class.attribute_map[key]].nil? && self.class.openapi_nullable.include?(key)
          ...
          if res.instance_of? DatadogAPIClient::UnparsedObject
            self._unparsed = true
          elsif (res.kind_of? DatadogAPIClient::V1_20270101::BaseGenericModel) && res._unparsed
            self._unparsed = true
          end
          self.send("#{key}=", res)
        end
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+?), (?<v_type>.+)>\z/
        ...
        klass = DatadogAPIClient::V1_20270101.model_class(type)
  ...
  module BaseOneOfModelNoDiscriminator
    ...
    def find_and_cast_into_type(klass, data)
      ...
      when /\AHash<String, (?<sub_type>.+)>\z/ # "type: object" with "additionalProperties: { ... }"
        ...
        const = DatadogAPIClient::V1_20270101.model_class(klass)
        if const
