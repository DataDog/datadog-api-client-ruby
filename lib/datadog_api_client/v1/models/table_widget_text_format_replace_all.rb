  ...
  class TableWidgetTextFormatReplaceAll
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::TableWidgetTextFormatReplaceAll` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [type, with, additional_properties].hash
    end
  end
end
