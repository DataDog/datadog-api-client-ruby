  ...
  class GuidedTableMetricsQuery
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::GuidedTableMetricsQuery` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [_alias, data_source, filter, metric_name, name, additional_properties].hash
    end
  end
end
