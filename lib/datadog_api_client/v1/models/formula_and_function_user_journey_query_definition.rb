...
module DatadogAPIClient::V1
  ...
  class FormulaAndFunctionUserJourneyQueryDefinition
    ...
    def self.openapi_types
      {
        ...
        :'group_by' => :'Array<UserJourneyFormulaGroupBy>',
        :'name' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::FormulaAndFunctionUserJourneyQueryDefinition` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [compute, data_source, group_by, name, search, additional_properties].hash
    end
  end
end
