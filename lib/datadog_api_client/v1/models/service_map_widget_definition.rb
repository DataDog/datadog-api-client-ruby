...
module DatadogAPIClient::V1
  ...
  class ServiceMapWidgetDefinition
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DatadogAPIClient::V1::ServiceMapWidgetDefinition`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @!visibility private
    def type=(type)
      validator = DatadogAPIClient::V1::EnumAttributeValidator.new('ServiceMapWidgetDefinitionType', ['servicemap'])
    ...
    # @!visibility private
    def hash
      [custom_links, filters, service, title, title_align, title_size, type].hash
    end
