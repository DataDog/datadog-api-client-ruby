...
module DatadogAPIClient::V1
  ...
  class GuidedTableColumnFunction
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::GuidedTableColumnFunction` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [args, name, additional_properties].hash
    end
  end
end
