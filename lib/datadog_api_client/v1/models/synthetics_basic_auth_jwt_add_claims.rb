...
module DatadogAPIClient::V1
  ...
  class SyntheticsBasicAuthJWTAddClaims
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::SyntheticsBasicAuthJWTAddClaims` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [exp, iat, additional_properties].hash
    end
  end
end
