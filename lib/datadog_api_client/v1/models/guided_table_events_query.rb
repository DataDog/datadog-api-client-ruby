  ...
  class GuidedTableEventsQuery
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::GuidedTableEventsQuery` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [_alias, data_source, indexes, name, search, storage, additional_properties].hash
    end
  end
end
