...
module DatadogAPIClient::V1
  ...
  class ViewingPreferences
    ...
    # Whether the widgets on the shared dash should be displayed with high density.
    attr_accessor :high_density

    # The theme of the shared dashboard view. "system" will follow your system's default viewing theme.
    attr_accessor :theme
