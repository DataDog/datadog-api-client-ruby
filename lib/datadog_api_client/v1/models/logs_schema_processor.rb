  ...
  class LogsSchemaProcessor
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::LogsSchemaProcessor` initialize method"
      end
      ...
      if attributes.key?(:'mappers')
        if (value = attributes[:'mappers']).is_a?(Array)
          self.mappers = value
        end
      end
    ...
    # @param mappers [Object] Object to be assigned
    # @!visibility private
    def mappers=(mappers)
      if mappers.nil?
        fail ArgumentError, 'invalid value for "mappers", mappers cannot be nil.'
      end
      @mappers = mappers
    end
    ...
    # @!visibility private
    def hash
      [is_enabled, mappers, name, schema, type, additional_properties].hash
    end
  end
end
