...
module DatadogAPIClient::V1
  ...
  class GuidedTableTextFormattingRuleReplaceOneOf4484404608
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::GuidedTableTextFormattingRuleReplaceOneOf4484404608` initialize method"
      end
