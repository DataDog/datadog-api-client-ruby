...
module DatadogAPIClient::V1
  ...
  class GuidedTableComputeColumn
    ...
    def self.openapi_types
      {
        ...
        :'compute' => :'GuidedTableComputeColumnCompute',
        :'format' => :'GuidedTableColumnFormat',
        :'functions' => :'Array<GuidedTableColumnFunction>',
        :'is_hidden' => :'Boolean',
        :'name' => :'String',
        :'type' => :'GuidedTableComputeColumnType'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::GuidedTableComputeColumn` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [_alias, comparison, compute, format, functions, is_hidden, name, type, additional_properties].hash
    end
  end
end
