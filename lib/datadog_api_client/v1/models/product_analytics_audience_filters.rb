  ...
  class ProductAnalyticsAudienceFilters
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::ProductAnalyticsAudienceFilters` initialize method"
      end
      ...
      if attributes.key?(:'filter_condition')
        self.filter_condition = attributes[:'filter_condition']
      end
    ...
    # @!visibility private
    def hash
      [accounts, filter_condition, segments, users, additional_properties].hash
    end
  end
end
