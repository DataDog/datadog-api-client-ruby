  ...
  class GuidedTableNumberFormat
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::GuidedTableNumberFormat` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [precision, unit, unit_scale, additional_properties].hash
    end
  end
end
