  ...
  class FormulaAndFunctionProductAnalyticsExtendedQueryDefinition
    ...
    def self.openapi_types
      {
        ...
        :'group_by' => :'Array<ProductAnalyticsExtendedGroupBy>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::FormulaAndFunctionProductAnalyticsExtendedQueryDefinition` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [audience_filters, compute, data_source, group_by, indexes, name, query, additional_properties].hash
    end
  end
end
