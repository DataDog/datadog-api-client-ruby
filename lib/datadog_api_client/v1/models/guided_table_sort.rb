  ...
  class GuidedTableSort
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::GuidedTableSort` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [columns, limit, additional_properties].hash
    end
  end
end
