...
module DatadogAPIClient::V1
  ...
  class QueryValueWidgetComparison
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::QueryValueWidgetComparison` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [directionality, duration, type, additional_properties].hash
    end
  end
end
