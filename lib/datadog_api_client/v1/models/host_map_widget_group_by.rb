  ...
  class HostMapWidgetGroupBy
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::HostMapWidgetGroupBy` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [column, key, additional_properties].hash
    end
  end
end
