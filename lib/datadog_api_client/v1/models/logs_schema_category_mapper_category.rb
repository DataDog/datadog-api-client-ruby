  ...
  class LogsSchemaCategoryMapperCategory
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::LogsSchemaCategoryMapperCategory` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [filter, id, name, additional_properties].hash
    end
  end
end
