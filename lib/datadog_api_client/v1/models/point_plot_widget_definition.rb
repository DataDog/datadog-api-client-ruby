  ...
  class PointPlotWidgetDefinition
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::PointPlotWidgetDefinition` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [custom_links, description, legend, markers, requests, time, title, title_align, title_size, type, yaxis, additional_properties].hash
    end
  end
end
