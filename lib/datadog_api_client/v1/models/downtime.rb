...
module DatadogAPIClient::V1
  ...
  class Downtime
    ...
    # @!visibility private
    def hash
      [active, active_child, canceled, creator_id, disabled, downtime_type, _end, id, message, monitor_id, monitor_tags, mute_first_recovery_notification, notify_end_states, notify_end_types, parent_id, recurrence, scope, start, timezone, updater_id, additional_properties].hash
    end
  end
end
