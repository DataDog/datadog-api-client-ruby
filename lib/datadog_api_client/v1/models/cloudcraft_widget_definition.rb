...
module DatadogAPIClient::V1
  ...
  class CloudcraftWidgetDefinition
    ...
    # @!visibility private
    def hash
      [custom_links, description, group_by, overlay, overlay_filter, projection, provider, query_string, title, title_align, title_size, type, additional_properties].hash
    end
  end
end
