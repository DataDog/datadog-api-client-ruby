...
module DatadogAPIClient::V1
  ...
  class FormulaAndFunctionRetentionQueryDefinition
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::FormulaAndFunctionRetentionQueryDefinition` initialize method"
      end
