...
module DatadogAPIClient::V1
  ...
  class GuidedTableTrendColumnFormat
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::GuidedTableTrendColumnFormat` initialize method"
      end
      ...
      if attributes.key?(:'trend_options')
        self.trend_options = attributes[:'trend_options']
      end
    end
    ...
    def valid?
      ...
      return false if @trend_options.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param trend_options [Object] Object to be assigned
    # @!visibility private
    def trend_options=(trend_options)
      if trend_options.nil?
        fail ArgumentError, 'invalid value for "trend_options", trend_options cannot be nil.'
      end
      @trend_options = trend_options
    end
    ...
    # @!visibility private
    def hash
      [conditional_formats, mode, number_format, trend_options, additional_properties].hash
    end
  end
end
