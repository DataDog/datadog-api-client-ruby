  ...
  class LogsSchemaCategoryMapperFallback
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::LogsSchemaCategoryMapperFallback` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [sources, values, additional_properties].hash
    end
  end
end
