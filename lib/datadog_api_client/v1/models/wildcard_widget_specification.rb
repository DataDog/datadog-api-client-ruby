  ...
  class WildcardWidgetSpecification
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::WildcardWidgetSpecification` initialize method"
      end
    ...
    # @param contents [Object] Object to be assigned
    # @!visibility private
    def contents=(contents)
      if contents.nil?
        fail ArgumentError, 'invalid value for "contents", contents cannot be nil.'
      end
      @contents = contents
    end
    ...
    # @!visibility private
    def hash
      [contents, type, additional_properties].hash
    end
  end
end
