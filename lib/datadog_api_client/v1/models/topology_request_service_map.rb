...
module DatadogAPIClient::V1
  ...
  class TopologyRequestServiceMap
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::TopologyRequestServiceMap` initialize method"
      end
    ...
    # @!visibility private
    def hash
      [query, request_type, additional_properties].hash
    end
  end
end
