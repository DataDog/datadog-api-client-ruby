...
module DatadogAPIClient::V1
  ...
  class SankeyWidgetDefinition
    ...
    attr_accessor :show_other_links

    # Whether to sort nodes in the Sankey diagram.
    attr_accessor :sort_nodes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DatadogAPIClient::V1::SankeyWidgetDefinition` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `DatadogAPIClient::V1::SankeyWidgetDefinition`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'show_other_links')
        self.show_other_links = attributes[:'show_other_links']
      end

      if attributes.key?(:'sort_nodes')
        self.sort_nodes = attributes[:'sort_nodes']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          requests == o.requests &&
          show_other_links == o.show_other_links &&
          sort_nodes == o.sort_nodes &&
          time == o.time &&
          title == o.title &&
    ...
    # @!visibility private
    def hash
      [requests, show_other_links, sort_nodes, time, title, title_align, title_size, type].hash
    end
  end
end
