...
module DatadogAPIClient::V1
  class ServiceLevelObjectivesApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [SLOListResponse]
    def list_sl_os(ids, opts = {})
      data, _status_code, _headers = list_sl_os_with_http_info(ids, opts)
      data
    end
    ...
    def list_sl_os_with_http_info(ids, opts = {})
      ...
      # verify the required parameter 'ids' is set
      if @api_client.config.client_side_validation && ids.nil?
        fail ArgumentError, "Missing the required parameter 'ids' when calling ServiceLevelObjectivesApi.list_sl_os"
      end
      # resource path
      local_var_path = '/api/v1/slo'
