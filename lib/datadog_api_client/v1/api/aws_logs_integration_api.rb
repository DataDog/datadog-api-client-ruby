...
module DatadogAPIClient::V1
  class AWSLogsIntegrationApi
    ...
    def check_aws_logs_lambda_async_with_http_info(body, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'AWSLogsAsyncResponse' 
    ...
    def list_aws_logs_integrations_with_http_info(opts = {})
      ...
      form_params = opts[:form_params] || {}
      # return_type
      return_type = opts[:return_type] || 'Array<AWSLogsListResponse>' 
    ...
    def list_aws_logs_services_with_http_info(opts = {})
      ...
      form_params = opts[:form_params] || {}
      # return_type
      return_type = opts[:return_type] || 'Array<AWSLogsListServicesResponse>' 
