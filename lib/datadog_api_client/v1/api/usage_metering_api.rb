...
module DatadogAPIClient::V1
  class UsageMeteringAPI
    ...
    def get_hourly_usage_attribution_with_http_info(start_hr, usage_type, opts = {})
      ...
      # verify enum value
      allowable_values = ['api_usage', 'apm_fargate_usage', 'apm_host_usage', 'apm_usm_usage', 'appsec_fargate_usage', 'appsec_usage', 'browser_usage', 'ci_visibility_itr_usage', 'cloud_siem_usage', 'container_excl_agent_usage', 'container_usage', 'cspm_containers_usage', 'cspm_hosts_usage', 'custom_ingested_timeseries_usage', 'custom_timeseries_usage', 'cws_containers_usage', 'cws_hosts_usage', 'dbm_hosts_usage', 'dbm_queries_usage', 'estimated_indexed_logs_usage', 'estimated_indexed_spans_usage', 'estimated_ingested_logs_usage', 'estimated_ingested_spans_usage', 'estimated_rum_sessions_usage', 'fargate_usage', 'functions_usage', 'infra_host_usage', 'invocations_usage', 'lambda_traced_invocations_usage', 'mobile_app_testing_usage', 'ndm_netflow_usage', 'npm_host_usage', 'obs_pipeline_bytes_usage', 'profiled_container_usage', 'profiled_fargate_usage', 'profiled_host_usage', 'sds_scanned_bytes_usage', 'serverless_apps_usage', 'snmp_usage', 'universal_service_monitoring_usage', 'vuln_management_hosts_usage']
