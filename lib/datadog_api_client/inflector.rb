    ...
    def overrides
      @overrides ||= {
        # Models
          ...
          "v2.dashboard_report" => "DashboardReport",
          "v2.dashboard_report_attributes" => "DashboardReportAttributes",
          "v2.dashboard_report_create" => "DashboardReportCreate",
          "v2.dashboard_report_create_attributes" => "DashboardReportCreateAttributes",
          "v2.dashboard_report_create_request" => "DashboardReportCreateRequest",
          "v2.dashboard_report_destination" => "DashboardReportDestination",
          "v2.dashboard_report_destination_email" => "DashboardReportDestinationEmail",
          "v2.dashboard_report_relationships" => "DashboardReportRelationships",
          "v2.dashboard_report_relationships_dashboard" => "DashboardReportRelationshipsDashboard",
          "v2.dashboard_report_relationships_dashboard_data" => "DashboardReportRelationshipsDashboardData",
          "v2.dashboard_report_resource_type" => "DashboardReportResourceType",
          "v2.dashboard_report_response" => "DashboardReportResponse",
          "v2.dashboard_report_schedule" => "DashboardReportSchedule",
          "v2.dashboard_report_schedule_frequency" => "DashboardReportScheduleFrequency",
          "v2.dashboard_report_schedule_repeat_at" => "DashboardReportScheduleRepeatAt",
          "v2.dashboard_report_schedule_repeat_on_day_of_month" => "DashboardReportScheduleRepeatOnDayOfMonth",
          "v2.dashboard_report_schedule_repeat_on_day_of_week" => "DashboardReportScheduleRepeatOnDayOfWeek",
          "v2.dashboard_reports_response" => "DashboardReportsResponse",
          "v2.dashboard_report_timeframe" => "DashboardReportTimeframe",
          "v2.dashboard_report_type" => "DashboardReportType",
          "v2.dashboard_report_update_attributes" => "DashboardReportUpdateAttributes",
          "v2.dashboard_report_update_request" => "DashboardReportUpdateRequest",
          "v2.dashboard_report_update_request_data" => "DashboardReportUpdateRequestData",
        ...
        "v2.dashboard_reports_api" => "DashboardReportsAPI",
