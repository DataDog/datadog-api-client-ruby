    ...
    def overrides
      @overrides ||= {
        # Models
          ...
          "v2.change_event" => "ChangeEvent",
          "v2.change_event_category" => "ChangeEventCategory",
          "v2.change_event_create_request" => "ChangeEventCreateRequest",
          "v2.change_event_create_request_payload" => "ChangeEventCreateRequestPayload",
          "v2.change_event_create_request_type" => "ChangeEventCreateRequestType",
          "v2.change_event_create_response" => "ChangeEventCreateResponse",
          "v2.change_event_create_response_attributes" => "ChangeEventCreateResponseAttributes",
          "v2.change_event_create_response_attributes_attributes" => "ChangeEventCreateResponseAttributesAttributes",
          "v2.change_event_create_response_attributes_attributes_evt" => "ChangeEventCreateResponseAttributesAttributesEvt",
          "v2.change_event_create_response_payload" => "ChangeEventCreateResponsePayload",
