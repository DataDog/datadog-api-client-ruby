    ...
    def overrides
      @overrides ||= {
        # Models
          ...
          "v2.downtime_attribute_create_request" => "DowntimeAttributeCreateRequest",
          "v2.downtime_attribute_edit_request" => "DowntimeAttributeEditRequest",
          "v2.downtime_attribute_monitor_identifier" => "DowntimeAttributeMonitorIdentifier",
          "v2.downtime_attribute_monitor_identifier_id" => "DowntimeAttributeMonitorIdentifierId",
          "v2.downtime_attribute_monitor_identifier_tags" => "DowntimeAttributeMonitorIdentifierTags",
          "v2.downtime_attribute_notify_end_state_actions" => "DowntimeAttributeNotifyEndStateActions",
          "v2.downtime_attribute_notify_end_state_types" => "DowntimeAttributeNotifyEndStateTypes",
          "v2.downtime_attribute_response" => "DowntimeAttributeResponse",
          "v2.downtime_attribute_schedule_create_request" => "DowntimeAttributeScheduleCreateRequest",
          "v2.downtime_attribute_schedule_current_downtime_response" => "DowntimeAttributeScheduleCurrentDowntimeResponse",
          "v2.downtime_attribute_schedule_edit_request" => "DowntimeAttributeScheduleEditRequest",
          "v2.downtime_attribute_schedule_one_time_create_edit_request" => "DowntimeAttributeScheduleOneTimeCreateEditRequest",
          "v2.downtime_attribute_schedule_one_time_response" => "DowntimeAttributeScheduleOneTimeResponse",
          "v2.downtime_attribute_schedule_recurrence_create_edit_request" => "DowntimeAttributeScheduleRecurrenceCreateEditRequest",
          "v2.downtime_attribute_schedule_recurrence_response" => "DowntimeAttributeScheduleRecurrenceResponse",
          "v2.downtime_attribute_schedule_recurrences_create_request" => "DowntimeAttributeScheduleRecurrencesCreateRequest",
          "v2.downtime_attribute_schedule_recurrences_edit_request" => "DowntimeAttributeScheduleRecurrencesEditRequest",
          "v2.downtime_attribute_schedule_recurrences_response" => "DowntimeAttributeScheduleRecurrencesResponse",
          "v2.downtime_attribute_schedule_response" => "DowntimeAttributeScheduleResponse",
          "v2.downtime_create_data" => "DowntimeCreateData",
          "v2.downtime_create_request" => "DowntimeCreateRequest",
          "v2.downtime_edit_data" => "DowntimeEditData",
          "v2.downtime_edit_request" => "DowntimeEditRequest",
          "v2.downtime_included_monitor_type" => "DowntimeIncludedMonitorType",
          "v2.downtime_list_item_response" => "DowntimeListItemResponse",
          ...
          "v2.downtime_status_enum" => "DowntimeStatusEnum",
          "v2.downtime_user_type" => "DowntimeUserType",
          "v2.event" => "Event",
          ...
          "v2.monitor_downtime_match_attribute_response" => "MonitorDowntimeMatchAttributeResponse",
          "v2.monitor_downtime_match_list_item_response" => "MonitorDowntimeMatchListItemResponse",
          ...
          "v2.mute_finding_request_data" => "MuteFindingRequestData",
          "v2.mute_finding_request_properties" => "MuteFindingRequestProperties",
          "v2.mute_finding_response" => "MuteFindingResponse",
