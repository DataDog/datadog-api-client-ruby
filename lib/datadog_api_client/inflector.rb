    ...
    def overrides
      @overrides ||= {
        # Models
          ...
          "v2.vercel_api_key" => "VercelApiKey",
          "v2.vercel_config_attributes" => "VercelConfigAttributes",
          "v2.vercel_config_data_response" => "VercelConfigDataResponse",
          "v2.vercel_config_data_response_type" => "VercelConfigDataResponseType",
          "v2.vercel_config_response" => "VercelConfigResponse",
          "v2.vercel_environment" => "VercelEnvironment",
          "v2.vercel_logs_config" => "VercelLogsConfig",
          "v2.vercel_log_source" => "VercelLogSource",
          "v2.vercel_token_create_request" => "VercelTokenCreateRequest",
          "v2.vercel_trace_config" => "VercelTraceConfig",
