    ...
    def overrides
      @overrides ||= {
        # Models
          ...
          "v2.parse_json_processor" => "ParseJSONProcessor",
          ...
          "v2.pipeline_add_fields_processor" => "PipelineAddFieldsProcessor",
          "v2.pipeline_add_fields_processor_type" => "PipelineAddFieldsProcessorType",
          "v2.pipeline_config" => "PipelineConfig",
          "v2.pipeline_config_destination" => "PipelineConfigDestination",
          "v2.pipeline_config_processor" => "PipelineConfigProcessor",
          "v2.pipeline_config_source" => "PipelineConfigSource",
          "v2.pipeline_create_request" => "PipelineCreateRequest",
          "v2.pipeline_create_request_data" => "PipelineCreateRequestData",
          "v2.pipeline_data" => "PipelineData",
          "v2.pipeline_data_attributes" => "PipelineDataAttributes",
          "v2.pipeline_datadog_agent_source" => "PipelineDatadogAgentSource",
          "v2.pipeline_datadog_agent_source_type" => "PipelineDatadogAgentSourceType",
          "v2.pipeline_datadog_logs_destination" => "PipelineDatadogLogsDestination",
          "v2.pipeline_datadog_logs_destination_type" => "PipelineDatadogLogsDestinationType",
          "v2.pipeline_field_value" => "PipelineFieldValue",
          "v2.pipeline_filter_processor" => "PipelineFilterProcessor",
          "v2.pipeline_filter_processor_type" => "PipelineFilterProcessorType",
          "v2.pipeline_kafka_source" => "PipelineKafkaSource",
          "v2.pipeline_kafka_source_librdkafka_option" => "PipelineKafkaSourceLibrdkafkaOption",
          "v2.pipeline_kafka_source_sasl" => "PipelineKafkaSourceSasl",
          "v2.pipeline_kafka_source_type" => "PipelineKafkaSourceType",
          "v2.pipeline_parse_json_processor_type" => "PipelineParseJSONProcessorType",
          "v2.pipeline_pipeline_kafka_source_sasl_mechanism" => "PipelinePipelineKafkaSourceSaslMechanism",
          "v2.pipeline_quota_processor" => "PipelineQuotaProcessor",
          "v2.pipeline_quota_processor_limit" => "PipelineQuotaProcessorLimit",
          "v2.pipeline_quota_processor_limit_enforce_type" => "PipelineQuotaProcessorLimitEnforceType",
          "v2.pipeline_quota_processor_override" => "PipelineQuotaProcessorOverride",
          "v2.pipeline_quota_processor_type" => "PipelineQuotaProcessorType",
          "v2.pipeline_remove_fields_processor" => "PipelineRemoveFieldsProcessor",
          "v2.pipeline_remove_fields_processor_type" => "PipelineRemoveFieldsProcessorType",
          "v2.pipeline_rename_fields_processor" => "PipelineRenameFieldsProcessor",
          "v2.pipeline_rename_fields_processor_field" => "PipelineRenameFieldsProcessorField",
          "v2.pipeline_rename_fields_processor_type" => "PipelineRenameFieldsProcessorType",
          "v2.pipeline_tls" => "PipelineTls",
