    ...
    def overrides
      @overrides ||= {
        # Models
          ...
          "v2.application_security_exclusion_filter_attributes" => "ApplicationSecurityExclusionFilterAttributes",
          "v2.application_security_exclusion_filter_metadata" => "ApplicationSecurityExclusionFilterMetadata",
          "v2.application_security_exclusion_filter_on_match" => "ApplicationSecurityExclusionFilterOnMatch",
          "v2.application_security_exclusion_filter_request" => "ApplicationSecurityExclusionFilterRequest",
          "v2.application_security_exclusion_filter_resource" => "ApplicationSecurityExclusionFilterResource",
          "v2.application_security_exclusion_filter_response" => "ApplicationSecurityExclusionFilterResponse",
          "v2.application_security_exclusion_filter_rules_target" => "ApplicationSecurityExclusionFilterRulesTarget",
          "v2.application_security_exclusion_filter_rules_target_tags" => "ApplicationSecurityExclusionFilterRulesTargetTags",
          "v2.application_security_exclusion_filter_scope" => "ApplicationSecurityExclusionFilterScope",
          "v2.application_security_exclusion_filters_response" => "ApplicationSecurityExclusionFiltersResponse",
          "v2.application_security_exclusion_filter_type" => "ApplicationSecurityExclusionFilterType",
          "v2.app_meta" => "AppMeta",
