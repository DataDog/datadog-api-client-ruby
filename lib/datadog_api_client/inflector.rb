    ...
    def overrides
      @overrides ||= {
        # Models
          ...
          "v2.rum_metric_response_compute_aggregation_type" => "RumMetricResponseComputeAggregationType",
          ...
          "v2.rum_metric_response_uniqueness_when" => "RumMetricResponseUniquenessWhen",
