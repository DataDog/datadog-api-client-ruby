    ...
    def overrides
      @overrides ||= {
        # Models
          ...
          "v1.bar_chart_widget_definition" => "BarChartWidgetDefinition",
          "v1.bar_chart_widget_definition_type" => "BarChartWidgetDefinitionType",
          "v1.bar_chart_widget_display" => "BarChartWidgetDisplay",
          "v1.bar_chart_widget_flat" => "BarChartWidgetFlat",
          "v1.bar_chart_widget_flat_type" => "BarChartWidgetFlatType",
          "v1.bar_chart_widget_legend" => "BarChartWidgetLegend",
          "v1.bar_chart_widget_request" => "BarChartWidgetRequest",
          "v1.bar_chart_widget_scaling" => "BarChartWidgetScaling",
          ...
          "v1.dataset_list_query" => "DatasetListQuery",
          "v1.dataset_list_query_data_source_type" => "DatasetListQueryDataSourceType",
          "v1.dataset_list_query_sort" => "DatasetListQuerySort",
          "v1.dataset_list_query_sort_field" => "DatasetListQuerySortField",
          ...
          "v1.embedded_app_widget_definition" => "EmbeddedAppWidgetDefinition",
          "v1.embedded_app_widget_definition_type" => "EmbeddedAppWidgetDefinitionType",
          "v1.embedded_app_widget_input" => "EmbeddedAppWidgetInput",
          "v1.event" => "Event",
          ...
          "v1.events_aggregation" => "EventsAggregation",
          "v1.events_aggregation_value" => "EventsAggregationValue",
          ...
          "v1.host_map_widget_definition_request_type" => "HostMapWidgetDefinitionRequestType",
          ...
          "v1.host_map_widget_dimension" => "HostMapWidgetDimension",
          "v1.host_map_widget_formula" => "HostMapWidgetFormula",
          "v1.host_map_widget_group_by" => "HostMapWidgetGroupBy",
          "v1.host_map_widget_infrastructure_request" => "HostMapWidgetInfrastructureRequest",
          "v1.host_map_widget_infrastructure_request_leaf" => "HostMapWidgetInfrastructureRequestLeaf",
          "v1.host_map_widget_infrastructure_request_request_type" => "HostMapWidgetInfrastructureRequestRequestType",
          "v1.host_map_widget_infrastructure_style" => "HostMapWidgetInfrastructureStyle",
          "v1.host_map_widget_node_type" => "HostMapWidgetNodeType",
          "v1.host_map_widget_projection" => "HostMapWidgetProjection",
          "v1.host_map_widget_projection_dimension_mapping" => "HostMapWidgetProjectionDimensionMapping",
          "v1.host_map_widget_projection_type" => "HostMapWidgetProjectionType",
          "v1.host_map_widget_scalar_request" => "HostMapWidgetScalarRequest",
          "v1.host_map_widget_scalar_request_response_format" => "HostMapWidgetScalarRequestResponseFormat",
          ...
          "v1.logs_schema_category_mapper" => "LogsSchemaCategoryMapper",
          "v1.logs_schema_category_mapper_category" => "LogsSchemaCategoryMapperCategory",
          "v1.logs_schema_category_mapper_fallback" => "LogsSchemaCategoryMapperFallback",
          "v1.logs_schema_category_mapper_targets" => "LogsSchemaCategoryMapperTargets",
          "v1.logs_schema_category_mapper_type" => "LogsSchemaCategoryMapperType",
          "v1.logs_schema_data" => "LogsSchemaData",
          "v1.logs_schema_mapper" => "LogsSchemaMapper",
          "v1.logs_schema_processor" => "LogsSchemaProcessor",
          "v1.logs_schema_processor_type" => "LogsSchemaProcessorType",
          "v1.logs_schema_remapper" => "LogsSchemaRemapper",
          "v1.logs_schema_remapper_type" => "LogsSchemaRemapperType",
          ...
          "v1.monitor_formula_and_function_aggregate_augmented_data_source" => "MonitorFormulaAndFunctionAggregateAugmentedDataSource",
          "v1.monitor_formula_and_function_aggregate_augmented_query_definition" => "MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition",
          "v1.monitor_formula_and_function_aggregate_augment_query" => "MonitorFormulaAndFunctionAggregateAugmentQuery",
          "v1.monitor_formula_and_function_aggregate_base_query" => "MonitorFormulaAndFunctionAggregateBaseQuery",
          "v1.monitor_formula_and_function_aggregate_filtered_data_source" => "MonitorFormulaAndFunctionAggregateFilteredDataSource",
          "v1.monitor_formula_and_function_aggregate_filtered_query_definition" => "MonitorFormulaAndFunctionAggregateFilteredQueryDefinition",
          "v1.monitor_formula_and_function_aggregate_filter_query" => "MonitorFormulaAndFunctionAggregateFilterQuery",
          "v1.monitor_formula_and_function_aggregate_query_filter" => "MonitorFormulaAndFunctionAggregateQueryFilter",
          ...
          "v1.monitor_formula_and_function_data_quality_diff_function" => "MonitorFormulaAndFunctionDataQualityDiffFunction",
          "v1.monitor_formula_and_function_data_quality_diff_type" => "MonitorFormulaAndFunctionDataQualityDiffType",
          "v1.monitor_formula_and_function_data_quality_entity_metric_config" => "MonitorFormulaAndFunctionDataQualityEntityMetricConfig",
          "v1.monitor_formula_and_function_data_quality_model_bounds_override" => "MonitorFormulaAndFunctionDataQualityModelBoundsOverride",
          "v1.monitor_formula_and_function_data_quality_model_configuration" => "MonitorFormulaAndFunctionDataQualityModelConfiguration",
          ...
          "v1.monitor_formula_and_function_data_quality_query_definition" => "MonitorFormulaAndFunctionDataQualityQueryDefinition",
          "v1.monitor_formula_and_function_data_quality_source_to_target_config" => "MonitorFormulaAndFunctionDataQualitySourceToTargetConfig",
          ...
          "v1.monitor_formula_and_function_metrics_aggregator" => "MonitorFormulaAndFunctionMetricsAggregator",
          "v1.monitor_formula_and_function_metrics_data_source" => "MonitorFormulaAndFunctionMetricsDataSource",
          "v1.monitor_formula_and_function_metrics_query_definition" => "MonitorFormulaAndFunctionMetricsQueryDefinition",
          "v1.monitor_formula_and_function_query_definition" => "MonitorFormulaAndFunctionQueryDefinition",
          "v1.monitor_formula_and_function_reference_table_column" => "MonitorFormulaAndFunctionReferenceTableColumn",
          "v1.monitor_formula_and_function_reference_table_data_source" => "MonitorFormulaAndFunctionReferenceTableDataSource",
          "v1.monitor_formula_and_function_reference_table_query_definition" => "MonitorFormulaAndFunctionReferenceTableQueryDefinition",
          ...
          "v1.notebook_template_variable_available_values_query" => "NotebookTemplateVariableAvailableValuesQuery",
          "v1.notebook_template_variable_available_values_query_group_by" => "NotebookTemplateVariableAvailableValuesQueryGroupBy",
          "v1.notebook_template_variable_available_values_query_log_rum_spans" => "NotebookTemplateVariableAvailableValuesQueryLogRumSpans",
          "v1.notebook_template_variable_available_values_query_metrics" => "NotebookTemplateVariableAvailableValuesQueryMetrics",
          "v1.notebook_template_variable_available_values_query_search" => "NotebookTemplateVariableAvailableValuesQuerySearch",
          ...
          "v1.product_analytics_audience_account_subquery" => "ProductAnalyticsAudienceAccountSubquery",
          "v1.product_analytics_audience_filters" => "ProductAnalyticsAudienceFilters",
          ...
          "v1.published_dataset_provider" => "PublishedDatasetProvider",
          ...
          "v1.sankey_join_keys" => "SankeyJoinKeys",
          "v1.sankey_network_data_source" => "SankeyNetworkDataSource",
          "v1.sankey_network_query" => "SankeyNetworkQuery",
          "v1.sankey_network_query_compute" => "SankeyNetworkQueryCompute",
          "v1.sankey_network_query_mode" => "SankeyNetworkQueryMode",
          "v1.sankey_network_query_sort" => "SankeyNetworkQuerySort",
          "v1.sankey_network_request" => "SankeyNetworkRequest",
          "v1.sankey_network_request_type" => "SankeyNetworkRequestType",
          "v1.sankey_rum_data_source" => "SankeyRumDataSource",
          "v1.sankey_rum_query" => "SankeyRumQuery",
          "v1.sankey_rum_query_mode" => "SankeyRumQueryMode",
          "v1.sankey_rum_request" => "SankeyRumRequest",
          ...
          "v1.synthetics_assertion_mcp_respects_specification" => "SyntheticsAssertionMCPRespectsSpecification",
          "v1.synthetics_assertion_mcp_respects_specification_type" => "SyntheticsAssertionMCPRespectsSpecificationType",
          "v1.synthetics_assertion_mcp_server_capabilities_target" => "SyntheticsAssertionMCPServerCapabilitiesTarget",
          "v1.synthetics_assertion_mcp_server_capabilities_type" => "SyntheticsAssertionMCPServerCapabilitiesType",
          ...
          "v1.synthetics_mcp_protocol_version" => "SyntheticsMCPProtocolVersion",
          "v1.synthetics_mcp_server_capability" => "SyntheticsMCPServerCapability",
          ...
          "v1.widget_histogram_request_type" => "WidgetHistogramRequestType",
          ...
          "v2.access_tokens_type" => "AccessTokensType",
          "v2.account_filtering_config" => "AccountFilteringConfig",
          "v2.account_filters" => "AccountFilters",
          "v2.account_filters_attributes" => "AccountFiltersAttributes",
          "v2.account_filters_patch_data" => "AccountFiltersPatchData",
          "v2.account_filters_patch_request" => "AccountFiltersPatchRequest",
          "v2.account_filters_patch_request_attributes" => "AccountFiltersPatchRequestAttributes",
          "v2.account_filters_patch_request_type" => "AccountFiltersPatchRequestType",
          "v2.account_filters_response" => "AccountFiltersResponse",
          "v2.account_filters_type" => "AccountFiltersType",
          ...
          "v2.ai_custom_rule_request" => "AiCustomRuleRequest",
          "v2.ai_custom_rule_request_attributes" => "AiCustomRuleRequestAttributes",
          "v2.ai_custom_rule_request_data" => "AiCustomRuleRequestData",
          "v2.ai_custom_rule_response" => "AiCustomRuleResponse",
          "v2.ai_custom_rule_response_data" => "AiCustomRuleResponseData",
          "v2.ai_custom_rule_revision_data_type" => "AiCustomRuleRevisionDataType",
          "v2.ai_custom_rule_revision_execution_mode" => "AiCustomRuleRevisionExecutionMode",
          "v2.ai_custom_rule_revision_request" => "AiCustomRuleRevisionRequest",
          "v2.ai_custom_rule_revision_request_attributes" => "AiCustomRuleRevisionRequestAttributes",
          "v2.ai_custom_rule_revision_request_data" => "AiCustomRuleRevisionRequestData",
          "v2.ai_custom_rule_revision_response" => "AiCustomRuleRevisionResponse",
          "v2.ai_custom_rule_revision_response_attributes" => "AiCustomRuleRevisionResponseAttributes",
          "v2.ai_custom_rule_revision_response_data" => "AiCustomRuleRevisionResponseData",
          "v2.ai_custom_rule_revisions_response" => "AiCustomRuleRevisionsResponse",
          "v2.ai_custom_ruleset_data_type" => "AiCustomRulesetDataType",
          "v2.ai_custom_ruleset_request" => "AiCustomRulesetRequest",
          "v2.ai_custom_ruleset_request_attributes" => "AiCustomRulesetRequestAttributes",
          "v2.ai_custom_ruleset_request_data" => "AiCustomRulesetRequestData",
          "v2.ai_custom_ruleset_response" => "AiCustomRulesetResponse",
          "v2.ai_custom_ruleset_response_attributes" => "AiCustomRulesetResponseAttributes",
          "v2.ai_custom_ruleset_response_data" => "AiCustomRulesetResponseData",
          "v2.ai_custom_rulesets_response" => "AiCustomRulesetsResponse",
          "v2.ai_custom_ruleset_update_attributes" => "AiCustomRulesetUpdateAttributes",
          "v2.ai_custom_ruleset_update_data" => "AiCustomRulesetUpdateData",
          "v2.ai_custom_ruleset_update_request" => "AiCustomRulesetUpdateRequest",
          "v2.ai_memory_violation_result_data_type" => "AiMemoryViolationResultDataType",
          "v2.ai_memory_violation_result_request" => "AiMemoryViolationResultRequest",
          "v2.ai_memory_violation_result_request_attributes" => "AiMemoryViolationResultRequestAttributes",
          "v2.ai_memory_violation_result_request_data" => "AiMemoryViolationResultRequestData",
          "v2.ai_memory_violation_result_response_attributes" => "AiMemoryViolationResultResponseAttributes",
          "v2.ai_memory_violation_result_response_data" => "AiMemoryViolationResultResponseData",
          "v2.ai_memory_violation_results_response" => "AiMemoryViolationResultsResponse",
          "v2.ai_memory_violation_type" => "AiMemoryViolationType",
          "v2.ai_prompt_data_type" => "AiPromptDataType",
          "v2.ai_prompt_response_attributes" => "AiPromptResponseAttributes",
          "v2.ai_prompt_response_data" => "AiPromptResponseData",
          "v2.ai_prompts_response" => "AiPromptsResponse",
          ...
          "v2.allocation" => "Allocation",
          "v2.allocation_data_request" => "AllocationDataRequest",
          "v2.allocation_data_response" => "AllocationDataResponse",
          "v2.allocation_data_type" => "AllocationDataType",
          "v2.allocation_exposure_guardrail_trigger" => "AllocationExposureGuardrailTrigger",
          "v2.allocation_exposure_rollout_step" => "AllocationExposureRolloutStep",
          "v2.allocation_exposure_schedule" => "AllocationExposureSchedule",
          "v2.allocation_exposure_schedule_data" => "AllocationExposureScheduleData",
          "v2.allocation_exposure_schedule_data_type" => "AllocationExposureScheduleDataType",
          "v2.allocation_exposure_schedule_response" => "AllocationExposureScheduleResponse",
          "v2.allocation_response" => "AllocationResponse",
          "v2.allocation_type" => "AllocationType",
          "v2.ams_integration_account_attributes" => "AmsIntegrationAccountAttributes",
          "v2.ams_integration_account_create_request" => "AmsIntegrationAccountCreateRequest",
          "v2.ams_integration_account_create_request_attributes" => "AmsIntegrationAccountCreateRequestAttributes",
          "v2.ams_integration_account_create_request_data" => "AmsIntegrationAccountCreateRequestData",
          "v2.ams_integration_account_response" => "AmsIntegrationAccountResponse",
          "v2.ams_integration_account_response_data" => "AmsIntegrationAccountResponseData",
          "v2.ams_integration_account_schema_response" => "AmsIntegrationAccountSchemaResponse",
          "v2.ams_integration_account_schema_response_properties" => "AmsIntegrationAccountSchemaResponseProperties",
          "v2.ams_integration_account_schema_response_secrets_object" => "AmsIntegrationAccountSchemaResponseSecretsObject",
          "v2.ams_integration_account_schema_response_settings_field" => "AmsIntegrationAccountSchemaResponseSettingsField",
          "v2.ams_integration_account_schema_response_settings_object" => "AmsIntegrationAccountSchemaResponseSettingsObject",
          "v2.ams_integration_accounts_response" => "AmsIntegrationAccountsResponse",
          "v2.ams_integration_account_type" => "AmsIntegrationAccountType",
          "v2.ams_integration_account_update_request" => "AmsIntegrationAccountUpdateRequest",
          "v2.ams_integration_account_update_request_attributes" => "AmsIntegrationAccountUpdateRequestAttributes",
          "v2.ams_integration_account_update_request_data" => "AmsIntegrationAccountUpdateRequestData",
          "v2.analysis_edit" => "AnalysisEdit",
          "v2.analysis_edit_type" => "AnalysisEditType",
          "v2.analysis_fix" => "AnalysisFix",
          "v2.analysis_position" => "AnalysisPosition",
          "v2.analysis_request" => "AnalysisRequest",
          "v2.analysis_request_data" => "AnalysisRequestData",
          "v2.analysis_request_data_attributes" => "AnalysisRequestDataAttributes",
          "v2.analysis_request_data_type" => "AnalysisRequestDataType",
          "v2.analysis_request_rule" => "AnalysisRequestRule",
          "v2.analysis_request_rule_argument" => "AnalysisRequestRuleArgument",
          "v2.analysis_request_rule_test" => "AnalysisRequestRuleTest",
          "v2.analysis_response" => "AnalysisResponse",
          "v2.analysis_response_data" => "AnalysisResponseData",
          "v2.analysis_response_data_attributes" => "AnalysisResponseDataAttributes",
          "v2.analysis_response_data_type" => "AnalysisResponseDataType",
          "v2.analysis_rule_response" => "AnalysisRuleResponse",
          "v2.analysis_violation" => "AnalysisViolation",
          "v2.annotation" => "Annotation",
          "v2.annotation_attributes" => "AnnotationAttributes",
          "v2.annotation_color" => "AnnotationColor",
          "v2.annotation_create_attributes" => "AnnotationCreateAttributes",
          "v2.annotation_create_request" => "AnnotationCreateRequest",
          "v2.annotation_data" => "AnnotationData",
          "v2.annotation_display" => "AnnotationDisplay",
          "v2.annotation_display_bounds" => "AnnotationDisplayBounds",
          "v2.annotation_in_page" => "AnnotationInPage",
          "v2.annotation_kind" => "AnnotationKind",
          "v2.annotation_markdown_text_annotation" => "AnnotationMarkdownTextAnnotation",
          "v2.annotation_request_data" => "AnnotationRequestData",
          "v2.annotation_response" => "AnnotationResponse",
          "v2.annotations_response" => "AnnotationsResponse",
          "v2.annotation_type" => "AnnotationType",
          "v2.annotation_update_request" => "AnnotationUpdateRequest",
          ...
          "v2.any_value" => "AnyValue",
          "v2.any_value_item" => "AnyValueItem",
          ...
          "v2.apm_dependency_stat_name" => "ApmDependencyStatName",
          "v2.apm_dependency_stats_data_source" => "ApmDependencyStatsDataSource",
          "v2.apm_dependency_stats_query" => "ApmDependencyStatsQuery",
          "v2.apm_metrics_data_source" => "ApmMetricsDataSource",
          "v2.apm_metrics_query" => "ApmMetricsQuery",
          "v2.apm_metrics_span_kind" => "ApmMetricsSpanKind",
          "v2.apm_metrics_stat" => "ApmMetricsStat",
          "v2.apm_resource_stat_name" => "ApmResourceStatName",
          ...
          "v2.app_builder_list_tags_response" => "AppBuilderListTagsResponse",
          "v2.app_definition_type" => "AppDefinitionType",
          "v2.app_deployment_type" => "AppDeploymentType",
          "v2.app_favorite_type" => "AppFavoriteType",
          ...
          "v2.application_security_policy_attributes" => "ApplicationSecurityPolicyAttributes",
          "v2.application_security_policy_create_attributes" => "ApplicationSecurityPolicyCreateAttributes",
          "v2.application_security_policy_create_data" => "ApplicationSecurityPolicyCreateData",
          "v2.application_security_policy_create_request" => "ApplicationSecurityPolicyCreateRequest",
          "v2.application_security_policy_data" => "ApplicationSecurityPolicyData",
          "v2.application_security_policy_list_response" => "ApplicationSecurityPolicyListResponse",
          "v2.application_security_policy_metadata" => "ApplicationSecurityPolicyMetadata",
          "v2.application_security_policy_response" => "ApplicationSecurityPolicyResponse",
          "v2.application_security_policy_rule_override" => "ApplicationSecurityPolicyRuleOverride",
          "v2.application_security_policy_ruleset_override" => "ApplicationSecurityPolicyRulesetOverride",
          "v2.application_security_policy_scope" => "ApplicationSecurityPolicyScope",
          "v2.application_security_policy_type" => "ApplicationSecurityPolicyType",
          ...
          "v2.app_meta" => "AppMeta",
          "v2.app_protection_level" => "AppProtectionLevel",
          "v2.app_protection_level_type" => "AppProtectionLevelType",
          "v2.app_relationship" => "AppRelationship",
          "v2.app_self_service_type" => "AppSelfServiceType",
          "v2.apps_sort_field" => "AppsSortField",
          "v2.app_tags_type" => "AppTagsType",
          "v2.app_trigger_wrapper" => "AppTriggerWrapper",
          "v2.app_version" => "AppVersion",
          "v2.app_version_attributes" => "AppVersionAttributes",
          "v2.app_version_name_type" => "AppVersionNameType",
          "v2.app_version_type" => "AppVersionType",
          ...
          "v2.assign_seats_user_response" => "AssignSeatsUserResponse",
          "v2.assign_seats_user_response_data" => "AssignSeatsUserResponseData",
          "v2.assign_seats_user_response_data_attributes" => "AssignSeatsUserResponseDataAttributes",
          "v2.ast_node" => "AstNode",
          ...
          "v2.attach_linear_issue_request" => "AttachLinearIssueRequest",
          "v2.attach_linear_issue_request_data" => "AttachLinearIssueRequestData",
          "v2.attach_linear_issue_request_data_attributes" => "AttachLinearIssueRequestDataAttributes",
          "v2.attach_linear_issue_request_data_relationships" => "AttachLinearIssueRequestDataRelationships",
          ...
          "v2.auto_close_inactive_cases" => "AutoCloseInactiveCases",
          "v2.automation_rule" => "AutomationRule",
          ...
          "v2.automation_rule_trigger_type" => "AutomationRuleTriggerType",
          "v2.automation_rule_update" => "AutomationRuleUpdate",
          "v2.automation_rule_update_request" => "AutomationRuleUpdateRequest",
          "v2.auto_transition_assigned_cases" => "AutoTransitionAssignedCases",
          ...
          "v2.aws_ccm_config" => "AWSCcmConfig",
          "v2.aws_ccm_config_request" => "AWSCcmConfigRequest",
          "v2.aws_ccm_config_request_attributes" => "AWSCcmConfigRequestAttributes",
          "v2.aws_ccm_config_request_data" => "AWSCcmConfigRequestData",
          "v2.aws_ccm_config_response" => "AWSCcmConfigResponse",
          ...
          "v2.aws_metric_name_filter_preview_dd_name" => "AWSMetricNameFilterPreviewDDName",
          "v2.aws_metric_name_filter_preview_filter_match" => "AWSMetricNameFilterPreviewFilterMatch",
          "v2.aws_metric_name_filter_preview_metric" => "AWSMetricNameFilterPreviewMetric",
          "v2.aws_metric_name_filter_preview_namespace" => "AWSMetricNameFilterPreviewNamespace",
          "v2.aws_metric_name_filter_preview_request" => "AWSMetricNameFilterPreviewRequest",
          "v2.aws_metric_name_filter_preview_request_attributes" => "AWSMetricNameFilterPreviewRequestAttributes",
          "v2.aws_metric_name_filter_preview_request_data" => "AWSMetricNameFilterPreviewRequestData",
          "v2.aws_metric_name_filter_preview_response" => "AWSMetricNameFilterPreviewResponse",
          "v2.aws_metric_name_filter_preview_response_attributes" => "AWSMetricNameFilterPreviewResponseAttributes",
          "v2.aws_metric_name_filter_preview_response_data" => "AWSMetricNameFilterPreviewResponseData",
          "v2.aws_metric_name_filter_preview_type" => "AWSMetricNameFilterPreviewType",
          "v2.aws_metric_name_filters" => "AWSMetricNameFilters",
          "v2.aws_metric_name_filters_exclude_only" => "AWSMetricNameFiltersExcludeOnly",
          "v2.aws_metric_name_filters_include_only" => "AWSMetricNameFiltersIncludeOnly",
          ...
          "v2.blueprint_attributes" => "BlueprintAttributes",
          "v2.blueprint_data" => "BlueprintData",
          "v2.blueprint_data_type" => "BlueprintDataType",
          "v2.blueprint_metadata_attributes" => "BlueprintMetadataAttributes",
          "v2.blueprint_metadata_data" => "BlueprintMetadataData",
          "v2.branch_coverage_summary_request" => "BranchCoverageSummaryRequest",
          "v2.branch_coverage_summary_request_attributes" => "BranchCoverageSummaryRequestAttributes",
          "v2.branch_coverage_summary_request_data" => "BranchCoverageSummaryRequestData",
          "v2.branch_coverage_summary_request_type" => "BranchCoverageSummaryRequestType",
          "v2.budget" => "Budget",
          ...
          "v2.budget_validation_response_data" => "BudgetValidationResponseData",
          "v2.budget_validation_response_data_attributes" => "BudgetValidationResponseDataAttributes",
          "v2.budget_validation_response_data_type" => "BudgetValidationResponseDataType",
          ...
          "v2.campaign_response" => "CampaignResponse",
          "v2.campaign_response_attributes" => "CampaignResponseAttributes",
          "v2.campaign_response_data" => "CampaignResponseData",
          "v2.campaign_status" => "CampaignStatus",
          "v2.campaign_type" => "CampaignType",
          ...
          "v2.case_aggregate_group" => "CaseAggregateGroup",
          "v2.case_aggregate_group_by" => "CaseAggregateGroupBy",
          "v2.case_aggregate_request" => "CaseAggregateRequest",
          "v2.case_aggregate_request_attributes" => "CaseAggregateRequestAttributes",
          "v2.case_aggregate_request_data" => "CaseAggregateRequestData",
          "v2.case_aggregate_resource_type" => "CaseAggregateResourceType",
          "v2.case_aggregate_response" => "CaseAggregateResponse",
          "v2.case_aggregate_response_attributes" => "CaseAggregateResponseAttributes",
          "v2.case_aggregate_response_data" => "CaseAggregateResponseData",
          ...
          "v2.case_automation_rule_resource_type" => "CaseAutomationRuleResourceType",
          "v2.case_automation_rule_state" => "CaseAutomationRuleState",
          "v2.case_bulk_action_type" => "CaseBulkActionType",
          "v2.case_bulk_resource_type" => "CaseBulkResourceType",
          "v2.case_bulk_update_request" => "CaseBulkUpdateRequest",
          "v2.case_bulk_update_request_attributes" => "CaseBulkUpdateRequestAttributes",
          "v2.case_bulk_update_request_data" => "CaseBulkUpdateRequestData",
          "v2.case_comment" => "CaseComment",
          "v2.case_comment_attributes" => "CaseCommentAttributes",
          "v2.case_comment_request" => "CaseCommentRequest",
          "v2.case_count_group" => "CaseCountGroup",
          "v2.case_count_group_value" => "CaseCountGroupValue",
          "v2.case_count_response" => "CaseCountResponse",
          "v2.case_count_response_attributes" => "CaseCountResponseAttributes",
          "v2.case_count_response_data" => "CaseCountResponseData",
          ...
          "v2.case_insight" => "CaseInsight",
          "v2.case_insights_attributes" => "CaseInsightsAttributes",
          "v2.case_insights_data" => "CaseInsightsData",
          "v2.case_insights_items" => "CaseInsightsItems",
          "v2.case_insights_request" => "CaseInsightsRequest",
          "v2.case_insight_type" => "CaseInsightType",
          "v2.case_link" => "CaseLink",
          "v2.case_link_attributes" => "CaseLinkAttributes",
          "v2.case_link_create" => "CaseLinkCreate",
          "v2.case_link_create_request" => "CaseLinkCreateRequest",
          "v2.case_link_resource_type" => "CaseLinkResourceType",
          "v2.case_link_response" => "CaseLinkResponse",
          "v2.case_links_response" => "CaseLinksResponse",
          ...
          "v2.case_notification_rule" => "CaseNotificationRule",
          "v2.case_notification_rule_attributes" => "CaseNotificationRuleAttributes",
          "v2.case_notification_rule_create" => "CaseNotificationRuleCreate",
          "v2.case_notification_rule_create_attributes" => "CaseNotificationRuleCreateAttributes",
          "v2.case_notification_rule_create_request" => "CaseNotificationRuleCreateRequest",
          "v2.case_notification_rule_recipient" => "CaseNotificationRuleRecipient",
          "v2.case_notification_rule_recipient_data" => "CaseNotificationRuleRecipientData",
          "v2.case_notification_rule_resource_type" => "CaseNotificationRuleResourceType",
          "v2.case_notification_rule_response" => "CaseNotificationRuleResponse",
          "v2.case_notification_rules_response" => "CaseNotificationRulesResponse",
          "v2.case_notification_rule_trigger" => "CaseNotificationRuleTrigger",
          "v2.case_notification_rule_trigger_data" => "CaseNotificationRuleTriggerData",
          "v2.case_notification_rule_update" => "CaseNotificationRuleUpdate",
          "v2.case_notification_rule_update_request" => "CaseNotificationRuleUpdateRequest",
          ...
          "v2.case_type_create" => "CaseTypeCreate",
          "v2.case_type_create_request" => "CaseTypeCreateRequest",
          "v2.case_type_resource" => "CaseTypeResource",
          "v2.case_type_resource_attributes" => "CaseTypeResourceAttributes",
          "v2.case_type_resource_type" => "CaseTypeResourceType",
          "v2.case_type_response" => "CaseTypeResponse",
          "v2.case_types_response" => "CaseTypesResponse",
          "v2.case_type_update" => "CaseTypeUpdate",
          "v2.case_type_update_request" => "CaseTypeUpdateRequest",
          ...
          "v2.case_update_comment" => "CaseUpdateComment",
          "v2.case_update_comment_attributes" => "CaseUpdateCommentAttributes",
          "v2.case_update_comment_request" => "CaseUpdateCommentRequest",
          "v2.case_update_custom_attribute" => "CaseUpdateCustomAttribute",
          "v2.case_update_custom_attribute_request" => "CaseUpdateCustomAttributeRequest",
          "v2.case_update_description" => "CaseUpdateDescription",
          "v2.case_update_description_attributes" => "CaseUpdateDescriptionAttributes",
          "v2.case_update_description_request" => "CaseUpdateDescriptionRequest",
          "v2.case_update_due_date" => "CaseUpdateDueDate",
          "v2.case_update_due_date_attributes" => "CaseUpdateDueDateAttributes",
          "v2.case_update_due_date_request" => "CaseUpdateDueDateRequest",
          ...
          "v2.case_update_resolved_reason" => "CaseUpdateResolvedReason",
          "v2.case_update_resolved_reason_attributes" => "CaseUpdateResolvedReasonAttributes",
          ...
          "v2.case_update_title" => "CaseUpdateTitle",
          "v2.case_update_title_attributes" => "CaseUpdateTitleAttributes",
          "v2.case_update_title_request" => "CaseUpdateTitleRequest",
          "v2.case_view" => "CaseView",
          "v2.case_view_attributes" => "CaseViewAttributes",
          "v2.case_view_create" => "CaseViewCreate",
          "v2.case_view_create_attributes" => "CaseViewCreateAttributes",
          "v2.case_view_create_request" => "CaseViewCreateRequest",
          "v2.case_view_relationships" => "CaseViewRelationships",
          "v2.case_view_resource_type" => "CaseViewResourceType",
          "v2.case_view_response" => "CaseViewResponse",
          "v2.case_views_response" => "CaseViewsResponse",
          "v2.case_view_update" => "CaseViewUpdate",
          "v2.case_view_update_attributes" => "CaseViewUpdateAttributes",
          "v2.case_view_update_request" => "CaseViewUpdateRequest",
          "v2.case_watcher" => "CaseWatcher",
          "v2.case_watcher_relationships" => "CaseWatcherRelationships",
          "v2.case_watcher_resource_type" => "CaseWatcherResourceType",
          "v2.case_watchers_response" => "CaseWatchersResponse",
          ...
          "v2.change_request_branch_create_attributes" => "ChangeRequestBranchCreateAttributes",
          "v2.change_request_branch_create_data" => "ChangeRequestBranchCreateData",
          "v2.change_request_branch_create_request" => "ChangeRequestBranchCreateRequest",
          "v2.change_request_branch_resource_type" => "ChangeRequestBranchResourceType",
          "v2.change_request_change_type" => "ChangeRequestChangeType",
          "v2.change_request_create_attributes" => "ChangeRequestCreateAttributes",
          "v2.change_request_create_data" => "ChangeRequestCreateData",
          "v2.change_request_create_request" => "ChangeRequestCreateRequest",
          "v2.change_request_decision_create_attributes" => "ChangeRequestDecisionCreateAttributes",
          "v2.change_request_decision_create_item" => "ChangeRequestDecisionCreateItem",
          "v2.change_request_decision_create_relationships" => "ChangeRequestDecisionCreateRelationships",
          "v2.change_request_decision_relationship_data" => "ChangeRequestDecisionRelationshipData",
          "v2.change_request_decision_relationships" => "ChangeRequestDecisionRelationships",
          "v2.change_request_decision_resource_type" => "ChangeRequestDecisionResourceType",
          "v2.change_request_decision_response_attributes" => "ChangeRequestDecisionResponseAttributes",
          "v2.change_request_decisions_relationship" => "ChangeRequestDecisionsRelationship",
          "v2.change_request_decision_status_type" => "ChangeRequestDecisionStatusType",
          "v2.change_request_decision_update_data" => "ChangeRequestDecisionUpdateData",
          "v2.change_request_decision_update_data_attributes" => "ChangeRequestDecisionUpdateDataAttributes",
          "v2.change_request_decision_update_data_relationships" => "ChangeRequestDecisionUpdateDataRelationships",
          "v2.change_request_decision_update_request" => "ChangeRequestDecisionUpdateRequest",
          "v2.change_request_included_decision" => "ChangeRequestIncludedDecision",
          "v2.change_request_included_item" => "ChangeRequestIncludedItem",
          "v2.change_request_included_user" => "ChangeRequestIncludedUser",
          "v2.change_request_included_user_attributes" => "ChangeRequestIncludedUserAttributes",
          "v2.change_request_relationships" => "ChangeRequestRelationships",
          "v2.change_request_resource_type" => "ChangeRequestResourceType",
          "v2.change_request_response" => "ChangeRequestResponse",
          "v2.change_request_response_attributes" => "ChangeRequestResponseAttributes",
          "v2.change_request_response_data" => "ChangeRequestResponseData",
          "v2.change_request_risk_level" => "ChangeRequestRiskLevel",
          "v2.change_request_update_attributes" => "ChangeRequestUpdateAttributes",
          "v2.change_request_update_data" => "ChangeRequestUpdateData",
          "v2.change_request_update_relationships" => "ChangeRequestUpdateRelationships",
          "v2.change_request_update_request" => "ChangeRequestUpdateRequest",
          "v2.change_request_user_relationship" => "ChangeRequestUserRelationship",
          "v2.change_request_user_relationship_data" => "ChangeRequestUserRelationshipData",
          ...
          "v2.clone_form_data" => "CloneFormData",
          "v2.clone_form_data_attributes" => "CloneFormDataAttributes",
          "v2.clone_form_request" => "CloneFormRequest",
          ...
          "v2.cloud_inventory_cloud_provider_id" => "CloudInventoryCloudProviderId",
          "v2.cloud_inventory_cloud_provider_request_type" => "CloudInventoryCloudProviderRequestType",
          "v2.cloud_inventory_sync_config_attributes" => "CloudInventorySyncConfigAttributes",
          "v2.cloud_inventory_sync_config_aws_request_attributes" => "CloudInventorySyncConfigAWSRequestAttributes",
          "v2.cloud_inventory_sync_config_azure_request_attributes" => "CloudInventorySyncConfigAzureRequestAttributes",
          "v2.cloud_inventory_sync_config_gcp_request_attributes" => "CloudInventorySyncConfigGCPRequestAttributes",
          "v2.cloud_inventory_sync_config_resource_type" => "CloudInventorySyncConfigResourceType",
          "v2.cloud_inventory_sync_config_response" => "CloudInventorySyncConfigResponse",
          "v2.cloud_inventory_sync_config_response_data" => "CloudInventorySyncConfigResponseData",
          ...
          "v2.cloud_workload_security_agent_rule_action_core_dump" => "CloudWorkloadSecurityAgentRuleActionCoreDump",
          "v2.cloud_workload_security_agent_rule_action_hash" => "CloudWorkloadSecurityAgentRuleActionHash",
          "v2.cloud_workload_security_agent_rule_action_log" => "CloudWorkloadSecurityAgentRuleActionLog",
          "v2.cloud_workload_security_agent_rule_action_metadata" => "CloudWorkloadSecurityAgentRuleActionMetadata",
          "v2.cloud_workload_security_agent_rule_action_network_filter" => "CloudWorkloadSecurityAgentRuleActionNetworkFilter",
          ...
          "v2.commit_coverage_summary_request" => "CommitCoverageSummaryRequest",
          "v2.commit_coverage_summary_request_attributes" => "CommitCoverageSummaryRequestAttributes",
          "v2.commit_coverage_summary_request_data" => "CommitCoverageSummaryRequestData",
          "v2.commit_coverage_summary_request_type" => "CommitCoverageSummaryRequestType",
          "v2.commitments_aws_ec2_ri_commitment" => "CommitmentsAwsEC2RICommitment",
          "v2.commitments_aws_elasticache_ri_commitment" => "CommitmentsAwsElasticacheRICommitment",
          "v2.commitments_aws_rdsri_commitment" => "CommitmentsAwsRDSRICommitment",
          "v2.commitments_aws_sp_commitment" => "CommitmentsAwsSPCommitment",
          "v2.commitments_azure_compute_sp_commitment" => "CommitmentsAzureComputeSPCommitment",
          "v2.commitments_azure_vmri_commitment" => "CommitmentsAzureVMRICommitment",
          "v2.commitments_azure_vmri_status" => "CommitmentsAzureVMRIStatus",
          "v2.commitments_commitment_type" => "CommitmentsCommitmentType",
          "v2.commitments_coverage_scalar_response" => "CommitmentsCoverageScalarResponse",
          "v2.commitments_coverage_timeseries_response" => "CommitmentsCoverageTimeseriesResponse",
          "v2.commitments_list_item" => "CommitmentsListItem",
          "v2.commitments_list_meta" => "CommitmentsListMeta",
          "v2.commitments_list_response" => "CommitmentsListResponse",
          "v2.commitments_on_demand_hotspots_scalar_meta" => "CommitmentsOnDemandHotspotsScalarMeta",
          "v2.commitments_on_demand_hotspots_scalar_response" => "CommitmentsOnDemandHotspotsScalarResponse",
          "v2.commitments_provider" => "CommitmentsProvider",
          "v2.commitments_savings_scalar_response" => "CommitmentsSavingsScalarResponse",
          "v2.commitments_savings_timeseries_response" => "CommitmentsSavingsTimeseriesResponse",
          "v2.commitments_scalar_column" => "CommitmentsScalarColumn",
          "v2.commitments_scalar_column_meta" => "CommitmentsScalarColumnMeta",
          "v2.commitments_scalar_column_type" => "CommitmentsScalarColumnType",
          "v2.commitments_timeseries_metric" => "CommitmentsTimeseriesMetric",
          "v2.commitments_unit" => "CommitmentsUnit",
          "v2.commitments_utilization_scalar_product_breakdown_entry" => "CommitmentsUtilizationScalarProductBreakdownEntry",
          "v2.commitments_utilization_scalar_response" => "CommitmentsUtilizationScalarResponse",
          "v2.commitments_utilization_timeseries_response" => "CommitmentsUtilizationTimeseriesResponse",
          ...
          "v2.condition_operator" => "ConditionOperator",
          "v2.condition_request" => "ConditionRequest",
          ...
          "v2.container_data_source" => "ContainerDataSource",
          ...
          "v2.container_scalar_query" => "ContainerScalarQuery",
          "v2.containers_response" => "ContainersResponse",
          "v2.containers_response_links" => "ContainersResponseLinks",
          "v2.container_timeseries_query" => "ContainerTimeseriesQuery",
          "v2.container_type" => "ContainerType",
          "v2.content_encoding" => "ContentEncoding",
          "v2.control_notification_event_setting" => "ControlNotificationEventSetting",
          "v2.control_notification_settings_attributes" => "ControlNotificationSettingsAttributes",
          "v2.control_notification_settings_data" => "ControlNotificationSettingsData",
          ...
          "v2.control_notification_settings_update_attributes" => "ControlNotificationSettingsUpdateAttributes",
          "v2.control_notification_settings_update_data" => "ControlNotificationSettingsUpdateData",
          "v2.control_notification_settings_update_request" => "ControlNotificationSettingsUpdateRequest",
          "v2.control_notification_target" => "ControlNotificationTarget",
          "v2.control_notification_target_type" => "ControlNotificationTargetType",
          ...
          "v2.cost_currency" => "CostCurrency",
          "v2.cost_currency_response" => "CostCurrencyResponse",
          "v2.cost_currency_type" => "CostCurrencyType",
          "v2.cost_metric" => "CostMetric",
          "v2.cost_metrics_response" => "CostMetricsResponse",
          "v2.cost_metric_type" => "CostMetricType",
          "v2.cost_orchestrator" => "CostOrchestrator",
          "v2.cost_orchestrators_response" => "CostOrchestratorsResponse",
          "v2.cost_orchestrator_type" => "CostOrchestratorType",
          "v2.cost_recommendation_array" => "CostRecommendationArray",
          "v2.cost_recommendation_data" => "CostRecommendationData",
          "v2.cost_recommendation_data_attributes" => "CostRecommendationDataAttributes",
          "v2.cost_recommendation_data_attributes_potential_daily_savings" => "CostRecommendationDataAttributesPotentialDailySavings",
          "v2.cost_recommendation_data_type" => "CostRecommendationDataType",
          "v2.cost_tag" => "CostTag",
          ...
          "v2.cost_tag_description_response" => "CostTagDescriptionResponse",
          ...
          "v2.cost_tag_description_upsert_request" => "CostTagDescriptionUpsertRequest",
          "v2.cost_tag_description_upsert_request_data" => "CostTagDescriptionUpsertRequestData",
          "v2.cost_tag_description_upsert_request_data_attributes" => "CostTagDescriptionUpsertRequestDataAttributes",
          "v2.cost_tag_key" => "CostTagKey",
          "v2.cost_tag_key_attributes" => "CostTagKeyAttributes",
          "v2.cost_tag_key_details" => "CostTagKeyDetails",
          "v2.cost_tag_key_metadata" => "CostTagKeyMetadata",
          "v2.cost_tag_key_metadata_attributes" => "CostTagKeyMetadataAttributes",
          "v2.cost_tag_key_metadata_response" => "CostTagKeyMetadataResponse",
          "v2.cost_tag_key_metadata_type" => "CostTagKeyMetadataType",
          "v2.cost_tag_key_response" => "CostTagKeyResponse",
          "v2.cost_tag_key_source" => "CostTagKeySource",
          "v2.cost_tag_key_source_attributes" => "CostTagKeySourceAttributes",
          "v2.cost_tag_key_sources_response" => "CostTagKeySourcesResponse",
          "v2.cost_tag_key_source_type" => "CostTagKeySourceType",
          ...
          "v2.coverage_summary_response" => "CoverageSummaryResponse",
          "v2.coverage_summary_service_stats" => "CoverageSummaryServiceStats",
          "v2.coverage_summary_type" => "CoverageSummaryType",
          "v2.cpu" => "Cpu",
          ...
          "v2.create_allocations_request" => "CreateAllocationsRequest",
          ...
          "v2.create_backfilled_degradation_request" => "CreateBackfilledDegradationRequest",
          "v2.create_backfilled_degradation_request_data" => "CreateBackfilledDegradationRequestData",
          "v2.create_backfilled_degradation_request_data_attributes" => "CreateBackfilledDegradationRequestDataAttributes",
          "v2.create_backfilled_degradation_request_data_attributes_updates_items" => "CreateBackfilledDegradationRequestDataAttributesUpdatesItems",
          "v2.create_backfilled_degradation_request_data_relationships" => "CreateBackfilledDegradationRequestDataRelationships",
          "v2.create_backfilled_degradation_request_data_relationships_template" => "CreateBackfilledDegradationRequestDataRelationshipsTemplate",
          "v2.create_backfilled_degradation_request_data_relationships_template_data" => "CreateBackfilledDegradationRequestDataRelationshipsTemplateData",
          "v2.create_backfilled_maintenance_request" => "CreateBackfilledMaintenanceRequest",
          "v2.create_backfilled_maintenance_request_data" => "CreateBackfilledMaintenanceRequestData",
          "v2.create_backfilled_maintenance_request_data_attributes" => "CreateBackfilledMaintenanceRequestDataAttributes",
          "v2.create_backfilled_maintenance_request_data_attributes_updates_items" => "CreateBackfilledMaintenanceRequestDataAttributesUpdatesItems",
          "v2.create_backfilled_maintenance_request_data_relationships" => "CreateBackfilledMaintenanceRequestDataRelationships",
          "v2.create_backfilled_maintenance_request_data_relationships_template" => "CreateBackfilledMaintenanceRequestDataRelationshipsTemplate",
          "v2.create_backfilled_maintenance_request_data_relationships_template_data" => "CreateBackfilledMaintenanceRequestDataRelationshipsTemplateData",
          "v2.create_campaign_request" => "CreateCampaignRequest",
          "v2.create_campaign_request_attributes" => "CreateCampaignRequestAttributes",
          "v2.create_campaign_request_data" => "CreateCampaignRequestData",
          ...
          "v2.create_component_request" => "CreateComponentRequest",
          "v2.create_component_request_data" => "CreateComponentRequestData",
          "v2.create_component_request_data_attributes" => "CreateComponentRequestDataAttributes",
          "v2.create_component_request_data_attributes_components_items" => "CreateComponentRequestDataAttributesComponentsItems",
          "v2.create_component_request_data_attributes_type" => "CreateComponentRequestDataAttributesType",
          "v2.create_component_request_data_relationships" => "CreateComponentRequestDataRelationships",
          "v2.create_component_request_data_relationships_group" => "CreateComponentRequestDataRelationshipsGroup",
          "v2.create_component_request_data_relationships_group_data" => "CreateComponentRequestDataRelationshipsGroupData",
          ...
          "v2.create_degradation_request" => "CreateDegradationRequest",
          "v2.create_degradation_request_data" => "CreateDegradationRequestData",
          "v2.create_degradation_request_data_attributes" => "CreateDegradationRequestDataAttributes",
          "v2.create_degradation_request_data_attributes_components_affected_items" => "CreateDegradationRequestDataAttributesComponentsAffectedItems",
          "v2.create_degradation_request_data_attributes_status" => "CreateDegradationRequestDataAttributesStatus",
          "v2.create_degradation_request_data_relationships" => "CreateDegradationRequestDataRelationships",
          "v2.create_degradation_request_data_relationships_template" => "CreateDegradationRequestDataRelationshipsTemplate",
          "v2.create_degradation_request_data_relationships_template_data" => "CreateDegradationRequestDataRelationshipsTemplateData",
          "v2.create_degradation_template_request" => "CreateDegradationTemplateRequest",
          "v2.create_degradation_template_request_data" => "CreateDegradationTemplateRequestData",
          "v2.create_degradation_template_request_data_attributes" => "CreateDegradationTemplateRequestDataAttributes",
          "v2.create_degradation_template_request_data_attributes_components_affected_items" => "CreateDegradationTemplateRequestDataAttributesComponentsAffectedItems",
          "v2.create_degradation_template_request_data_attributes_updates_items" => "CreateDegradationTemplateRequestDataAttributesUpdatesItems",
          ...
          "v2.create_environment_attributes" => "CreateEnvironmentAttributes",
          "v2.create_environment_data" => "CreateEnvironmentData",
          "v2.create_environment_data_type" => "CreateEnvironmentDataType",
          "v2.create_environment_request" => "CreateEnvironmentRequest",
          "v2.create_feature_flag_attributes" => "CreateFeatureFlagAttributes",
          ...
          "v2.create_feature_flag_staleness_status" => "CreateFeatureFlagStalenessStatus",
          "v2.create_form_data" => "CreateFormData",
          "v2.create_form_data_attributes" => "CreateFormDataAttributes",
          "v2.create_form_request" => "CreateFormRequest",
          ...
          "v2.create_linear_issue_request_array" => "CreateLinearIssueRequestArray",
          "v2.create_linear_issue_request_data" => "CreateLinearIssueRequestData",
          "v2.create_linear_issue_request_data_attributes" => "CreateLinearIssueRequestDataAttributes",
          "v2.create_linear_issue_request_data_relationships" => "CreateLinearIssueRequestDataRelationships",
          "v2.create_maintenance_request" => "CreateMaintenanceRequest",
          "v2.create_maintenance_request_data" => "CreateMaintenanceRequestData",
          "v2.create_maintenance_request_data_attributes" => "CreateMaintenanceRequestDataAttributes",
          "v2.create_maintenance_request_data_attributes_components_affected_items" => "CreateMaintenanceRequestDataAttributesComponentsAffectedItems",
          "v2.create_maintenance_request_data_attributes_updates_items_status" => "CreateMaintenanceRequestDataAttributesUpdatesItemsStatus",
          "v2.create_maintenance_request_data_relationships" => "CreateMaintenanceRequestDataRelationships",
          "v2.create_maintenance_request_data_relationships_template" => "CreateMaintenanceRequestDataRelationshipsTemplate",
          "v2.create_maintenance_request_data_relationships_template_data" => "CreateMaintenanceRequestDataRelationshipsTemplateData",
          "v2.create_maintenance_template_request" => "CreateMaintenanceTemplateRequest",
          "v2.create_maintenance_template_request_data" => "CreateMaintenanceTemplateRequestData",
          "v2.create_maintenance_template_request_data_attributes" => "CreateMaintenanceTemplateRequestDataAttributes",
          ...
          "v2.create_publish_request_request" => "CreatePublishRequestRequest",
          "v2.create_publish_request_request_data" => "CreatePublishRequestRequestData",
          "v2.create_publish_request_request_data_attributes" => "CreatePublishRequestRequestDataAttributes",
          ...
          "v2.create_status_page_request_data_attributes_components_items" => "CreateStatusPageRequestDataAttributesComponentsItems",
          "v2.create_status_page_request_data_attributes_components_items_components_items" => "CreateStatusPageRequestDataAttributesComponentsItemsComponentsItems",
          "v2.create_status_page_request_data_attributes_type" => "CreateStatusPageRequestDataAttributesType",
          "v2.create_status_page_request_data_attributes_visualization_type" => "CreateStatusPageRequestDataAttributesVisualizationType",
          "v2.create_table_request" => "CreateTableRequest",
          "v2.create_table_request_data" => "CreateTableRequestData",
          "v2.create_table_request_data_attributes" => "CreateTableRequestDataAttributes",
          "v2.create_table_request_data_attributes_file_metadata" => "CreateTableRequestDataAttributesFileMetadata",
          "v2.create_table_request_data_attributes_file_metadata_cloud_storage" => "CreateTableRequestDataAttributesFileMetadataCloudStorage",
          "v2.create_table_request_data_attributes_file_metadata_local_file" => "CreateTableRequestDataAttributesFileMetadataLocalFile",
          "v2.create_table_request_data_attributes_file_metadata_one_of_access_details" => "CreateTableRequestDataAttributesFileMetadataOneOfAccessDetails",
          "v2.create_table_request_data_attributes_file_metadata_one_of_access_details_aws_detail" => "CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsAwsDetail",
          "v2.create_table_request_data_attributes_file_metadata_one_of_access_details_azure_detail" => "CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsAzureDetail",
          "v2.create_table_request_data_attributes_file_metadata_one_of_access_details_gcp_detail" => "CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail",
          "v2.create_table_request_data_attributes_schema" => "CreateTableRequestDataAttributesSchema",
          "v2.create_table_request_data_attributes_schema_fields_items" => "CreateTableRequestDataAttributesSchemaFieldsItems",
          "v2.create_table_request_data_type" => "CreateTableRequestDataType",
          "v2.create_tenancy_config_data" => "CreateTenancyConfigData",
          "v2.create_tenancy_config_data_attributes" => "CreateTenancyConfigDataAttributes",
          "v2.create_tenancy_config_data_attributes_auth_credentials" => "CreateTenancyConfigDataAttributesAuthCredentials",
          "v2.create_tenancy_config_data_attributes_logs_config" => "CreateTenancyConfigDataAttributesLogsConfig",
          "v2.create_tenancy_config_data_attributes_metrics_config" => "CreateTenancyConfigDataAttributesMetricsConfig",
          "v2.create_tenancy_config_data_attributes_regions_config" => "CreateTenancyConfigDataAttributesRegionsConfig",
          "v2.create_tenancy_config_request" => "CreateTenancyConfigRequest",
          "v2.create_upload_request" => "CreateUploadRequest",
          "v2.create_upload_request_data" => "CreateUploadRequestData",
          "v2.create_upload_request_data_attributes" => "CreateUploadRequestDataAttributes",
          "v2.create_upload_request_data_type" => "CreateUploadRequestDataType",
          "v2.create_upload_response" => "CreateUploadResponse",
          ...
          "v2.create_variant" => "CreateVariant",
          ...
          "v2.custom_attribute_config_create_request" => "CustomAttributeConfigCreateRequest",
          "v2.custom_attribute_config_resource_attributes" => "CustomAttributeConfigResourceAttributes",
          "v2.custom_attribute_config_resource_type" => "CustomAttributeConfigResourceType",
          "v2.custom_attribute_config_response" => "CustomAttributeConfigResponse",
          "v2.custom_attribute_configs_response" => "CustomAttributeConfigsResponse",
          "v2.custom_attribute_config_update" => "CustomAttributeConfigUpdate",
          "v2.custom_attribute_config_update_attributes" => "CustomAttributeConfigUpdateAttributes",
          "v2.custom_attribute_config_update_request" => "CustomAttributeConfigUpdateRequest",
          "v2.custom_attribute_select_option" => "CustomAttributeSelectOption",
          "v2.custom_attribute_type" => "CustomAttributeType",
          "v2.custom_attribute_type_data" => "CustomAttributeTypeData",
          "v2.custom_attribute_value" => "CustomAttributeValue",
          "v2.custom_attribute_values_union" => "CustomAttributeValuesUnion",
          ...
          "v2.custom_rule_attributes" => "CustomRuleAttributes",
          "v2.custom_rule_data_type" => "CustomRuleDataType",
          "v2.custom_rule_request" => "CustomRuleRequest",
          "v2.custom_rule_request_data" => "CustomRuleRequestData",
          "v2.custom_rule_request_data_attributes" => "CustomRuleRequestDataAttributes",
          "v2.custom_rule_response" => "CustomRuleResponse",
          "v2.custom_rule_response_data" => "CustomRuleResponseData",
          "v2.custom_rule_revision" => "CustomRuleRevision",
          "v2.custom_rule_revision_attributes" => "CustomRuleRevisionAttributes",
          "v2.custom_rule_revision_attributes_category" => "CustomRuleRevisionAttributesCategory",
          "v2.custom_rule_revision_attributes_severity" => "CustomRuleRevisionAttributesSeverity",
          "v2.custom_rule_revision_data_type" => "CustomRuleRevisionDataType",
          "v2.custom_rule_revision_embedded" => "CustomRuleRevisionEmbedded",
          "v2.custom_rule_revision_input" => "CustomRuleRevisionInput",
          "v2.custom_rule_revision_input_attributes" => "CustomRuleRevisionInputAttributes",
          "v2.custom_rule_revision_request" => "CustomRuleRevisionRequest",
          "v2.custom_rule_revision_request_data" => "CustomRuleRevisionRequestData",
          "v2.custom_rule_revision_response" => "CustomRuleRevisionResponse",
          "v2.custom_rule_revisions_response" => "CustomRuleRevisionsResponse",
          "v2.custom_rule_revision_test" => "CustomRuleRevisionTest",
          "v2.custom_ruleset" => "CustomRuleset",
          "v2.custom_ruleset_attributes" => "CustomRulesetAttributes",
          "v2.custom_ruleset_data_type" => "CustomRulesetDataType",
          "v2.custom_ruleset_list_response" => "CustomRulesetListResponse",
          "v2.custom_ruleset_request" => "CustomRulesetRequest",
          "v2.custom_ruleset_request_data" => "CustomRulesetRequestData",
          ...
          "v2.custom_ruleset_rule_embedded" => "CustomRulesetRuleEmbedded",
          "v2.cvss" => "CVSS",
          ...
          "v2.dashboard_usage" => "DashboardUsage",
          "v2.dashboard_usage_attributes" => "DashboardUsageAttributes",
          ...
          "v2.databricks_cloud_cost_metrics_integration_dataflow_request" => "DatabricksCloudCostMetricsIntegrationDataflowRequest",
          "v2.databricks_cloud_cost_metrics_integration_dataflow_response" => "DatabricksCloudCostMetricsIntegrationDataflowResponse",
          "v2.databricks_cloud_cost_metrics_integration_dataflow_settings_request" => "DatabricksCloudCostMetricsIntegrationDataflowSettingsRequest",
          "v2.databricks_cloud_cost_metrics_integration_dataflow_settings_response" => "DatabricksCloudCostMetricsIntegrationDataflowSettingsResponse",
          "v2.databricks_data_observability_jobs_monitoring_integration_dataflow_request" => "DatabricksDataObservabilityJobsMonitoringIntegrationDataflowRequest",
          "v2.databricks_data_observability_jobs_monitoring_integration_dataflow_response" => "DatabricksDataObservabilityJobsMonitoringIntegrationDataflowResponse",
          "v2.databricks_data_observability_jobs_monitoring_integration_dataflow_settings_request" => "DatabricksDataObservabilityJobsMonitoringIntegrationDataflowSettingsRequest",
          "v2.databricks_data_observability_jobs_monitoring_integration_dataflow_settings_response" => "DatabricksDataObservabilityJobsMonitoringIntegrationDataflowSettingsResponse",
          "v2.databricks_data_observability_quality_monitoring_integration_dataflow_request" => "DatabricksDataObservabilityQualityMonitoringIntegrationDataflowRequest",
          "v2.databricks_data_observability_quality_monitoring_integration_dataflow_response" => "DatabricksDataObservabilityQualityMonitoringIntegrationDataflowResponse",
          "v2.databricks_data_observability_quality_monitoring_integration_dataflow_settings_request" => "DatabricksDataObservabilityQualityMonitoringIntegrationDataflowSettingsRequest",
          "v2.databricks_data_observability_quality_monitoring_integration_dataflow_settings_response" => "DatabricksDataObservabilityQualityMonitoringIntegrationDataflowSettingsResponse",
          "v2.databricks_integration_account_authentication_request" => "DatabricksIntegrationAccountAuthenticationRequest",
          "v2.databricks_integration_account_authentication_response" => "DatabricksIntegrationAccountAuthenticationResponse",
          "v2.databricks_integration_account_authentication_update" => "DatabricksIntegrationAccountAuthenticationUpdate",
          "v2.databricks_integration_account_bearer_token_auth_response" => "DatabricksIntegrationAccountBearerTokenAuthResponse",
          "v2.databricks_integration_account_bearer_token_auth_type" => "DatabricksIntegrationAccountBearerTokenAuthType",
          "v2.databricks_integration_account_bearer_token_auth_update" => "DatabricksIntegrationAccountBearerTokenAuthUpdate",
          "v2.databricks_integration_account_create_attributes" => "DatabricksIntegrationAccountCreateAttributes",
          "v2.databricks_integration_account_create_data" => "DatabricksIntegrationAccountCreateData",
          "v2.databricks_integration_account_create_request" => "DatabricksIntegrationAccountCreateRequest",
          "v2.databricks_integration_account_o_auth_auth_request" => "DatabricksIntegrationAccountOAuthAuthRequest",
          "v2.databricks_integration_account_o_auth_auth_response" => "DatabricksIntegrationAccountOAuthAuthResponse",
          "v2.databricks_integration_account_o_auth_auth_type" => "DatabricksIntegrationAccountOAuthAuthType",
          "v2.databricks_integration_account_o_auth_auth_update" => "DatabricksIntegrationAccountOAuthAuthUpdate",
          "v2.databricks_integration_account_private_action_runner_auth_request" => "DatabricksIntegrationAccountPrivateActionRunnerAuthRequest",
          "v2.databricks_integration_account_private_action_runner_auth_response" => "DatabricksIntegrationAccountPrivateActionRunnerAuthResponse",
          "v2.databricks_integration_account_private_action_runner_auth_type" => "DatabricksIntegrationAccountPrivateActionRunnerAuthType",
          "v2.databricks_integration_account_private_action_runner_auth_update" => "DatabricksIntegrationAccountPrivateActionRunnerAuthUpdate",
          "v2.databricks_integration_account_response" => "DatabricksIntegrationAccountResponse",
          "v2.databricks_integration_account_response_attributes" => "DatabricksIntegrationAccountResponseAttributes",
          "v2.databricks_integration_account_response_data" => "DatabricksIntegrationAccountResponseData",
          "v2.databricks_integration_account_settings_request" => "DatabricksIntegrationAccountSettingsRequest",
          "v2.databricks_integration_account_settings_response" => "DatabricksIntegrationAccountSettingsResponse",
          "v2.databricks_integration_account_settings_update" => "DatabricksIntegrationAccountSettingsUpdate",
          "v2.databricks_integration_accounts_response" => "DatabricksIntegrationAccountsResponse",
          "v2.databricks_integration_account_update_attributes" => "DatabricksIntegrationAccountUpdateAttributes",
          "v2.databricks_integration_account_update_data" => "DatabricksIntegrationAccountUpdateData",
          "v2.databricks_integration_account_update_request" => "DatabricksIntegrationAccountUpdateRequest",
          "v2.databricks_integration_dataflows_request" => "DatabricksIntegrationDataflowsRequest",
          "v2.databricks_integration_dataflows_response" => "DatabricksIntegrationDataflowsResponse",
          "v2.databricks_model_serving_metrics_integration_dataflow_request" => "DatabricksModelServingMetricsIntegrationDataflowRequest",
          "v2.databricks_model_serving_metrics_integration_dataflow_response" => "DatabricksModelServingMetricsIntegrationDataflowResponse",
          ...
          "v2.data_observability_monitor_run_status" => "DataObservabilityMonitorRunStatus",
          "v2.data_observability_monitor_run_type" => "DataObservabilityMonitorRunType",
          ...
          "v2.default_inbox_rule_attributes_response" => "DefaultInboxRuleAttributesResponse",
          "v2.default_inbox_rule_data_response" => "DefaultInboxRuleDataResponse",
          "v2.default_inbox_rule_response" => "DefaultInboxRuleResponse",
          "v2.default_inbox_rules_response" => "DefaultInboxRulesResponse",
          "v2.default_inbox_rule_type" => "DefaultInboxRuleType",
          ...
          "v2.default_rulesets_per_language_response" => "DefaultRulesetsPerLanguageResponse",
          "v2.degradation" => "Degradation",
          "v2.degradation_array" => "DegradationArray",
          "v2.degradation_data" => "DegradationData",
          "v2.degradation_data_attributes" => "DegradationDataAttributes",
          "v2.degradation_data_attributes_components_affected_items" => "DegradationDataAttributesComponentsAffectedItems",
          "v2.degradation_data_attributes_source" => "DegradationDataAttributesSource",
          "v2.degradation_data_attributes_source_type" => "DegradationDataAttributesSourceType",
          "v2.degradation_data_attributes_updates_items" => "DegradationDataAttributesUpdatesItems",
          "v2.degradation_data_attributes_updates_items_components_affected_items" => "DegradationDataAttributesUpdatesItemsComponentsAffectedItems",
          "v2.degradation_data_relationships" => "DegradationDataRelationships",
          "v2.degradation_data_relationships_created_by_user" => "DegradationDataRelationshipsCreatedByUser",
          "v2.degradation_data_relationships_created_by_user_data" => "DegradationDataRelationshipsCreatedByUserData",
          "v2.degradation_data_relationships_last_modified_by_user" => "DegradationDataRelationshipsLastModifiedByUser",
          "v2.degradation_data_relationships_last_modified_by_user_data" => "DegradationDataRelationshipsLastModifiedByUserData",
          ...
          "v2.degradation_template_data_attributes" => "DegradationTemplateDataAttributes",
          "v2.degradation_template_data_attributes_components_affected_items" => "DegradationTemplateDataAttributesComponentsAffectedItems",
          "v2.degradation_template_data_attributes_updates_items" => "DegradationTemplateDataAttributesUpdatesItems",
          "v2.degradation_template_data_relationships" => "DegradationTemplateDataRelationships",
          "v2.degradation_template_data_relationships_created_by_user" => "DegradationTemplateDataRelationshipsCreatedByUser",
          "v2.degradation_template_data_relationships_created_by_user_data" => "DegradationTemplateDataRelationshipsCreatedByUserData",
          "v2.degradation_template_data_relationships_last_modified_by_user" => "DegradationTemplateDataRelationshipsLastModifiedByUser",
          "v2.degradation_template_data_relationships_last_modified_by_user_data" => "DegradationTemplateDataRelationshipsLastModifiedByUserData",
          "v2.degradation_template_data_relationships_status_page" => "DegradationTemplateDataRelationshipsStatusPage",
          "v2.degradation_template_data_relationships_status_page_data" => "DegradationTemplateDataRelationshipsStatusPageData",
          ...
          "v2.deleted_test_response_data" => "DeletedTestResponseData",
          "v2.deleted_test_response_data_attributes" => "DeletedTestResponseDataAttributes",
          "v2.deleted_tests_request_delete" => "DeletedTestsRequestDelete",
          "v2.deleted_tests_request_delete_attributes" => "DeletedTestsRequestDeleteAttributes",
          "v2.deleted_tests_request_delete_request" => "DeletedTestsRequestDeleteRequest",
          "v2.deleted_tests_request_type" => "DeletedTestsRequestType",
          "v2.deleted_tests_response" => "DeletedTestsResponse",
          "v2.deleted_tests_response_type" => "DeletedTestsResponseType",
          "v2.delete_form_data" => "DeleteFormData",
          "v2.delete_form_response" => "DeleteFormResponse",
          "v2.dem_batch_get_journeys_attributes" => "DemBatchGetJourneysAttributes",
          "v2.dem_batch_get_journeys_data" => "DemBatchGetJourneysData",
          "v2.dem_batch_get_journeys_request" => "DemBatchGetJourneysRequest",
          "v2.dem_batch_get_journeys_request_type" => "DemBatchGetJourneysRequestType",
          "v2.dem_create_journey_test_suite_attributes" => "DemCreateJourneyTestSuiteAttributes",
          "v2.dem_create_journey_test_suite_data" => "DemCreateJourneyTestSuiteData",
          "v2.dem_create_journey_test_suite_request" => "DemCreateJourneyTestSuiteRequest",
          "v2.dem_create_journey_test_suite_request_type" => "DemCreateJourneyTestSuiteRequestType",
          "v2.dem_inferred_journey_candidate_attributes" => "DemInferredJourneyCandidateAttributes",
          "v2.dem_inferred_journey_candidate_data" => "DemInferredJourneyCandidateData",
          "v2.dem_inferred_journey_ignored_attributes" => "DemInferredJourneyIgnoredAttributes",
          "v2.dem_inferred_journey_ignored_data" => "DemInferredJourneyIgnoredData",
          "v2.dem_inferred_journey_status" => "DemInferredJourneyStatus",
          "v2.dem_journey_create_attributes" => "DemJourneyCreateAttributes",
          "v2.dem_journey_create_data" => "DemJourneyCreateData",
          "v2.dem_journey_create_request" => "DemJourneyCreateRequest",
          "v2.dem_journey_response" => "DemJourneyResponse",
          "v2.dem_journey_response_attributes" => "DemJourneyResponseAttributes",
          "v2.dem_journey_response_data" => "DemJourneyResponseData",
          "v2.dem_journey_rum" => "DemJourneyRum",
          "v2.dem_journeys_list_response" => "DemJourneysListResponse",
          "v2.dem_journey_test_suite_response" => "DemJourneyTestSuiteResponse",
          "v2.dem_journey_test_suite_response_attributes" => "DemJourneyTestSuiteResponseAttributes",
          "v2.dem_journey_test_suite_response_data" => "DemJourneyTestSuiteResponseData",
          "v2.dem_journey_test_suite_type" => "DemJourneyTestSuiteType",
          "v2.dem_journey_type" => "DemJourneyType",
          "v2.dem_recommended_test_attributes" => "DemRecommendedTestAttributes",
          "v2.dem_recommended_test_data" => "DemRecommendedTestData",
          "v2.dem_recommended_tests_response" => "DemRecommendedTestsResponse",
          "v2.dem_recommended_test_type" => "DemRecommendedTestType",
          "v2.dem_rum_node" => "DemRumNode",
          "v2.dem_rum_step" => "DemRumStep",
          "v2.dem_rum_step_type" => "DemRumStepType",
          "v2.dem_search_inferred_journeys_response" => "DemSearchInferredJourneysResponse",
          "v2.dem_search_inferred_journeys_response_data_item" => "DemSearchInferredJourneysResponse_dataItem",
          "v2.dem_test_suite_nested" => "DemTestSuiteNested",
          "v2.dem_user" => "DemUser",
          "v2.dem_variant" => "DemVariant",
          "v2.dem_variant_attributes" => "DemVariantAttributes",
          "v2.dem_variant_request" => "DemVariantRequest",
          "v2.dem_variant_request_data" => "DemVariantRequestData",
          "v2.dem_variant_response" => "DemVariantResponse",
          "v2.dem_variant_response_data" => "DemVariantResponseData",
          "v2.dem_variant_type" => "DemVariantType",
          ...
          "v2.deployment_gates_evaluation_request_data_type" => "DeploymentGatesEvaluationRequestDataType",
          "v2.deployment_gates_evaluation_response" => "DeploymentGatesEvaluationResponse",
          "v2.deployment_gates_evaluation_response_attributes" => "DeploymentGatesEvaluationResponseAttributes",
          "v2.deployment_gates_evaluation_response_data" => "DeploymentGatesEvaluationResponseData",
          "v2.deployment_gates_evaluation_response_data_type" => "DeploymentGatesEvaluationResponseDataType",
          "v2.deployment_gates_evaluation_result_response" => "DeploymentGatesEvaluationResultResponse",
          "v2.deployment_gates_evaluation_result_response_attributes" => "DeploymentGatesEvaluationResultResponseAttributes",
          ...
          "v2.downtime_run_as_item" => "DowntimeRunAsItem",
          "v2.downtime_run_as_principal" => "DowntimeRunAsPrincipal",
          "v2.downtime_run_as_principal_type" => "DowntimeRunAsPrincipalType",
          ...
          "v2.elastic_cloud_detailed_index_stats_integration_dataflow_request" => "ElasticCloudDetailedIndexStatsIntegrationDataflowRequest",
          "v2.elastic_cloud_detailed_index_stats_integration_dataflow_response" => "ElasticCloudDetailedIndexStatsIntegrationDataflowResponse",
          "v2.elastic_cloud_index_stats_integration_dataflow_request" => "ElasticCloudIndexStatsIntegrationDataflowRequest",
          "v2.elastic_cloud_index_stats_integration_dataflow_response" => "ElasticCloudIndexStatsIntegrationDataflowResponse",
          "v2.elastic_cloud_integration_account_authentication_request" => "ElasticCloudIntegrationAccountAuthenticationRequest",
          "v2.elastic_cloud_integration_account_authentication_response" => "ElasticCloudIntegrationAccountAuthenticationResponse",
          "v2.elastic_cloud_integration_account_authentication_update" => "ElasticCloudIntegrationAccountAuthenticationUpdate",
          "v2.elastic_cloud_integration_account_basic_auth_request" => "ElasticCloudIntegrationAccountBasicAuthRequest",
          "v2.elastic_cloud_integration_account_basic_auth_response" => "ElasticCloudIntegrationAccountBasicAuthResponse",
          "v2.elastic_cloud_integration_account_basic_auth_type" => "ElasticCloudIntegrationAccountBasicAuthType",
          "v2.elastic_cloud_integration_account_basic_auth_update" => "ElasticCloudIntegrationAccountBasicAuthUpdate",
          "v2.elastic_cloud_integration_account_create_attributes" => "ElasticCloudIntegrationAccountCreateAttributes",
          "v2.elastic_cloud_integration_account_create_data" => "ElasticCloudIntegrationAccountCreateData",
          "v2.elastic_cloud_integration_account_create_request" => "ElasticCloudIntegrationAccountCreateRequest",
          "v2.elastic_cloud_integration_account_response" => "ElasticCloudIntegrationAccountResponse",
          "v2.elastic_cloud_integration_account_response_attributes" => "ElasticCloudIntegrationAccountResponseAttributes",
          "v2.elastic_cloud_integration_account_response_data" => "ElasticCloudIntegrationAccountResponseData",
          "v2.elastic_cloud_integration_account_settings_request" => "ElasticCloudIntegrationAccountSettingsRequest",
          "v2.elastic_cloud_integration_account_settings_response" => "ElasticCloudIntegrationAccountSettingsResponse",
          "v2.elastic_cloud_integration_account_settings_update" => "ElasticCloudIntegrationAccountSettingsUpdate",
          "v2.elastic_cloud_integration_accounts_response" => "ElasticCloudIntegrationAccountsResponse",
          "v2.elastic_cloud_integration_account_update_attributes" => "ElasticCloudIntegrationAccountUpdateAttributes",
          "v2.elastic_cloud_integration_account_update_data" => "ElasticCloudIntegrationAccountUpdateData",
          "v2.elastic_cloud_integration_account_update_request" => "ElasticCloudIntegrationAccountUpdateRequest",
          "v2.elastic_cloud_integration_dataflows_request" => "ElasticCloudIntegrationDataflowsRequest",
          "v2.elastic_cloud_integration_dataflows_response" => "ElasticCloudIntegrationDataflowsResponse",
          "v2.elastic_cloud_metrics_integration_dataflow_response" => "ElasticCloudMetricsIntegrationDataflowResponse",
          "v2.elastic_cloud_pending_task_stats_integration_dataflow_request" => "ElasticCloudPendingTaskStatsIntegrationDataflowRequest",
          "v2.elastic_cloud_pending_task_stats_integration_dataflow_response" => "ElasticCloudPendingTaskStatsIntegrationDataflowResponse",
          ...
          "v2.elastic_cloud_primary_shard_graceful_timeout_integration_dataflow_response" => "ElasticCloudPrimaryShardGracefulTimeoutIntegrationDataflowResponse",
          ...
          "v2.elastic_cloud_shard_allocation_stats_integration_dataflow_request" => "ElasticCloudShardAllocationStatsIntegrationDataflowRequest",
          "v2.elastic_cloud_shard_allocation_stats_integration_dataflow_response" => "ElasticCloudShardAllocationStatsIntegrationDataflowResponse",
          "v2.elastic_cloud_slm_stats_integration_dataflow_request" => "ElasticCloudSlmStatsIntegrationDataflowRequest",
          "v2.elastic_cloud_slm_stats_integration_dataflow_response" => "ElasticCloudSlmStatsIntegrationDataflowResponse",
          ...
          "v2.entity_context_entity" => "EntityContextEntity",
          "v2.entity_context_entity_attributes" => "EntityContextEntityAttributes",
          "v2.entity_context_page" => "EntityContextPage",
          "v2.entity_context_response" => "EntityContextResponse",
          "v2.entity_context_response_meta" => "EntityContextResponseMeta",
          "v2.entity_context_revision" => "EntityContextRevision",
          "v2.entity_data" => "EntityData",
          "v2.entity_integration_config_attributes" => "EntityIntegrationConfigAttributes",
          "v2.entity_integration_config_data" => "EntityIntegrationConfigData",
          "v2.entity_integration_config_request" => "EntityIntegrationConfigRequest",
          "v2.entity_integration_config_request_attributes" => "EntityIntegrationConfigRequestAttributes",
          "v2.entity_integration_config_request_data" => "EntityIntegrationConfigRequestData",
          "v2.entity_integration_config_request_type" => "EntityIntegrationConfigRequestType",
          "v2.entity_integration_config_response" => "EntityIntegrationConfigResponse",
          "v2.entity_integration_config_type" => "EntityIntegrationConfigType",
          ...
          "v2.environment_attributes" => "EnvironmentAttributes",
          "v2.environment_response" => "EnvironmentResponse",
          "v2.environments_pagination_meta" => "EnvironmentsPaginationMeta",
          "v2.environments_pagination_meta_page" => "EnvironmentsPaginationMetaPage",
          "v2.epss" => "EPSS",
          ...
          "v2.execution_limit" => "ExecutionLimit",
          "v2.execution_policy_action_pattern" => "ExecutionPolicyActionPattern",
          "v2.execution_policy_attributes" => "ExecutionPolicyAttributes",
          "v2.execution_policy_create_request" => "ExecutionPolicyCreateRequest",
          "v2.execution_policy_create_request_data" => "ExecutionPolicyCreateRequestData",
          "v2.execution_policy_effect" => "ExecutionPolicyEffect",
          "v2.execution_policy_integration" => "ExecutionPolicyIntegration",
          "v2.execution_policy_kubernetes_scope" => "ExecutionPolicyKubernetesScope",
          "v2.execution_policy_kubernetes_scope_rule" => "ExecutionPolicyKubernetesScopeRule",
          "v2.execution_policy_list_response" => "ExecutionPolicyListResponse",
          "v2.execution_policy_list_response_meta" => "ExecutionPolicyListResponseMeta",
          "v2.execution_policy_list_response_page" => "ExecutionPolicyListResponsePage",
          "v2.execution_policy_remote_action_rshell_access" => "ExecutionPolicyRemoteActionRshellAccess",
          "v2.execution_policy_remote_action_rshell_scope" => "ExecutionPolicyRemoteActionRshellScope",
          "v2.execution_policy_remote_action_rshell_scope_rule" => "ExecutionPolicyRemoteActionRshellScopeRule",
          "v2.execution_policy_response" => "ExecutionPolicyResponse",
          "v2.execution_policy_response_data" => "ExecutionPolicyResponseData",
          "v2.execution_policy_scope" => "ExecutionPolicyScope",
          "v2.execution_policy_script_scope" => "ExecutionPolicyScriptScope",
          "v2.execution_policy_script_scope_rule" => "ExecutionPolicyScriptScopeRule",
          "v2.execution_policy_target" => "ExecutionPolicyTarget",
          "v2.execution_policy_type" => "ExecutionPolicyType",
          "v2.execution_policy_update_request" => "ExecutionPolicyUpdateRequest",
          "v2.execution_policy_update_request_data" => "ExecutionPolicyUpdateRequestData",
          "v2.execution_policy_write_attributes" => "ExecutionPolicyWriteAttributes",
          "v2.exposure_rollout_step_request" => "ExposureRolloutStepRequest",
          "v2.exposure_schedule_request" => "ExposureScheduleRequest",
          ...
          "v2.feature_flag_distribution_channel" => "FeatureFlagDistributionChannel",
          ...
          "v2.feature_flag_status" => "FeatureFlagStatus",
          "v2.file_coverage_lines" => "FileCoverageLines",
          "v2.files_coverage_attributes" => "FilesCoverageAttributes",
          "v2.files_coverage_data" => "FilesCoverageData",
          "v2.files_coverage_request" => "FilesCoverageRequest",
          "v2.files_coverage_request_attributes" => "FilesCoverageRequestAttributes",
          "v2.files_coverage_request_data" => "FilesCoverageRequestData",
          "v2.files_coverage_request_type" => "FilesCoverageRequestType",
          "v2.files_coverage_response" => "FilesCoverageResponse",
          "v2.files_coverage_response_type" => "FilesCoverageResponseType",
          ...
          "v2.finding_linear_issue" => "FindingLinearIssue",
          "v2.finding_linear_issue_result" => "FindingLinearIssueResult",
          ...
          "v2.fleet_agent_configuration_files_v2" => "FleetAgentConfigurationFilesV2",
          "v2.fleet_agent_detail_v2" => "FleetAgentDetailV2",
          "v2.fleet_agent_detail_v2_attributes" => "FleetAgentDetailV2Attributes",
          "v2.fleet_agent_detail_v2_response" => "FleetAgentDetailV2Response",
          "v2.fleet_agent_info_details_v2" => "FleetAgentInfoDetailsV2",
          "v2.fleet_agents_v2_page" => "FleetAgentsV2Page",
          "v2.fleet_agents_v2_response" => "FleetAgentsV2Response",
          "v2.fleet_agents_v2_response_meta" => "FleetAgentsV2ResponseMeta",
          "v2.fleet_agent_v2" => "FleetAgentV2",
          "v2.fleet_agent_v2_attributes" => "FleetAgentV2Attributes",
          "v2.fleet_agent_v2_attributes_instrumentation_status" => "FleetAgentV2AttributesInstrumentationStatus",
          "v2.fleet_agent_v2_resource_type" => "FleetAgentV2ResourceType",
          "v2.fleet_agent_versions_v2_page" => "FleetAgentVersionsV2Page",
          "v2.fleet_agent_versions_v2_response" => "FleetAgentVersionsV2Response",
          "v2.fleet_agent_versions_v2_response_meta" => "FleetAgentVersionsV2ResponseMeta",
          "v2.fleet_agent_version_v2" => "FleetAgentVersionV2",
          "v2.fleet_agent_version_v2_attributes" => "FleetAgentVersionV2Attributes",
          "v2.fleet_agent_version_v2_resource_type" => "FleetAgentVersionV2ResourceType",
          "v2.fleet_configuration_file_v2" => "FleetConfigurationFileV2",
          ...
          "v2.fleet_deployment_configure_v2_attributes" => "FleetDeploymentConfigureV2Attributes",
          "v2.fleet_deployment_configure_v2_create" => "FleetDeploymentConfigureV2Create",
          "v2.fleet_deployment_configure_v2_create_request" => "FleetDeploymentConfigureV2CreateRequest",
          "v2.fleet_deployment_configure_v2_dry_run" => "FleetDeploymentConfigureV2DryRun",
          "v2.fleet_deployment_configure_v2_dry_run_attributes" => "FleetDeploymentConfigureV2DryRunAttributes",
          "v2.fleet_deployment_configure_v2_dry_run_response" => "FleetDeploymentConfigureV2DryRunResponse",
          "v2.fleet_deployment_configure_v2_dry_run_result" => "FleetDeploymentConfigureV2DryRunResult",
          "v2.fleet_deployment_configure_v2_package" => "FleetDeploymentConfigureV2Package",
          ...
          "v2.fleet_deployment_package_upgrade_v2_attributes" => "FleetDeploymentPackageUpgradeV2Attributes",
          "v2.fleet_deployment_package_upgrade_v2_create" => "FleetDeploymentPackageUpgradeV2Create",
          "v2.fleet_deployment_package_upgrade_v2_create_request" => "FleetDeploymentPackageUpgradeV2CreateRequest",
          ...
          "v2.fleet_deployments_v2_page" => "FleetDeploymentsV2Page",
          "v2.fleet_deployments_v2_response" => "FleetDeploymentsV2Response",
          "v2.fleet_deployments_v2_response_meta" => "FleetDeploymentsV2ResponseMeta",
          "v2.fleet_deployment_v2" => "FleetDeploymentV2",
          "v2.fleet_deployment_v2_attributes" => "FleetDeploymentV2Attributes",
          "v2.fleet_deployment_v2_cancel" => "FleetDeploymentV2Cancel",
          "v2.fleet_deployment_v2_cancel_attributes" => "FleetDeploymentV2CancelAttributes",
          "v2.fleet_deployment_v2_cancel_response" => "FleetDeploymentV2CancelResponse",
          "v2.fleet_deployment_v2_create_response" => "FleetDeploymentV2CreateResponse",
          "v2.fleet_deployment_v2_detail" => "FleetDeploymentV2Detail",
          "v2.fleet_deployment_v2_detail_agent" => "FleetDeploymentV2DetailAgent",
          "v2.fleet_deployment_v2_detail_attributes" => "FleetDeploymentV2DetailAttributes",
          "v2.fleet_deployment_v2_detail_response" => "FleetDeploymentV2DetailResponse",
          "v2.fleet_detected_integration" => "FleetDetectedIntegration",
          "v2.fleet_integration_details_v2" => "FleetIntegrationDetailsV2",
          "v2.fleet_integrations_by_status_v2" => "FleetIntegrationsByStatusV2",
          "v2.fleet_otel_collector_configuration_v2" => "FleetOtelCollectorConfigurationV2",
          ...
          "v2.fleet_schedules_v2_page" => "FleetSchedulesV2Page",
          "v2.fleet_schedules_v2_response" => "FleetSchedulesV2Response",
          "v2.fleet_schedules_v2_response_meta" => "FleetSchedulesV2ResponseMeta",
          "v2.fleet_schedule_v2" => "FleetScheduleV2",
          "v2.fleet_schedule_v2_attributes" => "FleetScheduleV2Attributes",
          "v2.fleet_schedule_v2_notification_rule" => "FleetScheduleV2NotificationRule",
          "v2.fleet_schedule_v2_recurrence_rule" => "FleetScheduleV2RecurrenceRule",
          "v2.fleet_schedule_v2_response" => "FleetScheduleV2Response",
          ...
          "v2.flutter_sourcemap_attributes" => "FlutterSourcemapAttributes",
          "v2.flutter_sourcemap_data" => "FlutterSourcemapData",
          "v2.form_data" => "FormData",
          "v2.form_data_attributes" => "FormDataAttributes",
          "v2.form_data_definition" => "FormDataDefinition",
          "v2.form_data_definition_type" => "FormDataDefinitionType",
          "v2.form_datastore_config_attributes" => "FormDatastoreConfigAttributes",
          "v2.form_publication_attributes" => "FormPublicationAttributes",
          "v2.form_publication_data" => "FormPublicationData",
          "v2.form_publication_response" => "FormPublicationResponse",
          "v2.form_publication_type" => "FormPublicationType",
          "v2.form_response" => "FormResponse",
          "v2.forms_response" => "FormsResponse",
          "v2.form_trigger" => "FormTrigger",
          "v2.form_trigger_wrapper" => "FormTriggerWrapper",
          "v2.form_type" => "FormType",
          "v2.form_ui_definition" => "FormUiDefinition",
          "v2.form_ui_definition_ui_theme" => "FormUiDefinitionUiTheme",
          "v2.form_ui_definition_ui_theme_primary_color" => "FormUiDefinitionUiThemePrimaryColor",
          "v2.formula_limit" => "FormulaLimit",
          "v2.form_update_attributes" => "FormUpdateAttributes",
          "v2.form_version_attributes" => "FormVersionAttributes",
          "v2.form_version_data" => "FormVersionData",
          "v2.form_version_response" => "FormVersionResponse",
          "v2.form_version_state" => "FormVersionState",
          "v2.form_version_type" => "FormVersionType",
          ...
          "v2.full_personal_access_token" => "FullPersonalAccessToken",
          "v2.full_personal_access_token_attributes" => "FullPersonalAccessTokenAttributes",
          "v2.full_service_access_token" => "FullServiceAccessToken",
          "v2.full_service_access_token_attributes" => "FullServiceAccessTokenAttributes",
          ...
          "v2.gcp_scan_options" => "GcpScanOptions",
          "v2.gcp_scan_options_array" => "GcpScanOptionsArray",
          "v2.gcp_scan_options_data" => "GcpScanOptionsData",
          "v2.gcp_scan_options_data_attributes" => "GcpScanOptionsDataAttributes",
          "v2.gcp_scan_options_data_type" => "GcpScanOptionsDataType",
          "v2.gcp_scan_options_input_update" => "GcpScanOptionsInputUpdate",
          "v2.gcp_scan_options_input_update_data" => "GcpScanOptionsInputUpdateData",
          "v2.gcp_scan_options_input_update_data_attributes" => "GcpScanOptionsInputUpdateDataAttributes",
          "v2.gcp_scan_options_input_update_data_type" => "GcpScanOptionsInputUpdateDataType",
          ...
          "v2.generate_cost_tag_description_response" => "GenerateCostTagDescriptionResponse",
          "v2.generated_cost_tag_description" => "GeneratedCostTagDescription",
          "v2.generated_cost_tag_description_attributes" => "GeneratedCostTagDescriptionAttributes",
          "v2.generated_cost_tag_description_type" => "GeneratedCostTagDescriptionType",
          ...
          "v2.get_ast_request" => "GetAstRequest",
          "v2.get_ast_request_data" => "GetAstRequestData",
          "v2.get_ast_request_data_attributes" => "GetAstRequestDataAttributes",
          "v2.get_ast_request_data_type" => "GetAstRequestDataType",
          "v2.get_ast_response" => "GetAstResponse",
          "v2.get_ast_response_data" => "GetAstResponseData",
          "v2.get_ast_response_data_attributes" => "GetAstResponseDataAttributes",
          "v2.get_ast_response_data_type" => "GetAstResponseDataType",
          "v2.get_blueprint_response" => "GetBlueprintResponse",
          "v2.get_blueprints_response" => "GetBlueprintsResponse",
          ...
          "v2.get_data_observability_monitor_run_status_response" => "GetDataObservabilityMonitorRunStatusResponse",
          "v2.get_data_observability_monitor_run_status_response_attributes" => "GetDataObservabilityMonitorRunStatusResponseAttributes",
          "v2.get_data_observability_monitor_run_status_response_data" => "GetDataObservabilityMonitorRunStatusResponseData",
          ...
          "v2.google_chat_app_named_space_response" => "GoogleChatAppNamedSpaceResponse",
          "v2.google_chat_app_named_space_response_attributes" => "GoogleChatAppNamedSpaceResponseAttributes",
          "v2.google_chat_app_named_space_response_data" => "GoogleChatAppNamedSpaceResponseData",
          "v2.google_chat_app_named_space_type" => "GoogleChatAppNamedSpaceType",
          "v2.google_chat_create_organization_handle_request" => "GoogleChatCreateOrganizationHandleRequest",
          "v2.google_chat_create_organization_handle_request_attributes" => "GoogleChatCreateOrganizationHandleRequestAttributes",
          "v2.google_chat_create_organization_handle_request_data" => "GoogleChatCreateOrganizationHandleRequestData",
          "v2.google_chat_delegated_user_attributes" => "GoogleChatDelegatedUserAttributes",
          "v2.google_chat_delegated_user_data" => "GoogleChatDelegatedUserData",
          "v2.google_chat_delegated_user_response" => "GoogleChatDelegatedUserResponse",
          "v2.google_chat_delegated_user_type" => "GoogleChatDelegatedUserType",
          "v2.google_chat_organization_attributes" => "GoogleChatOrganizationAttributes",
          "v2.google_chat_organization_data" => "GoogleChatOrganizationData",
          "v2.google_chat_organization_handle_response" => "GoogleChatOrganizationHandleResponse",
          "v2.google_chat_organization_handle_response_attributes" => "GoogleChatOrganizationHandleResponseAttributes",
          "v2.google_chat_organization_handle_response_data" => "GoogleChatOrganizationHandleResponseData",
          "v2.google_chat_organization_handles_response" => "GoogleChatOrganizationHandlesResponse",
          "v2.google_chat_organization_handle_type" => "GoogleChatOrganizationHandleType",
          "v2.google_chat_organization_relationships" => "GoogleChatOrganizationRelationships",
          "v2.google_chat_organization_relationships_delegated_user" => "GoogleChatOrganizationRelationshipsDelegatedUser",
          "v2.google_chat_organization_relationships_delegated_user_data" => "GoogleChatOrganizationRelationshipsDelegatedUserData",
          "v2.google_chat_organization_response" => "GoogleChatOrganizationResponse",
          "v2.google_chat_organizations_response" => "GoogleChatOrganizationsResponse",
          "v2.google_chat_organization_type" => "GoogleChatOrganizationType",
          "v2.google_chat_target_audience_attributes" => "GoogleChatTargetAudienceAttributes",
          "v2.google_chat_target_audience_create_request" => "GoogleChatTargetAudienceCreateRequest",
          "v2.google_chat_target_audience_create_request_attributes" => "GoogleChatTargetAudienceCreateRequestAttributes",
          "v2.google_chat_target_audience_create_request_data" => "GoogleChatTargetAudienceCreateRequestData",
          "v2.google_chat_target_audience_data" => "GoogleChatTargetAudienceData",
          "v2.google_chat_target_audience_response" => "GoogleChatTargetAudienceResponse",
          "v2.google_chat_target_audiences_response" => "GoogleChatTargetAudiencesResponse",
          "v2.google_chat_target_audience_type" => "GoogleChatTargetAudienceType",
          "v2.google_chat_target_audience_update_request" => "GoogleChatTargetAudienceUpdateRequest",
          "v2.google_chat_target_audience_update_request_attributes" => "GoogleChatTargetAudienceUpdateRequestAttributes",
          "v2.google_chat_target_audience_update_request_data" => "GoogleChatTargetAudienceUpdateRequestData",
          ...
          "v2.governance_config_attributes" => "GovernanceConfigAttributes",
          "v2.governance_config_data" => "GovernanceConfigData",
          "v2.governance_config_response" => "GovernanceConfigResponse",
          "v2.governance_console_config_resource_type" => "GovernanceConsoleConfigResourceType",
          "v2.governance_control_attributes" => "GovernanceControlAttributes",
          "v2.governance_control_data" => "GovernanceControlData",
          "v2.governance_control_detection_assignment_source" => "GovernanceControlDetectionAssignmentSource",
          "v2.governance_control_detection_attributes" => "GovernanceControlDetectionAttributes",
          "v2.governance_control_detection_data" => "GovernanceControlDetectionData",
          "v2.governance_control_detection_resource_type" => "GovernanceControlDetectionResourceType",
          "v2.governance_control_detection_response" => "GovernanceControlDetectionResponse",
          "v2.governance_control_detections_response" => "GovernanceControlDetectionsResponse",
          "v2.governance_control_detection_state" => "GovernanceControlDetectionState",
          "v2.governance_control_detection_update_attributes" => "GovernanceControlDetectionUpdateAttributes",
          "v2.governance_control_detection_update_data" => "GovernanceControlDetectionUpdateData",
          "v2.governance_control_detection_update_request" => "GovernanceControlDetectionUpdateRequest",
          "v2.governance_control_detection_update_state" => "GovernanceControlDetectionUpdateState",
          ...
          "v2.governance_insight_directionality" => "GovernanceInsightDirectionality",
          ...
          "v2.governance_mitigation_request" => "GovernanceMitigationRequest",
          "v2.governance_mitigation_request_attributes" => "GovernanceMitigationRequestAttributes",
          "v2.governance_mitigation_request_data" => "GovernanceMitigationRequestData",
          "v2.governance_notification_settings_attributes" => "GovernanceNotificationSettingsAttributes",
          "v2.governance_notification_settings_data" => "GovernanceNotificationSettingsData",
          "v2.governance_notification_settings_resource_type" => "GovernanceNotificationSettingsResourceType",
          "v2.governance_notification_settings_response" => "GovernanceNotificationSettingsResponse",
          "v2.governance_notification_settings_update_attributes" => "GovernanceNotificationSettingsUpdateAttributes",
          ...
          "v2.guardrail_metric" => "GuardrailMetric",
          "v2.guardrail_metric_request" => "GuardrailMetricRequest",
          "v2.guardrail_trigger_action" => "GuardrailTriggerAction",
          "v2.hamr_org_connection_attributes_request" => "HamrOrgConnectionAttributesRequest",
          "v2.hamr_org_connection_attributes_response" => "HamrOrgConnectionAttributesResponse",
          "v2.hamr_org_connection_data_request" => "HamrOrgConnectionDataRequest",
          "v2.hamr_org_connection_data_response" => "HamrOrgConnectionDataResponse",
          "v2.hamr_org_connection_request" => "HamrOrgConnectionRequest",
          "v2.hamr_org_connection_response" => "HamrOrgConnectionResponse",
          "v2.hamr_org_connection_status" => "HamrOrgConnectionStatus",
          "v2.hamr_org_connection_type" => "HamrOrgConnectionType",
          ...
          "v2.identity_provider_attributes" => "IdentityProviderAttributes",
          "v2.identity_provider_data" => "IdentityProviderData",
          "v2.identity_provider_response" => "IdentityProviderResponse",
          "v2.identity_providers_response" => "IdentityProvidersResponse",
          "v2.identity_provider_type" => "IdentityProviderType",
          "v2.identity_provider_update_attributes" => "IdentityProviderUpdateAttributes",
          "v2.identity_provider_update_data" => "IdentityProviderUpdateData",
          "v2.identity_provider_update_request" => "IdentityProviderUpdateRequest",
          "v2.idp_metadata_form_data" => "IdPMetadataFormData",
          "v2.il2_cpp_sourcemap_attributes" => "IL2CPPSourcemapAttributes",
          "v2.il2_cpp_sourcemap_data" => "IL2CPPSourcemapData",
          "v2.inbox_rule_action" => "InboxRuleAction",
          "v2.inbox_rule_attributes_create" => "InboxRuleAttributesCreate",
          "v2.inbox_rule_attributes_response" => "InboxRuleAttributesResponse",
          "v2.inbox_rule_create_request" => "InboxRuleCreateRequest",
          "v2.inbox_rule_data_create" => "InboxRuleDataCreate",
          "v2.inbox_rule_data_response" => "InboxRuleDataResponse",
          "v2.inbox_rule_data_update" => "InboxRuleDataUpdate",
          "v2.inbox_rule_reorder_item" => "InboxRuleReorderItem",
          "v2.inbox_rule_reorder_request" => "InboxRuleReorderRequest",
          "v2.inbox_rule_reorder_response" => "InboxRuleReorderResponse",
          "v2.inbox_rule_response" => "InboxRuleResponse",
          "v2.inbox_rules_response" => "InboxRulesResponse",
          "v2.inbox_rule_type" => "InboxRuleType",
          "v2.inbox_rule_update_request" => "InboxRuleUpdateRequest",
          "v2.incident_ai_postmortem_data_attributes_response" => "IncidentAIPostmortemDataAttributesResponse",
          "v2.incident_ai_postmortem_data_response" => "IncidentAIPostmortemDataResponse",
          "v2.incident_ai_postmortem_response" => "IncidentAIPostmortemResponse",
          "v2.incident_ai_postmortem_response_type" => "IncidentAIPostmortemResponseType",
          "v2.incident_attachment_type" => "IncidentAttachmentType",
          "v2.incident_condition" => "IncidentCondition",
          "v2.incident_configuration_data_attributes_request" => "IncidentConfigurationDataAttributesRequest",
          "v2.incident_configuration_data_attributes_response" => "IncidentConfigurationDataAttributesResponse",
          "v2.incident_configuration_data_request" => "IncidentConfigurationDataRequest",
          "v2.incident_configuration_data_response" => "IncidentConfigurationDataResponse",
          "v2.incident_configuration_patch_data_attributes_request" => "IncidentConfigurationPatchDataAttributesRequest",
          "v2.incident_configuration_patch_data_request" => "IncidentConfigurationPatchDataRequest",
          "v2.incident_configuration_patch_request" => "IncidentConfigurationPatchRequest",
          "v2.incident_configuration_relationships" => "IncidentConfigurationRelationships",
          "v2.incident_configuration_request" => "IncidentConfigurationRequest",
          "v2.incident_configuration_response" => "IncidentConfigurationResponse",
          "v2.incident_configuration_type" => "IncidentConfigurationType",
          "v2.incident_create_attributes" => "IncidentCreateAttributes",
          "v2.incident_create_data" => "IncidentCreateData",
          "v2.incident_created_trigger" => "IncidentCreatedTrigger",
          "v2.incident_created_trigger_wrapper" => "IncidentCreatedTriggerWrapper",
          "v2.incident_create_on_call_page_data_attributes_request" => "IncidentCreateOnCallPageDataAttributesRequest",
          "v2.incident_create_on_call_page_data_request" => "IncidentCreateOnCallPageDataRequest",
          "v2.incident_create_on_call_page_request" => "IncidentCreateOnCallPageRequest",
          "v2.incident_create_page_from_incident_data_attributes_request" => "IncidentCreatePageFromIncidentDataAttributesRequest",
          "v2.incident_create_page_from_incident_data_request" => "IncidentCreatePageFromIncidentDataRequest",
          "v2.incident_create_page_from_incident_request" => "IncidentCreatePageFromIncidentRequest",
          "v2.incident_create_page_from_incident_type" => "IncidentCreatePageFromIncidentType",
          ...
          "v2.incident_google_chat_configuration_data_attributes_request" => "IncidentGoogleChatConfigurationDataAttributesRequest",
          "v2.incident_google_chat_configuration_data_attributes_response" => "IncidentGoogleChatConfigurationDataAttributesResponse",
          "v2.incident_google_chat_configuration_data_request" => "IncidentGoogleChatConfigurationDataRequest",
          "v2.incident_google_chat_configuration_data_response" => "IncidentGoogleChatConfigurationDataResponse",
          "v2.incident_google_chat_configuration_patch_data_attributes_request" => "IncidentGoogleChatConfigurationPatchDataAttributesRequest",
          "v2.incident_google_chat_configuration_patch_data_request" => "IncidentGoogleChatConfigurationPatchDataRequest",
          "v2.incident_google_chat_configuration_patch_request" => "IncidentGoogleChatConfigurationPatchRequest",
          "v2.incident_google_chat_configuration_relationships" => "IncidentGoogleChatConfigurationRelationships",
          "v2.incident_google_chat_configuration_relationships_request" => "IncidentGoogleChatConfigurationRelationshipsRequest",
          "v2.incident_google_chat_configuration_request" => "IncidentGoogleChatConfigurationRequest",
          "v2.incident_google_chat_configuration_response" => "IncidentGoogleChatConfigurationResponse",
          "v2.incident_google_chat_configuration_type" => "IncidentGoogleChatConfigurationType",
          "v2.incident_google_meet_configuration_data_attributes_request" => "IncidentGoogleMeetConfigurationDataAttributesRequest",
          "v2.incident_google_meet_configuration_data_attributes_response" => "IncidentGoogleMeetConfigurationDataAttributesResponse",
          "v2.incident_google_meet_configuration_data_request" => "IncidentGoogleMeetConfigurationDataRequest",
          "v2.incident_google_meet_configuration_data_response" => "IncidentGoogleMeetConfigurationDataResponse",
          "v2.incident_google_meet_configuration_patch_data_attributes_request" => "IncidentGoogleMeetConfigurationPatchDataAttributesRequest",
          "v2.incident_google_meet_configuration_patch_data_request" => "IncidentGoogleMeetConfigurationPatchDataRequest",
          "v2.incident_google_meet_configuration_patch_request" => "IncidentGoogleMeetConfigurationPatchRequest",
          "v2.incident_google_meet_configuration_relationships" => "IncidentGoogleMeetConfigurationRelationships",
          "v2.incident_google_meet_configuration_relationships_request" => "IncidentGoogleMeetConfigurationRelationshipsRequest",
          "v2.incident_google_meet_configuration_request" => "IncidentGoogleMeetConfigurationRequest",
          "v2.incident_google_meet_configuration_response" => "IncidentGoogleMeetConfigurationResponse",
          "v2.incident_google_meet_configuration_type" => "IncidentGoogleMeetConfigurationType",
          ...
          "v2.incident_impact_created_trigger" => "IncidentImpactCreatedTrigger",
          "v2.incident_impact_created_trigger_wrapper" => "IncidentImpactCreatedTriggerWrapper",
          "v2.incident_impact_create_request" => "IncidentImpactCreateRequest",
          "v2.incident_impact_field_choice" => "IncidentImpactFieldChoice",
          "v2.incident_impact_field_data_attributes_request" => "IncidentImpactFieldDataAttributesRequest",
          "v2.incident_impact_field_data_attributes_response" => "IncidentImpactFieldDataAttributesResponse",
          "v2.incident_impact_field_data_request" => "IncidentImpactFieldDataRequest",
          "v2.incident_impact_field_data_response" => "IncidentImpactFieldDataResponse",
          "v2.incident_impact_field_relationships" => "IncidentImpactFieldRelationships",
          "v2.incident_impact_field_relationships_request" => "IncidentImpactFieldRelationshipsRequest",
          "v2.incident_impact_field_request" => "IncidentImpactFieldRequest",
          "v2.incident_impact_field_response" => "IncidentImpactFieldResponse",
          "v2.incident_impact_fields_response" => "IncidentImpactFieldsResponse",
          "v2.incident_impact_field_type" => "IncidentImpactFieldType",
          "v2.incident_impact_field_value_type" => "IncidentImpactFieldValueType",
          "v2.incident_impact_patch_attributes" => "IncidentImpactPatchAttributes",
          "v2.incident_impact_patch_data" => "IncidentImpactPatchData",
          "v2.incident_impact_patch_request" => "IncidentImpactPatchRequest",
          ...
          "v2.incident_impact_updated_trigger" => "IncidentImpactUpdatedTrigger",
          "v2.incident_impact_updated_trigger_wrapper" => "IncidentImpactUpdatedTriggerWrapper",
          "v2.incident_import_field_attributes" => "IncidentImportFieldAttributes",
          "v2.incident_import_field_attributes_multiple_value" => "IncidentImportFieldAttributesMultipleValue",
          "v2.incident_import_field_attributes_single_value" => "IncidentImportFieldAttributesSingleValue",
          "v2.incident_import_related_object" => "IncidentImportRelatedObject",
          "v2.incident_import_relationships" => "IncidentImportRelationships",
          "v2.incident_import_request" => "IncidentImportRequest",
          "v2.incident_import_request_attributes" => "IncidentImportRequestAttributes",
          "v2.incident_import_request_data" => "IncidentImportRequestData",
          "v2.incident_import_response" => "IncidentImportResponse",
          "v2.incident_import_response_attributes" => "IncidentImportResponseAttributes",
          "v2.incident_import_response_data" => "IncidentImportResponseData",
          "v2.incident_import_response_included_item" => "IncidentImportResponseIncludedItem",
          "v2.incident_import_response_relationships" => "IncidentImportResponseRelationships",
          "v2.incident_import_visibility" => "IncidentImportVisibility",
          ...
          "v2.incident_on_call_page_data_attributes_request" => "IncidentOnCallPageDataAttributesRequest",
          "v2.incident_on_call_page_data_request" => "IncidentOnCallPageDataRequest",
          "v2.incident_on_call_page_link_request" => "IncidentOnCallPageLinkRequest",
          "v2.incident_on_call_page_target" => "IncidentOnCallPageTarget",
          "v2.incident_on_call_page_type" => "IncidentOnCallPageType",
          "v2.incident_org_settings_data_attributes_response" => "IncidentOrgSettingsDataAttributesResponse",
          "v2.incident_org_settings_data_response" => "IncidentOrgSettingsDataResponse",
          "v2.incident_org_settings_list_response" => "IncidentOrgSettingsListResponse",
          "v2.incident_org_settings_relationships" => "IncidentOrgSettingsRelationships",
          "v2.incident_org_settings_response" => "IncidentOrgSettingsResponse",
          "v2.incident_org_settings_type" => "IncidentOrgSettingsType",
          "v2.incident_page_role_reference" => "IncidentPageRoleReference",
          "v2.incident_page_role_type" => "IncidentPageRoleType",
          "v2.incident_page_target" => "IncidentPageTarget",
          "v2.incident_page_target_type" => "IncidentPageTargetType",
          "v2.incident_page_uuid_data_response" => "IncidentPageUUIDDataResponse",
          "v2.incident_page_uuid_response" => "IncidentPageUUIDResponse",
          "v2.incident_page_uuid_type" => "IncidentPageUUIDType",
          "v2.incident_postmortem_type" => "IncidentPostmortemType",
          "v2.incident_postmortem_updated_trigger" => "IncidentPostmortemUpdatedTrigger",
          "v2.incident_postmortem_updated_trigger_wrapper" => "IncidentPostmortemUpdatedTriggerWrapper",
          "v2.incident_related_object" => "IncidentRelatedObject",
          "v2.incident_relationship_data" => "IncidentRelationshipData",
          "v2.incident_resource_type" => "IncidentResourceType",
          "v2.incident_responder_created_trigger" => "IncidentResponderCreatedTrigger",
          "v2.incident_responder_created_trigger_wrapper" => "IncidentResponderCreatedTriggerWrapper",
          "v2.incident_responder_data_attributes_response" => "IncidentResponderDataAttributesResponse",
          "v2.incident_responder_data_request" => "IncidentResponderDataRequest",
          "v2.incident_responder_data_response" => "IncidentResponderDataResponse",
          "v2.incident_responder_relationships" => "IncidentResponderRelationships",
          "v2.incident_responder_relationships_request" => "IncidentResponderRelationshipsRequest",
          "v2.incident_responder_request" => "IncidentResponderRequest",
          "v2.incident_responder_response" => "IncidentResponderResponse",
          ...
          "v2.incident_responders_response" => "IncidentRespondersResponse",
          "v2.incident_responders_type" => "IncidentRespondersType",
          "v2.incident_responder_type" => "IncidentResponderType",
          "v2.incident_responder_user_relationship" => "IncidentResponderUserRelationship",
          "v2.incident_responder_user_relationship_data" => "IncidentResponderUserRelationshipData",
          ...
          "v2.incident_rule_condition" => "IncidentRuleCondition",
          "v2.incident_rule_data_attributes_request" => "IncidentRuleDataAttributesRequest",
          "v2.incident_rule_data_attributes_response" => "IncidentRuleDataAttributesResponse",
          "v2.incident_rule_data_request" => "IncidentRuleDataRequest",
          "v2.incident_rule_data_response" => "IncidentRuleDataResponse",
          "v2.incident_rule_execution_type" => "IncidentRuleExecutionType",
          "v2.incident_rule_patch_data_attributes_request" => "IncidentRulePatchDataAttributesRequest",
          "v2.incident_rule_patch_data_request" => "IncidentRulePatchDataRequest",
          "v2.incident_rule_patch_request" => "IncidentRulePatchRequest",
          "v2.incident_rule_query_condition" => "IncidentRuleQueryCondition",
          "v2.incident_rule_request" => "IncidentRuleRequest",
          "v2.incident_rule_response" => "IncidentRuleResponse",
          "v2.incident_rule_response_type" => "IncidentRuleResponseType",
          "v2.incident_rules_response" => "IncidentRulesResponse",
          "v2.incident_rule_task_id_type" => "IncidentRuleTaskIDType",
          "v2.incident_rule_trigger_type" => "IncidentRuleTriggerType",
          "v2.incident_rule_type" => "IncidentRuleType",
          "v2.incident_saved_trigger" => "IncidentSavedTrigger",
          "v2.incident_saved_trigger_wrapper" => "IncidentSavedTriggerWrapper",
          ...
          "v2.incident_service_now_record_data_attributes_request" => "IncidentServiceNowRecordDataAttributesRequest",
          "v2.incident_service_now_record_data_request" => "IncidentServiceNowRecordDataRequest",
          "v2.incident_service_now_record_prompt_type" => "IncidentServiceNowRecordPromptType",
          "v2.incident_service_now_record_request" => "IncidentServiceNowRecordRequest",
          "v2.incident_severity" => "IncidentSeverity",
          "v2.incidents_response" => "IncidentsResponse",
          "v2.incident_tag_value" => "IncidentTagValue",
          ...
          "v2.incident_timestamp_override_data_attributes_request" => "IncidentTimestampOverrideDataAttributesRequest",
          "v2.incident_timestamp_override_data_attributes_response" => "IncidentTimestampOverrideDataAttributesResponse",
          "v2.incident_timestamp_override_data_request" => "IncidentTimestampOverrideDataRequest",
          "v2.incident_timestamp_override_data_response" => "IncidentTimestampOverrideDataResponse",
          "v2.incident_timestamp_override_patch_data_attributes_request" => "IncidentTimestampOverridePatchDataAttributesRequest",
          ...
          "v2.incident_timestamp_override_request" => "IncidentTimestampOverrideRequest",
          ...
          "v2.incident_timestamp_override_type" => "IncidentTimestampOverrideType",
          "v2.incident_timestamp_type" => "IncidentTimestampType",
          ...
          "v2.incident_user_defined_field_attributes_create_request" => "IncidentUserDefinedFieldAttributesCreateRequest",
          "v2.incident_user_defined_field_attributes_response" => "IncidentUserDefinedFieldAttributesResponse",
          "v2.incident_user_defined_field_attributes_update_request" => "IncidentUserDefinedFieldAttributesUpdateRequest",
          "v2.incident_user_defined_field_category" => "IncidentUserDefinedFieldCategory",
          "v2.incident_user_defined_field_collected" => "IncidentUserDefinedFieldCollected",
          "v2.incident_user_defined_field_create_data" => "IncidentUserDefinedFieldCreateData",
          "v2.incident_user_defined_field_create_relationships" => "IncidentUserDefinedFieldCreateRelationships",
          "v2.incident_user_defined_field_create_request" => "IncidentUserDefinedFieldCreateRequest",
          "v2.incident_user_defined_field_field_type" => "IncidentUserDefinedFieldFieldType",
          "v2.incident_user_defined_field_list_meta" => "IncidentUserDefinedFieldListMeta",
          "v2.incident_user_defined_field_list_response" => "IncidentUserDefinedFieldListResponse",
          "v2.incident_user_defined_field_metadata" => "IncidentUserDefinedFieldMetadata",
          "v2.incident_user_defined_field_relationships" => "IncidentUserDefinedFieldRelationships",
          "v2.incident_user_defined_field_response" => "IncidentUserDefinedFieldResponse",
          "v2.incident_user_defined_field_response_data" => "IncidentUserDefinedFieldResponseData",
          "v2.incident_user_defined_field_type" => "IncidentUserDefinedFieldType",
          "v2.incident_user_defined_field_update_data" => "IncidentUserDefinedFieldUpdateData",
          "v2.incident_user_defined_field_update_request" => "IncidentUserDefinedFieldUpdateRequest",
          "v2.incident_user_defined_field_valid_value" => "IncidentUserDefinedFieldValidValue",
          "v2.incident_user_defined_role_data_attributes_request" => "IncidentUserDefinedRoleDataAttributesRequest",
          "v2.incident_user_defined_role_data_attributes_response" => "IncidentUserDefinedRoleDataAttributesResponse",
          "v2.incident_user_defined_role_data_request" => "IncidentUserDefinedRoleDataRequest",
          "v2.incident_user_defined_role_data_response" => "IncidentUserDefinedRoleDataResponse",
          "v2.incident_user_defined_role_incident_type_relationship" => "IncidentUserDefinedRoleIncidentTypeRelationship",
          "v2.incident_user_defined_role_incident_type_relationship_data" => "IncidentUserDefinedRoleIncidentTypeRelationshipData",
          "v2.incident_user_defined_role_included_item" => "IncidentUserDefinedRoleIncludedItem",
          "v2.incident_user_defined_role_patch_data_attributes_request" => "IncidentUserDefinedRolePatchDataAttributesRequest",
          "v2.incident_user_defined_role_patch_data_request" => "IncidentUserDefinedRolePatchDataRequest",
          "v2.incident_user_defined_role_patch_request" => "IncidentUserDefinedRolePatchRequest",
          "v2.incident_user_defined_role_policy" => "IncidentUserDefinedRolePolicy",
          "v2.incident_user_defined_role_relationships_request" => "IncidentUserDefinedRoleRelationshipsRequest",
          "v2.incident_user_defined_role_relationships_response" => "IncidentUserDefinedRoleRelationshipsResponse",
          "v2.incident_user_defined_role_request" => "IncidentUserDefinedRoleRequest",
          "v2.incident_user_defined_role_response" => "IncidentUserDefinedRoleResponse",
          "v2.incident_user_defined_roles_response" => "IncidentUserDefinedRolesResponse",
          "v2.incident_user_defined_role_type" => "IncidentUserDefinedRoleType",
          ...
          "v2.integration_account_dataflow_health" => "IntegrationAccountDataflowHealth",
          "v2.integration_account_dataflow_status" => "IntegrationAccountDataflowStatus",
          "v2.integration_account_type" => "IntegrationAccountType",
          "v2.integration_attributes" => "IntegrationAttributes",
          ...
          "v2.integration_jira" => "IntegrationJira",
          "v2.integration_jira_auto_creation" => "IntegrationJiraAutoCreation",
          "v2.integration_jira_metadata" => "IntegrationJiraMetadata",
          "v2.integration_jira_sync" => "IntegrationJiraSync",
          "v2.integration_jira_sync_due_date" => "IntegrationJiraSyncDueDate",
          "v2.integration_jira_sync_properties" => "IntegrationJiraSyncProperties",
          "v2.integration_jira_sync_properties_custom_fields_additional_properties" => "IntegrationJiraSyncPropertiesCustomFieldsAdditionalProperties",
          "v2.integration_links" => "IntegrationLinks",
          "v2.integration_monitor" => "IntegrationMonitor",
          "v2.integration_on_call" => "IntegrationOnCall",
          "v2.integration_on_call_escalation_queries_items" => "IntegrationOnCallEscalationQueriesItems",
          "v2.integration_on_call_escalation_queries_items_target" => "IntegrationOnCallEscalationQueriesItemsTarget",
          "v2.integration_service_now" => "IntegrationServiceNow",
          "v2.integration_service_now_auto_creation" => "IntegrationServiceNowAutoCreation",
          "v2.integration_service_now_sync_config" => "IntegrationServiceNowSyncConfig",
          "v2.integration_service_now_sync_config139772721534496" => "IntegrationServiceNowSyncConfig139772721534496",
          "v2.integration_service_now_sync_config_priority" => "IntegrationServiceNowSyncConfigPriority",
          ...
          "v2.io_c_triage_event" => "IoCTriageEvent",
          "v2.io_c_triage_state" => "IoCTriageState",
          "v2.io_c_triage_write_request" => "IoCTriageWriteRequest",
          "v2.io_c_triage_write_request_attributes" => "IoCTriageWriteRequestAttributes",
          "v2.io_c_triage_write_request_data" => "IoCTriageWriteRequestData",
          "v2.io_c_triage_write_response" => "IoCTriageWriteResponse",
          "v2.io_c_triage_write_response_attributes" => "IoCTriageWriteResponseAttributes",
          "v2.io_c_triage_write_response_data" => "IoCTriageWriteResponseData",
          "v2.ios_sourcemap_attributes" => "IOSSourcemapAttributes",
          "v2.ios_sourcemap_data" => "IOSSourcemapData",
          ...
          "v2.jira_account_attributes" => "JiraAccountAttributes",
          "v2.jira_account_data" => "JiraAccountData",
          "v2.jira_account_relationship" => "JiraAccountRelationship",
          "v2.jira_accounts_meta" => "JiraAccountsMeta",
          "v2.jira_accounts_response" => "JiraAccountsResponse",
          "v2.jira_account_type" => "JiraAccountType",
          ...
          "v2.jira_issue_create_attributes" => "JiraIssueCreateAttributes",
          "v2.jira_issue_create_data" => "JiraIssueCreateData",
          "v2.jira_issue_create_request" => "JiraIssueCreateRequest",
          "v2.jira_issue_link_attributes" => "JiraIssueLinkAttributes",
          "v2.jira_issue_link_data" => "JiraIssueLinkData",
          "v2.jira_issue_link_request" => "JiraIssueLinkRequest",
          "v2.jira_issue_resource_type" => "JiraIssueResourceType",
          ...
          "v2.jira_issue_template_create_request_data" => "JiraIssueTemplateCreateRequestData",
          "v2.jira_issue_template_data" => "JiraIssueTemplateData",
          "v2.jira_issue_template_data_attributes" => "JiraIssueTemplateDataAttributes",
          "v2.jira_issue_template_data_relationships" => "JiraIssueTemplateDataRelationships",
          "v2.jira_issue_template_response" => "JiraIssueTemplateResponse",
          "v2.jira_issue_templates_response" => "JiraIssueTemplatesResponse",
          "v2.jira_issue_template_type" => "JiraIssueTemplateType",
          ...
          "v2.js_sourcemap_attributes" => "JSSourcemapAttributes",
          "v2.js_sourcemap_data" => "JSSourcemapData",
          "v2.jvm_sourcemap_attributes" => "JVMSourcemapAttributes",
          "v2.jvm_sourcemap_data" => "JVMSourcemapData",
          ...
          "v2.latest_version_match_policy" => "LatestVersionMatchPolicy",
          ...
          "v2.library" => "Library",
          "v2.licenses_list_response" => "LicensesListResponse",
          "v2.licenses_list_response_data" => "LicensesListResponseData",
          "v2.licenses_list_response_data_attributes" => "LicensesListResponseDataAttributes",
          "v2.licenses_list_response_data_attributes_licenses_items" => "LicensesListResponseDataAttributesLicensesItems",
          "v2.licenses_list_response_data_type" => "LicensesListResponseDataType",
          "v2.linear_issues_data_type" => "LinearIssuesDataType",
          "v2.links" => "Links",
          ...
          "v2.list_app_versions_response" => "ListAppVersionsResponse",
          "v2.list_assets_sbo_ms_response" => "ListAssetsSBOMsResponse",
          "v2.list_blueprints_response" => "ListBlueprintsResponse",
          "v2.list_campaigns_response" => "ListCampaignsResponse",
          ...
          "v2.list_dashboards_usage_response" => "ListDashboardsUsageResponse",
          "v2.list_dashboards_usage_response_links" => "ListDashboardsUsageResponseLinks",
          "v2.list_dashboards_usage_response_meta" => "ListDashboardsUsageResponseMeta",
          ...
          "v2.list_environments_response" => "ListEnvironmentsResponse",
          "v2.list_feature_flags_response" => "ListFeatureFlagsResponse",
          ...
          "v2.list_personal_access_tokens_response" => "ListPersonalAccessTokensResponse",
          ...
          "v2.list_workflows_response" => "ListWorkflowsResponse",
          "v2.list_workflows_response_meta" => "ListWorkflowsResponseMeta",
          "v2.list_workflows_response_meta_page" => "ListWorkflowsResponseMetaPage",
          "v2.llm_obs_annotated_interaction_by_trace_item" => "LLMObsAnnotatedInteractionByTraceItem",
          "v2.llm_obs_annotated_interaction_data_attributes_response" => "LLMObsAnnotatedInteractionDataAttributesResponse",
          "v2.llm_obs_annotated_interaction_data_response" => "LLMObsAnnotatedInteractionDataResponse",
          "v2.llm_obs_annotated_interaction_event" => "LLMObsAnnotatedInteractionEvent",
          "v2.llm_obs_annotated_interaction_item" => "LLMObsAnnotatedInteractionItem",
          "v2.llm_obs_annotated_interaction_response" => "LLMObsAnnotatedInteractionResponse",
          ...
          "v2.llm_obs_annotation_queue_data_response" => "LLMObsAnnotationQueueDataResponse",
          "v2.llm_obs_annotation_queue_interaction_item" => "LLMObsAnnotationQueueInteractionItem",
          "v2.llm_obs_annotation_queue_interaction_response_item" => "LLMObsAnnotationQueueInteractionResponseItem",
          "v2.llm_obs_annotation_queue_interactions_data_attributes_request" => "LLMObsAnnotationQueueInteractionsDataAttributesRequest",
          "v2.llm_obs_annotation_queue_interactions_data_attributes_response" => "LLMObsAnnotationQueueInteractionsDataAttributesResponse",
          "v2.llm_obs_annotation_queue_interactions_data_request" => "LLMObsAnnotationQueueInteractionsDataRequest",
          "v2.llm_obs_annotation_queue_interactions_data_response" => "LLMObsAnnotationQueueInteractionsDataResponse",
          ...
          "v2.llm_obs_create_prompt_data" => "LLMObsCreatePromptData",
          "v2.llm_obs_create_prompt_data_attributes" => "LLMObsCreatePromptDataAttributes",
          "v2.llm_obs_create_prompt_request" => "LLMObsCreatePromptRequest",
          "v2.llm_obs_create_prompt_response" => "LLMObsCreatePromptResponse",
          "v2.llm_obs_create_prompt_response_data" => "LLMObsCreatePromptResponseData",
          "v2.llm_obs_create_prompt_response_data_attributes" => "LLMObsCreatePromptResponseDataAttributes",
          "v2.llm_obs_create_prompt_version_data" => "LLMObsCreatePromptVersionData",
          "v2.llm_obs_create_prompt_version_data_attributes" => "LLMObsCreatePromptVersionDataAttributes",
          "v2.llm_obs_create_prompt_version_request" => "LLMObsCreatePromptVersionRequest",
          ...
          "v2.llm_obs_custom_eval_config_bedrock_options" => "LLMObsCustomEvalConfigBedrockOptions",
          "v2.llm_obs_custom_eval_config_data" => "LLMObsCustomEvalConfigData",
          ...
          "v2.llm_obs_custom_eval_config_prompt_content" => "LLMObsCustomEvalConfigPromptContent",
          "v2.llm_obs_custom_eval_config_prompt_content_value" => "LLMObsCustomEvalConfigPromptContentValue",
          "v2.llm_obs_custom_eval_config_prompt_message" => "LLMObsCustomEvalConfigPromptMessage",
          "v2.llm_obs_custom_eval_config_prompt_tool_call" => "LLMObsCustomEvalConfigPromptToolCall",
          "v2.llm_obs_custom_eval_config_prompt_tool_result" => "LLMObsCustomEvalConfigPromptToolResult",
          "v2.llm_obs_custom_eval_config_response" => "LLMObsCustomEvalConfigResponse",
          "v2.llm_obs_custom_eval_config_target" => "LLMObsCustomEvalConfigTarget",
          "v2.llm_obs_custom_eval_config_type" => "LLMObsCustomEvalConfigType",
          "v2.llm_obs_custom_eval_config_update_attributes" => "LLMObsCustomEvalConfigUpdateAttributes",
          "v2.llm_obs_custom_eval_config_update_data" => "LLMObsCustomEvalConfigUpdateData",
          ...
          "v2.llm_obs_dataset_batch_update_data_attributes_request" => "LLMObsDatasetBatchUpdateDataAttributesRequest",
          "v2.llm_obs_dataset_batch_update_data_request" => "LLMObsDatasetBatchUpdateDataRequest",
          "v2.llm_obs_dataset_batch_update_insert_record" => "LLMObsDatasetBatchUpdateInsertRecord",
          "v2.llm_obs_dataset_batch_update_request" => "LLMObsDatasetBatchUpdateRequest",
          "v2.llm_obs_dataset_batch_update_update_record" => "LLMObsDatasetBatchUpdateUpdateRecord",
          "v2.llm_obs_dataset_clone_data_attributes_request" => "LLMObsDatasetCloneDataAttributesRequest",
          "v2.llm_obs_dataset_clone_data_request" => "LLMObsDatasetCloneDataRequest",
          "v2.llm_obs_dataset_clone_request" => "LLMObsDatasetCloneRequest",
          ...
          "v2.llm_obs_dataset_export_format" => "LLMObsDatasetExportFormat",
          ...
          "v2.llm_obs_dataset_records_data_request" => "LLMObsDatasetRecordsDataRequest",
          "v2.llm_obs_dataset_records_list_response" => "LLMObsDatasetRecordsListResponse",
          "v2.llm_obs_dataset_records_mutation_data" => "LLMObsDatasetRecordsMutationData",
          "v2.llm_obs_dataset_records_mutation_response" => "LLMObsDatasetRecordsMutationResponse",
          "v2.llm_obs_dataset_records_request" => "LLMObsDatasetRecordsRequest",
          "v2.llm_obs_dataset_records_update_data_attributes_request" => "LLMObsDatasetRecordsUpdateDataAttributesRequest",
          "v2.llm_obs_dataset_records_update_data_request" => "LLMObsDatasetRecordsUpdateDataRequest",
          "v2.llm_obs_dataset_records_update_request" => "LLMObsDatasetRecordsUpdateRequest",
          "v2.llm_obs_dataset_records_upload_file" => "LLMObsDatasetRecordsUploadFile",
          "v2.llm_obs_dataset_record_tag_operations" => "LLMObsDatasetRecordTagOperations",
          "v2.llm_obs_dataset_record_update_item" => "LLMObsDatasetRecordUpdateItem",
          "v2.llm_obs_dataset_request" => "LLMObsDatasetRequest",
          "v2.llm_obs_dataset_response" => "LLMObsDatasetResponse",
          "v2.llm_obs_dataset_restore_version_data_attributes_request" => "LLMObsDatasetRestoreVersionDataAttributesRequest",
          "v2.llm_obs_dataset_restore_version_data_request" => "LLMObsDatasetRestoreVersionDataRequest",
          "v2.llm_obs_dataset_restore_version_request" => "LLMObsDatasetRestoreVersionRequest",
          "v2.llm_obs_datasets_response" => "LLMObsDatasetsResponse",
          "v2.llm_obs_dataset_type" => "LLMObsDatasetType",
          ...
          "v2.llm_obs_delete_datasets_data_attributes_request" => "LLMObsDeleteDatasetsDataAttributesRequest",
          "v2.llm_obs_delete_datasets_data_request" => "LLMObsDeleteDatasetsDataRequest",
          "v2.llm_obs_delete_datasets_request" => "LLMObsDeleteDatasetsRequest",
          "v2.llm_obs_deleted_prompt_data" => "LLMObsDeletedPromptData",
          "v2.llm_obs_deleted_prompt_data_attributes" => "LLMObsDeletedPromptDataAttributes",
          "v2.llm_obs_deleted_prompt_response" => "LLMObsDeletedPromptResponse",
          "v2.llm_obs_delete_experiments_data_attributes_request" => "LLMObsDeleteExperimentsDataAttributesRequest",
          "v2.llm_obs_delete_experiments_data_request" => "LLMObsDeleteExperimentsDataRequest",
          "v2.llm_obs_delete_experiments_request" => "LLMObsDeleteExperimentsRequest",
          ...
          "v2.llm_obs_experimentation_analytics_aggregate" => "LLMObsExperimentationAnalyticsAggregate",
          "v2.llm_obs_experimentation_analytics_compute" => "LLMObsExperimentationAnalyticsCompute",
          "v2.llm_obs_experimentation_analytics_data_attributes_request" => "LLMObsExperimentationAnalyticsDataAttributesRequest",
          "v2.llm_obs_experimentation_analytics_data_attributes_response" => "LLMObsExperimentationAnalyticsDataAttributesResponse",
          "v2.llm_obs_experimentation_analytics_data_request" => "LLMObsExperimentationAnalyticsDataRequest",
          "v2.llm_obs_experimentation_analytics_data_response" => "LLMObsExperimentationAnalyticsDataResponse",
          "v2.llm_obs_experimentation_analytics_group_by" => "LLMObsExperimentationAnalyticsGroupBy",
          "v2.llm_obs_experimentation_analytics_request" => "LLMObsExperimentationAnalyticsRequest",
          "v2.llm_obs_experimentation_analytics_response" => "LLMObsExperimentationAnalyticsResponse",
          "v2.llm_obs_experimentation_analytics_result" => "LLMObsExperimentationAnalyticsResult",
          "v2.llm_obs_experimentation_analytics_search" => "LLMObsExperimentationAnalyticsSearch",
          "v2.llm_obs_experimentation_analytics_time_range" => "LLMObsExperimentationAnalyticsTimeRange",
          "v2.llm_obs_experimentation_analytics_value" => "LLMObsExperimentationAnalyticsValue",
          "v2.llm_obs_experimentation_content_preview" => "LLMObsExperimentationContentPreview",
          "v2.llm_obs_experimentation_cursor_page" => "LLMObsExperimentationCursorPage",
          "v2.llm_obs_experimentation_filter" => "LLMObsExperimentationFilter",
          "v2.llm_obs_experimentation_include" => "LLMObsExperimentationInclude",
          "v2.llm_obs_experimentation_number_page" => "LLMObsExperimentationNumberPage",
          "v2.llm_obs_experimentation_search_data_attributes_request" => "LLMObsExperimentationSearchDataAttributesRequest",
          "v2.llm_obs_experimentation_search_data_request" => "LLMObsExperimentationSearchDataRequest",
          "v2.llm_obs_experimentation_search_data_response" => "LLMObsExperimentationSearchDataResponse",
          "v2.llm_obs_experimentation_search_request" => "LLMObsExperimentationSearchRequest",
          "v2.llm_obs_experimentation_search_response" => "LLMObsExperimentationSearchResponse",
          "v2.llm_obs_experimentation_search_results" => "LLMObsExperimentationSearchResults",
          "v2.llm_obs_experimentation_simple_search_data_attributes_request" => "LLMObsExperimentationSimpleSearchDataAttributesRequest",
          "v2.llm_obs_experimentation_simple_search_data_request" => "LLMObsExperimentationSimpleSearchDataRequest",
          "v2.llm_obs_experimentation_simple_search_data_response" => "LLMObsExperimentationSimpleSearchDataResponse",
          "v2.llm_obs_experimentation_simple_search_meta" => "LLMObsExperimentationSimpleSearchMeta",
          "v2.llm_obs_experimentation_simple_search_meta_page" => "LLMObsExperimentationSimpleSearchMetaPage",
          "v2.llm_obs_experimentation_simple_search_request" => "LLMObsExperimentationSimpleSearchRequest",
          "v2.llm_obs_experimentation_simple_search_response" => "LLMObsExperimentationSimpleSearchResponse",
          "v2.llm_obs_experimentation_sort_field" => "LLMObsExperimentationSortField",
          "v2.llm_obs_experimentation_sort_field_direction" => "LLMObsExperimentationSortFieldDirection",
          "v2.llm_obs_experimentation_type" => "LLMObsExperimentationType",
          ...
          "v2.llm_obs_experiment_data_request" => "LLMObsExperimentDataRequest",
          "v2.llm_obs_experiment_data_response" => "LLMObsExperimentDataResponse",
          "v2.llm_obs_experiment_eval_metric_event" => "LLMObsExperimentEvalMetricEvent",
          "v2.llm_obs_experiment_events_data_attributes_request" => "LLMObsExperimentEventsDataAttributesRequest",
          "v2.llm_obs_experiment_events_data_request" => "LLMObsExperimentEventsDataRequest",
          "v2.llm_obs_experiment_events_request" => "LLMObsExperimentEventsRequest",
          "v2.llm_obs_experiment_events_type" => "LLMObsExperimentEventsType",
          "v2.llm_obs_experiment_events_v2_data_attributes_response" => "LLMObsExperimentEventsV2DataAttributesResponse",
          "v2.llm_obs_experiment_events_v2_data_response" => "LLMObsExperimentEventsV2DataResponse",
          "v2.llm_obs_experiment_events_v2_response" => "LLMObsExperimentEventsV2Response",
          "v2.llm_obs_experiment_metric" => "LLMObsExperimentMetric",
          "v2.llm_obs_experiment_metric_error" => "LLMObsExperimentMetricError",
          "v2.llm_obs_experiment_request" => "LLMObsExperimentRequest",
          ...
          "v2.llm_obs_frontend_content_block" => "LLMObsFrontendContentBlock",
          "v2.llm_obs_frontend_content_block_type" => "LLMObsFrontendContentBlockType",
          ...
          "v2.llm_obs_legacy_content_block" => "LLMObsLegacyContentBlock",
          "v2.llm_obs_legacy_content_block_type" => "LLMObsLegacyContentBlockType",
          ...
          "v2.llm_obs_patterns_activity_progress" => "LLMObsPatternsActivityProgress",
          "v2.llm_obs_patterns_clustered_point" => "LLMObsPatternsClusteredPoint",
          "v2.llm_obs_patterns_clustered_point_ref" => "LLMObsPatternsClusteredPointRef",
          "v2.llm_obs_patterns_clustered_points_response" => "LLMObsPatternsClusteredPointsResponse",
          "v2.llm_obs_patterns_clustered_points_response_attributes" => "LLMObsPatternsClusteredPointsResponseAttributes",
          "v2.llm_obs_patterns_clustered_points_response_data" => "LLMObsPatternsClusteredPointsResponseData",
          "v2.llm_obs_patterns_clustered_points_type" => "LLMObsPatternsClusteredPointsType",
          "v2.llm_obs_patterns_config_attributes" => "LLMObsPatternsConfigAttributes",
          "v2.llm_obs_patterns_config_item" => "LLMObsPatternsConfigItem",
          "v2.llm_obs_patterns_config_response" => "LLMObsPatternsConfigResponse",
          "v2.llm_obs_patterns_config_response_data" => "LLMObsPatternsConfigResponseData",
          "v2.llm_obs_patterns_configs_list_type" => "LLMObsPatternsConfigsListType",
          "v2.llm_obs_patterns_config_snapshot" => "LLMObsPatternsConfigSnapshot",
          "v2.llm_obs_patterns_configs_response" => "LLMObsPatternsConfigsResponse",
          "v2.llm_obs_patterns_configs_response_attributes" => "LLMObsPatternsConfigsResponseAttributes",
          "v2.llm_obs_patterns_configs_response_data" => "LLMObsPatternsConfigsResponseData",
          "v2.llm_obs_patterns_config_type" => "LLMObsPatternsConfigType",
          "v2.llm_obs_patterns_config_upsert_request" => "LLMObsPatternsConfigUpsertRequest",
          "v2.llm_obs_patterns_config_upsert_request_attributes" => "LLMObsPatternsConfigUpsertRequestAttributes",
          "v2.llm_obs_patterns_config_upsert_request_data" => "LLMObsPatternsConfigUpsertRequestData",
          "v2.llm_obs_patterns_request_type" => "LLMObsPatternsRequestType",
          "v2.llm_obs_patterns_runs_list_type" => "LLMObsPatternsRunsListType",
          "v2.llm_obs_patterns_runs_response" => "LLMObsPatternsRunsResponse",
          "v2.llm_obs_patterns_runs_response_attributes" => "LLMObsPatternsRunsResponseAttributes",
          "v2.llm_obs_patterns_runs_response_data" => "LLMObsPatternsRunsResponseData",
          "v2.llm_obs_patterns_run_status_response" => "LLMObsPatternsRunStatusResponse",
          "v2.llm_obs_patterns_run_status_response_attributes" => "LLMObsPatternsRunStatusResponseAttributes",
          "v2.llm_obs_patterns_run_status_response_data" => "LLMObsPatternsRunStatusResponseData",
          "v2.llm_obs_patterns_run_status_type" => "LLMObsPatternsRunStatusType",
          "v2.llm_obs_patterns_run_summary" => "LLMObsPatternsRunSummary",
          "v2.llm_obs_patterns_topic" => "LLMObsPatternsTopic",
          "v2.llm_obs_patterns_topics_response" => "LLMObsPatternsTopicsResponse",
          "v2.llm_obs_patterns_topics_response_attributes" => "LLMObsPatternsTopicsResponseAttributes",
          "v2.llm_obs_patterns_topics_response_data" => "LLMObsPatternsTopicsResponseData",
          "v2.llm_obs_patterns_topics_type" => "LLMObsPatternsTopicsType",
          "v2.llm_obs_patterns_topics_with_clustered_points_response" => "LLMObsPatternsTopicsWithClusteredPointsResponse",
          "v2.llm_obs_patterns_topics_with_clustered_points_response_attributes" => "LLMObsPatternsTopicsWithClusteredPointsResponseAttributes",
          "v2.llm_obs_patterns_topics_with_clustered_points_response_data" => "LLMObsPatternsTopicsWithClusteredPointsResponseData",
          "v2.llm_obs_patterns_topics_with_clustered_points_type" => "LLMObsPatternsTopicsWithClusteredPointsType",
          "v2.llm_obs_patterns_topic_with_clustered_points" => "LLMObsPatternsTopicWithClusteredPoints",
          "v2.llm_obs_patterns_trigger_request" => "LLMObsPatternsTriggerRequest",
          "v2.llm_obs_patterns_trigger_request_attributes" => "LLMObsPatternsTriggerRequestAttributes",
          "v2.llm_obs_patterns_trigger_request_data" => "LLMObsPatternsTriggerRequestData",
          "v2.llm_obs_patterns_trigger_response" => "LLMObsPatternsTriggerResponse",
          "v2.llm_obs_patterns_trigger_response_attributes" => "LLMObsPatternsTriggerResponseAttributes",
          "v2.llm_obs_patterns_trigger_response_data" => "LLMObsPatternsTriggerResponseData",
          "v2.llm_obs_patterns_trigger_response_type" => "LLMObsPatternsTriggerResponseType",
          ...
          "v2.llm_obs_project_data_response" => "LLMObsProjectDataResponse",
          "v2.llm_obs_project_request" => "LLMObsProjectRequest",
          "v2.llm_obs_project_response" => "LLMObsProjectResponse",
          "v2.llm_obs_projects_response" => "LLMObsProjectsResponse",
          "v2.llm_obs_project_type" => "LLMObsProjectType",
          ...
          "v2.llm_obs_prompt_sdk_data_attributes" => "LLMObsPromptSDKDataAttributes",
          "v2.llm_obs_prompt_sdk_response" => "LLMObsPromptSDKResponse",
          "v2.llm_obs_prompts_response" => "LLMObsPromptsResponse",
          "v2.llm_obs_prompt_template" => "LLMObsPromptTemplate",
          "v2.llm_obs_prompt_type" => "LLMObsPromptType",
          "v2.llm_obs_prompt_version_data" => "LLMObsPromptVersionData",
          "v2.llm_obs_prompt_version_data_attributes" => "LLMObsPromptVersionDataAttributes",
          "v2.llm_obs_prompt_version_label" => "LLMObsPromptVersionLabel",
          "v2.llm_obs_prompt_version_list_data" => "LLMObsPromptVersionListData",
          "v2.llm_obs_prompt_version_list_data_attributes" => "LLMObsPromptVersionListDataAttributes",
          "v2.llm_obs_prompt_version_response" => "LLMObsPromptVersionResponse",
          "v2.llm_obs_prompt_versions_response" => "LLMObsPromptVersionsResponse",
          "v2.llm_obs_prompt_version_type" => "LLMObsPromptVersionType",
          ...
          "v2.llm_obs_update_prompt_data" => "LLMObsUpdatePromptData",
          "v2.llm_obs_update_prompt_data_attributes" => "LLMObsUpdatePromptDataAttributes",
          "v2.llm_obs_update_prompt_request" => "LLMObsUpdatePromptRequest",
          "v2.llm_obs_update_prompt_version_data" => "LLMObsUpdatePromptVersionData",
          "v2.llm_obs_update_prompt_version_data_attributes" => "LLMObsUpdatePromptVersionDataAttributes",
          "v2.llm_obs_update_prompt_version_request" => "LLMObsUpdatePromptVersionRequest",
          ...
          "v2.maintenance_data_attributes" => "MaintenanceDataAttributes",
          "v2.maintenance_data_attributes_components_affected_items" => "MaintenanceDataAttributesComponentsAffectedItems",
          "v2.maintenance_data_attributes_status" => "MaintenanceDataAttributesStatus",
          "v2.maintenance_data_attributes_updates_items" => "MaintenanceDataAttributesUpdatesItems",
          "v2.maintenance_data_attributes_updates_items_components_affected_items" => "MaintenanceDataAttributesUpdatesItemsComponentsAffectedItems",
          "v2.maintenance_data_relationships" => "MaintenanceDataRelationships",
          "v2.maintenance_data_relationships_created_by_user" => "MaintenanceDataRelationshipsCreatedByUser",
          "v2.maintenance_data_relationships_created_by_user_data" => "MaintenanceDataRelationshipsCreatedByUserData",
          "v2.maintenance_data_relationships_last_modified_by_user" => "MaintenanceDataRelationshipsLastModifiedByUser",
          ...
          "v2.maintenance_data_relationships_template" => "MaintenanceDataRelationshipsTemplate",
          "v2.maintenance_data_relationships_template_data" => "MaintenanceDataRelationshipsTemplateData",
          "v2.maintenance_template" => "MaintenanceTemplate",
          "v2.maintenance_template_array" => "MaintenanceTemplateArray",
          "v2.maintenance_template_data" => "MaintenanceTemplateData",
          "v2.maintenance_template_data_attributes" => "MaintenanceTemplateDataAttributes",
          "v2.maintenance_template_data_relationships" => "MaintenanceTemplateDataRelationships",
          "v2.maintenance_template_data_relationships_created_by_user" => "MaintenanceTemplateDataRelationshipsCreatedByUser",
          "v2.maintenance_template_data_relationships_created_by_user_data" => "MaintenanceTemplateDataRelationshipsCreatedByUserData",
          "v2.maintenance_template_data_relationships_last_modified_by_user" => "MaintenanceTemplateDataRelationshipsLastModifiedByUser",
          ...
          "v2.maintenance_window_create_attributes" => "MaintenanceWindowCreateAttributes",
          "v2.maintenance_window_create_request" => "MaintenanceWindowCreateRequest",
          "v2.maintenance_window_resource_type" => "MaintenanceWindowResourceType",
          "v2.maintenance_window_response" => "MaintenanceWindowResponse",
          "v2.maintenance_windows_response" => "MaintenanceWindowsResponse",
          "v2.maintenance_window_update" => "MaintenanceWindowUpdate",
          "v2.maintenance_window_update_attributes" => "MaintenanceWindowUpdateAttributes",
          "v2.maintenance_window_update_request" => "MaintenanceWindowUpdateRequest",
          ...
          "v2.matching_signal_attributes" => "MatchingSignalAttributes",
          "v2.matching_signal_data" => "MatchingSignalData",
          "v2.matching_signals_response" => "MatchingSignalsResponse",
          "v2.matching_signal_type" => "MatchingSignalType",
          ...
          "v2.mcp_scan_request_data_attributes_libraries_items" => "McpScanRequestDataAttributesLibrariesItems",
          "v2.mcp_scan_request_data_type" => "McpScanRequestDataType",
          "v2.mcp_scan_request_response" => "McpScanRequestResponse",
          "v2.mcp_scan_request_response_data" => "McpScanRequestResponseData",
          "v2.mcp_scan_request_response_data_attributes" => "McpScanRequestResponseDataAttributes",
          "v2.mcp_scan_request_response_data_type" => "McpScanRequestResponseDataType",
          ...
          "v2.model_lab_artifact_info" => "ModelLabArtifactInfo",
          "v2.model_lab_artifact_object_info" => "ModelLabArtifactObjectInfo",
          "v2.model_lab_facet_keys_attributes" => "ModelLabFacetKeysAttributes",
          "v2.model_lab_facet_keys_data" => "ModelLabFacetKeysData",
          "v2.model_lab_facet_keys_response" => "ModelLabFacetKeysResponse",
          "v2.model_lab_facet_keys_type" => "ModelLabFacetKeysType",
          "v2.model_lab_facet_type" => "ModelLabFacetType",
          "v2.model_lab_facet_values_attributes" => "ModelLabFacetValuesAttributes",
          "v2.model_lab_facet_values_data" => "ModelLabFacetValuesData",
          "v2.model_lab_facet_values_response" => "ModelLabFacetValuesResponse",
          "v2.model_lab_facet_values_type" => "ModelLabFacetValuesType",
          "v2.model_lab_metric_stat_range" => "ModelLabMetricStatRange",
          "v2.model_lab_metric_summary" => "ModelLabMetricSummary",
          "v2.model_lab_numeric_range" => "ModelLabNumericRange",
          "v2.model_lab_page_meta" => "ModelLabPageMeta",
          "v2.model_lab_page_meta_page" => "ModelLabPageMetaPage",
          "v2.model_lab_pagination_links" => "ModelLabPaginationLinks",
          "v2.model_lab_project_artifacts_attributes" => "ModelLabProjectArtifactsAttributes",
          "v2.model_lab_project_artifacts_data" => "ModelLabProjectArtifactsData",
          "v2.model_lab_project_artifacts_response" => "ModelLabProjectArtifactsResponse",
          "v2.model_lab_project_artifacts_type" => "ModelLabProjectArtifactsType",
          "v2.model_lab_project_attributes" => "ModelLabProjectAttributes",
          "v2.model_lab_project_data" => "ModelLabProjectData",
          "v2.model_lab_project_facet_type" => "ModelLabProjectFacetType",
          "v2.model_lab_project_response" => "ModelLabProjectResponse",
          "v2.model_lab_projects_response" => "ModelLabProjectsResponse",
          "v2.model_lab_project_type" => "ModelLabProjectType",
          "v2.model_lab_run_artifacts_attributes" => "ModelLabRunArtifactsAttributes",
          "v2.model_lab_run_artifacts_data" => "ModelLabRunArtifactsData",
          "v2.model_lab_run_artifacts_response" => "ModelLabRunArtifactsResponse",
          "v2.model_lab_run_artifacts_type" => "ModelLabRunArtifactsType",
          "v2.model_lab_run_attributes" => "ModelLabRunAttributes",
          "v2.model_lab_run_data" => "ModelLabRunData",
          "v2.model_lab_run_param" => "ModelLabRunParam",
          "v2.model_lab_run_response" => "ModelLabRunResponse",
          "v2.model_lab_runs_response" => "ModelLabRunsResponse",
          "v2.model_lab_run_status" => "ModelLabRunStatus",
          "v2.model_lab_run_type" => "ModelLabRunType",
          "v2.model_lab_tag" => "ModelLabTag",
          ...
          "v2.mute_data_type" => "MuteDataType",
          "v2.mute_findings_mute_attributes" => "MuteFindingsMuteAttributes",
          "v2.mute_findings_reason" => "MuteFindingsReason",
          "v2.mute_findings_request" => "MuteFindingsRequest",
          "v2.mute_findings_request_data" => "MuteFindingsRequestData",
          "v2.mute_findings_request_data_attributes" => "MuteFindingsRequestDataAttributes",
          ...
          "v2.network_health_insight_attributes" => "NetworkHealthInsightAttributes",
          "v2.network_health_insight_category" => "NetworkHealthInsightCategory",
          "v2.network_health_insight_failure_type" => "NetworkHealthInsightFailureType",
          "v2.network_health_insights_response" => "NetworkHealthInsightsResponse",
          "v2.network_health_insights_type" => "NetworkHealthInsightsType",
          "v2.network_health_insight_traffic_volume" => "NetworkHealthInsightTrafficVolume",
          "v2.node_types_response" => "NodeTypesResponse",
          "v2.node_types_response_data" => "NodeTypesResponseData",
          "v2.node_types_response_data_attributes" => "NodeTypesResponseDataAttributes",
          "v2.node_types_response_data_type" => "NodeTypesResponseDataType",
          "v2.notebook_create_data" => "NotebookCreateData",
          "v2.notebook_create_request" => "NotebookCreateRequest",
          "v2.notebook_resource_type" => "NotebookResourceType",
          ...
          "v2.o_auth2_well_known_sites_attributes" => "OAuth2WellKnownSitesAttributes",
          "v2.o_auth2_well_known_sites_data" => "OAuth2WellKnownSitesData",
          "v2.o_auth2_well_known_sites_env_type" => "OAuth2WellKnownSitesEnvType",
          "v2.o_auth2_well_known_sites_response" => "OAuth2WellKnownSitesResponse",
          ...
          "v2.observability_pipeline_add_hostname_processor" => "ObservabilityPipelineAddHostnameProcessor",
          "v2.observability_pipeline_add_hostname_processor_type" => "ObservabilityPipelineAddHostnameProcessorType",
          ...
          "v2.observability_pipeline_amazon_s3_destination_compression" => "ObservabilityPipelineAmazonS3DestinationCompression",
          "v2.observability_pipeline_amazon_s3_destination_compression_gzip" => "ObservabilityPipelineAmazonS3DestinationCompressionGzip",
          "v2.observability_pipeline_amazon_s3_destination_compression_gzip_type" => "ObservabilityPipelineAmazonS3DestinationCompressionGzipType",
          ...
          "v2.observability_pipeline_azure_storage_destination_compression" => "ObservabilityPipelineAzureStorageDestinationCompression",
          "v2.observability_pipeline_azure_storage_destination_compression_gzip" => "ObservabilityPipelineAzureStorageDestinationCompressionGzip",
          "v2.observability_pipeline_azure_storage_destination_compression_gzip_type" => "ObservabilityPipelineAzureStorageDestinationCompressionGzipType",
          "v2.observability_pipeline_azure_storage_destination_compression_zstd" => "ObservabilityPipelineAzureStorageDestinationCompressionZstd",
          "v2.observability_pipeline_azure_storage_destination_compression_zstd_type" => "ObservabilityPipelineAzureStorageDestinationCompressionZstdType",
          ...
          "v2.observability_pipeline_enrichment_table_field_event_lookup" => "ObservabilityPipelineEnrichmentTableFieldEventLookup",
          "v2.observability_pipeline_enrichment_table_field_secret_lookup" => "ObservabilityPipelineEnrichmentTableFieldSecretLookup",
          "v2.observability_pipeline_enrichment_table_field_vrl_lookup" => "ObservabilityPipelineEnrichmentTableFieldVrlLookup",
          ...
          "v2.observability_pipeline_enrichment_table_file_key_item_field" => "ObservabilityPipelineEnrichmentTableFileKeyItemField",
          ...
          "v2.observability_pipeline_google_cloud_storage_destination_compression" => "ObservabilityPipelineGoogleCloudStorageDestinationCompression",
          "v2.observability_pipeline_google_cloud_storage_destination_compression_gzip" => "ObservabilityPipelineGoogleCloudStorageDestinationCompressionGzip",
          "v2.observability_pipeline_google_cloud_storage_destination_compression_gzip_type" => "ObservabilityPipelineGoogleCloudStorageDestinationCompressionGzipType",
          "v2.observability_pipeline_google_cloud_storage_destination_compression_zstd" => "ObservabilityPipelineGoogleCloudStorageDestinationCompressionZstd",
          "v2.observability_pipeline_google_cloud_storage_destination_compression_zstd_type" => "ObservabilityPipelineGoogleCloudStorageDestinationCompressionZstdType",
          ...
          "v2.observability_pipeline_kafka_destination_type" => "ObservabilityPipelineKafkaDestinationType",
          "v2.observability_pipeline_kafka_librdkafka_option" => "ObservabilityPipelineKafkaLibrdkafkaOption",
          "v2.observability_pipeline_kafka_sasl" => "ObservabilityPipelineKafkaSasl",
          "v2.observability_pipeline_kafka_sasl_mechanism" => "ObservabilityPipelineKafkaSaslMechanism",
          ...
          "v2.observability_pipeline_ocsf_mapping_custom_field_mapping" => "ObservabilityPipelineOcsfMappingCustomFieldMapping",
          "v2.observability_pipeline_ocsf_mapping_custom_lookup" => "ObservabilityPipelineOcsfMappingCustomLookup",
          "v2.observability_pipeline_ocsf_mapping_custom_lookup_table_entry" => "ObservabilityPipelineOcsfMappingCustomLookupTableEntry",
          "v2.observability_pipeline_ocsf_mapping_custom_metadata" => "ObservabilityPipelineOcsfMappingCustomMetadata",
          ...
          "v2.observability_pipeline_parse_grok_processor_include_rule" => "ObservabilityPipelineParseGrokProcessorIncludeRule",
          "v2.observability_pipeline_parse_grok_processor_rule" => "ObservabilityPipelineParseGrokProcessorRule",
          "v2.observability_pipeline_parse_grok_processor_rule_item" => "ObservabilityPipelineParseGrokProcessorRuleItem",
          ...
          "v2.observability_pipeline_parse_xml_processor" => "ObservabilityPipelineParseXMLProcessor",
          "v2.observability_pipeline_parse_xml_processor_type" => "ObservabilityPipelineParseXMLProcessorType",
          "v2.observability_pipeline_prometheus_remote_write_destination" => "ObservabilityPipelinePrometheusRemoteWriteDestination",
          "v2.observability_pipeline_prometheus_remote_write_destination_auth_strategy" => "ObservabilityPipelinePrometheusRemoteWriteDestinationAuthStrategy",
          "v2.observability_pipeline_prometheus_remote_write_destination_type" => "ObservabilityPipelinePrometheusRemoteWriteDestinationType",
          "v2.observability_pipeline_prometheus_remote_write_source" => "ObservabilityPipelinePrometheusRemoteWriteSource",
          "v2.observability_pipeline_prometheus_remote_write_source_auth_strategy" => "ObservabilityPipelinePrometheusRemoteWriteSourceAuthStrategy",
          "v2.observability_pipeline_prometheus_remote_write_source_type" => "ObservabilityPipelinePrometheusRemoteWriteSourceType",
          "v2.observability_pipeline_prometheus_remote_write_source_valid_token" => "ObservabilityPipelinePrometheusRemoteWriteSourceValidToken",
          ...
          "v2.observability_pipeline_rename_metric_tags_processor_tag" => "ObservabilityPipelineRenameMetricTagsProcessorTag",
          "v2.observability_pipeline_rename_metric_tags_processor_type" => "ObservabilityPipelineRenameMetricTagsProcessorType",
          ...
          "v2.observability_pipeline_split_array_processor_array_config" => "ObservabilityPipelineSplitArrayProcessorArrayConfig",
          ...
          "v2.opsgenie_account_create_attributes" => "OpsgenieAccountCreateAttributes",
          "v2.opsgenie_account_create_data" => "OpsgenieAccountCreateData",
          "v2.opsgenie_account_create_request" => "OpsgenieAccountCreateRequest",
          "v2.opsgenie_account_response" => "OpsgenieAccountResponse",
          "v2.opsgenie_account_response_attributes" => "OpsgenieAccountResponseAttributes",
          "v2.opsgenie_account_response_data" => "OpsgenieAccountResponseData",
          "v2.opsgenie_accounts_response" => "OpsgenieAccountsResponse",
          "v2.opsgenie_account_type" => "OpsgenieAccountType",
          "v2.opsgenie_account_update_attributes" => "OpsgenieAccountUpdateAttributes",
          "v2.opsgenie_account_update_data" => "OpsgenieAccountUpdateData",
          "v2.opsgenie_account_update_request" => "OpsgenieAccountUpdateRequest",
          ...
          "v2.org_authorized_client_attributes" => "OrgAuthorizedClientAttributes",
          "v2.org_authorized_client_data" => "OrgAuthorizedClientData",
          "v2.org_authorized_client_relationship_o_auth2_client" => "OrgAuthorizedClientRelationshipOAuth2Client",
          "v2.org_authorized_client_relationship_o_auth2_client_data" => "OrgAuthorizedClientRelationshipOAuth2ClientData",
          "v2.org_authorized_client_relationship_o_auth2_client_data_type" => "OrgAuthorizedClientRelationshipOAuth2ClientDataType",
          "v2.org_authorized_client_relationships" => "OrgAuthorizedClientRelationships",
          "v2.org_authorized_client_relationship_user_authorized_clients" => "OrgAuthorizedClientRelationshipUserAuthorizedClients",
          "v2.org_authorized_client_relationship_user_authorized_clients_data" => "OrgAuthorizedClientRelationshipUserAuthorizedClientsData",
          "v2.org_authorized_client_relationship_user_authorized_clients_data_type" => "OrgAuthorizedClientRelationshipUserAuthorizedClientsDataType",
          "v2.org_authorized_client_relationship_user_authorized_clients_links" => "OrgAuthorizedClientRelationshipUserAuthorizedClientsLinks",
          "v2.org_authorized_client_response" => "OrgAuthorizedClientResponse",
          "v2.org_authorized_clients_response" => "OrgAuthorizedClientsResponse",
          "v2.org_authorized_client_type" => "OrgAuthorizedClientType",
          "v2.org_authorized_client_update_attributes" => "OrgAuthorizedClientUpdateAttributes",
          "v2.org_authorized_client_update_data" => "OrgAuthorizedClientUpdateData",
          "v2.org_authorized_client_update_request" => "OrgAuthorizedClientUpdateRequest",
          "v2.org_authorized_client_user_authorizations_sort" => "OrgAuthorizedClientUserAuthorizationsSort",
          ...
          "v2.ownership_confidence_level" => "OwnershipConfidenceLevel",
          ...
          "v2.ownership_settings_attributes" => "OwnershipSettingsAttributes",
          "v2.ownership_settings_data" => "OwnershipSettingsData",
          "v2.ownership_settings_request" => "OwnershipSettingsRequest",
          "v2.ownership_settings_request_attributes" => "OwnershipSettingsRequestAttributes",
          "v2.ownership_settings_request_data" => "OwnershipSettingsRequestData",
          "v2.ownership_settings_response" => "OwnershipSettingsResponse",
          "v2.ownership_settings_type" => "OwnershipSettingsType",
          "v2.ownership_untagged_findings_attributes" => "OwnershipUntaggedFindingsAttributes",
          "v2.ownership_untagged_findings_data" => "OwnershipUntaggedFindingsData",
          "v2.ownership_untagged_findings_response" => "OwnershipUntaggedFindingsResponse",
          "v2.ownership_untagged_findings_type" => "OwnershipUntaggedFindingsType",
          ...
          "v2.page_annotations_type" => "PageAnnotationsType",
          "v2.page_urgency" => "PageUrgency",
          "v2.paginated_response_meta" => "PaginatedResponseMeta",
          "v2.pagination" => "Pagination",
          "v2.pagination_meta" => "PaginationMeta",
          "v2.pagination_meta_page" => "PaginationMetaPage",
          "v2.pagination_meta_page_type" => "PaginationMetaPageType",
          ...
          "v2.patch_component_request" => "PatchComponentRequest",
          "v2.patch_component_request_data" => "PatchComponentRequestData",
          "v2.patch_component_request_data_attributes" => "PatchComponentRequestDataAttributes",
          "v2.patch_degradation_request" => "PatchDegradationRequest",
          "v2.patch_degradation_request_data" => "PatchDegradationRequestData",
          "v2.patch_degradation_request_data_attributes" => "PatchDegradationRequestDataAttributes",
          ...
          "v2.patch_degradation_request_data_relationships" => "PatchDegradationRequestDataRelationships",
          "v2.patch_degradation_request_data_relationships_template" => "PatchDegradationRequestDataRelationshipsTemplate",
          "v2.patch_degradation_request_data_relationships_template_data" => "PatchDegradationRequestDataRelationshipsTemplateData",
          "v2.patch_degradation_request_data_type" => "PatchDegradationRequestDataType",
          "v2.patch_degradation_template_request" => "PatchDegradationTemplateRequest",
          "v2.patch_degradation_template_request_data" => "PatchDegradationTemplateRequestData",
          "v2.patch_degradation_template_request_data_attributes" => "PatchDegradationTemplateRequestDataAttributes",
          "v2.patch_degradation_template_request_data_attributes_components_affected_items" => "PatchDegradationTemplateRequestDataAttributesComponentsAffectedItems",
          "v2.patch_degradation_template_request_data_attributes_components_affected_items_status" => "PatchDegradationTemplateRequestDataAttributesComponentsAffectedItemsStatus",
          "v2.patch_degradation_template_request_data_attributes_updates_items" => "PatchDegradationTemplateRequestDataAttributesUpdatesItems",
          "v2.patch_degradation_template_request_data_type" => "PatchDegradationTemplateRequestDataType",
          ...
          "v2.patch_maintenance_request_data_attributes" => "PatchMaintenanceRequestDataAttributes",
          "v2.patch_maintenance_request_data_attributes_components_affected_items" => "PatchMaintenanceRequestDataAttributesComponentsAffectedItems",
          "v2.patch_maintenance_request_data_attributes_components_affected_items_status" => "PatchMaintenanceRequestDataAttributesComponentsAffectedItemsStatus",
          "v2.patch_maintenance_request_data_relationships" => "PatchMaintenanceRequestDataRelationships",
          "v2.patch_maintenance_request_data_relationships_template" => "PatchMaintenanceRequestDataRelationshipsTemplate",
          "v2.patch_maintenance_request_data_relationships_template_data" => "PatchMaintenanceRequestDataRelationshipsTemplateData",
          "v2.patch_maintenance_request_data_type" => "PatchMaintenanceRequestDataType",
          "v2.patch_maintenance_template_request" => "PatchMaintenanceTemplateRequest",
          ...
          "v2.patch_status_page_request" => "PatchStatusPageRequest",
          "v2.patch_status_page_request_data" => "PatchStatusPageRequestData",
          "v2.patch_status_page_request_data_attributes" => "PatchStatusPageRequestDataAttributes",
          "v2.patch_table_request" => "PatchTableRequest",
          "v2.patch_table_request_data" => "PatchTableRequestData",
          "v2.patch_table_request_data_attributes" => "PatchTableRequestDataAttributes",
          "v2.patch_table_request_data_attributes_file_metadata" => "PatchTableRequestDataAttributesFileMetadata",
          "v2.patch_table_request_data_attributes_file_metadata_cloud_storage" => "PatchTableRequestDataAttributesFileMetadataCloudStorage",
          "v2.patch_table_request_data_attributes_file_metadata_local_file" => "PatchTableRequestDataAttributesFileMetadataLocalFile",
          "v2.patch_table_request_data_attributes_file_metadata_one_of_access_details" => "PatchTableRequestDataAttributesFileMetadataOneOfAccessDetails",
          "v2.patch_table_request_data_attributes_file_metadata_one_of_access_details_aws_detail" => "PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsAwsDetail",
          "v2.patch_table_request_data_attributes_file_metadata_one_of_access_details_azure_detail" => "PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsAzureDetail",
          "v2.patch_table_request_data_attributes_file_metadata_one_of_access_details_gcp_detail" => "PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail",
          "v2.patch_table_request_data_attributes_schema" => "PatchTableRequestDataAttributesSchema",
          "v2.patch_table_request_data_attributes_schema_fields_items" => "PatchTableRequestDataAttributesSchemaFieldsItems",
          "v2.patch_table_request_data_type" => "PatchTableRequestDataType",
          ...
          "v2.personal_access_token" => "PersonalAccessToken",
          "v2.personal_access_token_attributes" => "PersonalAccessTokenAttributes",
          "v2.personal_access_token_create_attributes" => "PersonalAccessTokenCreateAttributes",
          "v2.personal_access_token_create_data" => "PersonalAccessTokenCreateData",
          "v2.personal_access_token_create_request" => "PersonalAccessTokenCreateRequest",
          "v2.personal_access_token_create_response" => "PersonalAccessTokenCreateResponse",
          "v2.personal_access_token_relationships" => "PersonalAccessTokenRelationships",
          "v2.personal_access_token_response" => "PersonalAccessTokenResponse",
          "v2.personal_access_token_response_meta" => "PersonalAccessTokenResponseMeta",
          "v2.personal_access_token_response_meta_page" => "PersonalAccessTokenResponseMetaPage",
          "v2.personal_access_tokens_sort" => "PersonalAccessTokensSort",
          "v2.personal_access_tokens_type" => "PersonalAccessTokensType",
          "v2.personal_access_token_update_attributes" => "PersonalAccessTokenUpdateAttributes",
          "v2.personal_access_token_update_data" => "PersonalAccessTokenUpdateData",
          "v2.personal_access_token_update_request" => "PersonalAccessTokenUpdateRequest",
          "v2.playlist" => "Playlist",
          "v2.playlist_array" => "PlaylistArray",
          "v2.playlist_data" => "PlaylistData",
          "v2.playlist_data_attributes" => "PlaylistDataAttributes",
          "v2.playlist_data_attributes_created_by" => "PlaylistDataAttributesCreatedBy",
          "v2.playlist_data_type" => "PlaylistDataType",
          "v2.playlists_session" => "PlaylistsSession",
          "v2.playlists_session_array" => "PlaylistsSessionArray",
          "v2.playlists_session_data" => "PlaylistsSessionData",
          "v2.playlists_session_data_attributes" => "PlaylistsSessionDataAttributes",
          ...
          "v2.pr_coverage_summary_request" => "PRCoverageSummaryRequest",
          "v2.pr_coverage_summary_request_attributes" => "PRCoverageSummaryRequestAttributes",
          "v2.pr_coverage_summary_request_data" => "PRCoverageSummaryRequestData",
          "v2.pr_coverage_summary_request_type" => "PRCoverageSummaryRequestType",
          ...
          "v2.process_timeseries_query" => "ProcessTimeseriesQuery",
          "v2.product_analytics_analytics_list_query" => "ProductAnalyticsAnalyticsListQuery",
          "v2.product_analytics_analytics_list_request" => "ProductAnalyticsAnalyticsListRequest",
          "v2.product_analytics_analytics_list_request_attributes" => "ProductAnalyticsAnalyticsListRequestAttributes",
          "v2.product_analytics_analytics_list_request_data" => "ProductAnalyticsAnalyticsListRequestData",
          "v2.product_analytics_analytics_list_request_type" => "ProductAnalyticsAnalyticsListRequestType",
          "v2.product_analytics_analytics_list_response" => "ProductAnalyticsAnalyticsListResponse",
          "v2.product_analytics_analytics_list_response_attributes" => "ProductAnalyticsAnalyticsListResponseAttributes",
          "v2.product_analytics_analytics_list_response_data" => "ProductAnalyticsAnalyticsListResponseData",
          "v2.product_analytics_analytics_list_response_type" => "ProductAnalyticsAnalyticsListResponseType",
          "v2.product_analytics_analytics_list_sort" => "ProductAnalyticsAnalyticsListSort",
          "v2.product_analytics_analytics_list_sort_order" => "ProductAnalyticsAnalyticsListSortOrder",
          ...
          "v2.product_analytics_calendar_interval" => "ProductAnalyticsCalendarInterval",
          "v2.product_analytics_calendar_interval_type" => "ProductAnalyticsCalendarIntervalType",
          "v2.product_analytics_compute" => "ProductAnalyticsCompute",
          "v2.product_analytics_elapsed_time" => "ProductAnalyticsElapsedTime",
          ...
          "v2.product_analytics_formula_journey_query" => "ProductAnalyticsFormulaJourneyQuery",
          "v2.product_analytics_formula_journey_request" => "ProductAnalyticsFormulaJourneyRequest",
          "v2.product_analytics_formula_journey_request_attributes" => "ProductAnalyticsFormulaJourneyRequestAttributes",
          "v2.product_analytics_formula_journey_request_data" => "ProductAnalyticsFormulaJourneyRequestData",
          "v2.product_analytics_formula_journey_request_type" => "ProductAnalyticsFormulaJourneyRequestType",
          "v2.product_analytics_formula_retention_query" => "ProductAnalyticsFormulaRetentionQuery",
          "v2.product_analytics_formula_retention_request" => "ProductAnalyticsFormulaRetentionRequest",
          "v2.product_analytics_formula_retention_request_attributes" => "ProductAnalyticsFormulaRetentionRequestAttributes",
          "v2.product_analytics_formula_retention_request_data" => "ProductAnalyticsFormulaRetentionRequestData",
          "v2.product_analytics_formula_retention_request_type" => "ProductAnalyticsFormulaRetentionRequestType",
          "v2.product_analytics_graph_query_compute" => "ProductAnalyticsGraphQueryCompute",
          "v2.product_analytics_graph_query_group_by" => "ProductAnalyticsGraphQueryGroupBy",
          "v2.product_analytics_graph_query_group_by_source" => "ProductAnalyticsGraphQueryGroupBySource",
          ...
          "v2.product_analytics_join_keys" => "ProductAnalyticsJoinKeys",
          "v2.product_analytics_journey_audience_account_query" => "ProductAnalyticsJourneyAudienceAccountQuery",
          "v2.product_analytics_journey_audience_filters" => "ProductAnalyticsJourneyAudienceFilters",
          "v2.product_analytics_journey_audience_segment_query" => "ProductAnalyticsJourneyAudienceSegmentQuery",
          "v2.product_analytics_journey_audience_user_query" => "ProductAnalyticsJourneyAudienceUserQuery",
          "v2.product_analytics_journey_computed_column" => "ProductAnalyticsJourneyComputedColumn",
          "v2.product_analytics_journey_computed_column_name" => "ProductAnalyticsJourneyComputedColumnName",
          "v2.product_analytics_journey_conversion_type" => "ProductAnalyticsJourneyConversionType",
          "v2.product_analytics_journey_entity" => "ProductAnalyticsJourneyEntity",
          "v2.product_analytics_journey_funnel_compute" => "ProductAnalyticsJourneyFunnelCompute",
          "v2.product_analytics_journey_funnel_query" => "ProductAnalyticsJourneyFunnelQuery",
          "v2.product_analytics_journey_funnel_request" => "ProductAnalyticsJourneyFunnelRequest",
          "v2.product_analytics_journey_funnel_request_attributes" => "ProductAnalyticsJourneyFunnelRequestAttributes",
          "v2.product_analytics_journey_funnel_request_data" => "ProductAnalyticsJourneyFunnelRequestData",
          "v2.product_analytics_journey_funnel_response" => "ProductAnalyticsJourneyFunnelResponse",
          "v2.product_analytics_journey_funnel_response_attributes" => "ProductAnalyticsJourneyFunnelResponseAttributes",
          "v2.product_analytics_journey_funnel_response_data" => "ProductAnalyticsJourneyFunnelResponseData",
          "v2.product_analytics_journey_funnel_response_type" => "ProductAnalyticsJourneyFunnelResponseType",
          "v2.product_analytics_journey_funnel_step" => "ProductAnalyticsJourneyFunnelStep",
          "v2.product_analytics_journey_funnel_step_group" => "ProductAnalyticsJourneyFunnelStepGroup",
          "v2.product_analytics_journey_list_query" => "ProductAnalyticsJourneyListQuery",
          "v2.product_analytics_journey_list_request" => "ProductAnalyticsJourneyListRequest",
          "v2.product_analytics_journey_list_request_attributes" => "ProductAnalyticsJourneyListRequestAttributes",
          "v2.product_analytics_journey_list_request_data" => "ProductAnalyticsJourneyListRequestData",
          "v2.product_analytics_journey_list_request_type" => "ProductAnalyticsJourneyListRequestType",
          "v2.product_analytics_journey_list_response" => "ProductAnalyticsJourneyListResponse",
          "v2.product_analytics_journey_list_response_attributes" => "ProductAnalyticsJourneyListResponseAttributes",
          "v2.product_analytics_journey_list_response_data" => "ProductAnalyticsJourneyListResponseData",
          "v2.product_analytics_journey_list_response_type" => "ProductAnalyticsJourneyListResponseType",
          "v2.product_analytics_journey_list_sort" => "ProductAnalyticsJourneyListSort",
          "v2.product_analytics_journey_node_target" => "ProductAnalyticsJourneyNodeTarget",
          "v2.product_analytics_journey_node_target_type" => "ProductAnalyticsJourneyNodeTargetType",
          "v2.product_analytics_journey_path_target" => "ProductAnalyticsJourneyPathTarget",
          "v2.product_analytics_journey_path_target_type" => "ProductAnalyticsJourneyPathTargetType",
          "v2.product_analytics_journey_request_type" => "ProductAnalyticsJourneyRequestType",
          "v2.product_analytics_journey_scalar_compute" => "ProductAnalyticsJourneyScalarCompute",
          "v2.product_analytics_journey_scalar_query" => "ProductAnalyticsJourneyScalarQuery",
          "v2.product_analytics_journey_scalar_request" => "ProductAnalyticsJourneyScalarRequest",
          "v2.product_analytics_journey_scalar_request_attributes" => "ProductAnalyticsJourneyScalarRequestAttributes",
          "v2.product_analytics_journey_scalar_request_data" => "ProductAnalyticsJourneyScalarRequestData",
          "v2.product_analytics_journey_scalar_response" => "ProductAnalyticsJourneyScalarResponse",
          "v2.product_analytics_journey_scalar_response_data" => "ProductAnalyticsJourneyScalarResponseData",
          "v2.product_analytics_journey_scalar_response_type" => "ProductAnalyticsJourneyScalarResponseType",
          "v2.product_analytics_journey_search" => "ProductAnalyticsJourneySearch",
          "v2.product_analytics_journey_search_filters" => "ProductAnalyticsJourneySearchFilters",
          "v2.product_analytics_journey_search_graph_filter" => "ProductAnalyticsJourneySearchGraphFilter",
          "v2.product_analytics_journey_search_graph_filter_name" => "ProductAnalyticsJourneySearchGraphFilterName",
          "v2.product_analytics_journey_search_graph_filter_operator" => "ProductAnalyticsJourneySearchGraphFilterOperator",
          "v2.product_analytics_journey_target" => "ProductAnalyticsJourneyTarget",
          "v2.product_analytics_journey_timeseries_response" => "ProductAnalyticsJourneyTimeseriesResponse",
          "v2.product_analytics_journey_timeseries_response_data" => "ProductAnalyticsJourneyTimeseriesResponseData",
          "v2.product_analytics_journey_timeseries_response_type" => "ProductAnalyticsJourneyTimeseriesResponseType",
          ...
          "v2.product_analytics_retention_aggregation_target" => "ProductAnalyticsRetentionAggregationTarget",
          "v2.product_analytics_retention_aggregation_target_type" => "ProductAnalyticsRetentionAggregationTargetType",
          "v2.product_analytics_retention_calendar_time_interval" => "ProductAnalyticsRetentionCalendarTimeInterval",
          "v2.product_analytics_retention_calendar_time_interval_type" => "ProductAnalyticsRetentionCalendarTimeIntervalType",
          "v2.product_analytics_retention_cell_scope" => "ProductAnalyticsRetentionCellScope",
          "v2.product_analytics_retention_cell_scope_type" => "ProductAnalyticsRetentionCellScopeType",
          "v2.product_analytics_retention_cohort_criteria" => "ProductAnalyticsRetentionCohortCriteria",
          "v2.product_analytics_retention_cohort_scope" => "ProductAnalyticsRetentionCohortScope",
          "v2.product_analytics_retention_cohort_scope_type" => "ProductAnalyticsRetentionCohortScopeType",
          "v2.product_analytics_retention_cohort_target" => "ProductAnalyticsRetentionCohortTarget",
          "v2.product_analytics_retention_compute" => "ProductAnalyticsRetentionCompute",
          "v2.product_analytics_retention_compute_metric" => "ProductAnalyticsRetentionComputeMetric",
          "v2.product_analytics_retention_entity" => "ProductAnalyticsRetentionEntity",
          "v2.product_analytics_retention_filters" => "ProductAnalyticsRetentionFilters",
          "v2.product_analytics_retention_fixed_time_interval" => "ProductAnalyticsRetentionFixedTimeInterval",
          "v2.product_analytics_retention_fixed_time_interval_type" => "ProductAnalyticsRetentionFixedTimeIntervalType",
          "v2.product_analytics_retention_fixed_time_interval_unit" => "ProductAnalyticsRetentionFixedTimeIntervalUnit",
          "v2.product_analytics_retention_grid_cohort" => "ProductAnalyticsRetentionGridCohort",
          "v2.product_analytics_retention_grid_cohort_cell" => "ProductAnalyticsRetentionGridCohortCell",
          "v2.product_analytics_retention_grid_cohort_type" => "ProductAnalyticsRetentionGridCohortType",
          "v2.product_analytics_retention_grid_query" => "ProductAnalyticsRetentionGridQuery",
          "v2.product_analytics_retention_grid_request" => "ProductAnalyticsRetentionGridRequest",
          "v2.product_analytics_retention_grid_request_attributes" => "ProductAnalyticsRetentionGridRequestAttributes",
          "v2.product_analytics_retention_grid_request_data" => "ProductAnalyticsRetentionGridRequestData",
          "v2.product_analytics_retention_grid_request_type" => "ProductAnalyticsRetentionGridRequestType",
          "v2.product_analytics_retention_grid_response" => "ProductAnalyticsRetentionGridResponse",
          "v2.product_analytics_retention_grid_response_attributes" => "ProductAnalyticsRetentionGridResponseAttributes",
          "v2.product_analytics_retention_grid_response_data" => "ProductAnalyticsRetentionGridResponseData",
          "v2.product_analytics_retention_grid_response_type" => "ProductAnalyticsRetentionGridResponseType",
          "v2.product_analytics_retention_group_by" => "ProductAnalyticsRetentionGroupBy",
          "v2.product_analytics_retention_group_by_target" => "ProductAnalyticsRetentionGroupByTarget",
          "v2.product_analytics_retention_index_target" => "ProductAnalyticsRetentionIndexTarget",
          "v2.product_analytics_retention_index_target_type" => "ProductAnalyticsRetentionIndexTargetType",
          "v2.product_analytics_retention_list_column" => "ProductAnalyticsRetentionListColumn",
          "v2.product_analytics_retention_list_column_field" => "ProductAnalyticsRetentionListColumnField",
          "v2.product_analytics_retention_list_query" => "ProductAnalyticsRetentionListQuery",
          "v2.product_analytics_retention_list_request" => "ProductAnalyticsRetentionListRequest",
          "v2.product_analytics_retention_list_request_attributes" => "ProductAnalyticsRetentionListRequestAttributes",
          "v2.product_analytics_retention_list_request_data" => "ProductAnalyticsRetentionListRequestData",
          "v2.product_analytics_retention_list_request_type" => "ProductAnalyticsRetentionListRequestType",
          "v2.product_analytics_retention_list_response" => "ProductAnalyticsRetentionListResponse",
          "v2.product_analytics_retention_list_response_attributes" => "ProductAnalyticsRetentionListResponseAttributes",
          "v2.product_analytics_retention_list_response_data" => "ProductAnalyticsRetentionListResponseData",
          "v2.product_analytics_retention_list_response_type" => "ProductAnalyticsRetentionListResponseType",
          "v2.product_analytics_retention_period" => "ProductAnalyticsRetentionPeriod",
          "v2.product_analytics_retention_return_condition" => "ProductAnalyticsRetentionReturnCondition",
          "v2.product_analytics_retention_return_criteria" => "ProductAnalyticsRetentionReturnCriteria",
          "v2.product_analytics_retention_return_period_scope" => "ProductAnalyticsRetentionReturnPeriodScope",
          "v2.product_analytics_retention_return_period_scope_type" => "ProductAnalyticsRetentionReturnPeriodScopeType",
          "v2.product_analytics_retention_scope" => "ProductAnalyticsRetentionScope",
          "v2.product_analytics_retention_search" => "ProductAnalyticsRetentionSearch",
          "v2.product_analytics_retention_time_interval" => "ProductAnalyticsRetentionTimeInterval",
          "v2.product_analytics_sankey_aggregated_node" => "ProductAnalyticsSankeyAggregatedNode",
          "v2.product_analytics_sankey_aggregated_node_type" => "ProductAnalyticsSankeyAggregatedNodeType",
          "v2.product_analytics_sankey_definition" => "ProductAnalyticsSankeyDefinition",
          "v2.product_analytics_sankey_link" => "ProductAnalyticsSankeyLink",
          "v2.product_analytics_sankey_node" => "ProductAnalyticsSankeyNode",
          "v2.product_analytics_sankey_node_type" => "ProductAnalyticsSankeyNodeType",
          "v2.product_analytics_sankey_request" => "ProductAnalyticsSankeyRequest",
          "v2.product_analytics_sankey_request_attributes" => "ProductAnalyticsSankeyRequestAttributes",
          "v2.product_analytics_sankey_request_data" => "ProductAnalyticsSankeyRequestData",
          "v2.product_analytics_sankey_request_type" => "ProductAnalyticsSankeyRequestType",
          "v2.product_analytics_sankey_response" => "ProductAnalyticsSankeyResponse",
          "v2.product_analytics_sankey_response_attributes" => "ProductAnalyticsSankeyResponseAttributes",
          "v2.product_analytics_sankey_response_data" => "ProductAnalyticsSankeyResponseData",
          "v2.product_analytics_sankey_response_type" => "ProductAnalyticsSankeyResponseType",
          "v2.product_analytics_sankey_search" => "ProductAnalyticsSankeySearch",
          "v2.product_analytics_sankey_time" => "ProductAnalyticsSankeyTime",
          ...
          "v2.product_catalog_sku_allotment" => "ProductCatalogSKUAllotment",
          "v2.product_catalog_sku_data_attributes_response" => "ProductCatalogSKUDataAttributesResponse",
          "v2.product_catalog_sku_data_response" => "ProductCatalogSKUDataResponse",
          "v2.product_catalog_sku_on_demand_option" => "ProductCatalogSKUOnDemandOption",
          "v2.product_catalog_sku_pricing_tier" => "ProductCatalogSKUPricingTier",
          "v2.product_catalog_sku_pricing_type" => "ProductCatalogSKUPricingType",
          "v2.product_catalog_sku_pricing_unit_type" => "ProductCatalogSKUPricingUnitType",
          "v2.product_catalog_sk_us_api_version" => "ProductCatalogSKUsAPIVersion",
          "v2.product_catalog_sk_us_response" => "ProductCatalogSKUsResponse",
          "v2.product_catalog_sku_tiered_pricing" => "ProductCatalogSKUTieredPricing",
          "v2.product_catalog_sku_type" => "ProductCatalogSKUType",
          "v2.project" => "Project",
          "v2.project_attributes" => "ProjectAttributes",
          "v2.project_columns_config" => "ProjectColumnsConfig",
          "v2.project_columns_config_columns_items" => "ProjectColumnsConfigColumnsItems",
          "v2.project_columns_config_columns_items_sort" => "ProjectColumnsConfigColumnsItemsSort",
          ...
          "v2.project_settings" => "ProjectSettings",
          ...
          "v2.publish_form_data" => "PublishFormData",
          "v2.publish_form_data_attributes" => "PublishFormDataAttributes",
          "v2.publish_form_request" => "PublishFormRequest",
          ...
          "v2.react_native_sourcemap_attributes" => "ReactNativeSourcemapAttributes",
          "v2.react_native_sourcemap_data" => "ReactNativeSourcemapData",
          ...
          "v2.recommendations_filter_request_data" => "RecommendationsFilterRequestData",
          "v2.recommendations_filter_request_data_attributes" => "RecommendationsFilterRequestDataAttributes",
          "v2.recommendations_filter_request_data_type" => "RecommendationsFilterRequestDataType",
          ...
          "v2.reference_table_create_source_type" => "ReferenceTableCreateSourceType",
          "v2.reference_table_schema_field_type" => "ReferenceTableSchemaFieldType",
          "v2.reference_table_sort_type" => "ReferenceTableSortType",
          "v2.reference_table_source_type" => "ReferenceTableSourceType",
          ...
          "v2.relationship_to_access_token_owner" => "RelationshipToAccessTokenOwner",
          "v2.relationship_to_access_token_owner_data" => "RelationshipToAccessTokenOwnerData",
          ...
          "v2.relationship_to_incident_request" => "RelationshipToIncidentRequest",
          ...
          "v2.relationship_to_service_account" => "RelationshipToServiceAccount",
          "v2.relationship_to_service_account_data" => "RelationshipToServiceAccountData",
          ...
          "v2.revert_custom_rule_revision_data_type" => "RevertCustomRuleRevisionDataType",
          ...
          "v2.rollout_options" => "RolloutOptions",
          "v2.rollout_options_request" => "RolloutOptionsRequest",
          "v2.rollout_strategy" => "RolloutStrategy",
          ...
          "v2.rule_based_view_attributes" => "RuleBasedViewAttributes",
          "v2.rule_based_view_compliance_framework" => "RuleBasedViewComplianceFramework",
          "v2.rule_based_view_data" => "RuleBasedViewData",
          "v2.rule_based_view_response" => "RuleBasedViewResponse",
          "v2.rule_based_view_rule" => "RuleBasedViewRule",
          "v2.rule_based_view_rule_category" => "RuleBasedViewRuleCategory",
          "v2.rule_based_view_rule_stats" => "RuleBasedViewRuleStats",
          "v2.rule_based_view_type" => "RuleBasedViewType",
          ...
          "v2.rum_exclusion_filter_attributes" => "RumExclusionFilterAttributes",
          "v2.rum_exclusion_filter_create_attributes" => "RumExclusionFilterCreateAttributes",
          "v2.rum_exclusion_filter_create_data" => "RumExclusionFilterCreateData",
          "v2.rum_exclusion_filter_create_request" => "RumExclusionFilterCreateRequest",
          "v2.rum_exclusion_filter_data" => "RumExclusionFilterData",
          "v2.rum_exclusion_filter_event_type" => "RumExclusionFilterEventType",
          "v2.rum_exclusion_filter_meta" => "RumExclusionFilterMeta",
          "v2.rum_exclusion_filter_response" => "RumExclusionFilterResponse",
          "v2.rum_exclusion_filters_response" => "RumExclusionFiltersResponse",
          "v2.rum_exclusion_filter_type" => "RumExclusionFilterType",
          "v2.rum_exclusion_filter_update_attributes" => "RumExclusionFilterUpdateAttributes",
          "v2.rum_exclusion_filter_update_data" => "RumExclusionFilterUpdateData",
          ...
          "v2.rum_operation_create_request" => "RUMOperationCreateRequest",
          "v2.rum_operation_create_request_data" => "RUMOperationCreateRequestData",
          "v2.rum_operation_journey_composite_rule" => "RUMOperationJourneyCompositeRule",
          "v2.rum_operation_journey_composite_rule_kind" => "RUMOperationJourneyCompositeRuleKind",
          "v2.rum_operation_journey_node" => "RUMOperationJourneyNode",
          "v2.rum_operation_journey_predicate" => "RUMOperationJourneyPredicate",
          "v2.rum_operation_journey_rum" => "RUMOperationJourneyRum",
          "v2.rum_operation_journey_step" => "RUMOperationJourneyStep",
          "v2.rum_operation_journey_step_type" => "RUMOperationJourneyStepType",
          "v2.rum_operation_request_attributes" => "RUMOperationRequestAttributes",
          "v2.rum_operation_response" => "RUMOperationResponse",
          "v2.rum_operation_response_attributes" => "RUMOperationResponseAttributes",
          "v2.rum_operation_response_data" => "RUMOperationResponseData",
          "v2.rum_operations_list_response" => "RUMOperationsListResponse",
          "v2.rum_operations_list_response_meta" => "RUMOperationsListResponseMeta",
          "v2.rum_operations_list_response_meta_page" => "RUMOperationsListResponseMetaPage",
          "v2.rum_operation_strong_link_create_request" => "RUMOperationStrongLinkCreateRequest",
          "v2.rum_operation_strong_link_create_request_attributes" => "RUMOperationStrongLinkCreateRequestAttributes",
          "v2.rum_operation_strong_link_create_request_data" => "RUMOperationStrongLinkCreateRequestData",
          "v2.rum_operation_strong_link_response" => "RUMOperationStrongLinkResponse",
          "v2.rum_operation_strong_link_response_attributes" => "RUMOperationStrongLinkResponseAttributes",
          "v2.rum_operation_strong_link_response_data" => "RUMOperationStrongLinkResponseData",
          "v2.rum_operation_strong_links_list_response" => "RUMOperationStrongLinksListResponse",
          "v2.rum_operation_strong_links_list_response_meta" => "RUMOperationStrongLinksListResponseMeta",
          "v2.rum_operation_strong_link_status" => "RUMOperationStrongLinkStatus",
          "v2.rum_operation_strong_link_type" => "RUMOperationStrongLinkType",
          "v2.rum_operation_strong_link_update_request" => "RUMOperationStrongLinkUpdateRequest",
          "v2.rum_operation_strong_link_update_request_attributes" => "RUMOperationStrongLinkUpdateRequestAttributes",
          "v2.rum_operation_strong_link_update_request_data" => "RUMOperationStrongLinkUpdateRequestData",
          "v2.rum_operation_strong_link_update_status" => "RUMOperationStrongLinkUpdateStatus",
          "v2.rum_operation_type" => "RUMOperationType",
          "v2.rum_operation_update_request" => "RUMOperationUpdateRequest",
          "v2.rum_operation_update_request_data" => "RUMOperationUpdateRequestData",
          "v2.rum_operation_user" => "RUMOperationUser",
          "v2.rum_permanent_retention_filter_attributes" => "RumPermanentRetentionFilterAttributes",
          "v2.rum_permanent_retention_filter_data" => "RumPermanentRetentionFilterData",
          "v2.rum_permanent_retention_filter_editability" => "RumPermanentRetentionFilterEditability",
          "v2.rum_permanent_retention_filter_id" => "RumPermanentRetentionFilterID",
          "v2.rum_permanent_retention_filter_response" => "RumPermanentRetentionFilterResponse",
          "v2.rum_permanent_retention_filters_response" => "RumPermanentRetentionFiltersResponse",
          "v2.rum_permanent_retention_filter_type" => "RumPermanentRetentionFilterType",
          "v2.rum_permanent_retention_filter_update_attributes" => "RumPermanentRetentionFilterUpdateAttributes",
          "v2.rum_permanent_retention_filter_update_data" => "RumPermanentRetentionFilterUpdateData",
          "v2.rum_permanent_retention_filter_update_request" => "RumPermanentRetentionFilterUpdateRequest",
          ...
          "v2.rum_retention_quota_config_type" => "RumRetentionQuotaConfigType",
          "v2.rum_retention_quota_config_update_attributes" => "RumRetentionQuotaConfigUpdateAttributes",
          "v2.rum_retention_quota_config_update_data" => "RumRetentionQuotaConfigUpdateData",
          "v2.rum_retention_quota_config_update_request" => "RumRetentionQuotaConfigUpdateRequest",
          "v2.rum_retention_quota_custom_config" => "RumRetentionQuotaCustomConfig",
          "v2.rum_retention_quota_mode" => "RumRetentionQuotaMode",
          "v2.rum_retention_quota_reached_action" => "RumRetentionQuotaReachedAction",
          "v2.rum_retention_quota_scope_type" => "RumRetentionQuotaScopeType",
          "v2.rum_retention_quota_window_type" => "RumRetentionQuotaWindowType",
          ...
          "v2.run_data_observability_monitor_response" => "RunDataObservabilityMonitorResponse",
          "v2.run_data_observability_monitor_response_data" => "RunDataObservabilityMonitorResponseData",
          ...
          "v2.sample_log_generation_bulk_subscription_request" => "SampleLogGenerationBulkSubscriptionRequest",
          "v2.sample_log_generation_bulk_subscription_request_type" => "SampleLogGenerationBulkSubscriptionRequestType",
          "v2.sample_log_generation_bulk_subscription_response" => "SampleLogGenerationBulkSubscriptionResponse",
          "v2.sample_log_generation_bulk_subscription_result_item" => "SampleLogGenerationBulkSubscriptionResultItem",
          "v2.sample_log_generation_duration" => "SampleLogGenerationDuration",
          "v2.sample_log_generation_subscription_attributes" => "SampleLogGenerationSubscriptionAttributes",
          "v2.sample_log_generation_subscription_create_attributes" => "SampleLogGenerationSubscriptionCreateAttributes",
          "v2.sample_log_generation_subscription_create_data" => "SampleLogGenerationSubscriptionCreateData",
          "v2.sample_log_generation_subscription_create_request" => "SampleLogGenerationSubscriptionCreateRequest",
          "v2.sample_log_generation_subscription_data" => "SampleLogGenerationSubscriptionData",
          "v2.sample_log_generation_subscription_request_type" => "SampleLogGenerationSubscriptionRequestType",
          ...
          "v2.sample_log_generation_subscriptions_response_meta" => "SampleLogGenerationSubscriptionsResponseMeta",
          "v2.sample_log_generation_subscriptions_status_filter" => "SampleLogGenerationSubscriptionsStatusFilter",
          "v2.sample_log_generation_subscription_status" => "SampleLogGenerationSubscriptionStatus",
          "v2.sast_ruleset_data" => "SastRulesetData",
          "v2.sast_ruleset_data_attributes" => "SastRulesetDataAttributes",
          "v2.sast_ruleset_response" => "SastRulesetResponse",
          "v2.sast_rulesets_response" => "SastRulesetsResponse",
          "v2.sbom" => "SBOM",
          ...
          "v2.schedule_list_item" => "ScheduleListItem",
          "v2.schedule_list_item_relationships" => "ScheduleListItemRelationships",
          ...
          "v2.schedules_response_meta" => "SchedulesResponseMeta",
          "v2.schedules_response_meta_page" => "SchedulesResponseMetaPage",
          ...
          "v2.seat_user_data" => "SeatUserData",
          "v2.seat_user_data_array" => "SeatUserDataArray",
          "v2.seat_user_data_attributes" => "SeatUserDataAttributes",
          "v2.seat_user_data_type" => "SeatUserDataType",
          "v2.seat_user_meta" => "SeatUserMeta",
          ...
          "v2.security_filter_version" => "SecurityFilterVersion",
          "v2.security_filter_version_attributes" => "SecurityFilterVersionAttributes",
          "v2.security_filter_version_entry" => "SecurityFilterVersionEntry",
          "v2.security_filter_versions_response" => "SecurityFilterVersionsResponse",
          "v2.security_filter_version_type" => "SecurityFilterVersionType",
          "v2.security_findings_attributes" => "SecurityFindingsAttributes",
          "v2.security_findings_data" => "SecurityFindingsData",
          "v2.security_findings_data_type" => "SecurityFindingsDataType",
          "v2.security_findings_links" => "SecurityFindingsLinks",
          "v2.security_findings_meta" => "SecurityFindingsMeta",
          "v2.security_findings_page" => "SecurityFindingsPage",
          "v2.security_findings_search_request" => "SecurityFindingsSearchRequest",
          "v2.security_findings_search_request_data" => "SecurityFindingsSearchRequestData",
          "v2.security_findings_search_request_data_attributes" => "SecurityFindingsSearchRequestDataAttributes",
          ...
          "v2.security_monitoring_azure_app_registration" => "SecurityMonitoringAzureAppRegistration",
          "v2.security_monitoring_content_pack_activation" => "SecurityMonitoringContentPackActivation",
          "v2.security_monitoring_content_pack_app_sec_details" => "SecurityMonitoringContentPackAppSecDetails",
          "v2.security_monitoring_content_pack_app_sec_details_type" => "SecurityMonitoringContentPackAppSecDetailsType",
          "v2.security_monitoring_content_pack_audit_details" => "SecurityMonitoringContentPackAuditDetails",
          "v2.security_monitoring_content_pack_audit_details_type" => "SecurityMonitoringContentPackAuditDetailsType",
          "v2.security_monitoring_content_pack_entity_details" => "SecurityMonitoringContentPackEntityDetails",
          "v2.security_monitoring_content_pack_entity_details_type" => "SecurityMonitoringContentPackEntityDetailsType",
          "v2.security_monitoring_content_pack_integration_status" => "SecurityMonitoringContentPackIntegrationStatus",
          "v2.security_monitoring_content_pack_logs_details" => "SecurityMonitoringContentPackLogsDetails",
          "v2.security_monitoring_content_pack_onboarding_details" => "SecurityMonitoringContentPackOnboardingDetails",
          "v2.security_monitoring_content_pack_onboarding_details_type" => "SecurityMonitoringContentPackOnboardingDetailsType",
          "v2.security_monitoring_content_pack_state_attributes" => "SecurityMonitoringContentPackStateAttributes",
          "v2.security_monitoring_content_pack_state_data" => "SecurityMonitoringContentPackStateData",
          "v2.security_monitoring_content_pack_state_details" => "SecurityMonitoringContentPackStateDetails",
          "v2.security_monitoring_content_pack_state_meta" => "SecurityMonitoringContentPackStateMeta",
          "v2.security_monitoring_content_pack_states_response" => "SecurityMonitoringContentPackStatesResponse",
          "v2.security_monitoring_content_pack_state_type" => "SecurityMonitoringContentPackStateType",
          "v2.security_monitoring_content_pack_status" => "SecurityMonitoringContentPackStatus",
          "v2.security_monitoring_content_pack_threat_intel_details" => "SecurityMonitoringContentPackThreatIntelDetails",
          "v2.security_monitoring_content_pack_threat_intel_details_type" => "SecurityMonitoringContentPackThreatIntelDetailsType",
          "v2.security_monitoring_content_pack_timestamp_bucket" => "SecurityMonitoringContentPackTimestampBucket",
          "v2.security_monitoring_content_pack_vulnerability_details" => "SecurityMonitoringContentPackVulnerabilityDetails",
          "v2.security_monitoring_content_pack_vulnerability_details_type" => "SecurityMonitoringContentPackVulnerabilityDetailsType",
          "v2.security_monitoring_critical_asset" => "SecurityMonitoringCriticalAsset",
          "v2.security_monitoring_critical_asset_attributes" => "SecurityMonitoringCriticalAssetAttributes",
          "v2.security_monitoring_critical_asset_create_attributes" => "SecurityMonitoringCriticalAssetCreateAttributes",
          "v2.security_monitoring_critical_asset_create_data" => "SecurityMonitoringCriticalAssetCreateData",
          "v2.security_monitoring_critical_asset_create_request" => "SecurityMonitoringCriticalAssetCreateRequest",
          "v2.security_monitoring_critical_asset_response" => "SecurityMonitoringCriticalAssetResponse",
          "v2.security_monitoring_critical_asset_severity" => "SecurityMonitoringCriticalAssetSeverity",
          "v2.security_monitoring_critical_assets_response" => "SecurityMonitoringCriticalAssetsResponse",
          "v2.security_monitoring_critical_asset_type" => "SecurityMonitoringCriticalAssetType",
          "v2.security_monitoring_critical_asset_update_attributes" => "SecurityMonitoringCriticalAssetUpdateAttributes",
          "v2.security_monitoring_critical_asset_update_data" => "SecurityMonitoringCriticalAssetUpdateData",
          "v2.security_monitoring_critical_asset_update_request" => "SecurityMonitoringCriticalAssetUpdateRequest",
          "v2.security_monitoring_crowd_strike_integration_config_create_attributes" => "SecurityMonitoringCrowdStrikeIntegrationConfigCreateAttributes",
          "v2.security_monitoring_crowd_strike_integration_config_update_attributes" => "SecurityMonitoringCrowdStrikeIntegrationConfigUpdateAttributes",
          "v2.security_monitoring_crowd_strike_integration_credentials_validate_attributes" => "SecurityMonitoringCrowdStrikeIntegrationCredentialsValidateAttributes",
          "v2.security_monitoring_dataset_attributes_request" => "SecurityMonitoringDatasetAttributesRequest",
          "v2.security_monitoring_dataset_attributes_response" => "SecurityMonitoringDatasetAttributesResponse",
          "v2.security_monitoring_dataset_column" => "SecurityMonitoringDatasetColumn",
          ...
          "v2.security_monitoring_dataset_dependencies_request" => "SecurityMonitoringDatasetDependenciesRequest",
          "v2.security_monitoring_dataset_dependencies_request_attributes" => "SecurityMonitoringDatasetDependenciesRequestAttributes",
          "v2.security_monitoring_dataset_dependencies_request_data" => "SecurityMonitoringDatasetDependenciesRequestData",
          "v2.security_monitoring_dataset_dependencies_response" => "SecurityMonitoringDatasetDependenciesResponse",
          "v2.security_monitoring_dataset_dependents_attributes" => "SecurityMonitoringDatasetDependentsAttributes",
          "v2.security_monitoring_dataset_dependents_data" => "SecurityMonitoringDatasetDependentsData",
          "v2.security_monitoring_dataset_dependents_type" => "SecurityMonitoringDatasetDependentsType",
          "v2.security_monitoring_dataset_response" => "SecurityMonitoringDatasetResponse",
          "v2.security_monitoring_dataset_search" => "SecurityMonitoringDatasetSearch",
          "v2.security_monitoring_datasets_list_meta" => "SecurityMonitoringDatasetsListMeta",
          "v2.security_monitoring_datasets_list_response" => "SecurityMonitoringDatasetsListResponse",
          "v2.security_monitoring_dataset_time_window" => "SecurityMonitoringDatasetTimeWindow",
          "v2.security_monitoring_dataset_type" => "SecurityMonitoringDatasetType",
          "v2.security_monitoring_dataset_update_data" => "SecurityMonitoringDatasetUpdateData",
          "v2.security_monitoring_dataset_update_request" => "SecurityMonitoringDatasetUpdateRequest",
          "v2.security_monitoring_dataset_update_type" => "SecurityMonitoringDatasetUpdateType",
          "v2.security_monitoring_dataset_version_entry" => "SecurityMonitoringDatasetVersionEntry",
          "v2.security_monitoring_dataset_version_field_change" => "SecurityMonitoringDatasetVersionFieldChange",
          "v2.security_monitoring_dataset_version_history_attributes" => "SecurityMonitoringDatasetVersionHistoryAttributes",
          "v2.security_monitoring_dataset_version_history_data" => "SecurityMonitoringDatasetVersionHistoryData",
          "v2.security_monitoring_dataset_version_history_response" => "SecurityMonitoringDatasetVersionHistoryResponse",
          "v2.security_monitoring_dataset_version_history_type" => "SecurityMonitoringDatasetVersionHistoryType",
          "v2.security_monitoring_entra_id_azure_app_registrations_attributes" => "SecurityMonitoringEntraIdAzureAppRegistrationsAttributes",
          "v2.security_monitoring_entra_id_azure_app_registrations_data" => "SecurityMonitoringEntraIdAzureAppRegistrationsData",
          ...
          "v2.security_monitoring_entra_id_azure_app_registrations_response" => "SecurityMonitoringEntraIdAzureAppRegistrationsResponse",
          "v2.security_monitoring_entra_id_integration_config_create_attributes" => "SecurityMonitoringEntraIdIntegrationConfigCreateAttributes",
          "v2.security_monitoring_entra_id_integration_config_update_attributes" => "SecurityMonitoringEntraIdIntegrationConfigUpdateAttributes",
          "v2.security_monitoring_entra_id_integration_credentials_validate_attributes" => "SecurityMonitoringEntraIdIntegrationCredentialsValidateAttributes",
          ...
          "v2.security_monitoring_google_workspace_integration_config_update_attributes" => "SecurityMonitoringGoogleWorkspaceIntegrationConfigUpdateAttributes",
          "v2.security_monitoring_google_workspace_integration_credentials_validate_attributes" => "SecurityMonitoringGoogleWorkspaceIntegrationCredentialsValidateAttributes",
          "v2.security_monitoring_integration_activate_attributes" => "SecurityMonitoringIntegrationActivateAttributes",
          "v2.security_monitoring_integration_activate_data" => "SecurityMonitoringIntegrationActivateData",
          "v2.security_monitoring_integration_activate_request" => "SecurityMonitoringIntegrationActivateRequest",
          "v2.security_monitoring_integration_activate_resource_type" => "SecurityMonitoringIntegrationActivateResourceType",
          "v2.security_monitoring_integration_config_attributes" => "SecurityMonitoringIntegrationConfigAttributes",
          "v2.security_monitoring_integration_config_create_attributes" => "SecurityMonitoringIntegrationConfigCreateAttributes",
          "v2.security_monitoring_integration_config_create_data" => "SecurityMonitoringIntegrationConfigCreateData",
          "v2.security_monitoring_integration_config_create_request" => "SecurityMonitoringIntegrationConfigCreateRequest",
          "v2.security_monitoring_integration_config_crowd_strike_secrets" => "SecurityMonitoringIntegrationConfigCrowdStrikeSecrets",
          "v2.security_monitoring_integration_config_data" => "SecurityMonitoringIntegrationConfigData",
          "v2.security_monitoring_integration_config_google_workspace_secrets" => "SecurityMonitoringIntegrationConfigGoogleWorkspaceSecrets",
          "v2.security_monitoring_integration_config_google_workspace_service_account" => "SecurityMonitoringIntegrationConfigGoogleWorkspaceServiceAccount",
          "v2.security_monitoring_integration_config_okta_secrets" => "SecurityMonitoringIntegrationConfigOktaSecrets",
          "v2.security_monitoring_integration_config_resource_type" => "SecurityMonitoringIntegrationConfigResourceType",
          "v2.security_monitoring_integration_config_response" => "SecurityMonitoringIntegrationConfigResponse",
          "v2.security_monitoring_integration_config_sentinel_one_secrets" => "SecurityMonitoringIntegrationConfigSentinelOneSecrets",
          "v2.security_monitoring_integration_configs_response" => "SecurityMonitoringIntegrationConfigsResponse",
          "v2.security_monitoring_integration_config_state" => "SecurityMonitoringIntegrationConfigState",
          "v2.security_monitoring_integration_config_update_attributes" => "SecurityMonitoringIntegrationConfigUpdateAttributes",
          "v2.security_monitoring_integration_config_update_data" => "SecurityMonitoringIntegrationConfigUpdateData",
          "v2.security_monitoring_integration_config_update_request" => "SecurityMonitoringIntegrationConfigUpdateRequest",
          "v2.security_monitoring_integration_credentials_validate_attributes" => "SecurityMonitoringIntegrationCredentialsValidateAttributes",
          "v2.security_monitoring_integration_credentials_validate_data" => "SecurityMonitoringIntegrationCredentialsValidateData",
          "v2.security_monitoring_integration_credentials_validate_request" => "SecurityMonitoringIntegrationCredentialsValidateRequest",
          "v2.security_monitoring_integration_type" => "SecurityMonitoringIntegrationType",
          "v2.security_monitoring_integration_type_crowd_strike" => "SecurityMonitoringIntegrationTypeCrowdStrike",
          "v2.security_monitoring_integration_type_entra_id" => "SecurityMonitoringIntegrationTypeEntraId",
          "v2.security_monitoring_integration_type_google_workspace" => "SecurityMonitoringIntegrationTypeGoogleWorkspace",
          "v2.security_monitoring_integration_type_okta" => "SecurityMonitoringIntegrationTypeOkta",
          "v2.security_monitoring_integration_type_sentinel_one" => "SecurityMonitoringIntegrationTypeSentinelOne",
          "v2.security_monitoring_list_rules_response" => "SecurityMonitoringListRulesResponse",
          "v2.security_monitoring_okta_integration_config_create_attributes" => "SecurityMonitoringOktaIntegrationConfigCreateAttributes",
          "v2.security_monitoring_okta_integration_config_update_attributes" => "SecurityMonitoringOktaIntegrationConfigUpdateAttributes",
          "v2.security_monitoring_okta_integration_credentials_validate_attributes" => "SecurityMonitoringOktaIntegrationCredentialsValidateAttributes",
          "v2.security_monitoring_paginated_suppressions_response" => "SecurityMonitoringPaginatedSuppressionsResponse",
          ...
          "v2.security_monitoring_rule_bulk_delete_response_attributes" => "SecurityMonitoringRuleBulkDeleteResponseAttributes",
          "v2.security_monitoring_rule_bulk_delete_response_data" => "SecurityMonitoringRuleBulkDeleteResponseData",
          "v2.security_monitoring_rule_bulk_delete_response_data_type" => "SecurityMonitoringRuleBulkDeleteResponseDataType",
          ...
          "v2.security_monitoring_sentinel_one_integration_config_update_attributes" => "SecurityMonitoringSentinelOneIntegrationConfigUpdateAttributes",
          "v2.security_monitoring_sentinel_one_integration_credentials_validate_attributes" => "SecurityMonitoringSentinelOneIntegrationCredentialsValidateAttributes",
          ...
          "v2.security_monitoring_suppressions_meta" => "SecurityMonitoringSuppressionsMeta",
          "v2.security_monitoring_suppression_sort" => "SecurityMonitoringSuppressionSort",
          "v2.security_monitoring_suppressions_page_meta" => "SecurityMonitoringSuppressionsPageMeta",
          ...
          "v2.security_monitoring_terraform_bulk_export_attributes" => "SecurityMonitoringTerraformBulkExportAttributes",
          "v2.security_monitoring_terraform_bulk_export_data" => "SecurityMonitoringTerraformBulkExportData",
          "v2.security_monitoring_terraform_bulk_export_request" => "SecurityMonitoringTerraformBulkExportRequest",
          "v2.security_monitoring_terraform_convert_attributes" => "SecurityMonitoringTerraformConvertAttributes",
          "v2.security_monitoring_terraform_convert_data" => "SecurityMonitoringTerraformConvertData",
          "v2.security_monitoring_terraform_convert_request" => "SecurityMonitoringTerraformConvertRequest",
          "v2.security_monitoring_terraform_export_attributes" => "SecurityMonitoringTerraformExportAttributes",
          "v2.security_monitoring_terraform_export_data" => "SecurityMonitoringTerraformExportData",
          "v2.security_monitoring_terraform_export_response" => "SecurityMonitoringTerraformExportResponse",
          "v2.security_monitoring_terraform_resource_type" => "SecurityMonitoringTerraformResourceType",
          ...
          "v2.serial_execution" => "SerialExecution",
          "v2.service_access_token" => "ServiceAccessToken",
          "v2.service_access_token_attributes" => "ServiceAccessTokenAttributes",
          "v2.service_access_token_create_response" => "ServiceAccessTokenCreateResponse",
          "v2.service_access_token_relationships" => "ServiceAccessTokenRelationships",
          "v2.service_access_token_response" => "ServiceAccessTokenResponse",
          "v2.service_access_token_response_meta" => "ServiceAccessTokenResponseMeta",
          "v2.service_access_token_response_meta_page" => "ServiceAccessTokenResponseMetaPage",
          "v2.service_access_tokens_type" => "ServiceAccessTokensType",
          "v2.service_account_access_token_create_attributes" => "ServiceAccountAccessTokenCreateAttributes",
          "v2.service_account_access_token_create_data" => "ServiceAccountAccessTokenCreateData",
          "v2.service_account_access_token_create_request" => "ServiceAccountAccessTokenCreateRequest",
          "v2.service_account_access_token_update_attributes" => "ServiceAccountAccessTokenUpdateAttributes",
          "v2.service_account_access_token_update_data" => "ServiceAccountAccessTokenUpdateData",
          "v2.service_account_access_token_update_request" => "ServiceAccountAccessTokenUpdateRequest",
          ...
          "v2.service_account_type" => "ServiceAccountType",
          ...
          "v2.service_now_assignment_group_attributes" => "ServiceNowAssignmentGroupAttributes",
          "v2.service_now_assignment_group_data" => "ServiceNowAssignmentGroupData",
          "v2.service_now_assignment_groups_response" => "ServiceNowAssignmentGroupsResponse",
          "v2.service_now_assignment_group_type" => "ServiceNowAssignmentGroupType",
          ...
          "v2.service_now_business_service_attributes" => "ServiceNowBusinessServiceAttributes",
          "v2.service_now_business_service_data" => "ServiceNowBusinessServiceData",
          "v2.service_now_business_services_response" => "ServiceNowBusinessServicesResponse",
          "v2.service_now_business_service_type" => "ServiceNowBusinessServiceType",
          ...
          "v2.service_now_instance_data" => "ServiceNowInstanceData",
          "v2.service_now_instances_response" => "ServiceNowInstancesResponse",
          "v2.service_now_instance_type" => "ServiceNowInstanceType",
          ...
          "v2.service_now_template_attributes" => "ServiceNowTemplateAttributes",
          "v2.service_now_template_create_request" => "ServiceNowTemplateCreateRequest",
          "v2.service_now_template_create_request_attributes" => "ServiceNowTemplateCreateRequestAttributes",
          "v2.service_now_template_create_request_data" => "ServiceNowTemplateCreateRequestData",
          "v2.service_now_template_data" => "ServiceNowTemplateData",
          "v2.service_now_template_response" => "ServiceNowTemplateResponse",
          "v2.service_now_templates_response" => "ServiceNowTemplatesResponse",
          "v2.service_now_template_type" => "ServiceNowTemplateType",
          "v2.service_now_template_update_request" => "ServiceNowTemplateUpdateRequest",
          "v2.service_now_template_update_request_attributes" => "ServiceNowTemplateUpdateRequestAttributes",
          "v2.service_now_template_update_request_data" => "ServiceNowTemplateUpdateRequestData",
          "v2.service_now_ticket" => "ServiceNowTicket",
          "v2.service_now_ticket_create_attributes" => "ServiceNowTicketCreateAttributes",
          "v2.service_now_ticket_create_data" => "ServiceNowTicketCreateData",
          ...
          "v2.service_now_user_type" => "ServiceNowUserType",
          "v2.service_repository_info_data_type" => "ServiceRepositoryInfoDataType",
          "v2.service_repository_info_request" => "ServiceRepositoryInfoRequest",
          "v2.service_repository_info_request_attributes" => "ServiceRepositoryInfoRequestAttributes",
          "v2.service_repository_info_request_data" => "ServiceRepositoryInfoRequestData",
          "v2.service_repository_info_response" => "ServiceRepositoryInfoResponse",
          "v2.service_repository_info_response_attributes" => "ServiceRepositoryInfoResponseAttributes",
          "v2.service_repository_info_response_data" => "ServiceRepositoryInfoResponseData",
          ...
          "v2.severity_modifier_rule_action" => "SeverityModifierRuleAction",
          "v2.severity_modifier_rule_attributes_create" => "SeverityModifierRuleAttributesCreate",
          "v2.severity_modifier_rule_attributes_response" => "SeverityModifierRuleAttributesResponse",
          "v2.severity_modifier_rule_create_request" => "SeverityModifierRuleCreateRequest",
          "v2.severity_modifier_rule_data_create" => "SeverityModifierRuleDataCreate",
          "v2.severity_modifier_rule_data_response" => "SeverityModifierRuleDataResponse",
          "v2.severity_modifier_rule_reorder_item" => "SeverityModifierRuleReorderItem",
          "v2.severity_modifier_rule_reorder_request" => "SeverityModifierRuleReorderRequest",
          "v2.severity_modifier_rule_reorder_response" => "SeverityModifierRuleReorderResponse",
          "v2.severity_modifier_rule_response" => "SeverityModifierRuleResponse",
          "v2.severity_modifier_rule_set_action" => "SeverityModifierRuleSetAction",
          "v2.severity_modifier_rule_set_action_type" => "SeverityModifierRuleSetActionType",
          "v2.severity_modifier_rule_shift_action" => "SeverityModifierRuleShiftAction",
          "v2.severity_modifier_rule_shift_action_type" => "SeverityModifierRuleShiftActionType",
          ...
          "v2.severity_modifier_severity" => "SeverityModifierSeverity",
          "v2.severity_modifier_severity_delta" => "SeverityModifierSeverityDelta",
          ...
          "v2.signal_entities_attributes" => "SignalEntitiesAttributes",
          "v2.signal_entities_data" => "SignalEntitiesData",
          "v2.signal_entities_response" => "SignalEntitiesResponse",
          ...
          "v2.slack_reaction_config" => "SlackReactionConfig",
          "v2.slack_trigger" => "SlackTrigger",
          ...
          "v2.slos_group_mode" => "SlosGroupMode",
          "v2.slos_measure" => "SlosMeasure",
          "v2.slos_query_type" => "SlosQueryType",
          ...
          "v2.snapshot_array" => "SnapshotArray",
          "v2.snapshot_create_request" => "SnapshotCreateRequest",
          "v2.snapshot_create_request_data" => "SnapshotCreateRequestData",
          "v2.snapshot_create_request_data_attributes" => "SnapshotCreateRequestDataAttributes",
          "v2.snapshot_data" => "SnapshotData",
          "v2.snapshot_data_attributes" => "SnapshotDataAttributes",
          "v2.snapshot_update_request" => "SnapshotUpdateRequest",
          "v2.snapshot_update_request_data" => "SnapshotUpdateRequestData",
          "v2.snapshot_update_request_data_attributes" => "SnapshotUpdateRequestDataAttributes",
          "v2.snapshot_update_request_data_type" => "SnapshotUpdateRequestDataType",
          "v2.snowflake_account_usage_metrics_integration_dataflow_request" => "SnowflakeAccountUsageMetricsIntegrationDataflowRequest",
          "v2.snowflake_account_usage_metrics_integration_dataflow_response" => "SnowflakeAccountUsageMetricsIntegrationDataflowResponse",
          "v2.snowflake_account_usage_metrics_integration_dataflow_settings_request" => "SnowflakeAccountUsageMetricsIntegrationDataflowSettingsRequest",
          "v2.snowflake_account_usage_metrics_integration_dataflow_settings_response" => "SnowflakeAccountUsageMetricsIntegrationDataflowSettingsResponse",
          "v2.snowflake_cloud_cost_metrics_integration_dataflow_request" => "SnowflakeCloudCostMetricsIntegrationDataflowRequest",
          "v2.snowflake_cloud_cost_metrics_integration_dataflow_response" => "SnowflakeCloudCostMetricsIntegrationDataflowResponse",
          "v2.snowflake_cloud_cost_metrics_integration_dataflow_settings_request" => "SnowflakeCloudCostMetricsIntegrationDataflowSettingsRequest",
          "v2.snowflake_cloud_cost_metrics_integration_dataflow_settings_response" => "SnowflakeCloudCostMetricsIntegrationDataflowSettingsResponse",
          "v2.snowflake_data_observability_quality_monitoring_integration_dataflow_request" => "SnowflakeDataObservabilityQualityMonitoringIntegrationDataflowRequest",
          "v2.snowflake_data_observability_quality_monitoring_integration_dataflow_response" => "SnowflakeDataObservabilityQualityMonitoringIntegrationDataflowResponse",
          "v2.snowflake_data_observability_quality_monitoring_integration_dataflow_settings_request" => "SnowflakeDataObservabilityQualityMonitoringIntegrationDataflowSettingsRequest",
          "v2.snowflake_data_observability_quality_monitoring_integration_dataflow_settings_response" => "SnowflakeDataObservabilityQualityMonitoringIntegrationDataflowSettingsResponse",
          "v2.snowflake_event_table_logs_integration_dataflow_request" => "SnowflakeEventTableLogsIntegrationDataflowRequest",
          "v2.snowflake_event_table_logs_integration_dataflow_response" => "SnowflakeEventTableLogsIntegrationDataflowResponse",
          "v2.snowflake_event_table_logs_integration_dataflow_settings_request" => "SnowflakeEventTableLogsIntegrationDataflowSettingsRequest",
          "v2.snowflake_event_table_logs_integration_dataflow_settings_response" => "SnowflakeEventTableLogsIntegrationDataflowSettingsResponse",
          "v2.snowflake_integration_account_authentication_request" => "SnowflakeIntegrationAccountAuthenticationRequest",
          "v2.snowflake_integration_account_authentication_response" => "SnowflakeIntegrationAccountAuthenticationResponse",
          "v2.snowflake_integration_account_authentication_update" => "SnowflakeIntegrationAccountAuthenticationUpdate",
          "v2.snowflake_integration_account_create_attributes" => "SnowflakeIntegrationAccountCreateAttributes",
          "v2.snowflake_integration_account_create_data" => "SnowflakeIntegrationAccountCreateData",
          "v2.snowflake_integration_account_create_request" => "SnowflakeIntegrationAccountCreateRequest",
          "v2.snowflake_integration_account_private_key_auth_request" => "SnowflakeIntegrationAccountPrivateKeyAuthRequest",
          "v2.snowflake_integration_account_private_key_auth_response" => "SnowflakeIntegrationAccountPrivateKeyAuthResponse",
          "v2.snowflake_integration_account_private_key_auth_type" => "SnowflakeIntegrationAccountPrivateKeyAuthType",
          "v2.snowflake_integration_account_private_key_auth_update" => "SnowflakeIntegrationAccountPrivateKeyAuthUpdate",
          "v2.snowflake_integration_account_response" => "SnowflakeIntegrationAccountResponse",
          "v2.snowflake_integration_account_response_attributes" => "SnowflakeIntegrationAccountResponseAttributes",
          "v2.snowflake_integration_account_response_data" => "SnowflakeIntegrationAccountResponseData",
          "v2.snowflake_integration_account_settings_request" => "SnowflakeIntegrationAccountSettingsRequest",
          "v2.snowflake_integration_account_settings_response" => "SnowflakeIntegrationAccountSettingsResponse",
          "v2.snowflake_integration_account_settings_update" => "SnowflakeIntegrationAccountSettingsUpdate",
          "v2.snowflake_integration_accounts_response" => "SnowflakeIntegrationAccountsResponse",
          "v2.snowflake_integration_account_update_attributes" => "SnowflakeIntegrationAccountUpdateAttributes",
          "v2.snowflake_integration_account_update_data" => "SnowflakeIntegrationAccountUpdateData",
          "v2.snowflake_integration_account_update_request" => "SnowflakeIntegrationAccountUpdateRequest",
          "v2.snowflake_integration_dataflows_request" => "SnowflakeIntegrationDataflowsRequest",
          "v2.snowflake_integration_dataflows_response" => "SnowflakeIntegrationDataflowsResponse",
          "v2.snowflake_organization_usage_metrics_integration_dataflow_request" => "SnowflakeOrganizationUsageMetricsIntegrationDataflowRequest",
          "v2.snowflake_organization_usage_metrics_integration_dataflow_response" => "SnowflakeOrganizationUsageMetricsIntegrationDataflowResponse",
          "v2.snowflake_organization_usage_metrics_integration_dataflow_settings_request" => "SnowflakeOrganizationUsageMetricsIntegrationDataflowSettingsRequest",
          "v2.snowflake_organization_usage_metrics_integration_dataflow_settings_response" => "SnowflakeOrganizationUsageMetricsIntegrationDataflowSettingsResponse",
          "v2.snowflake_query_history_logs_integration_dataflow_request" => "SnowflakeQueryHistoryLogsIntegrationDataflowRequest",
          "v2.snowflake_query_history_logs_integration_dataflow_response" => "SnowflakeQueryHistoryLogsIntegrationDataflowResponse",
          "v2.snowflake_query_history_logs_integration_dataflow_settings_request" => "SnowflakeQueryHistoryLogsIntegrationDataflowSettingsRequest",
          "v2.snowflake_query_history_logs_integration_dataflow_settings_response" => "SnowflakeQueryHistoryLogsIntegrationDataflowSettingsResponse",
          "v2.snowflake_security_logs_integration_dataflow_request" => "SnowflakeSecurityLogsIntegrationDataflowRequest",
          "v2.snowflake_security_logs_integration_dataflow_response" => "SnowflakeSecurityLogsIntegrationDataflowResponse",
          "v2.snowflake_security_logs_integration_dataflow_settings_request" => "SnowflakeSecurityLogsIntegrationDataflowSettingsRequest",
          "v2.snowflake_security_logs_integration_dataflow_settings_response" => "SnowflakeSecurityLogsIntegrationDataflowSettingsResponse",
          "v2.snowflake_task_history_logs_integration_dataflow_request" => "SnowflakeTaskHistoryLogsIntegrationDataflowRequest",
          "v2.snowflake_task_history_logs_integration_dataflow_response" => "SnowflakeTaskHistoryLogsIntegrationDataflowResponse",
          "v2.snowflake_task_history_logs_integration_dataflow_settings_request" => "SnowflakeTaskHistoryLogsIntegrationDataflowSettingsRequest",
          "v2.snowflake_task_history_logs_integration_dataflow_settings_response" => "SnowflakeTaskHistoryLogsIntegrationDataflowSettingsResponse",
          "v2.software_catalog_trigger_wrapper" => "SoftwareCatalogTriggerWrapper",
          "v2.sort_direction" => "SortDirection",
          "v2.sourcemap_data_type" => "SourcemapDataType",
          "v2.sourcemap_file_attributes" => "SourcemapFileAttributes",
          "v2.sourcemap_file_data" => "SourcemapFileData",
          "v2.sourcemap_file_data_type" => "SourcemapFileDataType",
          ...
          "v2.status_page" => "StatusPage",
          "v2.statuspage_account_create_attributes" => "StatuspageAccountCreateAttributes",
          "v2.statuspage_account_create_data" => "StatuspageAccountCreateData",
          "v2.statuspage_account_create_request" => "StatuspageAccountCreateRequest",
          "v2.statuspage_account_response" => "StatuspageAccountResponse",
          "v2.statuspage_account_response_attributes" => "StatuspageAccountResponseAttributes",
          "v2.statuspage_account_response_data" => "StatuspageAccountResponseData",
          "v2.statuspage_account_type" => "StatuspageAccountType",
          "v2.statuspage_account_update_attributes" => "StatuspageAccountUpdateAttributes",
          "v2.statuspage_account_update_data" => "StatuspageAccountUpdateData",
          "v2.statuspage_account_update_request" => "StatuspageAccountUpdateRequest",
          "v2.status_page_array" => "StatusPageArray",
          "v2.status_page_array_included" => "StatusPageArrayIncluded",
          "v2.status_page_as_included" => "StatusPageAsIncluded",
          "v2.status_page_as_included_attributes" => "StatusPageAsIncludedAttributes",
          "v2.status_page_as_included_attributes_components_items" => "StatusPageAsIncludedAttributesComponentsItems",
          "v2.status_page_as_included_attributes_components_items_components_items" => "StatusPageAsIncludedAttributesComponentsItemsComponentsItems",
          "v2.status_page_as_included_relationships" => "StatusPageAsIncludedRelationships",
          "v2.status_page_as_included_relationships_created_by_user" => "StatusPageAsIncludedRelationshipsCreatedByUser",
          "v2.status_page_as_included_relationships_created_by_user_data" => "StatusPageAsIncludedRelationshipsCreatedByUserData",
          "v2.status_page_as_included_relationships_last_modified_by_user" => "StatusPageAsIncludedRelationshipsLastModifiedByUser",
          "v2.status_page_as_included_relationships_last_modified_by_user_data" => "StatusPageAsIncludedRelationshipsLastModifiedByUserData",
          "v2.status_page_data" => "StatusPageData",
          "v2.status_page_data_attributes" => "StatusPageDataAttributes",
          "v2.status_page_data_attributes_components_items" => "StatusPageDataAttributesComponentsItems",
          "v2.status_page_data_attributes_components_items_components_items" => "StatusPageDataAttributesComponentsItemsComponentsItems",
          "v2.status_page_data_relationships" => "StatusPageDataRelationships",
          "v2.status_page_data_relationships_created_by_user" => "StatusPageDataRelationshipsCreatedByUser",
          "v2.status_page_data_relationships_created_by_user_data" => "StatusPageDataRelationshipsCreatedByUserData",
          "v2.status_page_data_relationships_last_modified_by_user" => "StatusPageDataRelationshipsLastModifiedByUser",
          "v2.status_page_data_relationships_last_modified_by_user_data" => "StatusPageDataRelationshipsLastModifiedByUserData",
          "v2.status_page_data_type" => "StatusPageDataType",
          "v2.status_pages_component" => "StatusPagesComponent",
          "v2.status_pages_component_array" => "StatusPagesComponentArray",
          "v2.status_pages_component_array_included" => "StatusPagesComponentArrayIncluded",
          "v2.status_pages_component_data" => "StatusPagesComponentData",
          "v2.status_pages_component_data_attributes" => "StatusPagesComponentDataAttributes",
          "v2.status_pages_component_data_attributes_components_items" => "StatusPagesComponentDataAttributesComponentsItems",
          "v2.status_pages_component_data_attributes_status" => "StatusPagesComponentDataAttributesStatus",
          "v2.status_pages_component_data_relationships" => "StatusPagesComponentDataRelationships",
          "v2.status_pages_component_data_relationships_created_by_user" => "StatusPagesComponentDataRelationshipsCreatedByUser",
          "v2.status_pages_component_data_relationships_created_by_user_data" => "StatusPagesComponentDataRelationshipsCreatedByUserData",
          "v2.status_pages_component_data_relationships_group" => "StatusPagesComponentDataRelationshipsGroup",
          "v2.status_pages_component_data_relationships_group_data" => "StatusPagesComponentDataRelationshipsGroupData",
          "v2.status_pages_component_data_relationships_last_modified_by_user" => "StatusPagesComponentDataRelationshipsLastModifiedByUser",
          "v2.status_pages_component_data_relationships_last_modified_by_user_data" => "StatusPagesComponentDataRelationshipsLastModifiedByUserData",
          "v2.status_pages_component_data_relationships_status_page" => "StatusPagesComponentDataRelationshipsStatusPage",
          "v2.status_pages_component_data_relationships_status_page_data" => "StatusPagesComponentDataRelationshipsStatusPageData",
          "v2.status_pages_component_group" => "StatusPagesComponentGroup",
          "v2.status_pages_component_group_attributes" => "StatusPagesComponentGroupAttributes",
          "v2.status_pages_component_group_attributes_components_items" => "StatusPagesComponentGroupAttributesComponentsItems",
          "v2.status_pages_component_group_attributes_components_items_status" => "StatusPagesComponentGroupAttributesComponentsItemsStatus",
          "v2.status_pages_component_group_attributes_components_items_type" => "StatusPagesComponentGroupAttributesComponentsItemsType",
          "v2.status_pages_component_group_relationships" => "StatusPagesComponentGroupRelationships",
          "v2.status_pages_component_group_relationships_created_by_user" => "StatusPagesComponentGroupRelationshipsCreatedByUser",
          "v2.status_pages_component_group_relationships_created_by_user_data" => "StatusPagesComponentGroupRelationshipsCreatedByUserData",
          "v2.status_pages_component_group_relationships_group" => "StatusPagesComponentGroupRelationshipsGroup",
          "v2.status_pages_component_group_relationships_group_data" => "StatusPagesComponentGroupRelationshipsGroupData",
          ...
          "v2.status_pages_component_group_relationships_last_modified_by_user_data" => "StatusPagesComponentGroupRelationshipsLastModifiedByUserData",
          "v2.status_pages_component_group_relationships_status_page" => "StatusPagesComponentGroupRelationshipsStatusPage",
          "v2.status_pages_component_group_relationships_status_page_data" => "StatusPagesComponentGroupRelationshipsStatusPageData",
          "v2.status_pages_component_group_type" => "StatusPagesComponentGroupType",
          "v2.status_pages_user" => "StatusPagesUser",
          "v2.status_pages_user_attributes" => "StatusPagesUserAttributes",
          "v2.status_pages_user_type" => "StatusPagesUserType",
          "v2.statuspage_url_setting_create_attributes" => "StatuspageUrlSettingCreateAttributes",
          "v2.statuspage_url_setting_create_data" => "StatuspageUrlSettingCreateData",
          "v2.statuspage_url_setting_create_request" => "StatuspageUrlSettingCreateRequest",
          "v2.statuspage_url_setting_response" => "StatuspageUrlSettingResponse",
          "v2.statuspage_url_setting_response_attributes" => "StatuspageUrlSettingResponseAttributes",
          "v2.statuspage_url_setting_response_data" => "StatuspageUrlSettingResponseData",
          "v2.statuspage_url_settings_response" => "StatuspageUrlSettingsResponse",
          ...
          "v2.stegadography_get_widgets_request" => "StegadographyGetWidgetsRequest",
          "v2.stegadography_get_widgets_response" => "StegadographyGetWidgetsResponse",
          "v2.stegadography_widget" => "StegadographyWidget",
          ...
          "v2.stix_bundle_request" => "STIXBundleRequest",
          "v2.stix_bundle_type" => "STIXBundleType",
          "v2.stix_content_encoding" => "STIXContentEncoding",
          "v2.stix_ingest_response" => "STIXIngestResponse",
          "v2.stix_ingest_response_attributes" => "STIXIngestResponseAttributes",
          "v2.stix_ingest_response_data" => "STIXIngestResponseData",
          "v2.stix_ingest_response_type" => "STIXIngestResponseType",
          "v2.stix_object" => "STIXObject",
          "v2.stix_pattern_type" => "STIXPatternType",
          "v2.stix_spec_version" => "STIXSpecVersion",
          ...
          "v2.suite_json_patch_request_data" => "SuiteJsonPatchRequestData",
          ...
          "v2.sync_property_with_mapping" => "SyncPropertyWithMapping",
          "v2.synthetics_api_multistep_parent_test_attributes" => "SyntheticsApiMultistepParentTestAttributes",
          "v2.synthetics_api_multistep_parent_test_data" => "SyntheticsApiMultistepParentTestData",
          "v2.synthetics_api_multistep_parent_tests_response" => "SyntheticsApiMultistepParentTestsResponse",
          "v2.synthetics_api_multistep_parent_test_type" => "SyntheticsApiMultistepParentTestType",
          "v2.synthetics_api_multistep_subtest_attributes" => "SyntheticsApiMultistepSubtestAttributes",
          "v2.synthetics_api_multistep_subtest_data" => "SyntheticsApiMultistepSubtestData",
          "v2.synthetics_api_multistep_subtests_response" => "SyntheticsApiMultistepSubtestsResponse",
          "v2.synthetics_api_multistep_subtest_type" => "SyntheticsApiMultistepSubtestType",
          "v2.synthetics_downtime_data" => "SyntheticsDowntimeData",
          "v2.synthetics_downtime_data_attributes_request" => "SyntheticsDowntimeDataAttributesRequest",
          "v2.synthetics_downtime_data_attributes_response" => "SyntheticsDowntimeDataAttributesResponse",
          "v2.synthetics_downtime_data_request" => "SyntheticsDowntimeDataRequest",
          "v2.synthetics_downtime_frequency" => "SyntheticsDowntimeFrequency",
          "v2.synthetics_downtime_request" => "SyntheticsDowntimeRequest",
          "v2.synthetics_downtime_resource_type" => "SyntheticsDowntimeResourceType",
          "v2.synthetics_downtime_response" => "SyntheticsDowntimeResponse",
          "v2.synthetics_downtimes_response" => "SyntheticsDowntimesResponse",
          "v2.synthetics_downtime_time_slot_date" => "SyntheticsDowntimeTimeSlotDate",
          "v2.synthetics_downtime_time_slot_recurrence_request" => "SyntheticsDowntimeTimeSlotRecurrenceRequest",
          "v2.synthetics_downtime_time_slot_recurrence_response" => "SyntheticsDowntimeTimeSlotRecurrenceResponse",
          ...
          "v2.synthetics_network_assertion" => "SyntheticsNetworkAssertion",
          "v2.synthetics_network_assertion_jitter" => "SyntheticsNetworkAssertionJitter",
          "v2.synthetics_network_assertion_jitter_type" => "SyntheticsNetworkAssertionJitterType",
          "v2.synthetics_network_assertion_latency" => "SyntheticsNetworkAssertionLatency",
          "v2.synthetics_network_assertion_latency_type" => "SyntheticsNetworkAssertionLatencyType",
          "v2.synthetics_network_assertion_multi_network_hop" => "SyntheticsNetworkAssertionMultiNetworkHop",
          "v2.synthetics_network_assertion_multi_network_hop_type" => "SyntheticsNetworkAssertionMultiNetworkHopType",
          "v2.synthetics_network_assertion_operator" => "SyntheticsNetworkAssertionOperator",
          "v2.synthetics_network_assertion_packet_loss_percentage" => "SyntheticsNetworkAssertionPacketLossPercentage",
          "v2.synthetics_network_assertion_packet_loss_percentage_type" => "SyntheticsNetworkAssertionPacketLossPercentageType",
          "v2.synthetics_network_assertion_property" => "SyntheticsNetworkAssertionProperty",
          "v2.synthetics_network_test" => "SyntheticsNetworkTest",
          "v2.synthetics_network_test_config" => "SyntheticsNetworkTestConfig",
          "v2.synthetics_network_test_edit" => "SyntheticsNetworkTestEdit",
          "v2.synthetics_network_test_edit_request" => "SyntheticsNetworkTestEditRequest",
          "v2.synthetics_network_test_request" => "SyntheticsNetworkTestRequest",
          "v2.synthetics_network_test_request_tcp_method" => "SyntheticsNetworkTestRequestTCPMethod",
          "v2.synthetics_network_test_response" => "SyntheticsNetworkTestResponse",
          "v2.synthetics_network_test_response_data" => "SyntheticsNetworkTestResponseData",
          ...
          "v2.synthetics_suite_types" => "SyntheticsSuiteTypes",
          "v2.synthetics_test_file_abort_multipart_upload_request" => "SyntheticsTestFileAbortMultipartUploadRequest",
          "v2.synthetics_test_file_complete_multipart_upload_part" => "SyntheticsTestFileCompleteMultipartUploadPart",
          "v2.synthetics_test_file_complete_multipart_upload_request" => "SyntheticsTestFileCompleteMultipartUploadRequest",
          "v2.synthetics_test_file_download_request" => "SyntheticsTestFileDownloadRequest",
          "v2.synthetics_test_file_download_response" => "SyntheticsTestFileDownloadResponse",
          "v2.synthetics_test_file_multipart_presigned_urls_params" => "SyntheticsTestFileMultipartPresignedUrlsParams",
          "v2.synthetics_test_file_multipart_presigned_urls_part" => "SyntheticsTestFileMultipartPresignedUrlsPart",
          ...
          "v2.synthetics_test_options_retry" => "SyntheticsTestOptionsRetry",
          "v2.synthetics_test_options_scheduling" => "SyntheticsTestOptionsScheduling",
          "v2.synthetics_test_options_scheduling_timeframe" => "SyntheticsTestOptionsSchedulingTimeframe",
          "v2.synthetics_test_parent_suite_attributes" => "SyntheticsTestParentSuiteAttributes",
          "v2.synthetics_test_parent_suite_data" => "SyntheticsTestParentSuiteData",
          ...
          "v2.synthetics_test_version_change_attributes" => "SyntheticsTestVersionChangeAttributes",
          "v2.synthetics_test_version_change_data" => "SyntheticsTestVersionChangeData",
          "v2.synthetics_test_version_change_metadata_item" => "SyntheticsTestVersionChangeMetadataItem",
          "v2.synthetics_test_version_change_type" => "SyntheticsTestVersionChangeType",
          "v2.synthetics_test_version_data" => "SyntheticsTestVersionData",
          "v2.synthetics_test_version_diff_patch_diff" => "SyntheticsTestVersionDiffPatchDiff",
          "v2.synthetics_test_version_diff_patches" => "SyntheticsTestVersionDiffPatches",
          "v2.synthetics_test_version_history_meta" => "SyntheticsTestVersionHistoryMeta",
          "v2.synthetics_test_version_history_response" => "SyntheticsTestVersionHistoryResponse",
          "v2.synthetics_test_version_response" => "SyntheticsTestVersionResponse",
          "v2.synthetics_test_version_type" => "SyntheticsTestVersionType",
          ...
          "v2.table_result_v2_data_attributes_file_metadata_one_of_access_details_gcp_detail" => "TableResultV2DataAttributesFileMetadataOneOfAccessDetailsGcpDetail",
          "v2.table_result_v2_data_attributes_schema" => "TableResultV2DataAttributesSchema",
          ...
          "v2.tag_data" => "TagData",
          "v2.tag_data_type" => "TagDataType",
          "v2.tag_indexing_rule_attributes" => "TagIndexingRuleAttributes",
          "v2.tag_indexing_rule_create_attributes" => "TagIndexingRuleCreateAttributes",
          "v2.tag_indexing_rule_create_data" => "TagIndexingRuleCreateData",
          "v2.tag_indexing_rule_create_request" => "TagIndexingRuleCreateRequest",
          "v2.tag_indexing_rule_data" => "TagIndexingRuleData",
          "v2.tag_indexing_rule_dynamic_tags" => "TagIndexingRuleDynamicTags",
          "v2.tag_indexing_rule_exemption_attributes" => "TagIndexingRuleExemptionAttributes",
          "v2.tag_indexing_rule_exemption_create_attributes" => "TagIndexingRuleExemptionCreateAttributes",
          "v2.tag_indexing_rule_exemption_create_data" => "TagIndexingRuleExemptionCreateData",
          "v2.tag_indexing_rule_exemption_create_request" => "TagIndexingRuleExemptionCreateRequest",
          "v2.tag_indexing_rule_exemption_data" => "TagIndexingRuleExemptionData",
          "v2.tag_indexing_rule_exemption_response" => "TagIndexingRuleExemptionResponse",
          "v2.tag_indexing_rule_exemption_type" => "TagIndexingRuleExemptionType",
          "v2.tag_indexing_rule_metric_match" => "TagIndexingRuleMetricMatch",
          "v2.tag_indexing_rule_options" => "TagIndexingRuleOptions",
          "v2.tag_indexing_rule_options_data" => "TagIndexingRuleOptionsData",
          "v2.tag_indexing_rule_order_attributes" => "TagIndexingRuleOrderAttributes",
          "v2.tag_indexing_rule_order_data" => "TagIndexingRuleOrderData",
          "v2.tag_indexing_rule_order_request" => "TagIndexingRuleOrderRequest",
          "v2.tag_indexing_rule_response" => "TagIndexingRuleResponse",
          "v2.tag_indexing_rules_response" => "TagIndexingRulesResponse",
          "v2.tag_indexing_rules_response_meta" => "TagIndexingRulesResponseMeta",
          "v2.tag_indexing_rule_type" => "TagIndexingRuleType",
          ...
          "v2.tag_rule_attributes" => "TagRuleAttributes",
          "v2.tag_rule_create_attributes" => "TagRuleCreateAttributes",
          "v2.tag_rule_create_data" => "TagRuleCreateData",
          "v2.tag_rule_create_request" => "TagRuleCreateRequest",
          "v2.tag_rule_create_type" => "TagRuleCreateType",
          "v2.tag_rule_data" => "TagRuleData",
          "v2.tag_rule_include" => "TagRuleInclude",
          "v2.tag_rule_relationships" => "TagRuleRelationships",
          "v2.tag_rule_resource_type" => "TagRuleResourceType",
          "v2.tag_rule_response" => "TagRuleResponse",
          "v2.tag_rule_score_attributes" => "TagRuleScoreAttributes",
          "v2.tag_rule_score_data" => "TagRuleScoreData",
          "v2.tag_rule_score_relationship" => "TagRuleScoreRelationship",
          "v2.tag_rule_score_relationship_data" => "TagRuleScoreRelationshipData",
          "v2.tag_rule_score_resource_type" => "TagRuleScoreResourceType",
          "v2.tag_rule_score_response" => "TagRuleScoreResponse",
          "v2.tag_rules_list_response" => "TagRulesListResponse",
          "v2.tag_rule_source" => "TagRuleSource",
          "v2.tag_rule_type" => "TagRuleType",
          "v2.tag_rule_update_attributes" => "TagRuleUpdateAttributes",
          "v2.tag_rule_update_data" => "TagRuleUpdateData",
          "v2.tag_rule_update_request" => "TagRuleUpdateRequest",
          ...
          "v2.tenancy_config" => "TenancyConfig",
          "v2.tenancy_config_data" => "TenancyConfigData",
          "v2.tenancy_config_data_attributes" => "TenancyConfigDataAttributes",
          "v2.tenancy_config_data_attributes_logs_config" => "TenancyConfigDataAttributesLogsConfig",
          "v2.tenancy_config_data_attributes_metrics_config" => "TenancyConfigDataAttributesMetricsConfig",
          "v2.tenancy_config_data_attributes_regions_config" => "TenancyConfigDataAttributesRegionsConfig",
          "v2.tenancy_config_list" => "TenancyConfigList",
          "v2.tenancy_products_data" => "TenancyProductsData",
          "v2.tenancy_products_data_attributes" => "TenancyProductsDataAttributes",
          ...
          "v2.test_optimization_get_service_settings_request_data_type" => "TestOptimizationGetServiceSettingsRequestDataType",
          "v2.test_optimization_service_settings_attributes" => "TestOptimizationServiceSettingsAttributes",
          ...
          "v2.timeline_cell_author_user_content" => "TimelineCellAuthorUserContent",
          "v2.timeline_cell_author_user_type" => "TimelineCellAuthorUserType",
          "v2.timeline_cell_content" => "TimelineCellContent",
          "v2.timeline_cell_content_comment" => "TimelineCellContentComment",
          "v2.timeline_cell_resource" => "TimelineCellResource",
          "v2.timeline_cell_resource_type" => "TimelineCellResourceType",
          "v2.timeline_cell_type" => "TimelineCellType",
          "v2.timeline_response" => "TimelineResponse",
          "v2.time_restriction" => "TimeRestriction",
          "v2.time_restrictions" => "TimeRestrictions",
          "v2.timeseries_anomaly_investigation_anomaly" => "TimeseriesAnomalyInvestigationAnomaly",
          "v2.timeseries_anomaly_investigation_anomaly_finding" => "TimeseriesAnomalyInvestigationAnomalyFinding",
          "v2.timeseries_anomaly_investigation_anomaly_finding_type" => "TimeseriesAnomalyInvestigationAnomalyFindingType",
          "v2.timeseries_anomaly_investigation_anomaly_type" => "TimeseriesAnomalyInvestigationAnomalyType",
          "v2.timeseries_anomaly_investigation_complete_status" => "TimeseriesAnomalyInvestigationCompleteStatus",
          "v2.timeseries_anomaly_investigation_configuration_source" => "TimeseriesAnomalyInvestigationConfigurationSource",
          "v2.timeseries_anomaly_investigation_data_source" => "TimeseriesAnomalyInvestigationDataSource",
          "v2.timeseries_anomaly_investigation_detection" => "TimeseriesAnomalyInvestigationDetection",
          "v2.timeseries_anomaly_investigation_finding" => "TimeseriesAnomalyInvestigationFinding",
          "v2.timeseries_anomaly_investigation_finding_synonym" => "TimeseriesAnomalyInvestigationFindingSynonym",
          "v2.timeseries_anomaly_investigation_finding_tag" => "TimeseriesAnomalyInvestigationFindingTag",
          "v2.timeseries_anomaly_investigation_formula" => "TimeseriesAnomalyInvestigationFormula",
          "v2.timeseries_anomaly_investigation_formula_limit" => "TimeseriesAnomalyInvestigationFormulaLimit",
          "v2.timeseries_anomaly_investigation_formula_limit_order" => "TimeseriesAnomalyInvestigationFormulaLimitOrder",
          "v2.timeseries_anomaly_investigation_influence_type" => "TimeseriesAnomalyInvestigationInfluenceType",
          "v2.timeseries_anomaly_investigation_influential_tag_finding" => "TimeseriesAnomalyInvestigationInfluentialTagFinding",
          "v2.timeseries_anomaly_investigation_influential_tag_finding_type" => "TimeseriesAnomalyInvestigationInfluentialTagFindingType",
          "v2.timeseries_anomaly_investigation_interval" => "TimeseriesAnomalyInvestigationInterval",
          "v2.timeseries_anomaly_investigation_maximum_deviation" => "TimeseriesAnomalyInvestigationMaximumDeviation",
          "v2.timeseries_anomaly_investigation_meta_type" => "TimeseriesAnomalyInvestigationMetaType",
          "v2.timeseries_anomaly_investigation_metric_query" => "TimeseriesAnomalyInvestigationMetricQuery",
          "v2.timeseries_anomaly_investigation_query_execution_status" => "TimeseriesAnomalyInvestigationQueryExecutionStatus",
          "v2.timeseries_anomaly_investigation_query_status" => "TimeseriesAnomalyInvestigationQueryStatus",
          "v2.timeseries_anomaly_investigation_request" => "TimeseriesAnomalyInvestigationRequest",
          "v2.timeseries_anomaly_investigation_request_attributes" => "TimeseriesAnomalyInvestigationRequestAttributes",
          "v2.timeseries_anomaly_investigation_request_data" => "TimeseriesAnomalyInvestigationRequestData",
          "v2.timeseries_anomaly_investigation_response" => "TimeseriesAnomalyInvestigationResponse",
          "v2.timeseries_anomaly_investigation_response_attributes" => "TimeseriesAnomalyInvestigationResponseAttributes",
          "v2.timeseries_anomaly_investigation_response_data" => "TimeseriesAnomalyInvestigationResponseData",
          "v2.timeseries_anomaly_investigation_response_id" => "TimeseriesAnomalyInvestigationResponseID",
          "v2.timeseries_anomaly_investigation_response_meta" => "TimeseriesAnomalyInvestigationResponseMeta",
          "v2.timeseries_anomaly_investigation_result" => "TimeseriesAnomalyInvestigationResult",
          "v2.timeseries_anomaly_investigation_results_warning" => "TimeseriesAnomalyInvestigationResultsWarning",
          "v2.timeseries_anomaly_investigation_series" => "TimeseriesAnomalyInvestigationSeries",
          "v2.timeseries_anomaly_investigation_tag_analysis" => "TimeseriesAnomalyInvestigationTagAnalysis",
          "v2.timeseries_anomaly_investigation_tag_analysis_status" => "TimeseriesAnomalyInvestigationTagAnalysisStatus",
          "v2.timeseries_anomaly_investigation_timeseries_request" => "TimeseriesAnomalyInvestigationTimeseriesRequest",
          "v2.timeseries_anomaly_investigation_type" => "TimeseriesAnomalyInvestigationType",
          ...
          "v2.twilio_alerts_logs_integration_dataflow_request" => "TwilioAlertsLogsIntegrationDataflowRequest",
          "v2.twilio_alerts_logs_integration_dataflow_response" => "TwilioAlertsLogsIntegrationDataflowResponse",
          "v2.twilio_call_summaries_logs_integration_dataflow_request" => "TwilioCallSummariesLogsIntegrationDataflowRequest",
          "v2.twilio_call_summaries_logs_integration_dataflow_response" => "TwilioCallSummariesLogsIntegrationDataflowResponse",
          "v2.twilio_cloud_cost_metrics_integration_dataflow_request" => "TwilioCloudCostMetricsIntegrationDataflowRequest",
          "v2.twilio_cloud_cost_metrics_integration_dataflow_response" => "TwilioCloudCostMetricsIntegrationDataflowResponse",
          "v2.twilio_events_logs_integration_dataflow_request" => "TwilioEventsLogsIntegrationDataflowRequest",
          "v2.twilio_events_logs_integration_dataflow_response" => "TwilioEventsLogsIntegrationDataflowResponse",
          "v2.twilio_integration_account_authentication_request" => "TwilioIntegrationAccountAuthenticationRequest",
          "v2.twilio_integration_account_authentication_response" => "TwilioIntegrationAccountAuthenticationResponse",
          "v2.twilio_integration_account_authentication_update" => "TwilioIntegrationAccountAuthenticationUpdate",
          "v2.twilio_integration_account_basic_auth_request" => "TwilioIntegrationAccountBasicAuthRequest",
          "v2.twilio_integration_account_basic_auth_response" => "TwilioIntegrationAccountBasicAuthResponse",
          "v2.twilio_integration_account_basic_auth_type" => "TwilioIntegrationAccountBasicAuthType",
          "v2.twilio_integration_account_basic_auth_update" => "TwilioIntegrationAccountBasicAuthUpdate",
          ...
          "v2.twilio_integration_account_create_request" => "TwilioIntegrationAccountCreateRequest",
          "v2.twilio_integration_account_response" => "TwilioIntegrationAccountResponse",
          "v2.twilio_integration_account_response_attributes" => "TwilioIntegrationAccountResponseAttributes",
          "v2.twilio_integration_account_response_data" => "TwilioIntegrationAccountResponseData",
          "v2.twilio_integration_account_settings_request" => "TwilioIntegrationAccountSettingsRequest",
          "v2.twilio_integration_account_settings_response" => "TwilioIntegrationAccountSettingsResponse",
          "v2.twilio_integration_account_settings_update" => "TwilioIntegrationAccountSettingsUpdate",
          "v2.twilio_integration_accounts_response" => "TwilioIntegrationAccountsResponse",
          "v2.twilio_integration_account_update_attributes" => "TwilioIntegrationAccountUpdateAttributes",
          "v2.twilio_integration_account_update_data" => "TwilioIntegrationAccountUpdateData",
          "v2.twilio_integration_account_update_request" => "TwilioIntegrationAccountUpdateRequest",
          "v2.twilio_integration_dataflows_request" => "TwilioIntegrationDataflowsRequest",
          "v2.twilio_integration_dataflows_response" => "TwilioIntegrationDataflowsResponse",
          "v2.twilio_messages_logs_integration_dataflow_request" => "TwilioMessagesLogsIntegrationDataflowRequest",
          "v2.twilio_messages_logs_integration_dataflow_response" => "TwilioMessagesLogsIntegrationDataflowResponse",
          ...
          "v2.unassign_seats_user_request" => "UnassignSeatsUserRequest",
          "v2.unassign_seats_user_request_data" => "UnassignSeatsUserRequestData",
          "v2.unassign_seats_user_request_data_attributes" => "UnassignSeatsUserRequestDataAttributes",
          "v2.unit" => "Unit",
          "v2.unit_cost_create_request" => "UnitCostCreateRequest",
          "v2.unit_cost_create_request_data" => "UnitCostCreateRequestData",
          "v2.unit_cost_data_attributes_response" => "UnitCostDataAttributesResponse",
          "v2.unit_cost_data_response" => "UnitCostDataResponse",
          "v2.unit_cost_query_definition" => "UnitCostQueryDefinition",
          "v2.unit_cost_request_attributes" => "UnitCostRequestAttributes",
          "v2.unit_cost_response" => "UnitCostResponse",
          "v2.unit_costs_response" => "UnitCostsResponse",
          "v2.unit_cost_type" => "UnitCostType",
          "v2.unit_cost_update_request" => "UnitCostUpdateRequest",
          "v2.unit_cost_update_request_data" => "UnitCostUpdateRequestData",
          ...
          "v2.update_app_favorite_request" => "UpdateAppFavoriteRequest",
          "v2.update_app_favorite_request_data" => "UpdateAppFavoriteRequestData",
          "v2.update_app_favorite_request_data_attributes" => "UpdateAppFavoriteRequestDataAttributes",
          "v2.update_app_protection_level_request" => "UpdateAppProtectionLevelRequest",
          "v2.update_app_protection_level_request_data" => "UpdateAppProtectionLevelRequestData",
          "v2.update_app_protection_level_request_data_attributes" => "UpdateAppProtectionLevelRequestDataAttributes",
          ...
          "v2.update_app_self_service_request" => "UpdateAppSelfServiceRequest",
          "v2.update_app_self_service_request_data" => "UpdateAppSelfServiceRequestData",
          "v2.update_app_self_service_request_data_attributes" => "UpdateAppSelfServiceRequestDataAttributes",
          "v2.update_app_tags_request" => "UpdateAppTagsRequest",
          "v2.update_app_tags_request_data" => "UpdateAppTagsRequestData",
          "v2.update_app_tags_request_data_attributes" => "UpdateAppTagsRequestDataAttributes",
          "v2.update_app_version_name_request" => "UpdateAppVersionNameRequest",
          "v2.update_app_version_name_request_data" => "UpdateAppVersionNameRequestData",
          "v2.update_app_version_name_request_data_attributes" => "UpdateAppVersionNameRequestDataAttributes",
          "v2.update_campaign_request" => "UpdateCampaignRequest",
          "v2.update_campaign_request_attributes" => "UpdateCampaignRequestAttributes",
          "v2.update_campaign_request_data" => "UpdateCampaignRequestData",
          ...
          "v2.update_environment_attributes" => "UpdateEnvironmentAttributes",
          "v2.update_environment_data" => "UpdateEnvironmentData",
          "v2.update_environment_data_type" => "UpdateEnvironmentDataType",
          "v2.update_environment_request" => "UpdateEnvironmentRequest",
          "v2.update_feature_flag_attributes" => "UpdateFeatureFlagAttributes",
          "v2.update_feature_flag_data" => "UpdateFeatureFlagData",
          "v2.update_feature_flag_data_type" => "UpdateFeatureFlagDataType",
          "v2.update_feature_flag_request" => "UpdateFeatureFlagRequest",
          ...
          "v2.update_form_data" => "UpdateFormData",
          "v2.update_form_data_attributes" => "UpdateFormDataAttributes",
          "v2.update_form_request" => "UpdateFormRequest",
          ...
          "v2.update_tenancy_config_data" => "UpdateTenancyConfigData",
          "v2.update_tenancy_config_data_attributes" => "UpdateTenancyConfigDataAttributes",
          "v2.update_tenancy_config_data_attributes_auth_credentials" => "UpdateTenancyConfigDataAttributesAuthCredentials",
          "v2.update_tenancy_config_data_attributes_logs_config" => "UpdateTenancyConfigDataAttributesLogsConfig",
          "v2.update_tenancy_config_data_attributes_metrics_config" => "UpdateTenancyConfigDataAttributesMetricsConfig",
          ...
          "v2.update_user_identity_providers_request" => "UpdateUserIdentityProvidersRequest",
          ...
          "v2.upsert_and_publish_form_version_data" => "UpsertAndPublishFormVersionData",
          "v2.upsert_and_publish_form_version_data_attributes" => "UpsertAndPublishFormVersionDataAttributes",
          "v2.upsert_and_publish_form_version_request" => "UpsertAndPublishFormVersionRequest",
          "v2.upsert_and_publish_form_version_upsert_params" => "UpsertAndPublishFormVersionUpsertParams",
          ...
          "v2.upsert_form_version_data" => "UpsertFormVersionData",
          "v2.upsert_form_version_data_attributes" => "UpsertFormVersionDataAttributes",
          "v2.upsert_form_version_request" => "UpsertFormVersionRequest",
          "v2.upsert_form_version_upsert_params" => "UpsertFormVersionUpsertParams",
          ...
          "v2.usage_quota_bulk_result_attributes" => "UsageQuotaBulkResultAttributes",
          "v2.usage_quota_bulk_result_data" => "UsageQuotaBulkResultData",
          "v2.usage_quota_create_attributes" => "UsageQuotaCreateAttributes",
          "v2.usage_quota_create_data" => "UsageQuotaCreateData",
          "v2.usage_quota_response" => "UsageQuotaResponse",
          "v2.usage_quota_response_attributes" => "UsageQuotaResponseAttributes",
          "v2.usage_quota_response_data" => "UsageQuotaResponseData",
          "v2.usage_quotas_bulk_response" => "UsageQuotasBulkResponse",
          "v2.usage_quotas_create_request" => "UsageQuotasCreateRequest",
          "v2.usage_quotas_list_response" => "UsageQuotasListResponse",
          "v2.usage_quotas_response_meta" => "UsageQuotasResponseMeta",
          "v2.usage_quotas_response_meta_page" => "UsageQuotasResponseMetaPage",
          "v2.usage_quota_type" => "UsageQuotaType",
          "v2.usage_quota_update_attributes" => "UsageQuotaUpdateAttributes",
          "v2.usage_quota_update_data" => "UsageQuotaUpdateData",
          "v2.usage_quota_update_request" => "UsageQuotaUpdateRequest",
          ...
          "v2.user_authorized_client_attributes" => "UserAuthorizedClientAttributes",
          "v2.user_authorized_client_data" => "UserAuthorizedClientData",
          "v2.user_authorized_client_relationship_o_auth2_client" => "UserAuthorizedClientRelationshipOAuth2Client",
          "v2.user_authorized_client_relationship_o_auth2_client_data" => "UserAuthorizedClientRelationshipOAuth2ClientData",
          "v2.user_authorized_client_relationship_o_auth2_client_data_type" => "UserAuthorizedClientRelationshipOAuth2ClientDataType",
          "v2.user_authorized_client_relationships" => "UserAuthorizedClientRelationships",
          "v2.user_authorized_client_relationship_scope_data" => "UserAuthorizedClientRelationshipScopeData",
          "v2.user_authorized_client_relationship_scope_data_type" => "UserAuthorizedClientRelationshipScopeDataType",
          "v2.user_authorized_client_relationship_scopes" => "UserAuthorizedClientRelationshipScopes",
          "v2.user_authorized_client_relationship_user" => "UserAuthorizedClientRelationshipUser",
          "v2.user_authorized_client_relationship_user_data" => "UserAuthorizedClientRelationshipUserData",
          "v2.user_authorized_client_relationship_user_data_type" => "UserAuthorizedClientRelationshipUserDataType",
          "v2.user_authorized_client_response" => "UserAuthorizedClientResponse",
          "v2.user_authorized_clients_response" => "UserAuthorizedClientsResponse",
          "v2.user_authorized_client_type" => "UserAuthorizedClientType",
          ...
          "v2.user_override_identity_provider_data" => "UserOverrideIdentityProviderData",
          "v2.user_override_identity_provider_data_type" => "UserOverrideIdentityProviderDataType",
          "v2.user_override_identity_providers_response" => "UserOverrideIdentityProvidersResponse",
          "v2.user_relationship_data" => "UserRelationshipData",
          "v2.user_relationship_identity_provider_data" => "UserRelationshipIdentityProviderData",
          "v2.user_relationship_identity_provider_data_type" => "UserRelationshipIdentityProviderDataType",
          ...
          "v2.validate_api_key_status" => "ValidateAPIKeyStatus",
          "v2.validate_v2_attributes" => "ValidateV2Attributes",
          "v2.validate_v2_data" => "ValidateV2Data",
          "v2.validate_v2_response" => "ValidateV2Response",
          "v2.validate_v2_type" => "ValidateV2Type",
          "v2.validation_error" => "ValidationError",
          "v2.validation_error_meta" => "ValidationErrorMeta",
          "v2.validation_response" => "ValidationResponse",
          "v2.value_type" => "ValueType",
          "v2.variant" => "Variant",
          "v2.variant_weight" => "VariantWeight",
          "v2.variant_weight_request" => "VariantWeightRequest",
          "v2.version_history_update" => "VersionHistoryUpdate",
          "v2.version_history_update_type" => "VersionHistoryUpdateType",
          "v2.viewership_history_session_array" => "ViewershipHistorySessionArray",
          "v2.viewership_history_session_data" => "ViewershipHistorySessionData",
          "v2.viewership_history_session_data_attributes" => "ViewershipHistorySessionDataAttributes",
          "v2.viewership_history_session_data_type" => "ViewershipHistorySessionDataType",
          ...
          "v2.watch" => "Watch",
          "v2.watch_data" => "WatchData",
          "v2.watch_data_attributes" => "WatchDataAttributes",
          "v2.watch_data_type" => "WatchDataType",
          "v2.watcher_array" => "WatcherArray",
          ...
          "v2.workflow_list_item" => "WorkflowListItem",
          "v2.workflow_list_item_attributes" => "WorkflowListItemAttributes",
          "v2.workflow_run_as" => "WorkflowRunAs",
          "v2.workflow_run_as_initiator" => "WorkflowRunAsInitiator",
          "v2.workflow_run_as_initiator_type" => "WorkflowRunAsInitiatorType",
          "v2.workflow_run_as_owner" => "WorkflowRunAsOwner",
          "v2.workflow_run_as_owner_type" => "WorkflowRunAsOwnerType",
          "v2.workflow_run_as_service_account" => "WorkflowRunAsServiceAccount",
          "v2.workflow_run_as_service_account_type" => "WorkflowRunAsServiceAccountType",
          "v2.workflow_run_as_user_mode" => "WorkflowRunAsUserMode",
        ...
        "v2.compliance_api" => "ComplianceAPI",
        ...
        "v2.databricks_integration_api" => "DatabricksIntegrationAPI",
        ...
        "v2.elastic_cloud_integration_api" => "ElasticCloudIntegrationAPI",
        "v2.entity_integration_configs_api" => "EntityIntegrationConfigsAPI",
        "v2.entity_risk_scores_api" => "EntityRiskScoresAPI",
        "v2.error_tracking_api" => "ErrorTrackingAPI",
        "v2.events_api" => "EventsAPI",
        "v2.execution_policy_api" => "ExecutionPolicyAPI",
        "v2.fastly_integration_api" => "FastlyIntegrationAPI",
        "v2.feature_flags_api" => "FeatureFlagsAPI",
        "v2.fleet_automation_api" => "FleetAutomationAPI",
        ...
        "v2.identity_providers_api" => "IdentityProvidersAPI",
        "v2.incidents_api" => "IncidentsAPI",
        "v2.integration_accounts_api" => "IntegrationAccountsAPI",
        "v2.integrations_api" => "IntegrationsAPI",
        "v2.ip_allowlist_api" => "IPAllowlistAPI",
        "v2.jira_integration_api" => "JiraIntegrationAPI",
        ...
        "v2.network_health_insights_api" => "NetworkHealthInsightsAPI",
        ...
        "v2.org_authorized_clients_api" => "OrgAuthorizedClientsAPI",
        ...
        "v2.product_catalog_api" => "ProductCatalogAPI",
        ...
        "v2.snowflake_integration_api" => "SnowflakeIntegrationAPI",
        ...
        "v2.tag_rules_api" => "TagRulesAPI",
        "v2.teams_api" => "TeamsAPI",
        "v2.test_optimization_api" => "TestOptimizationAPI",
        "v2.threat_intelligence_api" => "ThreatIntelligenceAPI",
        "v2.timeseries_anomaly_investigations_api" => "TimeseriesAnomalyInvestigationsAPI",
        "v2.twilio_integration_api" => "TwilioIntegrationAPI",
        "v2.usage_metering_api" => "UsageMeteringAPI",
        "v2.user_authorized_clients_api" => "UserAuthorizedClientsAPI",
