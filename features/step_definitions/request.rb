module APIWorld
  ...
  def create_service
    @api_client.config.unstable_operations[:create_service] = true
    @api_client.config.unstable_operations[:delete_service] = true
  ...
  def create_team
    @api_client.config.unstable_operations[:create_team] = true
    @api_client.config.unstable_operations[:delete_team] = true
