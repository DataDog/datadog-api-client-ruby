ScenariosModelMappings = {
    ...
    "v2.DeleteSourcemaps" => {
            ...
            "filter_version" => "Array<String>",
            "filter_variant" => "Array<String>",
            "filter_id" => "Array<String>",
            "filter_build_id" => "Array<String>",
            "filter_uuid" => "Array<String>",
            "filter_platform" => "Array<String>",
            "filter_build_number" => "Array<String>",
            "filter_bundle_name" => "Array<String>",
            "filter_arch" => "Array<String>",
            "filter_symbol_source" => "Array<String>",
            "filter_origin" => "Array<String>",
            "filter_origin_version" => "Array<String>",
            "filter_filename" => "String",
            "filter_debug_id" => "String",
            "filter_gnu_build_id" => "String",
            "filter_go_build_id" => "String",
            "filter_file_hash" => "String",
    },
    "v2.GetSourcemaps" => {
            "filename" => "String",
            "service" => "String",
