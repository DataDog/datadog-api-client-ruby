...
This repository contains code that is autogenerated from Datadog's public OpenAPI specifications. The generator is maintained in the [Datadog API client generator](https://github.com/DataDog/datadog-api-client-generator) repository.
