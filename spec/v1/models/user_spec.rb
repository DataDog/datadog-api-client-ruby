...
# Unit tests for DatadogAPIClient::V1::User
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DatadogAPIClient::V1::User do
  let(:instance) { DatadogAPIClient::V1::User.new }

  describe 'test an instance of User' do
    it 'should create an instance of User' do
      expect(instance).to be_instance_of(DatadogAPIClient::V1::User)
    end
  end
