...
# Unit tests for DatadogAPIClient::V1::SyntheticsAPIStep
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe DatadogAPIClient::V1::SyntheticsAPIStep do
  let(:instance) { DatadogAPIClient::V1::SyntheticsAPIStep.new }

  describe 'test an instance of SyntheticsAPIStep' do
    it 'should create an instance of SyntheticsAPIStep' do
