...
| **mobile_rum_lite_session_count_sum**            | **Integer**                                                    | Shows the sum of all mobile lite sessions over all hours in the current date for all organizations.                                                               | [optional] |
...
| **mobile_rum_units_sum**                         | **Integer**                                                    | Shows the sum of all mobile RUM units over all hours in the current date for all organizations.                                                                   | [optional] |
