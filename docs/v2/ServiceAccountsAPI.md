...
| ------ | ------------ | ----------- |
| [**create_service_account**](ServiceAccountsAPI.md#create_service_account) | **POST** /api/v2/service_accounts | Create a service account |
| [**create_service_account_application_key**](ServiceAccountsAPI.md#create_service_account_application_key) | **POST** /api/v2/service_accounts/{service_account_id}/application_keys | Create an app key for this service account |
| [**delete_service_account_application_key**](ServiceAccountsAPI.md#delete_service_account_application_key) | **DELETE** /api/v2/service_accounts/{service_account_id}/application_keys/{app_key_id} | Delete an app key owned by this service account |
| [**get_service_account_application_key**](ServiceAccountsAPI.md#get_service_account_application_key) | **GET** /api/v2/service_accounts/{service_account_id}/application_keys/{app_key_id} | Get one app key owned by this service account |
| [**list_service_account_application_keys**](ServiceAccountsAPI.md#list_service_account_application_keys) | **GET** /api/v2/service_accounts/{service_account_id}/application_keys | Get all app keys owned by this service account |
| [**update_service_account_application_key**](ServiceAccountsAPI.md#update_service_account_application_key) | **PATCH** /api/v2/service_accounts/{service_account_id}/application_keys/{app_key_id} | Edit an app key owned by this service account |
...
body = DatadogAPIClient::V2::ServiceAccountCreateRequest.new({data: DatadogAPIClient::V2::UserCreateRequest.new({data: DatadogAPIClient::V2::UserCreateData.new({attributes: DatadogAPIClient::V2::UserCreateAttributes.new({email: 'jane.doe@example.com'}), type: DatadogAPIClient::V2::UsersType::USERS})})}) # ServiceAccountCreateRequest | 
...
begin
  ...
  puts "Error when calling ServiceAccountsAPI->create_service_account: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ServiceAccountsAPI->create_service_account_with_http_info: #{e}"
end
```
...
begin
  # Create an app key for this service account
...
begin
  # Delete an app key owned by this service account
...
begin
  # Get one app key owned by this service account
...
begin
  # Edit an app key owned by this service account
